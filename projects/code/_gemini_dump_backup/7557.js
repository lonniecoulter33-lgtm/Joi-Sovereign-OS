"use strict";(global.webpackChunk_loomhq_desktop_monorepo=global.webpackChunk_loomhq_desktop_monorepo||[]).push([[7557,3780,4460,9724],{862953:(Ce,ie,w)=>{var R;R={value:!0},ie.Z=void 0;var G=n(w(275271)),ge=n(w(774586));function n(ee){return ee&&ee.__esModule?ee:{default:ee}}const h=ee=>G.default.createElement(ge.default,Object.assign({dangerouslySetGlyph:'<path fill="currentcolor" fill-rule="evenodd" d="M7 2.5a4.5 4.5 0 1 0 0 9 4.5 4.5 0 0 0 0-9M1 7a6 6 0 1 1 10.74 3.68l3.29 3.29-1.06 1.06-3.29-3.29A6 6 0 0 1 1 7" clip-rule="evenodd"/>'},ee));h.displayName="SearchIcon";var pe=ie.Z=h},450630:(Ce,ie,w)=>{w.d(ie,{Ni:()=>n.T,Xn:()=>n.w,F4:()=>se});var R=w(908866),G=w(275271),ge=w(117267),n=w(156052),h=w(908308),pe=w(586997),ee=w(853434),T=w(669957),L=function(V,B){var O=arguments;if(B==null||!hasOwnProperty.call(B,"css"))return createElement.apply(void 0,O);var W=O.length,Q=new Array(W);Q[0]=Emotion,Q[1]=createEmotionProps(V,B);for(var q=2;q<W;q++)Q[q]=O[q];return createElement.apply(null,Q)},$=!1,M=null,N=function(Y){(0,R.Z)(V,Y);function V(O,W,Q){return Y.call(this,O,W,Q)||this}var B=V.prototype;return B.componentDidMount=function(){this.sheet=new ee.m({key:this.props.cache.key+"-global",nonce:this.props.cache.sheet.nonce,container:this.props.cache.sheet.container});var W=document.querySelector("style[data-emotion-"+this.props.cache.key+'="'+this.props.serialized.name+'"]');W!==null&&this.sheet.tags.push(W),this.props.cache.sheet.tags.length&&(this.sheet.before=this.props.cache.sheet.tags[0]),this.insertStyles()},B.componentDidUpdate=function(W){W.serialized.name!==this.props.serialized.name&&this.insertStyles()},B.insertStyles=function(){if(this.props.serialized.next!==void 0&&(0,h.M)(this.props.cache,this.props.serialized.next,!0),this.sheet.tags.length){var W=this.sheet.tags[this.sheet.tags.length-1].nextElementSibling;this.sheet.before=W,this.sheet.flush()}this.props.cache.insert("",this.props.serialized,this.sheet,!1)},B.componentWillUnmount=function(){this.sheet.flush()},B.render=function(){return null},V}(G.Component),se=function(){var V=T.Z.apply(void 0,arguments),B="animation-"+V.name;return{name:B,styles:"@keyframes "+B+"{"+V.styles+"}",anim:1,toString:function(){return"_EMO_"+this.name+"_"+this.styles+"_EMO_"}}},be=function Y(V){for(var B=V.length,O=0,W="";O<B;O++){var Q=V[O];if(Q!=null){var q=void 0;switch(typeof Q){case"boolean":break;case"object":{if(Array.isArray(Q))q=Y(Q);else{q="";for(var ye in Q)Q[ye]&&ye&&(q&&(q+=" "),q+=ye)}break}default:q=Q}q&&(W&&(W+=" "),W+=q)}}return W};function te(Y,V,B){var O=[],W=(0,h.f)(Y,O,B);return O.length<2?B:W+V(O)}var re=function(){return null},me=(0,n.w)(function(Y,V){return(0,G.createElement)(n.T.Consumer,null,function(B){var O=!1,W=function(){for(var i=arguments.length,k=new Array(i),E=0;E<i;E++)k[E]=arguments[E];var He=(0,pe.O)(k,V.registered);return(0,h.M)(V,He,!1),V.key+"-"+He.name},Q=function(){for(var i=arguments.length,k=new Array(i),E=0;E<i;E++)k[E]=arguments[E];return te(V.registered,W,be(k))},q={css:W,cx:Q,theme:B},ye=Y.children(q);O=!0;var Ue=(0,G.createElement)(re,null);return(0,G.createElement)(G.Fragment,null,Ue,ye)})})},896542:(Ce,ie,w)=>{w.d(ie,{u:()=>G});var R=w(275271);function G(){return R.createElement("span",{"aria-hidden":!0,"data-testid":"ads-refreshed-icon"},R.createElement("svg",{viewBox:"-2 -2 16 16"},R.createElement("path",{fill:"currentColor",fillRule:"evenodd",d:"M2.03 3.97 6 7.94l3.97-3.97 1.06 1.06-4.5 4.5a.75.75 0 0 1-1.06 0l-4.5-4.5z",clipRule:"evenodd"})))}var ge=w(182560)},182560:(Ce,ie,w)=>{var R=Object.defineProperty,G=Object.defineProperties,ge=Object.getOwnPropertyDescriptors,n=Object.getOwnPropertySymbols,h=Object.prototype.hasOwnProperty,pe=Object.prototype.propertyIsEnumerable,ee=($,M,N)=>M in $?R($,M,{enumerable:!0,configurable:!0,writable:!0,value:N}):$[M]=N,T=($,M)=>{for(var N in M||(M={}))h.call(M,N)&&ee($,N,M[N]);if(n)for(var N of n(M))pe.call(M,N)&&ee($,N,M[N]);return $},L=($,M)=>G($,ge(M))},183780:(Ce,ie,w)=>{w.d(ie,{ggW:()=>Ye,zxk:()=>cl,W20:()=>fe,Ltx:()=>Go,JO$:()=>ce,aVo:()=>j1,wc3:()=>qr,rsf:()=>Zr,OK9:()=>U1,mQc:()=>J1,xvT:()=>Ie,Ut4:()=>fr});var R=w(738067),G=w(66292),ge=w.n(G),n=w(275271),h=w(992671),pe=w(485800),ee=w(582805),T=w(66333),L=w(797981),$=w(773023),M=w(484285),N=w(862953),se=w(12131),be=w(566172),te=w.n(be),re=w(407770),me=w(306317),Y=w(957530),V=w(230967),B=w(854831),O=Object.defineProperty,W=Object.defineProperties,Q=Object.getOwnPropertyDescriptors,q=Object.getOwnPropertySymbols,ye=Object.prototype.hasOwnProperty,Ue=Object.prototype.propertyIsEnumerable,Ke=(e,t,a)=>t in e?O(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a,i=(e,t)=>{for(var a in t||(t={}))ye.call(t,a)&&Ke(e,a,t[a]);if(q)for(var a of q(t))Ue.call(t,a)&&Ke(e,a,t[a]);return e},k=(e,t)=>W(e,Q(t)),E=(e,t)=>{var a={};for(var r in e)ye.call(e,r)&&t.indexOf(r)<0&&(a[r]=e[r]);if(e!=null&&q)for(var r of q(e))t.indexOf(r)<0&&Ue.call(e,r)&&(a[r]=e[r]);return a},He=(e,t)=>Math.round(e*t/100),Xt=(e,t)=>k(i({},e),{l:e.l-He(e.l,t)}),Di=(e,t)=>k(i({},e),{l:e.l+He(e.l,t)}),Vi=(e,t)=>k(i({},e),{s:e.s+He(e.s,t)}),ot=(e,t)=>k(i({},e),{a:t}),ma=15.8,va=31.6,ga=.14,pa=.46,fa=.9,ba=.8,Jt=.25,Ca=.06,wa=.15,Ea=.3,ya=.45,ze={red:{h:4,s:64,l:48,a:1},blurpleLight:{h:214.3,s:91.3,l:95.5,a:1},blurpleMedium:{h:216.5,s:92,l:90.2,a:1},blurple:{h:215.4,s:80,l:47.65,a:1},blurpleDark:{h:215.9,s:79.9,l:41,a:1},blurpleStrong:{h:216.3,s:69.2,l:22.9,a:1},offWhite:{h:0,s:0,l:97.25,a:1},blueLight:{h:216.5,s:92,l:90.2,a:1},blue:{h:215.4,s:80,l:47.65,a:1},blueDark:{h:216.3,s:69.2,l:23,a:1},magenta:{h:323,s:42,l:48,a:1},orangeLight:{h:4,s:100,l:91.2,a:1},orange:{h:11,s:100,l:62.2,a:1},orangeDark:{h:10.9,s:100,l:42.2,a:1},tealLight:{h:155,s:70,l:84,a:1},teal:{h:155,s:62,l:32,a:1},tealDark:{h:155,s:55,l:19,a:1},yellowLight:{h:43,s:93,l:82,a:1},yellow:{h:45.5,s:96,l:57,a:1},yellowDark:{h:39.8,s:100,l:49.4,a:1}},it={grey8:{h:228,s:6,l:17,a:1},grey7:{h:223,s:6,l:24.5,a:1},grey6:{h:224,s:5,l:44,a:1},grey5:{h:224,s:5,l:57,a:1},grey4:{h:223,s:5,l:73,a:1},grey3:{h:225,s:6,l:87.5,a:1},grey2:{h:210,s:7,l:94.5,a:1},grey1:{h:0,s:0,l:97.25,a:1},white:{h:0,s:0,l:100,a:1}},Qt={record:ze.orange,recordHover:Xt(ze.orange,ma),recordActive:Xt(ze.orange,va),backdropDark:ot(it.grey8,fa),backdropTwilight:ot(ze.blurpleStrong,ba),highlight:ot(ze.blurple,wa),highlightHover:ot(ze.blurple,Ea),highlightActive:ot(ze.blurple,ya),warning:{h:45.5,s:96,l:57,a:1,ads:"--ds-background-warning-bold"}},Qe={light:k(i({primary:ze.blurple,primaryHover:ze.blurpleDark,primaryActive:ze.blurpleStrong,body:{h:228,s:6,l:17,a:1,ads:"--ds-text"},bodyDimmed:{h:224,s:5,l:44,a:1,ads:"--ds-text-subtlest"},bodyInverse:{h:0,s:0,l:100,a:1,ads:"--ds-text-inverse"},background:{h:0,s:0,l:100,a:1,ads:"--ds-surface"},backgroundHover:{h:209,s:75.6,l:8,a:.08,ads:"--ds-background-neutral-subtle-hovered"},backgroundActive:{h:225.5,s:56.9,l:10,a:.14,ads:"--ds-background-neutral-subtle-pressed"},backgroundSecondary:{h:0,s:0,l:97.25,a:1,ads:"--ds-surface-sunken"},backgroundSecondary2:{h:0,s:0,l:97.25,a:1,ads:"--ds-surface-sunken"},backgroundNeutral:{h:209,s:76,l:8,a:.08,ads:"--ds-background-neutral"},backgroundNeutralHover:{h:226,s:57,l:1,a:.14,ads:"--ds-background-neutral-hovered"},backgroundNeutralActive:{h:223,s:61,l:8,a:.28,ads:"--ds-background-neutral-pressed"},backgroundInverse:{h:228,s:6,l:17,a:1,ads:"--ds-background-neutral-bold"},focusRing:{h:216.1,s:81.4,l:60,a:1,ads:"--ds-border-focused"},overlay:{h:0,s:0,l:100,a:1,ads:"--ds-surface-overlay"},overlayHover:it.grey2,overlayActive:it.grey3,backdrop:{h:224,s:72,l:7,a:pa,ads:"--ds-blanket"},border:{h:225.5,s:57,l:10,a:ga,ads:"--ds-border"}},Qt),{info:{h:215,s:80.25,l:47.65,a:1,ads:"--ds-background-information-bold"},success:{h:155,s:62,l:32,a:1,ads:"--ds-background-accent-green-bolder"},danger:{h:4,s:64,l:48,a:1,ads:"--ds-background-danger-bold"},dangerHover:{h:4.3,s:65.7,l:41.2,a:1,ads:"--ds-background-danger-bold-hovered"},dangerActive:{h:4.5,s:56.3,l:23.3,a:1,ads:"--ds-background-danger-bold-pressed"},disabledContent:{h:223,s:5,l:73,a:1,ads:"--ds-text-disabled"},disabledBackground:{h:0,s:0,l:9,a:.03,ads:"--ds-background-disabled"},formFieldBorder:{h:223.6,s:5,l:57,a:1,ads:"--ds-border-input"},formFieldBackground:{h:0,s:0,l:100,a:1,ads:"--ds-background-input"},buttonBorder:{h:252,s:13,l:46,a:Jt,ads:"--ds-border"},tabBackground:{h:209,s:75.6,l:8,a:Ca,ads:"--ds-background-neutral"},upgrade:{h:277.5,s:89,l:96.5,a:1,ads:"--ds-background-discovery"},upgradeHover:{h:277,s:86,l:91.6,a:1,ads:"--ds-background-discovery-hovered"},upgradeActive:{h:278.6,s:84.5,l:79.8,a:1,ads:"--ds-background-discovery-pressed"},discoveryBackground:{h:278.6,s:48.4,l:52.2,a:1,ads:"--ds-background-discovery-bold"},discoveryLightBackground:{h:277.5,s:89,l:96.5,a:1,ads:"--ds-background-discovery"},discoveryTitle:{h:228,s:6,l:17,a:1,ads:"--ds-text"},discoveryHighlight:{h:277.5,s:89,l:96.5,a:1,ads:"--ds-background-discovery"}}),dark:k(i({primary:{h:216.3,s:83.2,l:67.3,a:1},primaryHover:{h:216.1,s:85.1,l:76.3,a:1},primaryActive:{h:216.5,s:92,l:90.2,a:1},body:{h:225,s:4.3,l:81.6,a:1,ads:"--ds-text"},bodyDimmed:{h:217.5,s:4,l:60.4,a:1,ads:"--ds-text-subtlest"},bodyInverse:{h:240,s:3,l:12.5,a:1,ads:"--ds-text-inverse"},background:{h:240,s:3,l:12.5,a:1,ads:"--ds-surface"},backgroundHover:{h:240,s:12.6,l:83,a:.07,ads:"--ds-background-neutral-subtle-hovered"},backgroundActive:{h:236,s:36.6,l:92,a:.12,ads:"--ds-background-neutral-subtle-pressed"},backgroundSecondary:{h:210,s:4,l:9.8,a:1,ads:"--ds-surface-sunken"},backgroundSecondary2:{h:210,s:4,l:9.8,a:1,ads:"--ds-surface-sunken"},backgroundNeutral:{h:240,s:12.6,l:83,a:.07,ads:"--ds-background-neutral"},backgroundNeutralHover:{h:236,s:36.6,l:92,a:.12,ads:"--ds-background-neutral-hovered"},backgroundNeutralActive:{h:226,s:49,l:93,a:.25,ads:"--ds-background-neutral-pressed"},backgroundInverse:{h:225,s:4.3,l:81.6,a:1,ads:"--ds-background-neutral-bold"},focusRing:{h:216.1,s:85.1,l:76.3,a:1,ads:"--ds-background-accent-blue-subtle-hovered"},overlay:{h:225,s:4,l:17.6,a:1,ads:"--ds-surface-overlay"},overlayHover:{h:225,s:4,l:19.61,a:1,ads:"--ds-surface-overlay-hovered"},overlayActive:{h:225,s:4.69,l:25.1,a:1,ads:"--ds-surface-overlay-pressed"},backdrop:{h:210,s:11,l:7,a:.6,ads:"--ds-blanket"},border:{h:236,s:36.6,l:92,a:.12,ads:"--ds-border"}},Qt),{info:{h:216.3,s:83,l:67.25,a:1,ads:"--ds-background-information-bold"},success:{h:155,s:57,l:55,a:1,ads:"--ds-background-accent-green-bolder"},danger:{h:3.75,s:91,l:69,a:1,ads:"--ds-background-danger-bold"},dangerHover:{h:4,s:96,l:78,a:1,ads:"--ds-background-danger-bold-hovered"},dangerActive:{h:4,s:100,l:91.2,a:1,ads:"--ds-background-danger-bold-pressed"},disabledContent:{h:225,s:5,l:33,a:1,ads:"--ds-text-disabled"},disabledBackground:{h:0,s:0,l:1,a:.46,ads:"--ds-background-disabled"},formFieldBorder:{h:222,s:4,l:51.4,a:1,ads:"--ds-border-input"},formFieldBackground:{h:225,s:5,l:15,a:1,ads:"--ds-background-input"},buttonBorder:{h:0,s:0,l:100,a:Jt,ads:"--ds-border"},tabBackground:{h:240,s:12.6,l:83,a:.07,ads:"--ds-background-neutral"},upgrade:{h:277.8,s:27.3,l:19.4,a:1,ads:"--ds-background-discovery"},upgradeHover:{h:278,s:44.2,l:25.3,a:1,ads:"--ds-background-discovery-hovered"},upgradeActive:{h:278,s:45,l:44.7,a:1,ads:"--ds-background-discovery-pressed"},discoveryBackground:{h:278.5,s:84.5,l:72.2,a:1,ads:"--ds-background-discovery-bold"},discoveryLightBackground:{h:277.8,s:27.3,l:19.4,a:1,ads:"--ds-background-discovery"},discoveryTitle:{h:225,s:4.3,l:81.6,a:1,ads:"--ds-text"},discoveryHighlight:{h:277.8,s:27.3,l:19.4,a:1,ads:"--ds-background-discovery"}})},ve=i(i({},ze),it),qt=[...Object.keys(ve),...Object.keys(Qe.light)],Wi=(e,t)=>`hsla(${ve[e].h},${ve[e].s}%,${ve[e].l}%,${t})`,Pi=(e,t,a)=>{const r=()=>{if(t==="dark")return ve[e].l-ve[e].l*a;if(t==="light")return ve[e].l+ve[e].l*a};return`hsla(${ve[e].h},${ve[e].s}%,${Math.round(r())}%,${ve[e].a})`},c=e=>{if(e)return e in ve||e in Qe.light?`var(--lns-color-${e})`:e in ir?`var(--lns-gradient-${e})`:e};function za(e,t,a){const r=React.useCallback(()=>typeof window>"u"?a:t[e.findIndex(s=>matchMedia(s).matches)]||a,[a,e,t]),[l,o]=React.useState(r);return React.useEffect(()=>{const s=_debounce(()=>o(r),150);return window.addEventListener("resize",s),()=>window.removeEventListener("resize",s)},[r]),l}var u=e=>e&&`calc(${e} * var(--lns-unit, ${et}px))`,Re=e=>{if(e in pt)return`var(--lns-space-${e})`;if(e&&isNaN(e))return`${e}`;if(e===0)return"0";if(e)return`${u(e)}`},b=(e,t)=>{if(t||t===0){if(Array.isArray(t)){const a=t.map(r=>`${e}: ${Re(r)}`);return qe(a)}if(typeof t=="object"){const a={};return Object.entries(t).forEach(([r,l])=>a[r]=Re(l)),st(e,a)}return`${e}: ${Re(t)};`}},er=(e,t,a)=>`@media(${e}: ${t}){${a}}`,qe=e=>{const t=Object.values(Ze)[0],a=er("max-width",t,e[0]),r=e.reduce((l,o,s)=>{const d=`${Object.values(Ze)[s]}`;return l+er("min-width",d,o)},"");return a+r},st=(e,t)=>{const a=[];return t.default&&a.push(`${e}: ${t.default};`),delete t.default,Object.entries(t).forEach(([r,l])=>{const o=r in Ze?Ze[r]:r;a.push(`@media(min-width: ${o}){ ${e}: ${l} }`)}),a.join(" ")},we=(e,t)=>{if(Array.isArray(t)){const a=t.map(r=>`${e}: ${r};`);return qe(a)}return typeof t=="object"?st(e,t):`${e}: ${t};`},tr=(e,t)=>{if(e){if(Array.isArray(e)){const a=[];return e.map(r=>{a.push(t[r])}),we("align-items",a)}return`align-items ${t[e]};`}},xa=(e,t,a)=>{if(Array.isArray(a)){const r=a.map(l=>{const o=l===!0?t[0]:t[1];return`${e}: ${o};`});return qe(r)}return`${e}: ${t[0]};`},rr=(e,t)=>{if(t||t===0){if(Array.isArray(t)){const a=t.map(r=>`${e}: ${r}`);return qe(a)}return typeof t=="object"&&!Array.isArray(t)?st(e,t):`${e}: ${t};`}},mt=e=>Array.isArray(e)?e.map(t=>Re(t)).join(" "):e,Ai=e=>{if(e){if(typeof e=="object"&&!Array.isArray(e)){const t={};return Object.entries(e).forEach(([a,r])=>t[a]=mt(r)),st("grid-template-columns",t)}return`grid-template-columns: ${mt(e)};`}},ar=(e,t)=>{if(e){if(typeof e=="object"&&!Array.isArray(e)){const a={};return Object.entries(e).forEach(([r,l])=>a[r]=mt(l)),st(`grid-template-${t}`,a)}return`grid-template-${t}: ${mt(e)};`}},Ti=({children:e,queries:t,values:a,defaultValue:r})=>{const l=za(t,a,r);return e(l)},Se=e=>e&&`
  font-size: var(--lns-fontSize-${e});
  line-height: var(--lns-lineHeight-${e});
  letter-spacing: var(--lns-letterSpacing-${e});
`,Te=e=>e&&`font-weight: var(--lns-fontWeight-${e});`,$a=e=>e&&`var(--lns-fontSetting-${e});`,X=e=>e&&`border-radius: var(--lns-radius-${e});`,ct=e=>e&&`box-shadow: var(--lns-shadow-${e});`,Me=(e,t)=>{const a=e||c("focusRing");return`box-shadow:${t||""} 0 0 0 2px ${a};`},vt=e=>`
  ...
  `}
`,Ha=e=>{var t=e,{children:a,size:r="body-md",color:l,isInline:o,isDimmed:s,fontWeight:d="regular",hasEllipsis:m,ellipsisLines:v,noWrap:p,variant:g,htmlTag:f="span",alignment:C,sizeMinMax:x,fontSetting:z="normal"}=t,y=E(t,["children","size","color","isInline","isDimmed","fontWeight","hasEllipsis","ellipsisLines","noWrap","variant","htmlTag","alignment","sizeMinMax","fontSetting"]);return s&&console.warn(Ma),r.includes("heading-")&&(d="bold"),n.createElement(_a,i({size:g?Ht[g].size:r,color:l,isInline:o,isDimmed:s,fontWeight:g?Ht[g].fontWeight:d,hasEllipsis:m,ellipsisLines:v,noWrap:p,variant:g,as:f,alignment:C,sizeMinMax:x,fontSetting:z},y),a)},Sa=["left","right","center"],Ie=Ha,bt=["top","bottom","left","right"],hr=i({0:"0"},pt),St=i({0:"0",auto:"auto"},pt),Ia=qt.map(e=>({selector:"c",modifier:e,declarations:[{property:"color",value:`var(--lns-color-${e})`}]})),Ba=qt.map(e=>({selector:"bgc",modifier:e,declarations:[{property:"background-color",value:`var(--lns-color-${e})`}]})),Oa=Object.keys(Fe).map(e=>({selector:"text",modifier:e,declarations:[{property:"font-size",value:`var(--lns-fontSize-${e})`},{property:"line-height",value:`var(--lns-lineHeight-${e})`},{property:"letter-spacing",value:`var(--lns-letterSpacing-${e})`},e.includes("heading-")||e.includes("xlarge")?{property:"font-weight",value:"var(--lns-fontWeight-bold)"}:{property:"font-weight",value:"var(--lns-fontWeight-regular)"}]})),Da=Object.keys(lr).map(e=>({selector:"weight",modifier:e,declarations:[{property:"font-weight",value:`var(--lns-fontWeight-${e})`}]})),Va=Object.entries(Ht).map(([e,t])=>({selector:"text",modifier:e,declarations:[{property:"font-size",value:`var(--lns-fontSize-${t.size})`},{property:"line-height",value:`var(--lns-lineHeight-${t.size})`},{property:"font-weight",value:`var(--lns-fontWeight-${t.fontWeight})`}]})),Wa=Sa.map(e=>({selector:"text",modifier:e,declarations:[{property:"text-align",value:e}]})),Pa=Object.keys(Lt).map(e=>({selector:"shadow",modifier:e,declarations:[{property:"box-shadow",value:`var(--lns-shadow-${e})`}]})),Aa=Object.keys(or).map(e=>({selector:"radius",modifier:e,declarations:[{property:"border-radius",value:`var(--lns-radius-${e})`}]})),dt=(e,t,a,r)=>{const l=[];return t.map(o=>{const s=r?`${e.charAt(0)}${o.charAt(0)}`:o;Object.keys(a).map(d=>{l.push({selector:s,property:`${e}${o&&e?`-${o}`:o||""}`,modifier:d,value:d==="auto"||d==="0"?d:`var(--lns-space-${d})`})})}),l},Ta=Object.values(dt("margin",["",...bt],St,"shortSides")).map(e=>({selector:e.selector,modifier:e.modifier,declarations:[{property:e.property,value:e.value}]})),Fa=Object.values(dt("margin",["x","y"],St,"shortSides")).map(e=>({selector:e.selector,modifier:e.modifier,declarations:[{property:e.property==="margin-x"?"margin-left":"margin-top",value:e.value},{property:e.property==="margin-x"?"margin-right":"margin-bottom",value:e.value}]})),Za=Object.values(dt("padding",["",...bt],hr,"shortSides")).map(e=>({selector:e.selector,modifier:e.modifier,declarations:[{property:e.property,value:e.value}]})),ja=Object.values(dt("padding",["x","y"],hr,"shortSides")).map(e=>({selector:e.selector,modifier:e.modifier,declarations:[{property:e.property==="padding-x"?"padding-left":"padding-top",value:e.value},{property:e.property==="padding-x"?"padding-right":"padding-bottom",value:e.value}]})),Na=["",...bt].map(e=>{const t="border"+e.replace(e.charAt(0),e.charAt(0).toUpperCase()),a=`border${e&&`-${e}`}`;return{selector:t,declarations:[{property:a,value:"1px solid var(--lns-color-border)"}]}}),Ua=["inline","block","flex","inlineBlock","inlineFlex","none"],Ka=Ua.map(e=>({selector:e,declarations:[{property:"display",value:gt(e)}]})),Ga=[{selector:"flexWrap",declarations:[{property:"flex-wrap",value:"wrap"}]}],Ya=["column","row"],Xa=Ya.map(e=>({selector:"flexDirection",modifier:e,declarations:[{property:"flex-direction",value:e}]})),Ja=["stretch","center","baseline","flexStart","flexEnd","selfStart","selfEnd"],Qa=Ja.map(e=>({selector:"items",modifier:e,declarations:[{property:"align-items",value:gt(e)}]})),qa=["flexStart","flexEnd","center","spaceBetween","spaceAround","spaceEvenly"],en=qa.map(e=>({selector:"justify",modifier:e,declarations:[{property:"justify-content",value:gt(e)}]})),tn=["0","1"],rn=tn.map(e=>({selector:"grow",modifier:e,declarations:[{property:"flex-grow",value:e}]})),an=["0","1"],nn=an.map(e=>({selector:"shrink",modifier:e,declarations:[{property:"flex-shrink",value:e}]})),ln=["auto","flexStart","flexEnd","center","baseline","stretch"],on=ln.map(e=>({selector:"self",modifier:e,declarations:[{property:"align-self",value:gt(e)}]})),sn=["hidden","auto"],cn=sn.map(e=>({selector:"overflow",modifier:e,declarations:[{property:"overflow",value:e}]})),dn=["relative","absolute","sticky","fixed"],un=dn.map(e=>({selector:e,declarations:[{property:"position",value:e}]})),hn=Object.values(dt("",bt,St)).map(e=>({selector:e.selector,modifier:e.modifier,declarations:[{property:e.property,value:e.value}]})),mn=["auto","full","0"],vn=mn.map(e=>({selector:"width",modifier:e,declarations:[{property:"width",value:e==="full"?"100%":e}]})),gn=[{selector:"minWidth",modifier:"0",declarations:[{property:"min-width",value:"0"}]}],pn=["auto","full","0"],fn=pn.map(e=>({selector:"height",modifier:e,declarations:[{property:"height",value:e==="full"?"100%":e}]})),bn=[{selector:"ellipsis",declarations:[{property:"overflow",value:"hidden"},{property:"text-overflow",value:"ellipsis"},{property:"white-space",value:"nowrap"}]}],Cn=[{selector:"srOnly",declarations:[{property:"position",value:"absolute"},{property:"width",value:"1px"},{property:"height",value:"1px"},{property:"padding",value:"0"},{property:"margin",value:"-1px"},{property:"overflow",value:"hidden"},{property:"clip",value:"rect(0, 0, 0, 0)"},{property:"white-space",value:"nowrap"},{property:"border-width",value:"0"}]}],wn="\\:",mr=[...Ia,...Pa,...Aa,...Ba,...Ta,...Fa,...Za,...ja,...Oa,...Da,...Va,...Wa,...Na,...Ka,...Ga,...Xa,...Qa,...en,...rn,...nn,...on,...cn,...un,...hn,...vn,...gn,...fn,...bn,...Cn],vr=(e,t)=>{const a=[],r=t?`${t}-`:"";return e.map(l=>{const o=[];l.declarations.map(d=>{o.push(`${d.property}:${d.value}`)});const s=`.${r}${l.selector}${l.modifier?wn:""}${l.modifier?l.modifier:""}{${o.join(";")}}`;a.push(s)}),a.join("")},En={xs:Ze.xsmall,sm:Ze.small,md:Ze.medium,lg:Ze.large},yn=()=>(()=>{const t=[];return t.push(`${vr(mr)}`),Object.entries(En).map(([a,r])=>{t.push(`@media(min-width:${r}){${vr(mr,a)}}`)}),t.join("")})(),ke=(e,t)=>{const a={};return Object.entries(t).forEach(([r,l])=>{const s=`--lns-${(e?`${e}-`:"")+r}`;a[s]=l}),a},zn=()=>{const e={};return Object.entries(Fe).forEach(([t,a])=>{const r={},l={},o={},s=`fontSize-${t}`,d=`lineHeight-${t}`,m=`letterSpacing-${t}`;r[s]=u(a.fontSize),r[d]=a.lineHeight,r[m]=a.letterSpacing,Object.assign(e,r,l,o)}),e},xn=()=>{const e={};return Object.entries(pt).forEach(([t,a])=>{const r=`space-${t}`;e[r]=u(a)}),e},$n=()=>{const e={};return Object.keys(i(i({},ze),it)).forEach(t=>{const a=t;e[a]=`hsla(${ve[t].h},${ve[t].s}%,${ve[t].l}%,${ve[t].a})`}),e},Rn=()=>{const e=(t,a)=>Object.keys(t).reduce((r,l)=>{const o=t[l],s=`${a}-color-${l}`;return r[s]=o.ads?`var(${o.ads}, hsla(${o.h},${o.s}%,${o.l}%,${o.a}))`:`hsla(${o.h},${o.s}%,${o.l}%,${o.a})`,r},{});return i(i({},e(Qe.light,"themeLight")),e(Qe.dark,"themeDark"))},Mn=ke(void 0,{unit:`${et/16}rem`}),kn=ke("fontWeight",lr),Ln=ke("fontSetting",Ra),_n=ke(void 0,zn()),Hn=ke("radius",or),Sn=ke("shadow",Lt),In=ke(void 0,xn()),Bn=ke(void 0,{formFieldBorderWidth:"1px",formFieldBorderWidthFocus:"2px",formFieldHeight:u(4.5),formFieldRadius:"var(--lns-radius-175)",formFieldHorizontalPadding:u(2),formFieldBorderShadow:`
  ...
  `}),On=ke("color",$n()),Dn=ke(void 0,Rn()),Vn=ke("gradient",ir),gr=[Mn,_n,Hn,Sn,In,Bn],Wn=()=>Object.assign({},...gr),Pn=()=>Object.assign({},kn,...gr,Ln),An=()=>i(i(i({},On),Dn),Vn),Tn=()=>Object.keys(Qe.light).map(e=>`--lns-color-${e}: var(--lns-themeLight-color-${e});`),Fn=()=>Object.keys(Qe.dark).map(e=>`--lns-color-${e}: var(--lns-themeDark-color-${e});`),pr=(e=":root")=>`
    ${e||":root"},
    .theme-light,
  ...
  `,Fi=()=>{const e=document.createElement("style");e.innerHTML=pr(),document.head.appendChild(e)},Zi=()=>Object.entries(Wn()).map(t=>`${t[0]}:${t[1]};`).join(""),Zn=e=>{const t=[],a=e||":root";return Object.entries(Pn()).forEach(r=>{t.push(`${r[0]}:${r[1]};`)}),Object.entries(An()).forEach(r=>{t.push(`${r[0]}:${r[1]};`)}),`
    ${a} {
      ${t.join("")}
    }
  `},jn=e=>{switch(e){case"orange":return{background:"orangeLight",text:"dangerHover"};case"blue":return{background:"blueLight",text:"blueDark"};case"yellow":return{background:"yellowLight",text:"#9E4C00"};case"teal":return{background:"tealLight",text:"tealDark"};default:return{background:"orangeLight",text:"dangerHover"}}},Nn=e=>`calc(${e} / 2)`,je=e=>{let t,a;if(e==="medium")t=u(4),a=u(4);else if(e==="large")t=u(7),a=u(7);else{const l=Re(e);t=l,a=l}const r=Nn(t);return{width:t,height:a,fontSize:r}},Un=h.Z.span`
  display: block;
...
`,Kn=h.Z.img`
  ...
  height: ${e=>{const{height:t}=je(e.size);return t}};
  font-size: ${e=>{const{fontSize:t}=je(e.size);return t}};
`,ji=e=>{var t=e,{altText:a="",size:r=4,letter:l,imageSrc:o,children:s,themeColor:d="blue"}=t,m=E(t,["altText","size","letter","imageSrc","children","themeColor"]);const v=()=>{if(s)return s;if(o){const f=je(r).height,C=je(r).width;return React3.createElement(Kn,{size:r,alt:a,src:o,height:f,width:C})}if(l)return a?React3.createElement("span",{"aria-label":a},l):l},p=l&&!o&&!s,g=jn(d||"blue");return React3.createElement(Un,i({hasBackgroundColor:p,size:r,backgroundColor:g.background,color:g.text},m),v())},Ni=null,fr=(e=":root",t="body")=>`
    ${e} {
      font-size: 100%;
    }
    ${t} {
    ...
    ${yn()}
  `,Ui=()=>React4.createElement(Global,{styles:css(fr())}),Ki=null,Gn=3,Yn=h.Z.span`
  display: block;
  color: ${e=>c(e.color)};
...
`,Xn=e=>{var t=e,{altText:a,icon:r,color:l="body",size:o=Gn}=t,s=E(t,["altText","icon","color","size"]);const d=n.useRef(null);return n.createElement(Yn,i({ref:d,"aria-label":a,color:l,size:o},s),r)},ce=Xn,br=1,It=8,Bt={small:{totalSize:18},medium:{totalSize:24},large:{totalSize:48}},Ct=e=>Bt[e.size].totalSize/6,Ot=e=>Bt[e.size].totalSize,Jn=R.F4`
  50% {
    transform: scale(1);
  }
`,Qn=h.Z.span`
...
`,tl=({position:e,color:t,size:a})=>n.createElement(el,{color:t,position:e,size:a}),rl=e=>{var t=e,{color:a="body",size:r="medium"}=t,l=E(t,["color","size"]);let o;const s=[];for(o=0;o<It;o++)s.push(n.createElement(tl,{color:a,position:o,size:r,key:o}));return n.createElement(Qn,i({size:r},l),n.createElement(qn,null,s))},Gi=Object.keys(Bt),Dt=rl,xe={small:{height:u(4),textSize:"small",iconSize:2,xSpace:u(1.5),radius:"var(--lns-radius-150)"},medium:{height:u(4.5),textSize:"medium",iconSize:3,xSpace:u(2),radius:"var(--lns-radius-175)"},large:{height:u(7),textSize:"large",iconSize:4,xSpace:u(2.5),radius:"var(--lns-radius-250)"}},Vt=e=>R.iv`
  ${e.hasLoader&&"display: none"};
`,Be={neutral:{color:c("body"),background:"transparent",borderColor:c("buttonBorder"),hover:c("backgroundHover"),active:c("backgroundActive"),floatingBackground:c("overlay"),floatingHover:c("overlayHover"),floatingActive:c("overlayActive")},neutralSecondary:{color:c("body"),background:c("backgroundNeutral"),borderColor:null,hover:c("backgroundNeutralHover"),active:c("backgroundNeutralActive")},primary:{color:c("white"),background:c("blurple"),borderColor:null,hover:c("primaryHover"),active:c("primaryActive")},secondary:{color:c("primary"),background:c("highlight"),borderColor:null,hover:c("highlightHover"),active:null},record:{color:c("white"),background:c("record"),borderColor:null,hover:c("recordHover"),active:c("recordActive")},upgrade:{color:c("body"),background:c("upgrade"),borderColor:null,hover:c("upgradeHover"),active:c("upgradeActive"),focusRing:Me()},danger:{color:c("bodyInverse"),background:c("danger"),borderColor:null,hover:c("dangerHover"),active:c("dangerActive")},ai:{color:c("white"),background:c("ai-primary"),borderColor:null,hover:null,active:null}},Cr=e=>({enabled:R.iv`
    cursor: pointer;
  `,disabled:R.iv`
  ...
  `}),wr=u(1),nl=h.Z.button`
  appearance: none;
  padding: 0
    ${e=>e.hasChildren?xe[e.size].xSpace:0};
  font: inherit;
...
`,il=h.Z.span`
  ${Vt};
`,sl=e=>{var t=e,{size:a="medium",children:r,variant:l="neutral",hasFullWidth:o,width:s="auto",icon:d,iconPosition:m="left",iconBefore:v,iconAfter:p,logoSrc:g,hasLoader:f,isDisabled:C,ariaDisabled:x,htmlTag:z="button",interactionName:y,onClick:_,refHandler:P}=t,U=E(t,["size","children","variant","hasFullWidth","width","icon","iconPosition","iconBefore","iconAfter","logoSrc","hasLoader","isDisabled","ariaDisabled","htmlTag","interactionName","onClick","refHandler"]);const I=d&&m==="left"?d:null,ae=v||I?n.createElement(Er,{hasLoader:f,paddingLeft:"0",paddingRight:r?wr:"0"},n.createElement(ce,{icon:v||I,color:"currentColor",size:xe[a].iconSize})):null,oe=d&&m==="right"?d:null,F=p||oe?n.createElement(Er,{hasLoader:f,paddingLeft:r?wr:"0",paddingRight:"unset"},n.createElement(ce,{icon:oe||p,color:"currentColor",size:xe[a].iconSize})):null,Z=(0,n.useCallback)(K=>{y&&(0,pe.Z)(y),_?.(K)},[_,y]);return n.createElement(nl,k(i({size:a,variant:l,hasFullWidth:o,width:s,icon:d,iconPosition:m,logoSrc:g,disabled:C,ariaDisabled:x,as:z,hasChildren:r,ref:K=>P&&P(K)},U),{onClick:y===void 0?_:Z}),f&&n.createElement(ol,null,n.createElement(Dt,{color:"currentColor"})),ae,g&&n.createElement(ll,{alt:"",hasSpacing:Boolean(r),src:g,size:a,height:xe[a].height,width:xe[a].height,hasLoader:f}),n.createElement(il,{hasLoader:f},r),F)},Yi=Object.keys(xe),Xi=Object.keys(Be),cl=sl,dl=h.Z.div`
...
`,ul=e=>{var t=e,{children:a,all:r,y:l,x:o,top:s,right:d,bottom:m,left:v,isInline:p}=t,g=E(t,["children","all","y","x","top","right","bottom","left","isInline"]);return n.createElement(dl,i({all:r,top:l||s,bottom:l||m,right:o||d,left:o||v,isInline:p},g),a)},wt=ul,Et={topLeft:"start",topCenter:"start center",topRight:"start end",centerLeft:"center start",center:"center",centerRight:"center end",bottomLeft:"end start",bottomCenter:"end center",bottomRight:"end"},hl=e=>{if(Array.isArray(e))return e.map(t=>Et[t]);if(typeof e=="object"){const t={};return Object.entries(e).forEach(([a,r])=>t[a]=Et[r]),t}return Et[e]},ml=h.Z.div`
  width: 100%;
  height: 100%;
  display: grid;
  ${e=>we("place-items",hl(e.alignment))};
`,vl=e=>{var t=e,{children:a,alignment:r="center",htmlTag:l="div"}=t,o=E(t,["children","alignment","htmlTag"]);return n.createElement(ml,i({alignment:r,as:l},o),a)},Ji=Object.keys(Et),Ge=vl,gl=(e,t,a)=>{const r=t||"border",o=`${Re(a)} solid ${c(r)}`;if(e)return e==="all"?`border: ${o};`:`border-${e}: ${o};`},pl=h.Z.div`
  ...
  ${e=>gl(e.borderSide,e.borderColor,e.borderWidth)};
  ${e=>X(e.radius)};
  ${e=>ct(e.shadow)};
  ${e=>b("width",e.width)};
  ${e=>b("height",e.height)};
...
`,fl=e=>{var t=e,{children:a,backgroundColor:r,backgroundImage:l,contentColor:o,borderColor:s,radius:d,borderSide:m,borderWidth:v="1px",shadow:p,padding:g,paddingX:f,paddingY:C,paddingLeft:x,paddingRight:z,paddingTop:y,paddingBottom:_,margin:P,marginX:U,marginY:I,marginLeft:ae,marginRight:oe,marginTop:F,marginBottom:Z,width:K,height:ue,minWidth:ne,minHeight:J,maxWidth:A,maxHeight:he,htmlTag:le="div",position:$e,overflow:De,zIndex:H,top:de,bottom:nt,left:Ve,right:Ae,refHandler:Le}=t,S=E(t,["children","backgroundColor","backgroundImage","contentColor","borderColor","radius","borderSide","borderWidth","shadow","padding","paddingX","paddingY","paddingLeft","paddingRight","paddingTop","paddingBottom","margin","marginX","marginY","marginLeft","marginRight","marginTop","marginBottom","width","height","minWidth","minHeight","maxWidth","maxHeight","htmlTag","position","overflow","zIndex","top","bottom","left","right","refHandler"]);return n.createElement(pl,i({backgroundColor:r,backgroundImage:l,contentColor:o,borderColor:s,radius:d,borderSide:m,shadow:p,padding:g,paddingLeft:f||x,paddingRight:f||z,paddingTop:C||y,paddingBottom:C||_,margin:P,marginLeft:U||ae,marginRight:U||oe,marginTop:I||F,marginBottom:I||Z,width:K,height:ue,minWidth:ne,minHeight:J,maxWidth:A,maxHeight:he,as:le,position:$e,top:de,bottom:nt,left:Ve,right:Ae,overflow:De,zIndex:H,borderWidth:v,ref:D=>Le&&Le(D)},S),a)},fe=fl,Ee={small:{height:u(4),width:u(5),iconSize:2,padding:u(1.75),withIconPadding:u(4.5),passwordAdditionalPadding:u(.5),textSize:"small",radius:"var(--lns-radius-150)"},medium:{height:"var(--lns-formFieldHeight)",width:u(6),iconSize:3,padding:"var(--lns-formFieldHorizontalPadding)",withIconPadding:u(5.5),passwordAdditionalPadding:u(.5),textSize:"medium",radius:"var(--lns-radius-175)"},large:{height:u(7),width:u(6),iconSize:3,padding:"var(--lns-formFieldHorizontalPadding)",withIconPadding:u(5.5),passwordAdditionalPadding:u(.5),textSize:"large",radius:"var(--lns-radius-250)"}},bl=e=>{let t=e.addOn?Ee[e.inputSize].withIconPadding:Ee[e.inputSize].padding;return e.type==="password"&&(t=`calc(${Ee[e.inputSize].passwordAdditionalPadding} + ${t})`),t},Cl=h.Z.input`
...
`,xl=(0,n.forwardRef)((e,t)=>{var a=e,{placeholder:r,onFocus:l,onChange:o,onBlur:s,onKeyDown:d,isDisabled:m,icon:v,type:p="text",value:g,hasError:f,size:C="medium",addOn:x}=a,z=E(a,["placeholder","onFocus","onChange","onBlur","onKeyDown","isDisabled","icon","type","value","hasError","size","addOn"]);const y=n.createElement(Cl,i({type:p,placeholder:r,onFocus:l,onChange:o,onBlur:s,onKeyDown:d,disabled:m,icon:v,ref:t,value:g,hasError:f,inputSize:C,addOn:x},z));return v||x?n.createElement(wl,null,v&&n.createElement(El,{size:C},typeof v=="string"?n.createElement(fe,{radius:"50",width:Ee[C].iconSize,height:Ee[C].iconSize,overflow:"hidden"},n.createElement(Ge,{alignment:"center"},n.createElement(yl,{src:v,alt:"",isDisabled:m}))):n.createElement(ce,{icon:v,size:Ee[C].iconSize,color:c(m?"disabledContent":"body")})),y,x&&n.createElement(zl,{size:C},x)):y}),$l=xl,yr={start:"flex-start",center:"center",end:"flex-end",stretch:"stretch"},zr=!1,yt=e=>Array.isArray(e)?e:[e],xr=(e,t)=>{if(e.length===t)return e;const a=e[e.length-1];return[...Array(t)].map((r,l)=>e[l]||a)},Rl=(e,t)=>{const a=Math.max(yt(e).length,yt(t).length),r=xr(yt(t),a),l=xr(yt(e),a),o="& > * + *",s=r.map((m,v)=>{const p=`${Re(m)} 0 0 0`,g=`0 0 0 ${Re(m)}`,f=l[v]==="column"?p:g;return`${o}{ margin: ${f}; }`}),d=l.map(m=>`flex-direction: ${m}`);return qe(s)+qe(d)},Ml=h.Z.div`
  display: flex;
  flex-wrap: wrap;
  ${e=>Rl(e.flexDirection,e.gap)};
  ${e=>tr(e.flexAlign,yr)};
  ${e=>e.isSpread&&xa("justify-content",["space-between","initial"],e.isSpread)};

  & > * {
    flex-shrink: 0;
  }
`,Qi=e=>{var t=e,{children:a,gap:r,direction:l="row",alignment:o="start",isSpread:s,htmlTag:d="div"}=t,m=E(t,["children","gap","direction","alignment","isSpread","htmlTag"]);return zr||(console.warn(ka),zr=!0),React12.createElement(Ml,i({gap:r,flexDirection:l,flexAlign:o,isSpread:s,as:d},m),a)},qi=Object.keys(yr),e0=null,kl=h.Z.div`
  display: grid;
  ...
  ${e=>nr(e.as)};
`,Ll=e=>{var t=e,{children:a,width:r,height:l,minWidth:o,minHeight:s,maxWidth:d,maxHeight:m,gap:v,columns:p,rows:g,alignItems:f="center",justifyContent:C="start",justifyItems:x,alignContent:z,autoFlow:y,htmlTag:_="div",className:P,style:U}=t,I=E(t,["children","width","height","minWidth","minHeight","maxWidth","maxHeight","gap","columns","rows","alignItems","justifyContent","justifyItems","alignContent","autoFlow","htmlTag","className","style"]);return(P||U)&&console.warn(_t),n.createElement(kl,i({alignItems:f,as:_,justifyContent:C,justifyItems:x,alignContent:z,gap:v,columns:p,rows:g,width:r,height:l,minWidth:o,minHeight:s,maxWidth:d,maxHeight:m,autoFlow:y},I),a)},Ye=Ll;function $r(){return n.createElement(ee.Z,{label:"",testId:"ads-refreshed-icon"})}var _l=h.Z.div`
  position: relative;
  ::before {
    content: '';
...
`,t0=({children:e,errorActive:t,errorMessage:a="Oops, that didn't work. Try again."})=>t?React15.createElement(_l,null,React15.createElement(Ye,{autoFlow:"row",gap:"small"},e,a?React15.createElement(Ye,{gap:"xsmall"},React15.createElement(ce,{icon:React15.createElement($r,null),size:2,color:"danger"}),React15.createElement(Ie,{size:"body-sm",color:"danger"},a)):null)):React15.createElement(React15.Fragment,null,e),r0=null,Hl={start:"flex-start",center:"center",end:"flex-end"},Sl=h.Z.div`
  display: flex;
  ${e=>tr(e.alignment,Hl)};
...
`,Bl=e=>{var t=e,{width:a,maxWidth:r,children:l}=t,o=E(t,["width","maxWidth","children"]);return console.warn(sr),n.createElement(Il,i({width:a,maxWidth:r},o),l)},Ol=class extends n.Component{render(){return console.warn(sr),n.createElement(Sl,i({},this.props),this.props.children)}};Ol.Section=Bl;var a0=null,ut={small:{size:u(3),iconSize:2.25,radius:"var(--lns-radius-100)"},medium:{size:u(4),iconSize:3,radius:"var(--lns-radius-150)"},large:{size:u(5),iconSize:4,radius:"var(--lns-radius-175)"}},Dl=h.Z.button`
...
`,Rr=n.forwardRef((e,t)=>{var a=e,{altText:r,icon:l,onClick:o,iconColor:s="body",backgroundColor:d,isActive:m,isDisabled:v,size:p="medium"}=a,g=E(a,["altText","icon","onClick","iconColor","backgroundColor","isActive","isDisabled","size"]);return n.createElement(Dl,i({"aria-label":r,onClick:o,isActive:m,disabled:v,size:p,backgroundColor:d,ref:t},g),n.createElement(ce,{icon:l,size:ut[p].iconSize,color:v?"disabledContent":s}))});Rr.displayName="IconButton";var Wt=Rr,Vl=e=>n.createElement("svg",i({width:12,height:9,viewBox:"0 0 12 9",fill:"none"},e),n.createElement("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M11.707.293a1 1 0 010 1.414l-7 7a1 1 0 01-1.414 0l-3-3a1 1 0 011.414-1.414L4 6.586 10.293.293a1 1 0 011.414 0z",fill:"currentColor"})),Wl=e=>n.createElement("svg",i({width:12,height:2,viewBox:"0 0 12 2",fill:"none"},e),n.createElement("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M0 1a1 1 0 011-1h10a1 1 0 110 2H1a1 1 0 01-1-1z",fill:"currentColor"})),Pl=h.Z.div`
  display: block;
  position: relative;
`,Al=h.Z.input`
  height: 100%;
...
`,Tl=h.Z.span`
  ...
  justify-content: center;
  user-select: none;
`,Fl=(0,n.forwardRef)((e,t)=>{var a=e,{isDisabled:r,isChecked:l,isIndeterminate:o,onFocus:s,onChange:d,onBlur:m}=a,v=E(a,["isDisabled","isChecked","isIndeterminate","onFocus","onChange","onBlur"]);const p=(0,n.useRef)(),g=t||p,f=c(r?"disabledContent":"currentColor");return(0,n.useEffect)(()=>{g.current.indeterminate=o}),n.createElement(Pl,null,n.createElement(Al,i({type:"checkbox",disabled:r,checked:l,onFocus:s,onChange:d,onBlur:m,ref:g,"aria-checked":l},v)),n.createElement(Tl,{className:"CheckboxBox"},n.createElement(Wl,{className:"Icon IconMinus",color:f}),n.createElement(Vl,{className:"Icon IconCheck",color:f})))}),Zl=Fl,tt={small:{textSize:"small",iconSize:2.25,height:u(3),xSpace:u(1),radius:"var(--lns-radius-100)"},medium:{textSize:"medium",iconSize:3,height:u(4),xSpace:u(1.5),radius:"var(--lns-radius-150)"},large:{textSize:"large",iconSize:4,height:u(6),xSpace:u(3),radius:"var(--lns-radius-200)"}},jl=h.Z.button`
...
`,Nl=n.forwardRef((e,t)=>{var a=e,{onClick:r,size:l="medium",children:o,icon:s,iconPosition:d="left",isActive:m,isDisabled:v,htmlTag:p,offsetSide:g}=a,f=E(a,["onClick","size","children","icon","iconPosition","isActive","isDisabled","htmlTag","offsetSide"]);const C=n.createElement(fe,{paddingLeft:d==="right"&&"small",paddingRight:d==="left"&&"small",htmlTag:"span"},n.createElement(ce,{icon:s,size:tt[l].iconSize,color:v?"disabledColor":void 0}));return n.createElement(jl,i({onClick:r,size:l,icon:s,iconPosition:d,disabled:v,isActive:m,as:p,offsetSide:g,ref:t},f),s&&d==="left"&&C,o,s&&d==="right"&&C)});Nl.displayName="TextButton";var n0=null,Pt=e=>{var t,a;const r=(a=(t=e?.())==null?void 0:t.getRootNode)==null?void 0:a.call(t);if(String(r)==="[object ShadowRoot]"){r.createElement=(...o)=>r.ownerDocument.createElement(...o);const l=r.createElement("div");return l.id="a11y-status-message",l.style.display="none",r.appendChild(l),{document:r,addEventListener:r.addEventListener.bind(r),removeEventListener:r.removeEventListener.bind(r)}}return typeof window>"u"?null:window},Ne=e=>typeof e=="string"?e:typeof e=="number"||typeof e=="boolean"||typeof e=="bigint"?e.toString():e==null?"":Ul(e)?Array.from(e).map(Ne).join(""):typeof e=="object"&&"props"in e&&e.props&&e.props.children!==void 0?Ne(e.props.children):"",Ul=e=>typeof e[Symbol.iterator]=="function";function Mr(){return n.createElement("span",{"aria-hidden":!0,"data-testid":"ads-refreshed-icon"},n.createElement("svg",{viewBox:"-2 -2 16 16"},n.createElement("path",{fill:"currentColor",fillRule:"evenodd",d:"M2.03 3.97 6 7.94l3.97-3.97 1.06 1.06-4.5 4.5a.75.75 0 0 1-1.06 0l-4.5-4.5z",clipRule:"evenodd"})))}function Kl(){return n.createElement(M.Z,{label:"",testId:"ads-refreshed-icon"})}var At={left:"bottom-start",right:"bottom-end",topLeft:"top-start",topRight:"top-end",leftSide:"left-start",rightSide:"right-start"},Gl=h.Z.div`
...
`,Jl=h.Z.img`
  ...
  object-fit: cover;
  opacity: ${({isDisabled:e})=>e?.5:1};
`,Tt=e=>{var t=e,{isDisabled:a,isHighlighted:r,isSelected:l,icon:o,hasDivider:s,children:d,menuItemRole:m,keyboardMove:v}=t,p=E(t,["isDisabled","isHighlighted","isSelected","icon","hasDivider","children","menuItemRole","keyboardMove"]);const C=`${o?"auto":""} 1fr ${l?"auto":""}`,x=a?"disabledContent":void 0,z=m?k(i({},p),{role:m}):p;return n.createElement(Xl,i({isHighlighted:r,isDisabled:a,keyboardMove:v,columns:C,hasDivider:s,tabIndex:a?-1:0,"data-highlighted":r||void 0},z),o&&(typeof o=="string"?n.createElement(fe,{radius:"50",width:3,height:3,overflow:"hidden"},n.createElement(Ge,{alignment:"center"},n.createElement(Jl,{src:o,alt:"",isDisabled:a}))):n.createElement(ce,{icon:o,color:x})),n.createElement(Ie,{color:x,hasEllipsis:!0},d),l&&n.createElement(ce,{icon:n.createElement(Kl,null),color:x}))},Ql=e=>{var t=e,{position:a,zIndex:r,minWidth:l,maxWidth:o,maxHeight:s,children:d,role:m,downshiftMenuProps:v=()=>null,search:p}=t,g=E(t,["position","zIndex","minWidth","maxWidth","maxHeight","children","role","downshiftMenuProps","search"]);const f=m?k(i({},v()),{role:m}):i({},v());return n.createElement(Gl,i(i({minWidth:l,maxWidth:o,maxHeight:s,zIndex:r,position:a},f),g),p&&p,n.createElement(Yl,{search:p},d))},Xe=Ql;function ql(){return n.createElement(N.Z,{label:"",testId:"ads-refreshed-icon"})}var eo=h.Z.div`
  padding: ${u(1.5)} ${u(1.5)} 0;
  margin-bottom: ${u(1.5)};
  position: sticky;
  top: 0;
`,to=({ariaLabel:e,placeholder:t,value:a,onChange:r,getInputProps:l})=>n.createElement(eo,null,n.createElement($l,i({"aria-label":e,icon:n.createElement(ql,null)},l({placeholder:t,value:a,onChange:r,type:"text"})))),kr=to,ro=h.Z.div`
  position: relative;
`,ao=h.Z.button`
  appearance: none;
  font: inherit;
...
`,oo=h.Z.span`
  ...
  grid-column-start: 1;
  grid-column-end: 3;
`,zt=e=>Array.isArray(e)&&e.length>0&&"group"in e[0],Ft=({options:e,selectedOptionValue:t})=>{if(!e||!t)return{icon:null,title:null};if(zt(e))for(const a of e){const r=a.items.find(l=>l.value===t);if(r)return r}else return e.find(r=>r.value===t)||{icon:null,title:null};return{icon:null,title:null}},Lr=({options:e,selectedItem:t,selectedOptionValue:a})=>{if(t)return t.icon;if(a)return Ft({options:e,selectedOptionValue:a}).icon},io=({options:e,selectedItem:t,selectedOptionValue:a,selectPlaceholder:r})=>t?t.title:a?Ft({options:e,selectedOptionValue:a}).title:r,_r=({selectedItem:e,getInputProps:t,getToggleButtonProps:a,ariaMenuName:r,isOpen:l})=>{const o=e?`selected value is ${e.title}`:"no value selected",s=a?.()["aria-label"];return{"aria-expanded":l,"aria-activedescendant":t()["aria-activedescendant"],"aria-label":[r,s,o].filter(Boolean).join(", ")}},so=({getToggleButtonProps:e,inputValue:t,selectedItem:a,selectedOptionValue:r,selectPlaceholder:l,isDisabled:o,options:s,getInputProps:d,ariaMenuName:m,hasError:v,isOpen:p})=>{const g=Lr({options:s,selectedItem:a,selectedOptionValue:r}),f=Boolean(g),C=!r&&!a,z=`${f?"auto":""} 1fr auto`,y=o?"disabledContent":void 0;return React26.createElement(ao,k(i(i({},e()),_r({selectedItem:a,getInputProps:d,getToggleButtonProps:e,ariaMenuName:m,isOpen:p})),{hasValue:t||r,disabled:o,columns:z,hasError:v}),f&&(typeof g=="string"?React26.createElement(fe,{radius:"50",width:3,height:3,overflow:"hidden"},React26.createElement(Ge,{alignment:"center"},React26.createElement(no,{src:g,alt:"",isDisabled:o}))):React26.createElement(ce,{icon:Lr({options:s,selectedItem:a,selectedOptionValue:r}),color:y})),React26.createElement(Ie,{hasEllipsis:!0,color:C?"bodyDimmed":"inherit"},io({options:s,selectedItem:a,selectedOptionValue:r,selectPlaceholder:l})),React26.createElement(ce,{icon:React26.createElement(Mr,null),color:y}))},co=({selectedOptionValue:e,selectedItem:t,trigger:a,getToggleButtonProps:r,options:l,selectPlaceholder:o,isDisabled:s,getInputProps:d,ariaMenuName:m,hasError:v,errorMessage:p,isOpen:g})=>{const f=()=>i(i({},r()),_r({selectedItem:t,getInputProps:d,getToggleButtonProps:r,ariaMenuName:m,isOpen:g})),x=k(i({},(()=>{if(t)return t;if(e)return Ft({options:l,selectedOptionValue:e})})()),{placeholder:o,isDisabled:s,hasError:v,errorMessage:p});return a(x,f())},Hr=(e,t)=>{if(zt(t))for(const a of t){const r=a.items.find(l=>l.value===e);if(r)return r}else return t.find(a=>a.value===e)},Sr=(e,t,a,r,l,o,s,d)=>{const m=!a&&e.value===r||a&&a.value===e.value;return React26.createElement(Tt,k(i({key:t,getItemProps:o,icon:e.icon,hidden:e.hidden},o({key:`${e.value}-${t}`,index:t,item:e,disabled:e.isDisabled,"aria-selected":m,onMouseMove:()=>{s&&d(!1)}})),{isDisabled:e.isDisabled,hasDivider:e.hasDivider,isHighlighted:l===t,keyboardMove:s&&l===t,isSelected:m}),e.title)},uo=e=>{var t=e,{options:a,selectedItem:r,selectedOptionValue:l,highlightedIndex:o,getItemProps:s,search:d,keyboardMove:m,setKeyboardMove:v}=t,p=E(t,["options","selectedItem","selectedOptionValue","highlightedIndex","getItemProps","search","keyboardMove","setKeyboardMove"]);if(!zt(a))return React26.createElement(Xe,i({search:d},p),a.map((f,C)=>Sr(f,C,r,l,o,s,m,v)));let g=0;return React26.createElement(Xe,i({search:d},p),a.map(f=>{const C=`group-${f.group.replace(/\s+/g,"-")}`;return React26.createElement("li",{key:C},React26.createElement(wt,{left:"medium",top:"small",bottom:"xsmall"},React26.createElement(Ie,{id:C,size:"body-sm",fontWeight:"bold"},f.group)),React26.createElement(lo,{role:"group","aria-labelledby":C},f.items.map(x=>Sr(x,g++,r,l,o,s,m,v))))}))},l0=e=>{var t=e,{container:a,onChange:r,menuZIndex:l=1100,menuMaxWidth:o,menuMaxHeight:s=34,menuMinWidth:d,triggerOffset:m=0,ariaMenuName:v,selectedOptionValue:p,onOuterClick:g,options:f,placeholder:C,menuPosition:x="left",isDisabled:z,onOpenChange:y,trigger:_,hasError:P,errorMessage:U="Oops, that didn't work.",search:I}=t,ae=E(t,["container","onChange","menuZIndex","menuMaxWidth","menuMaxHeight","menuMinWidth","triggerOffset","ariaMenuName","selectedOptionValue","onOuterClick","options","placeholder","menuPosition","isDisabled","onOpenChange","trigger","hasError","errorMessage","search"]);const oe=Pt(a),[F,Z]=useState(!1),[K,ue]=useState(!1),[ne,J]=useState(""),A=S=>{const D=S.target.value;J(D)},[he,le]=useState(Hr(p,f)),De={itemToString:S=>S?S.value:"",onChange:S=>{le(S),r&&r(S||"")},onOuterClick:g,environment:oe,selectedItem:he,isOpen:F};oe&&(De.environment=oe);const{layerProps:H,triggerProps:de,renderLayer:nt,triggerBounds:Ve}=useLayer({isOpen:F,container:a,ResizeObserver,placement:At[x],auto:!0,snap:!0,triggerOffset:m});useEffect2(()=>{const S=Hr(p,f);S?.value!==he?.value&&le(S)},[p,f,he]),useEffect2(()=>{y&&y(F)},[F,y]);const Ae=(S,D)=>{if(D.isOpen!==void 0){if(D.type===Downshift.stateChangeTypes.keyDownEscape)return Z(!1),{isOpen:!1};Z(D.isOpen)}return D},Le=S=>{switch(S.key){case"ArrowDown":case"ArrowUp":case"ArrowLeft":case"ArrowRight":case"Enter":case" ":case"Tab":case"Escape":ue(!0);break;default:break}};return f=useMemo(()=>{if(I){if(zt(f)){let S;return I.searchType==="startsWith"?S=f.map(D=>k(i({},D),{items:D.items.filter(We=>Ne(We.title).toLowerCase().startsWith(ne.toLowerCase()))})):S=f.map(D=>k(i({},D),{items:D.items.filter(We=>Ne(We.title).toLowerCase().includes(ne.toLowerCase()))})),S.reduce((D,We)=>(We.items.length>0&&D.push(We),D),[])}return I.searchType==="startsWith"?f.filter(S=>Ne(S.title).toLowerCase().startsWith(ne.toLowerCase())):f.filter(S=>Ne(S.title).toLowerCase().includes(ne.toLowerCase()))}return f},[f,ne,I]),React26.createElement(ro,i({},ae),React26.createElement(Downshift,k(i({},De),{stateReducer:Ae}),({getItemProps:S,getInputProps:D,getMenuProps:We,getToggleButtonProps:Mt,isOpen:j,inputValue:_e,highlightedIndex:Yt,selectedItem:lt})=>React26.createElement("div",{role:"presentation"},React26.createElement("div",i({},de),_?React26.createElement(co,{getToggleButtonProps:()=>i({},Mt({onKeyDown:Le})),selectedItem:lt,selectedOptionValue:p,selectPlaceholder:C,isDisabled:z,options:f,trigger:_,getInputProps:D,ariaMenuName:v,hasError:P,errorMessage:U,isOpen:j}):React26.createElement(so,{getToggleButtonProps:()=>i({},Mt({onKeyDown:Le})),selectedItem:lt,selectedOptionValue:p,selectPlaceholder:C,options:f,inputValue:_e,isDisabled:z,getInputProps:D,ariaMenuName:v,hasError:P,isOpen:j})),F&&j&&nt(React26.createElement("div",k(i({},H),{style:k(i({},H.style),{zIndex:l,width:d?"auto":Ve?.width})}),React26.createElement(uo,{options:f,selectedItem:lt,selectedOptionValue:p,highlightedIndex:Yt,getItemProps:S,position:x,downshiftMenuProps:()=>We({onKeyDown:Le}),maxWidth:o,maxHeight:s,minWidth:d,search:I&&React26.createElement(kr,{ariaLabel:I.searchPlaceholder,placeholder:I.searchPlaceholder,value:ne,onChange:A,getInputProps:D}),keyboardMove:K,setKeyboardMove:ue}))),P&&!F&&React26.createElement(oo,null,U))))},o0=null;function ho(e,t){const a=document;(0,n.useLayoutEffect)(()=>{const r=a?.documentElement,l=a?.body;if(!(a==null||!r||!l)){if(t){const o=window.innerWidth-r.clientWidth,s=parseInt(window.getComputedStyle(l).getPropertyValue("padding-right"),10)||0;switch(e){case"html":{r.style.position="relative",r.style.overflow="hidden",l.style.paddingRight=`${s+o}px`;break}case"body":{l.style.setProperty("position","relative"),l.style.setProperty("overflow","hidden"),l.style.setProperty("padding-right",`${s+o}px`);break}default:return}}return()=>{switch(e){case"html":{r.style.position="",r.style.overflow="",l.style.paddingRight="";break}case"body":{l.style.removeProperty("position"),l.style.removeProperty("overflow"),l.style.removeProperty("padding-right");break}default:return}}}},[a,t,e])}var Ir=ho,Br=300,mo=h.Z.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`,vo=h.Z.div`
  overflow: auto;
  height: 100%;
`,Or=n.forwardRef((e,t)=>{var a=e,{children:r,isOpen:l,zIndex:o=1e3,backgroundColor:s="backdropDark"}=a,d=E(a,["children","isOpen","zIndex","backgroundColor"]);const{stage:m,shouldMount:v}=(0,se.Yz)(l,Br);return Ir("html",l),n.createElement(n.Fragment,null,v&&n.createElement(mo,i({ref:t,backgroundColor:s,zIndex:o,style:{transition:`opacity ${Br}ms`,opacity:m==="enter"?1:0}},d),n.createElement(vo,null,r)))});Or.displayName="Backdrop";var go=Or;function Zt(){return n.createElement(re.Z,{label:"",testId:"ads-refreshed-icon"})}var po="70vh",fo=h.Z.div`
  display: grid;
  grid-template-rows: ${e=>e.rows};
  position: relative;
`,bo=h.Z.dialog`
  top: ${e=>kt(Re(e.maxHeight),e.placement).top};
  background-color: ${c("overlay")};
  color: ${c("body")};
...
`,Dr=e=>typeof e=="number"?b("max-height",e):"max-height: "+e,$o=e=>{var t=e,{children:a,onCloseClick:r,isOpen:l,maxWidth:o=60,maxHeight:s=po,placement:d="center",ariaLabel:m,ariaModal:v,ariaLabelledBy:p,ref:g,removeClose:f,initialFocus:C}=t,x=E(t,["children","onCloseClick","isOpen","maxWidth","maxHeight","placement","ariaLabel","ariaModal","ariaLabelledBy","ref","removeClose","initialFocus"]);const z=y=>{y.key==="Escape"&&(y.preventDefault(),f||r(y))};return(0,n.useEffect)(()=>(window.addEventListener("keydown",z),()=>{window.removeEventListener("keydown",z)}),[l,r]),Ir("html",l),n.createElement(te(),{active:l,focusTrapOptions:i({clickOutsideDeactivates:!1,allowOutsideClick:!0},C!==void 0?{initialFocus:C}:{})},n.createElement(bo,i({open:l,maxWidth:o,maxHeight:s,placement:d,onClick:y=>y.stopPropagation(),ref:g,"aria-label":m,"aria-modal":v,"aria-labelledby":p},x),!f&&r&&n.createElement(Co,null,n.createElement(Wt,{altText:"Close",icon:n.createElement(Zt,null),onClick:r})),n.createElement(xo,k(i({},f?{tabIndex:0}:{tabIndex:-1}),{maxHeight:s}),a)))},i0=n.forwardRef((e,t)=>{var a=e,{children:r,id:l,isOpen:o,mainButton:s,secondaryButton:d,alternativeButton:m,title:v,noPadding:p,onCloseClick:g,onBackgroundClick:f,onKeyDown:C,hasDividers:x,maxHeight:z="70vh",maxWidth:y=60,placement:_="center",zIndex:P=1e3,ariaLabel:U,ariaModal:I=!0,ariaLabelledBy:ae,initialFocus:oe}=a,F=E(a,["children","id","isOpen","mainButton","secondaryButton","alternativeButton","title","noPadding","onCloseClick","onBackgroundClick","onKeyDown","hasDividers","maxHeight","maxWidth","placement","zIndex","ariaLabel","ariaModal","ariaLabelledBy","initialFocus"]),Z;const K=(0,n.useRef)(null),ue=l?`${l}-modal-title`:"modal-title",ne=!!(s||d||m),J=A=>{if(f){A.stopPropagation(),f(A);return}g(A)};return(0,n.useEffect)(()=>{if(!o||!K.current)return;const A=K.current.parentElement;return A?(Array.from(A.children).filter(le=>le!==K.current&&le instanceof HTMLElement).forEach(le=>{le.hasAttribute("aria-hidden")||(le.setAttribute("aria-hidden","true"),le.setAttribute("data-lens-modal-hidden","true"))}),()=>{document.querySelectorAll("[data-lens-modal-hidden]").forEach($e=>{$e.removeAttribute("aria-hidden"),$e.removeAttribute("data-lens-modal-hidden")})}):void 0},[o]),n.createElement(go,i({ref:K,isOpen:o,zIndex:P},F),n.createElement(fe,{height:"100%",onClick:J,onKeyDown:C},n.createElement($o,{ref:t,id:l,isOpen:o,maxHeight:z,maxWidth:y,placement:_,onCloseClick:g,ariaLabel:U,ariaModal:I,ariaLabelledBy:(Z=ae??ue)!=null?Z:void 0,initialFocus:oe},n.createElement(fo,{rows:`${v?"auto ":""} ${r?"1fr ":""} ${ne?"auto":""}`},v&&n.createElement(Eo,{bottom:r?"var(--lns-space-medium)":"var(--lns-space-xlarge)"},n.createElement(Ie,{htmlTag:"h1",variant:"title",id:ue},v)),n.createElement(zo,{noPadding:p,hasDividers:x,hasTitle:Boolean(v),hasButtons:ne},r&&r),ne&&n.createElement(yo,{top:r?"var(--lns-space-xlarge)":0,hasDividers:x},m,n.createElement(wo,null,d&&n.createElement(wt,{right:"small",isInline:!0},d),s))))))}),s0=null,xt={neutral:{color:c("inherit"),focusRing:Me(),underline:"inactive"},primary:{color:c("primary"),focusRing:Me(),underline:"inactive"},subtle:{color:c("body"),focusRing:Me(),underline:"hover"}},Vr={enabled:R.iv`
    cursor: pointer;
  `,disabled:R.iv`
    pointer-events: none;
    color: ${c("disabledContent")};
...
`,c0=e=>{var t=e,{children:a,href:r,variant:l="primary",htmlTag:o="a",isDisabled:s,noWrap:d}=t,m=E(t,["children","href","variant","htmlTag","isDisabled","noWrap"]);return React30.createElement(Mo,i({href:r,variant:l,as:o,disabled:s,noWrap:d},m),a)},d0=Object.keys(xt),u0=null,Wr={small:{padding:`${u(1.5)} ${u(1.75)}`,textSize:"small"},medium:{padding:`${u(1.5)} var(--lns-formFieldHorizontalPadding)`,textSize:"medium"}},ko=h.Z.textarea`
  width: 100%;
  border: none;
  font-family: inherit;
  color: inherit;
...
`,h0=n.forwardRef((e,t)=>{var a=e,{onChange:r,value:l,rows:o=4,isDisabled:s,placeholder:d,size:m="medium",resize:v="both",error:p=null}=a,g=E(a,["onChange","value","rows","isDisabled","placeholder","size","resize","error"]);return n.createElement(n.Fragment,null,n.createElement(ko,i({disabled:s,onChange:r,placeholder:d,ref:t,rows:o,value:l,size:m,resize:v,error:p},g)),p?n.createElement(n.Fragment,null,n.createElement(wt,{bottom:"xmsall"}),n.createElement(Ie,{color:"danger",fontWeight:"regular",size:"body-md"},p)):null)}),m0=null,Lo=h.Z.div`
  position: relative;
`,_o=h.Z.ul`
  list-style: none;
  margin: 0;
...
`,Ho=h.Z.span`
  ...
  grid-column-start: 1;
  grid-column-end: 3;
`,$t=e=>Array.isArray(e)&&e.length>0&&"group"in e[0],Pr=({options:e,selectedOptionValue:t})=>{if(!e||!t)return{icon:null,title:null};if($t(e))for(const a of e){const r=a.items.find(l=>l.value===t);if(r)return r}else return e.find(r=>r.value===t)||{icon:null,title:null};return{icon:null,title:null}},So=({options:e,selectedItem:t,selectedOptionValue:a})=>{if(t)return t.icon;if(a)return Pr({options:e,selectedOptionValue:a}).icon},Io=({options:e,selectedItem:t,selectedOptionValue:a,placeholder:r})=>t?t.title:a?Pr({options:e,selectedOptionValue:a}).title:r,Bo=({selectedItem:e,getInputProps:t,ariaMenuName:a})=>{const r=e?`selected value is ${e.title}`:"no value selected";return{"aria-activedescendant":t()["aria-activedescendant"],"aria-label":[a,r].filter(Boolean).join(", ")}},Oo=h.Z.button`
  position: relative;
  width: 100%;
  background: none;
  border: none;
...
`,Ao=h.Z.img`
  ...
  object-fit: cover;
  opacity: ${({isDisabled:e})=>e?.5:1};
`,To=({selectedItem:e,selectedOptionValue:t,placeholder:a,isDisabled:r,options:l,getInputProps:o,ariaMenuName:s,isOpen:d,onInputFocus:m,hasError:v,hasLoader:p,inputValue:g,handleInputValueChange:f,inputRef:C,id:x})=>{const z=So({options:l,selectedItem:e,selectedOptionValue:t}),y=Boolean(z),_=r?"disabledContent":void 0,P=()=>{r||m()},U=i(i({role:"combobox","aria-autocomplete":"list","aria-haspopup":"listbox","aria-expanded":d},Bo({selectedItem:e,getInputProps:o,ariaMenuName:s})),o({id:x,"aria-labelledby":void 0,disabled:r,onFocus:P,onClick:P,value:g,onBlur:()=>{f("")},onChange:ae=>f(ae.target.value)})),I=!g&&!t;return n.createElement(Oo,{onClick:P,disabled:r},y&&n.createElement(Vo,null,typeof z=="string"?n.createElement(fe,{radius:"50",width:3,height:3,overflow:"hidden"},n.createElement(Ge,{alignment:"center"},n.createElement(Ao,{src:z,alt:"",isDisabled:r}))):n.createElement(ce,{icon:z,color:_})),n.createElement(Do,k(i({ref:C},U),{hasIcon:y,hasAddOn:!0,hasError:v,isDisabled:r})),!g&&n.createElement(Po,{hasIcon:y},n.createElement(Ie,{hasEllipsis:!0,color:I?"bodyDimmed":"inherit"},Io({options:l,selectedItem:e,selectedOptionValue:t,placeholder:a}))),n.createElement(Wo,null,p?n.createElement(Dt,{size:"small"}):n.createElement(ce,{icon:n.createElement(Mr,null),color:_})))},Ar=(e,t)=>{var a;if($t(t))for(const r of t){const l=r.items.find(o=>o.value===e);if(l)return l}else return(a=t.find(r=>r.value===e))!=null?a:null;return null},Fo=(e,t)=>(e||null)!=t?.value,Tr=(e,t,a,r,l,o)=>{const s=!a&&e.value===r||a&&a.value===e.value;return n.createElement(Tt,k(i({key:t,getItemProps:o,icon:e.icon,hidden:e.hidden},o({key:`${e.value}-${t}`,index:t,item:e,disabled:e.isDisabled,"aria-selected":s})),{isDisabled:e.isDisabled,hasDivider:e.hasDivider,isHighlighted:l===t,isSelected:s}),e.title)},Zo=e=>{var t=e,{options:a,selectedItem:r,selectedOptionValue:l,highlightedIndex:o,getItemProps:s,isLoading:d,loadingMessage:m,emptyResultsMessage:v,hasAvailableOptions:p}=t,g=E(t,["options","selectedItem","selectedOptionValue","highlightedIndex","getItemProps","isLoading","loadingMessage","emptyResultsMessage","hasAvailableOptions"]);const f=m||n.createElement(Dt,null),C=v||"No results";if(d)return n.createElement(Xe,i({as:"div"},g),n.createElement(fe,{padding:"large"},n.createElement(Ge,{alignment:"center"},f)));if(!p)return n.createElement(Xe,i({as:"div"},g),n.createElement(fe,{padding:"large"},n.createElement(Ge,{alignment:"center"},C)));if(!$t(a))return n.createElement(Xe,i({},g),a.map((z,y)=>Tr(z,y,r,l,o,s)));let x=0;return n.createElement(Xe,i({},g),a.map(z=>{const y=`group-${z.group.replace(/\s+/g,"-")}`;return n.createElement("li",{key:y},n.createElement(wt,{left:"medium",top:"small",bottom:"xsmall"},n.createElement(Ie,{id:y,size:"body-sm",fontWeight:"bold",htmlTag:z.headingTag||"h2"},z.group)),n.createElement(_o,{role:"group","aria-labelledby":y},z.items.map(_=>Tr(_,x++,r,l,o,s))))}))},jo=(0,n.forwardRef)((e,t)=>{var a=e,{container:r,onOptionChange:l,onInputValueChange:o,menuZIndex:s=1100,menuMaxWidth:d,menuMaxHeight:m=34,menuMinWidth:v,ariaMenuName:p,selectedOptionValue:g,onOuterClick:f,options:C,placeholder:x,menuPosition:z="left",isDisabled:y,onOpenChange:_,isLoading:P,loadingMessage:U,emptyResultsMessage:I,errorMessage:ae,id:oe}=a,F=E(a,["container","onOptionChange","onInputValueChange","menuZIndex","menuMaxWidth","menuMaxHeight","menuMinWidth","ariaMenuName","selectedOptionValue","onOuterClick","options","placeholder","menuPosition","isDisabled","onOpenChange","isLoading","loadingMessage","emptyResultsMessage","errorMessage","id"]);const Z=Pt(r),K=(0,n.useRef)(null),ue=(0,n.useCallback)(j=>{K.current=j,t&&(typeof t=="function"?t(j):t.current=j)},[t]),[ne,J]=(0,n.useState)(""),[A,he]=(0,n.useState)(!1),[le,$e]=(0,n.useState)(Ar(g,C)),[De,H]=(0,n.useState)(le),de=j=>{J(j),o&&o(j)},Ve={itemToString:j=>j?j.value:"",onChange:j=>{const _e=j||null;H(_e),l&&l(_e)},onOuterClick:f,environment:Z,selectedItem:De,isOpen:A};Z&&(Ve.environment=Z);const{layerProps:Ae,triggerProps:Le,renderLayer:S,triggerBounds:D}=(0,L.sJ)({isOpen:A,container:r,ResizeObserver:$.Z,placement:At[z],auto:!0,snap:!0});(0,n.useEffect)(()=>{if(Fo(g,le)){const j=Ar(g,C);$e(j),H(j),J("")}},[g,C,le]),(0,n.useEffect)(()=>{var j;_&&_(A),A||(j=K.current)==null||j.blur()},[A,_]);const We=(0,n.useMemo)(()=>Array.isArray(C)?$t(C)?C.some(j=>j.items.length>0):C.length>0:!1,[C]),Mt=(j,_e)=>{if(_e.isOpen!==void 0){if(_e.type===T.ZP.stateChangeTypes.keyDownEscape)return he(!1),{isOpen:!1};he(_e.isOpen)}return _e};return n.createElement(Lo,i({},F),n.createElement(T.ZP,k(i({},Ve),{stateReducer:Mt}),({getItemProps:j,getInputProps:_e,getMenuProps:Yt,isOpen:lt,highlightedIndex:Oi,selectedItem:ha})=>n.createElement("div",{role:"presentation"},n.createElement("div",i({},Le),n.createElement(To,{inputRef:ue,selectedItem:ha,selectedOptionValue:g,placeholder:x,isDisabled:y,options:C,getInputProps:_e,ariaMenuName:p,inputValue:ne,handleInputValueChange:de,isOpen:A&&lt,onInputFocus:()=>{he(!0)},hasLoader:P,hasError:Boolean(ae),id:oe})),A&&lt&&S(n.createElement("div",k(i({},Ae),{style:k(i({},Ae.style),{zIndex:s,width:v?"auto":D?.width})}),n.createElement(Zo,{options:C,selectedItem:ha,selectedOptionValue:g,hasAvailableOptions:We,highlightedIndex:Oi,getItemProps:j,isLoading:P,loadingMessage:U,emptyResultsMessage:I,position:z,downshiftMenuProps:Yt,maxWidth:d,maxHeight:m,minWidth:v}))),Boolean(ae)&&!A?n.createElement(Ho,null,ae):null)))});jo.displayName="Typeahead";var v0=null,No=({ariaMenuName:e,getInputProps:t,isOpen:a})=>({"aria-activedescendant":t()["aria-activedescendant"],"aria-expanded":a,"aria-label":e||""}),Uo=h.Z.div`
  display: inline-block;
  vertical-align: middle;
`,Ko=e=>{var t=e,{ariaMenuName:a,menuPosition:r="left",menuZIndex:l=1100,options:o,trigger:s,triggerCallback:d,isOpen:m,menuMinWidth:v=24,menuMaxWidth:p=48,menuMaxHeight:g,container:f,onOuterClick:C,triggerOffset:x=0,onOpenChange:z,search:y,role:_,menuItemRole:P}=t,U=E(t,["ariaMenuName","menuPosition","menuZIndex","options","trigger","triggerCallback","isOpen","menuMinWidth","menuMaxWidth","menuMaxHeight","container","onOuterClick","triggerOffset","onOpenChange","search","role","menuItemRole"]);const I=Pt(f),[ae,oe]=(0,n.useState)(!1),[F,Z]=(0,n.useState)(!1),[K,ue]=(0,n.useState)(""),ne=H=>{const de=H.target.value;ue(de)},J=H=>{switch(H.key){case"ArrowDown":case"ArrowUp":case"ArrowLeft":case"ArrowRight":case"Enter":case" ":case"Tab":case"Escape":Z(!0);break;default:break}},A=m||ae,{layerProps:he,triggerProps:le,renderLayer:$e}=(0,L.sJ)({isOpen:A,container:f,placement:At[r],ResizeObserver:$.Z,auto:!0,snap:!0,triggerOffset:x});(0,n.useEffect)(()=>{z&&z(A)},[A,z]);const De=(H,de)=>(de.isOpen!==void 0&&oe(de.isOpen),de);return o=(0,n.useMemo)(()=>y?y.searchType==="startsWith"?o.filter(H=>Ne(H.title).toLowerCase().startsWith(K.toLowerCase())):o.filter(H=>Ne(H.title).toLowerCase().includes(K.toLowerCase())):o,[o,K,y]),n.createElement(T.ZP,{stateReducer:De,itemToString:H=>H?H.title:"",onSelect:H=>H&&!H.disabled&&H.onClick&&H.onClick(),onOuterClick:C,environment:I},({getInputProps:H,getItemProps:de,getMenuProps:nt,getToggleButtonProps:Ve,highlightedIndex:Ae,isOpen:Le})=>n.createElement("div",i(i({},U),d?{role:null,"aria-haspopup":null,"aria-expanded":null,"aria-labelledby":null}:{}),n.createElement("div",i({},le),d?d(i(i({},Ve({onKeyDown:J})),No({ariaMenuName:a,getInputProps:H,isOpen:Le}))):n.createElement(Uo,i({},Ve({onKeyDown:J,tabIndex:0})),s)),Le&&$e(n.createElement("div",k(i({},he),{style:k(i({},he.style),{zIndex:l})}),n.createElement(Xe,{position:r,minWidth:v,maxWidth:p,maxHeight:g,downshiftMenuProps:()=>nt({onKeyDown:J}),role:_,search:y&&n.createElement(kr,{ariaLabel:y.searchPlaceholder,placeholder:y.searchPlaceholder,value:K,onChange:ne,getInputProps:H})},o.map((S,D)=>n.createElement(Tt,i({key:D,isHighlighted:Ae===D,keyboardMove:F&&Ae===D,isDisabled:S.disabled,isSelected:S.selected,icon:S.icon,hasDivider:S.hasDivider,getItemProps:de,menuItemRole:P,index:D},de({key:D,index:D,item:S,disabled:S.disabled,onMouseMove:()=>{F&&Z(!1)}})),S.title)))))))},Go=Ko,Yo=h.Z.label`
  display: block;
  position: relative;
...
`,Qo=(0,n.forwardRef)((e,t)=>{var a=e,{isDisabled:r,isChecked:l,onFocus:o,onChange:s,onBlur:d}=a,m=E(a,["isDisabled","isChecked","onFocus","onChange","onBlur"]);return n.createElement(Yo,{htmlFor:m.id},n.createElement(Xo,i({type:"radio",disabled:r,checked:l,onFocus:o,onChange:s,onBlur:d,ref:t},m)),n.createElement(Jo,{className:"RadioBox"}))}),qo=Qo,Oe={medium:{switchHeight:16,switchWidth:32,knobOffset:2},large:{switchHeight:20,switchWidth:36,knobOffset:2}},rt={knob:{active:{enabled:c("white"),disabled:c("disabledContent")},inactive:{enabled:c("white"),disabled:c("disabledContent")}},track:{active:{enabled:c("blurple"),disabled:c("disabledBackground")},inactive:{enabled:c("grey6"),disabled:c("disabledBackground")}}},e1=e=>Oe[e.switchSize].switchWidth-Oe[e.switchSize].switchHeight,Fr=e=>Oe[e.switchSize].switchHeight-Oe[e.switchSize].knobOffset*2,t1=h.Z.label`
  display: block;
  position: relative;
`,r1=h.Z.input`
  position: absolute;
  ...
  &:checked {
    ...
    & + .SwitchBox:after {
      transform: translateX(${e=>e1(e)}px);
    }
  }
  &:disabled {
    pointer-events: none;
...
`,n1=e=>{var t=e,{isActive:a,isDisabled:r,onChange:l,size:o="medium",ariaLabelledby:s,ariaLabel:d,ariaDescribedby:m}=t,v=E(t,["isActive","isDisabled","onChange","size","ariaLabelledby","ariaLabel","ariaDescribedby"]);if(s&&d)throw new Error("ariaLabelledby and ariaLabel serve the same purpose and therefore cannot be used at the same time. Choose the one that best suites your needs.");return n.createElement(t1,{htmlFor:v.id},n.createElement(r1,k(i({},v),{checked:a,disabled:r,onChange:l,type:"checkbox",switchSize:o,"aria-labelledby":s,"aria-label":d,"aria-describedby":m,"aria-checked":a})),n.createElement(a1,{className:"SwitchBox",isDisabled:r,isActive:a,switchSize:o}))},Zr=n1,jr={row:{wrapper:{display:"grid",gridTemplateColumns:"auto 1fr",alignItems:"center"},label:{marginLeft:"var(--lns-space-small)"},errorMessage:{marginLeft:"var(--lns-space-small)"}},"row-reverse":{wrapper:{display:"grid",gridTemplateColumns:"1fr auto",alignItems:"center"},label:{}},column:{wrapper:{},label:{marginBottom:"var(--lns-space-xsmall)"}}},l1=h.Z.div`
...
`,i1=h.Z.span`
  ...
  grid-column-start: 1;
  grid-column-end: 3;
`,s1=[qo,Zl,Zr],c1=e=>s1.includes(e),g0=e=>{var t=e,{label:a,children:r,errorMessage:l,labelFor:o,direction:s="column"}=t,d=E(t,["label","children","errorMessage","labelFor","direction"]);const m=React36.Children.toArray(r).some(p=>isValidElement(p)&&typeof p.type!="string"&&c1(p.type)),v=a&&React36.createElement(o1,{direction:s,htmlFor:o,isLabelClickable:m},a);return React36.createElement(l1,i({direction:s},d),s==="row"&&React36.createElement(React36.Fragment,null,r,v),s==="column"&&React36.createElement(React36.Fragment,null,v,r),s==="row-reverse"&&React36.createElement(React36.Fragment,null,v,r),l&&React36.createElement(i1,null,l))},p0=null;function f0(e,t){React37.useEffect(()=>{const a=r=>{!e.current||e.current.contains(r.target)||t(r)};return document.addEventListener("mousedown",a),document.addEventListener("touchstart",a),()=>{document.removeEventListener("mousedown",a),document.removeEventListener("touchstart",a)}},[e,t])}function b0(e){const[t,a]=useState4(!1),r=useCallback3(o=>{const s=e.current;o.type==="focusin"&&o.target===s&&a(!0)},[e]),l=useCallback3(o=>{const s=e.current;o.type==="focusout"&&o.target===s&&a(!1)},[e]);return useEffect6(()=>(document.addEventListener("focusin",r),document.addEventListener("focusout",l),()=>{document.removeEventListener("focusin",r),document.removeEventListener("focusout",l)}),[r,l]),Boolean(t)}function C0(e){const t=document;useLayoutEffect2(()=>{const a=t?.documentElement,r=t?.body;if(!(t==null||!a||!r))return e&&(r.style.setProperty("padding-top","3.25rem"),r.style.setProperty("transition","padding-top 350ms")),()=>{r.style.removeProperty("padding-top")}},[t,e])}var d1=null;function u1(){return n.createElement(me.Z,{label:"",testId:"ads-refreshed-icon"})}var h1=e=>n.createElement("svg",i({viewBox:"0 0 24 24",fill:"none"},e),n.createElement("path",{fill:"currentColor",fillRule:"evenodd",clipRule:"evenodd",d:"M7.42 2.293A1 1 0 0 1 8.127 2h7.245a1 1 0 0 1 .708.293l5.127 5.127a1 1 0 0 1 .293.707v7.245a1 1 0 0 1-.293.708l-5.127 5.127a1 1 0 0 1-.707.293H8.128a1 1 0 0 1-.708-.293L2.293 16.08A1 1 0 0 1 2 15.373V8.128a1 1 0 0 1 .293-.708L7.42 2.293ZM8.542 4 4 8.542v6.416L8.542 19.5h6.416l4.542-4.542V8.542L14.958 4H8.542Zm2.208 11.25a1 1 0 0 1 1-1h.009a1 1 0 1 1 0 2h-.009a1 1 0 0 1-1-1Zm2-7a1 1 0 1 0-2 0v3.5a1 1 0 1 0 2 0v-3.5Z"})),Je={info:{bgColor:"var(--lns-color-blurple)",icon:n.createElement(u1,null),color:"var(--lns-color-white)",fontFamily:"inherit"},warning:{bgColor:"var(--lns-color-warning)",icon:n.createElement(h1,null),color:"var(--lns-color-grey8)",fontFamily:"inherit"},error:{bgColor:"var(--lns-color-danger)",icon:n.createElement($r,null),color:"var(--lns-color-white)",fontFamily:"inherit"},internal:{icon:n.createElement("span",{role:"img"},"\u{1F514}"),color:"var(--lns-color-tealLight)",bgColor:"var(--lns-color-grey8)",fontFamily:"var(--lns-fontFamily-code)"}},Nr=350,m1=h.Z.aside`
...
`,w0=({children:e,onCloseClick:t,isOpen:a,severity:r="info",id:l})=>{var o,s,d;useEffect7(()=>{if(!a)return;const v=p=>{p.key==="Escape"&&(p.preventDefault(),t&&t())};return window.addEventListener("keydown",v),()=>{window.removeEventListener("keydown",v)}},[a,t]),d1(a);const m=r==="internal";return a?React40.createElement(m1,{isOpen:a,severity:r,id:l},React40.createElement(Ye,{alignItems:{default:"start",small:"center"},justifyContent:"space-between",autoFlow:m?"column":void 0,columns:m?void 0:["1fr auto"]},React40.createElement(fe,{paddingY:{default:"xsmall",xsmall:0},paddingLeft:m?void 0:{default:0,medium:u(3.5)},width:"100%"},React40.createElement(Ye,{autoFlow:"column",gap:m?"medium":"small",justifyContent:"center"},(o=Je[r])!=null&&o.icon?React40.createElement(Ge,{alignment:"topLeft"},React40.createElement(ce,{icon:Je[r].icon,color:(s=Je[r].color)!=null?s:"var(--lns-color-white)"})):null," ",e))),t&&React40.createElement(Wt,{iconColor:(d=Je[r].color)!=null?d:"var(--lns-color-white)",tabIndex:0,altText:"Close",icon:React40.createElement(Zt,null),onClick:t})):null},E0=null,Ur="web-app",jt="chrome-extension",v1={short:3e3,long:8e3},g1=(e,t)=>R.F4`
  0% {
    opacity: 0;
...
`,p1=e=>{switch(e){case Ur:return"unset";case jt:return u(4);default:return"unset"}},f1=e=>{switch(e){case Ur:return u(4);case jt:return"unset";default:return u(4)}},b1=h.Z.div`
  animation: ${e=>g1(e.toastDuration,e.platform)}
    ${e=>e.toastDuration}ms forwards;
  background-color: ${c("backgroundInverse")};
  ${X("250")};
  top: ${e=>p1(e.platform)};
  bottom: ${e=>f1(e.platform)};
  ${ct("large")};
  color: ${c("bodyInverse")};
  display: grid;
  grid-auto-flow: column;
...
`,C1=h.Z.div`
  align-self: center;
`,y0=({children:e,isOpen:t,onCloseClick:a,zIndex:r=1100,duration:l="short",platform:o="web-app"})=>{const s=v1[l];return useEffect8(()=>{const d=setTimeout(()=>{t&&a()},s);return()=>clearTimeout(d)},[t]),React41.createElement(React41.Fragment,null,t&&React41.createElement(b1,{role:"presentation",onClick:d=>d.stopPropagation(),zIndex:r,isOpen:t,toastDuration:s,platform:o},React41.createElement(C1,{"aria-live":"polite"},e),a&&React41.createElement(Wt,{altText:"Close",icon:React41.createElement(Zt,null),onClick:a,iconColor:"bodyInverse"})))},z0=null,Kr={topLeft:"top-start",topCenter:"top-center",topRight:"top-end",bottomLeft:"bottom-start",bottomCenter:"bottom-center",bottomRight:"bottom-end",leftTop:"left-start",leftCenter:"left-center",leftBottom:"left-end",rightTop:"right-start",rightCenter:"right-center",rightBottom:"right-end"},w1=4,E1=Fe.small.fontSize*Fe.small.lineHeight,y1=(w1-E1)/2,z1=h.Z.div`
  background-color: ${c("backgroundInverse")};
  color: ${c("bodyInverse")};
  ${X("150")};
  ${Te("bold")};
...
`,x1=h.Z.div`
  ...
  padding-left: ${u(.5)};
  padding-right: ${u(.5)};
`,$1=({children:e})=>n.createElement(x1,null,e),R1=e=>{var t=e,{children:a,maxWidth:r,onMouseEnter:l,onMouseLeave:o,layerProps:s,zIndex:d}=t,m=E(t,["children","maxWidth","onMouseEnter","onMouseLeave","layerProps","zIndex"]);return n.createElement(z1,i(i({maxWidth:r,onMouseEnter:l,onMouseLeave:o,zIndex:d},s),m),a)},M1=h.Z.div`
  display: ${e=>e.isInline?"inline-block":"block"};
...
`;function k1(e){switch(e){case"immediate":return 200;case"long":return 800;default:return 200}}var L1=e=>{var t=e,{ariaLive:a=!1,children:r,content:l,shortcut:o,placement:s="topCenter",keepOpen:d,triggerOffset:m=4,maxWidth:v=26,isInline:p=!0,isDisabled:g,container:f,tabIndex:C=0,zIndex:x=1100,verticalAlign:z="middle",delay:y="immediate",tooltipId:_}=t,P=E(t,["ariaLive","children","content","shortcut","placement","keepOpen","triggerOffset","maxWidth","isInline","isDisabled","container","tabIndex","zIndex","verticalAlign","delay","tooltipId"]);const[U,I]=(0,L.XI)({delayEnter:k1(y),delayLeave:200}),[ae,oe]=(0,n.useState)(!1),[F,Z]=(0,n.useState)(!1),[K,ue]=(0,n.useState)(!1),ne=(0,n.useRef)(),J=!l||g;(0,n.useEffect)(()=>{if(J){Z(!1);return}const H=ae&&d;(U||H)&&Z(!0),!U&&!H&&!K&&Z(!1)},[l,g,ae,J,d,Z,U,K]);const A=()=>{ue(!1),J||Z(!0)},he=()=>{Z(!1),ue(!1)};(0,n.useEffect)(()=>{if(!F)return;const H=de=>{de.key==="Escape"&&(de.preventDefault(),he())};return window.addEventListener("keydown",H),()=>{window.removeEventListener("keydown",H)}},[F,Z]);const{layerProps:le,triggerProps:$e,renderLayer:De}=(0,L.sJ)({isOpen:F,placement:Kr[s],ResizeObserver:$.Z,triggerOffset:m,container:f,auto:!0});return n.createElement(n.Fragment,null,n.createElement(M1,k(i(i({},$e),I),{onClick:H=>{H.detail===0&&ue(!0)},onFocus:A,onBlur:he,isInline:p,verticalAlign:z,tabIndex:J?-1:C,ref:(0,L.lq)($e.ref,ne)}),r),a&&n.createElement("span",{className:"srOnly","aria-live":"polite"},F&&l),F&&De(n.createElement("div",k(i({},le),{style:k(i({},le.style),{zIndex:x})}),n.createElement(R1,i({maxWidth:v,onMouseEnter:()=>oe(!0),onMouseLeave:()=>oe(!1),role:"tooltip",id:_},P),n.createElement(Ye,{gap:"small"},n.createElement(Ie,{size:"small",fontWeight:"bold"},l),o&&n.createElement(Ye,{gap:"xsmall"},o.map((H,de)=>n.createElement($1,{key:de},H))))))))},x0=Object.keys(Kr),_1=L1,Gr=R.iv`
...
`,M0=e=>{var t=e,{variant:a="combined",maxWidth:r,symbolColor:l,wordmarkColor:o="body",brand:s="loom",customId:d=""}=t,m=E(t,["variant","maxWidth","symbolColor","wordmarkColor","brand","customId"]);return React44.createElement(D1,i({variant:a,maxWidth:r},m),a==="combined"&&React44.createElement(O1,{brand:s,symbolColor:l,wordmarkColor:c(o),customId:d,className:"lns-logoSvg"}),a==="symbol"&&React44.createElement(I1,{brand:s,symbolColor:l,customId:d,className:"lns-logoSvg"}),a==="wordmark"&&React44.createElement(B1,{brand:s,wordmarkColor:c(o),className:"lns-logoSvg"}))},k0=null,V1="https://cdn.loom.com/assets/lens",Qr={small:"40px",medium:"80px"},W1=h.Z.span`
  animation: ${e=>e.animation};
  background-image: url(${V1}/${e=>e.brand}-loader.svg);
...
`,L0=({animation:e="spin 2s infinite steps(49) forwards",brand:t="loom",size:a="medium"})=>React45.createElement(W1,{animation:e,brand:t,size:a}),_0=null,Nt="/* emotion-disable-server-rendering-unsafe-selector-warning-please-do-not-use-this-the-warning-exists-for-a-reason */",P1={border:R.iv`
...
`,qr=e=>{var t=e,{children:a,htmlTag:r="li",className:l,backgroundColor:o,onClick:s,href:d,role:m}=t,v=E(t,["children","htmlTag","className","backgroundColor","onClick","href","role"]);const p=l?` ${l}`:"",g=["div","span","p","h1","h2","h3","h4","h5","h6","section","article","header","footer","main","aside","nav"],f=!r&&s;let C=!1;const x=r||"div";f||(C=g.includes(x));const z=!C||f?{onClick:s,onKeyDown:y=>{y.key==="Enter"&&(y.preventDefault(),s?.(y))}}:{};return n.createElement(T1,i(i({role:m||(r==="li"?"listitem":void 0),className:`ListRowWrapper${p}`,as:r,backgroundColor:o,href:d},z),v),a)},F1=e=>e.map(t=>Re(t)).join(" "),Z1=e=>{var t=e,{children:a,columns:r,gap:l,variant:o="stripe",htmlTag:s="ul"}=t,d=E(t,["children","columns","gap","variant","htmlTag"]);let m=a;return s==="ul"&&(m=n.Children.map(a,v=>n.isValidElement(v)&&v.type===qr?n.cloneElement(v,{htmlTag:"li"}):v)),n.createElement(A1,i({as:s,columns:r&&F1(r),gap:l,variant:o,role:s==="ul"?"list":void 0},d),m)},j1=Z1,Rt=n.createContext({}),N1=e=>`calc(-1 * ${Re(e)})`,ea=h.Z.div`
  ${e=>e.scrollOffset&&`margin: 0 ${N1(e.scrollOffset)};
  `};
`,ta=h.Z.div`
...
`,U1=e=>{var t=e,{children:a,isActive:r,htmlTag:l="button",icon:o,isDisabled:s=!1}=t,d=E(t,["children","isActive","htmlTag","icon","isDisabled"]);const{isPilledDesign:m}=n.useContext(Rt);return m?n.createElement(na,i({as:l,isActive:r,icon:o,role:"tab","aria-selected":r,disabled:s},d),o&&n.createElement(fe,{htmlTag:"span",paddingRight:a&&"small"},n.createElement(ce,{icon:o,color:"currentColor"})),a):n.createElement(aa,i({as:l,isActive:r,icon:o,role:"tab","aria-selected":r,disabled:s},d),o&&n.createElement(fe,{htmlTag:"span",paddingRight:a&&"small"},n.createElement(ce,{icon:o,color:"currentColor"})),a)},K1=e=>{var t=e,{children:a,scrollOffset:r,hasFullTabs:l,isPilledDesign:o,hasBottomBorder:s=!1}=t,d=E(t,["children","scrollOffset","hasFullTabs","isPilledDesign","hasBottomBorder"]);const m=o?n.createElement(ra,i({hasFullTabs:l,scrollOffset:r,role:"tablist"},d),a):n.createElement(ta,i({hasFullTabs:l,scrollOffset:r,hasBottomBorder:s,role:"tablist"},d),a);return r?n.createElement(ea,{scrollOffset:r},m):n.createElement(Rt.Provider,{value:{isPilledDesign:o}},m)},G1=({tooltipProps:e,children:t,tooltipId:a})=>e?n.createElement(_1,k(i({},e),{tooltipId:a,tabIndex:-1}),t):t,la=n.forwardRef((e,t)=>{var a=e,{tabContent:r,tooltipProps:l,isActive:o,htmlTag:s="button",icon:d,isDisabled:m=!1,onKeyDown:v,onClick:p}=a,g=E(a,["tabContent","tooltipProps","isActive","htmlTag","icon","isDisabled","onKeyDown","onClick"]);const{isPilledDesign:f}=n.useContext(Rt),C=(0,n.useId)(),x=i({as:s,isActive:o,icon:d,role:"tab","aria-selected":o,disabled:m,tabIndex:o?0:-1,"aria-describedby":l?C:void 0,onKeyDown:v,onClick:p,ref:t},g);return n.createElement(G1,{tooltipProps:l,tooltipId:C},f?n.createElement(na,i({},x),d?n.createElement(fe,{htmlTag:"span",paddingRight:r&&"small"},n.createElement(ce,{icon:d,color:"currentColor"})):null,r):n.createElement(aa,i({},x),d?n.createElement(fe,{htmlTag:"span",paddingRight:r&&"small"},n.createElement(ce,{icon:d,color:"currentColor"})):null,r))});la.displayName="TabNew";var Y1=e=>{var t=e,{tabs:a,scrollOffset:r,hasFullTabs:l,isPilledDesign:o,hasBottomBorder:s=!1}=t,d=E(t,["tabs","scrollOffset","hasFullTabs","isPilledDesign","hasBottomBorder"]);const m=(0,n.useRef)({}),v=(0,n.useCallback)((x,z)=>{var y;let _=z;switch(x.key){case"ArrowLeft":x.preventDefault(),_=z>0?z-1:a.length-1;break;case"ArrowRight":x.preventDefault(),_=z<a.length-1?z+1:0;break;case"Home":x.preventDefault(),_=0;break;case"End":x.preventDefault(),_=a.length-1;break;default:return}(y=m.current[_])==null||y.focus()},[a.length]),p=(0,n.useCallback)(x=>z=>{m.current[x]=z},[]),g=(0,n.useMemo)(()=>a.map((x,z)=>n.createElement(la,i({key:z,ref:p(z),onKeyDown:y=>v(y,z)},x))),[a,v,p]),f=(0,n.useMemo)(()=>o?n.createElement(ra,i({hasFullTabs:l,scrollOffset:r,role:"tablist"},d),g):n.createElement(ta,i({hasFullTabs:l,scrollOffset:r,hasBottomBorder:s,role:"tablist"},d),g),[g,l,r,s,o,d]),C=n.createElement(Rt.Provider,{value:{isPilledDesign:o}},f);return r?n.createElement(ea,{scrollOffset:r},C):C},X1=e=>{var t=e,{children:a,tabs:r}=t,l=E(t,["children","tabs"]);return a&&r&&console.warn("Both children and tabs props are provided. Please use only one of them."),!a&&!r?(console.error("Either children or tabs must be provided."),null):a?n.createElement(K1,i({},l),a):n.createElement(Y1,i({tabs:r},l))},J1=X1,Q1=h.Z.div`
  display: inline-grid;
  grid-auto-flow: column;
  align-items: center;
  vertical-align: middle;
  ...
  ${Te("bold")};
  ${b("gap","xsmall")};
`,H0=e=>{var t=e,{color:a,backgroundColor:r,children:l,icon:o,iconPosition:s="left"}=t,d=E(t,["color","backgroundColor","children","icon","iconPosition"]);const m=React48.createElement(fe,{htmlTag:"span",paddingLeft:s==="right"&&"xsmall",paddingRight:s==="left"&&"xsmall"},React48.createElement(ce,{icon:o,color:"currentColor",size:2}));return React48.createElement(Q1,i({color:a,backgroundColor:r},d),o&&s==="left"&&m,l,o&&s==="right"&&m)},S0=null,q1={topLeft:"top-start",topCenter:"top",topRight:"top-end",bottomLeft:"bottom-start",bottomCenter:"bottom",bottomRight:"bottom-end",leftTop:"left-start",leftCenter:"left",leftBottom:"left-end",rightTop:"right-start",rightCenter:"right",rightBottom:"right-end"},ei=h.Z.div`
  position: relative;
  width: fit-content;
...
`,oa=h.Z.div`
  ${e=>e.zIndex&&`z-index: ${e.zIndex}`};
`,I0=e=>{var t=e,{children:a,content:r,offset:l=.5,boundaryOffset:o=.5,isOpen:s,zIndex:d=500,childrenZIndex:m=1,placement:v="topCenter",rootId:p,boundaryElement:g="body",transitionDuration:f=0,transitionDelay:C=0}=t,x=E(t,["children","content","offset","boundaryOffset","isOpen","zIndex","childrenZIndex","placement","rootId","boundaryElement","transitionDuration","transitionDelay"]);const z=l*et,y=o*et,_=typeof window<"u",P=p&&_?document.getElementById(p):void 0,{stage:U,shouldMount:I}=useTransition2(s,f+C),ae=()=>g==="body"&&_?document.body:g,{x:oe,y:F,reference:Z,floating:K,strategy:ue,update:ne,refs:J}=useFloating({placement:q1[v],middleware:[shift({padding:y,boundary:g?ae():void 0,limiter:limitShift()}),flip({fallbackPlacements:["top","bottom"],fallbackStrategy:"initialPlacement"}),floatingUiOffset(z)],strategy:"fixed"});useEffect10(()=>{if(!(!J.reference.current||!J.floating.current))return autoUpdate(J.reference.current,J.floating.current,ne)},[J.reference,J.floating,ne,I]);const A={zIndex:d,ref:K,style:{position:ue,top:F??"",left:oe??"",transition:`opacity ${f}ms ${C}ms`,opacity:U==="enter"?1:0}};return React49.createElement(ei,k(i({ref:Z},x),{childrenZIndex:m}),a,I&&React49.createElement(React49.Fragment,null,!P&&React49.createElement(oa,i({},A),r),P&&ReactDOM.createPortal(React49.createElement(oa,i({},A),r),P)))},B0=null,ti=h.Z.span`
  display: block;
...
`,O0=e=>{var t=e,{altText:a,illustration:r,color:l="orange",size:o=12}=t,s=E(t,["altText","illustration","color","size"]);return React50.createElement(ti,i({"aria-hidden":"true","aria-label":a,color:l,size:o},s),r)},D0=null,ia=e=>R.iv`
  ${b("width",e.width)};
  ${b("height",e.height)};
...
`,ai=h.Z.div`
  ...
  ${e=>ia(e)};
`,ni=e=>{var t=e,{children:a,grow:r,shrink:l,basis:o,width:s,height:d,minWidth:m,minHeight:v,maxWidth:p,maxHeight:g,htmlTag:f="div",className:C,style:x}=t,z=E(t,["children","grow","shrink","basis","width","height","minWidth","minHeight","maxWidth","maxHeight","htmlTag","className","style"]);return(C||x)&&console.warn(_t),React51.createElement(ai,i({as:f,grow:r,shrink:l,basis:o,width:s,height:d,minWidth:m,minHeight:v,maxWidth:p,maxHeight:g},z),a)},li=e=>{var t=e,{children:a,gap:r="initial",rowGap:l,columnGap:o,alignItems:s="center",justifyContent:d,alignContent:m,wrap:v="wrap",width:p,height:g,minWidth:f,minHeight:C,maxWidth:x,maxHeight:z,htmlTag:y="div",className:_,style:P}=t,U=E(t,["children","gap","rowGap","columnGap","alignItems","justifyContent","alignContent","wrap","width","height","minWidth","minHeight","maxWidth","maxHeight","htmlTag","className","style"]);return(_||P)&&console.warn(_t),React51.createElement(ri,i({as:y,gap:r,rowGap:l,columnGap:o,alignItems:s,justifyContent:d,alignContent:m,wrap:v,width:p,height:g,minWidth:f,minHeight:C,maxWidth:x,maxHeight:z},U),y==="ul"||y==="ol"?Children.map(a,I=>I.type===ni||I.type===li?cloneElement(I,{htmlTag:"li"}):I):a)},V0=null,oi=h.Z.div`
...
`,mi=({swatches:e,currentColor:t,onSwatchClick:a})=>{const r=e.includes(t)&&t;return React52.createElement(ui,null,e.map(l=>React52.createElement(hi,{key:l,color:l,selected:r,onClick:()=>a(l),role:"button",tabIndex:0,onKeyDown:o=>{o.key==="Enter"&&(o.preventDefault(),a(l))}})))},vi=({color:e,setColor:t})=>React52.createElement(oi,null,React52.createElement(HexColorPicker,{color:e,onChange:t}),React52.createElement(si,null,React52.createElement(HexColorInput,{prefixed:!0,color:e,onChange:t}),React52.createElement(ci,{color:e}))),W0=e=>{var t=e,{defaultColor:a="#ffffff",confirmButton:r,swatches:l,onChange:o}=t,s=E(t,["defaultColor","confirmButton","swatches","onChange"]);const[d,m]=useState6(a||"#FFFFFF"),v=g=>{m(g),o(g)},p=g=>{v(g)};return React52.createElement(ii,i({},s),l&&React52.createElement(mi,{swatches:l,currentColor:d,onSwatchClick:p}),React52.createElement(vi,{color:d,setColor:v}),r&&React52.createElement(di,null,r))},P0=null,gi=2,at={small:{totalSize:u(2.25),height:u(.5625),dotSize:u(.375),gap:u(.25)},medium:{totalSize:u(3),height:u(.75),dotSize:u(.5),gap:u(.375)},large:{totalSize:u(6),height:u(1.5),dotSize:u(1),gap:u(.75)}},pi=e=>at[e.size].totalSize,fi=e=>at[e.size].height,sa=e=>at[e.size].dotSize,bi=e=>at[e.size].gap,Ci=e=>at[e.size].dotSize,wi=e=>R.F4`
  0%, 40%, 100% {
    transform: translateY(50%);
  }
  20% {
...
`,Ut=h.Z.span`
  ...
  background-color: ${e=>c(e.color)};
  transform: translateY(50%);
  animation: ${e=>wi(Ci(e))} ${gi}s
    ease-in-out infinite;
  animation-fill-mode: both;
  animation-delay: ${e=>e.delay}s;
`,A0=e=>{var t=e,{color:a="body",size:r="medium"}=t,l=E(t,["color","size"]);return React53.createElement(Ei,i({size:r},l),React53.createElement(Ut,{color:a,size:r,delay:0}),React53.createElement(Ut,{color:a,size:r,delay:.2}),React53.createElement(Ut,{color:a,size:r,delay:.4}))},T0=Object.keys(at),F0=null,Kt={medium:{totalSize:u(3),barHeight:u(2.25)}},ca={fast:1.2,slow:1.7},yi="linear-gradient(270deg, #565ADD 10.58%, #DC43BE 41.83%, #565ADD 69.23%, #565ADD 96.63%)",zi=2,Gt=5,xi=u(.25),$i=e=>Kt[e.size||"medium"].barHeight,ht=e=>Kt[e.size||"medium"].totalSize,da=e=>ca[e.speed||"fast"],Ri=R.F4`
  0%, 100% {
...
`,_i=h.Z.span`
  width: ${xi};
  height: ${e=>$i(e)};
  background: ${e=>e.color==="ai-primary"?yi:c(e.color)};
  ...
  animation:
    ${ki} 50ms ease-out forwards,
    ${Ri} ${e=>da(e)}s ease-in-out infinite,
    ${Mi} ${zi}s linear infinite;

  animation-delay: ${e=>-1+e.index*(da(e)/Gt)}s;
  position: relative;
`,Z0=e=>{var t=e,{size:a="medium",speed:r="fast",color:l="body"}=t,o=E(t,["size","speed","color"]);const s=Array.from({length:Gt},(d,m)=>React54.createElement(_i,{key:m,index:m,size:a,speed:r,color:l}));return React54.createElement(Li,i({size:a,color:l},o),s)},j0=Object.keys(Kt),N0=Object.keys(ca),U0=null,Hi=R.F4`
  0% {
    transform: scale(1);
    opacity: 0;
  }
...
`,Pe={dot:{size:"8px",borderWidth:"1px",borderColor:c("background")},positioning:{top:"-2px",right:"-2px"},animation:{duration:"2s",timing:"ease-out",iteration:"infinite"}},ua={blue:c("blue"),orange:c("orange")},Si=h.Z.span`
  position: relative;
  display: inline-block;
`,Ii=h.Z.span`
  position: absolute;
  height: ${Pe.dot.size};
  width: ${Pe.dot.size};
  top: ${Pe.positioning.top};
  right: ${Pe.positioning.right};
`,Bi=h.Z.span`
  position: absolute;
  height: 100%;
  width: 100%;
  border-radius: var(--lns-radius-full);
  background-color: ${e=>ua[e.color||"blue"]};
  border: ${Pe.dot.borderWidth} solid
    ${Pe.dot.borderColor};
