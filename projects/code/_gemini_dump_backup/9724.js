...
`,fe=e=>e&&`font-weight: var(--lns-fontWeight-${e});`,Ca=e=>e&&`var(--lns-fontSetting-${e});`,O=e=>e&&`border-radius: var(--lns-radius-${e});`,De=e=>e&&`box-shadow: var(--lns-shadow-${e});`,ae=(e,t)=>{const a=e||c("focusRing");return`box-shadow:${t||""} 0 0 0 2px ${a};`},je=e=>`
  ...
  ${e=>e.sizeMinMax&&`
    ...
    font-size: clamp(
      ${Xt(e.sizeMinMax[0])},
      ${Jt(Yt(e.sizeMinMax[0]),Yt(e.sizeMinMax[1]),496,1200)},
      ${Xt(e.sizeMinMax[1])}
    );

    line-height: clamp(
      ${Ke(e.sizeMinMax[0])}px,
      ${Jt(Ke(e.sizeMinMax[0]),Ke(e.sizeMinMax[1]),496,1200)},
      ${Ke(e.sizeMinMax[1])}px
    );
  `}
`,$a=e=>{var t=e,{children:a,size:r="body-md",color:l,isInline:n,isDimmed:s,fontWeight:d="regular",hasEllipsis:h,ellipsisLines:v,noWrap:p,variant:g,htmlTag:f="span",alignment:C,sizeMinMax:E,fontSetting:y="normal"}=t,w=z(t,["children","size","color","isInline","isDimmed","fontWeight","hasEllipsis","ellipsisLines","noWrap","variant","htmlTag","alignment","sizeMinMax","fontSetting"]);return s&&console.warn(ya),r.includes("heading-")&&(d="bold"),o.createElement(xa,i({size:g?ct[g].size:r,color:l,isInline:n,isDimmed:s,fontWeight:g?ct[g].fontWeight:d,hasEllipsis:h,ellipsisLines:v,noWrap:p,variant:g,as:f,alignment:C,sizeMinMax:E,fontSetting:y},w),a)},Ra=["left","right","center"],me=$a,Ge=["top","bottom","left","right"],Qt=i({0:"0"},Ue),dt=i({0:"0",auto:"auto"},Ue),ka=Ot.map(e=>({selector:"c",modifier:e,declarations:[{property:"color",value:`var(--lns-color-${e})`}]})),La=Ot.map(e=>({selector:"bgc",modifier:e,declarations:[{property:"background-color",value:`var(--lns-color-${e})`}]})),Ma=Object.keys(be).map(e=>({selector:"text",modifier:e,declarations:[{property:"font-size",value:`var(--lns-fontSize-${e})`},{property:"line-height",value:`var(--lns-lineHeight-${e})`},{property:"letter-spacing",value:`var(--lns-letterSpacing-${e})`},e.includes("heading-")||e.includes("xlarge")?{property:"font-weight",value:"var(--lns-fontWeight-bold)"}:{property:"font-weight",value:"var(--lns-fontWeight-regular)"}]})),Ha=Object.keys(Nt).map(e=>({selector:"weight",modifier:e,declarations:[{property:"font-weight",value:`var(--lns-fontWeight-${e})`}]})),Sa=Object.entries(ct).map(([e,t])=>({selector:"text",modifier:e,declarations:[{property:"font-size",value:`var(--lns-fontSize-${t.size})`},{property:"line-height",value:`var(--lns-lineHeight-${t.size})`},{property:"font-weight",value:`var(--lns-fontWeight-${t.fontWeight})`}]})),_a=Ra.map(e=>({selector:"text",modifier:e,declarations:[{property:"text-align",value:e}]})),Ia=Object.keys(it).map(e=>({selector:"shadow",modifier:e,declarations:[{property:"box-shadow",value:`var(--lns-shadow-${e})`}]})),Ba=Object.keys(Ut).map(e=>({selector:"radius",modifier:e,declarations:[{property:"border-radius",value:`var(--lns-radius-${e})`}]})),Ae=(e,t,a,r)=>{const l=[];return t.map(n=>{const s=r?`${e.charAt(0)}${n.charAt(0)}`:n;Object.keys(a).map(d=>{l.push({selector:s,property:`${e}${n&&e?`-${n}`:n||""}`,modifier:d,value:d==="auto"||d==="0"?d:`var(--lns-space-${d})`})})}),l},Va=Object.values(Ae("margin",["",...Ge],dt,"shortSides")).map(e=>({selector:e.selector,modifier:e.modifier,declarations:[{property:e.property,value:e.value}]})),Wa=Object.values(Ae("margin",["x","y"],dt,"shortSides")).map(e=>({selector:e.selector,modifier:e.modifier,declarations:[{property:e.property==="margin-x"?"margin-left":"margin-top",value:e.value},{property:e.property==="margin-x"?"margin-right":"margin-bottom",value:e.value}]})),Da=Object.values(Ae("padding",["",...Ge],Qt,"shortSides")).map(e=>({selector:e.selector,modifier:e.modifier,declarations:[{property:e.property,value:e.value}]})),Aa=Object.values(Ae("padding",["x","y"],Qt,"shortSides")).map(e=>({selector:e.selector,modifier:e.modifier,declarations:[{property:e.property==="padding-x"?"padding-left":"padding-top",value:e.value},{property:e.property==="padding-x"?"padding-right":"padding-bottom",value:e.value}]})),Oa=["",...Ge].map(e=>{const t="border"+e.replace(e.charAt(0),e.charAt(0).toUpperCase()),a=`border${e&&`-${e}`}`;return{selector:t,declarations:[{property:a,value:"1px solid var(--lns-color-border)"}]}}),Fa=["inline","block","flex","inlineBlock","inlineFlex","none"],Pa=Fa.map(e=>({selector:e,declarations:[{property:"display",value:Ne(e)}]})),Ta=[{selector:"flexWrap",declarations:[{property:"flex-wrap",value:"wrap"}]}],Za=["column","row"],ja=Za.map(e=>({selector:"flexDirection",modifier:e,declarations:[{property:"flex-direction",value:e}]})),Na=["stretch","center","baseline","flexStart","flexEnd","selfStart","selfEnd"],Ua=Na.map(e=>({selector:"items",modifier:e,declarations:[{property:"align-items",value:Ne(e)}]})),Ka=["flexStart","flexEnd","center","spaceBetween","spaceAround","spaceEvenly"],Ga=Ka.map(e=>({selector:"justify",modifier:e,declarations:[{property:"justify-content",value:Ne(e)}]})),Ya=["0","1"],Xa=Ya.map(e=>({selector:"grow",modifier:e,declarations:[{property:"flex-grow",value:e}]})),Ja=["0","1"],Qa=Ja.map(e=>({selector:"shrink",modifier:e,declarations:[{property:"flex-shrink",value:e}]})),qa=["auto","flexStart","flexEnd","center","baseline","stretch"],e1=qa.map(e=>({selector:"self",modifier:e,declarations:[{property:"align-self",value:Ne(e)}]})),t1=["hidden","auto"],r1=t1.map(e=>({selector:"overflow",modifier:e,declarations:[{property:"overflow",value:e}]})),a1=["relative","absolute","sticky","fixed"],l1=a1.map(e=>({selector:e,declarations:[{property:"position",value:e}]})),n1=Object.values(Ae("",Ge,dt)).map(e=>({selector:e.selector,modifier:e.modifier,declarations:[{property:e.property,value:e.value}]})),o1=["auto","full","0"],i1=o1.map(e=>({selector:"width",modifier:e,declarations:[{property:"width",value:e==="full"?"100%":e}]})),s1=[{selector:"minWidth",modifier:"0",declarations:[{property:"min-width",value:"0"}]}],c1=["auto","full","0"],d1=c1.map(e=>({selector:"height",modifier:e,declarations:[{property:"height",value:e==="full"?"100%":e}]})),u1=[{selector:"ellipsis",declarations:[{property:"overflow",value:"hidden"},{property:"text-overflow",value:"ellipsis"},{property:"white-space",value:"nowrap"}]}],h1=[{selector:"srOnly",declarations:[{property:"position",value:"absolute"},{property:"width",value:"1px"},{property:"height",value:"1px"},{property:"padding",value:"0"},{property:"margin",value:"-1px"},{property:"overflow",value:"hidden"},{property:"clip",value:"rect(0, 0, 0, 0)"},{property:"white-space",value:"nowrap"},{property:"border-width",value:"0"}]}],m1="\\:",qt=[...ka,...Ia,...Ba,...La,...Va,...Wa,...Da,...Aa,...Ma,...Ha,...Sa,..._a,...Oa,...Pa,...Ta,...ja,...Ua,...Ga,...Xa,...Qa,...e1,...r1,...l1,...n1,...i1,...s1,...d1,...u1,...h1],er=(e,t)=>{const a=[],r=t?`${t}-`:"";return e.map(l=>{const n=[];l.declarations.map(d=>{n.push(`${d.property}:${d.value}`)});const s=`.${r}${l.selector}${l.modifier?m1:""}${l.modifier?l.modifier:""}{${n.join(";")}}`;a.push(s)}),a.join("")},v1={xs:Ce.xsmall,sm:Ce.small,md:Ce.medium,lg:Ce.large},g1=()=>(()=>{const t=[];return t.push(`${er(qt)}`),Object.entries(v1).map(([a,r])=>{t.push(`@media(min-width:${r}){${er(qt,a)}}`)}),t.join("")})(),le=(e,t)=>{const a={};return Object.entries(t).forEach(([r,l])=>{const s=`--lns-${(e?`${e}-`:"")+r}`;a[s]=l}),a},p1=()=>{const e={};return Object.entries(be).forEach(([t,a])=>{const r={},l={},n={},s=`fontSize-${t}`,d=`lineHeight-${t}`,h=`letterSpacing-${t}`;r[s]=u(a.fontSize),r[d]=a.lineHeight,r[h]=a.letterSpacing,Object.assign(e,r,l,n)}),e},f1=()=>{const e={};return Object.entries(Ue).forEach(([t,a])=>{const r=`space-${t}`;e[r]=u(a)}),e},b1=()=>{const e={};return Object.keys(i(i({},q),Ve)).forEach(t=>{const a=t;e[a]=`hsla(${Y[t].h},${Y[t].s}%,${Y[t].l}%,${Y[t].a})`}),e},C1=()=>{const e=(t,a)=>Object.keys(t).reduce((r,l)=>{const n=t[l],s=`${a}-color-${l}`;return r[s]=n.ads?`var(${n.ads}, hsla(${n.h},${n.s}%,${n.l}%,${n.a}))`:`hsla(${n.h},${n.s}%,${n.l}%,${n.a})`,r},{});return i(i({},e($e.light,"themeLight")),e($e.dark,"themeDark"))},w1=le(void 0,{unit:`${ke/16}rem`}),y1=le("fontWeight",Nt),E1=le("fontSetting",wa),z1=le(void 0,p1()),x1=le("radius",Ut),$1=le("shadow",it),R1=le(void 0,f1()),k1=le(void 0,{formFieldBorderWidth:"1px",formFieldBorderWidthFocus:"2px",formFieldHeight:u(4.5),formFieldRadius:"var(--lns-radius-175)",formFieldHorizontalPadding:u(2),formFieldBorderShadow:`
  ...
  `}),L1=le("color",b1()),M1=le(void 0,C1()),H1=le("gradient",Kt),tr=[w1,z1,x1,$1,R1,k1],S1=()=>Object.assign({},...tr),_1=()=>Object.assign({},y1,...tr,E1),I1=()=>i(i(i({},L1),M1),H1),B1=()=>Object.keys($e.light).map(e=>`--lns-color-${e}: var(--lns-themeLight-color-${e});`),V1=()=>Object.keys($e.dark).map(e=>`--lns-color-${e}: var(--lns-themeDark-color-${e});`),rr=(e=":root")=>`
    ${e||":root"},
    .theme-light,
  ...
  `,Ii=()=>{const e=document.createElement("style");e.innerHTML=rr(),document.head.appendChild(e)},Bi=()=>Object.entries(S1()).map(t=>`${t[0]}:${t[1]};`).join(""),W1=e=>{const t=[],a=e||":root";return Object.entries(_1()).forEach(r=>{t.push(`${r[0]}:${r[1]};`)}),Object.entries(I1()).forEach(r=>{t.push(`${r[0]}:${r[1]};`)}),`
    ${a} {
      ${t.join("")}
    }
...
`,Vi=e=>{var t=e,{altText:a="",size:r=4,letter:l,imageSrc:n,children:s,themeColor:d="blue"}=t,h=z(t,["altText","size","letter","imageSrc","children","themeColor"]);const v=()=>{if(s)return s;if(n){const f=we(r).height,C=we(r).width;return React3.createElement(F1,{size:r,alt:a,src:n,height:f,width:C})}if(l)return a?React3.createElement("span",{"aria-label":a},l):l},p=l&&!n&&!s,g=D1(d||"blue");return React3.createElement(O1,i({hasBackgroundColor:p,size:r,backgroundColor:g.background,color:g.text},h),v())},Wi=null,ar=(e=":root",t="body")=>`
    ...
    ${g1()}
  `,Di=()=>React4.createElement(Global,{styles:css(ar())}),Ai=null,P1=3,T1=m.Z.span`
  display: block;
  color: ${e=>c(e.color)};
...
`,Z1=e=>{var t=e,{altText:a,icon:r,color:l="body",size:n=P1}=t,s=z(t,["altText","icon","color","size"]);const d=o.useRef(null);return o.createElement(T1,i({ref:d,"aria-label":a,color:l,size:n},s),r)},U=Z1,lr=1,ut=8,ht={small:{totalSize:18},medium:{totalSize:24},large:{totalSize:48}},Ye=e=>ht[e.size].totalSize/6,mt=e=>ht[e.size].totalSize,j1=_.F4`
  50% {
    transform: scale(1);
  }
`,N1=m.Z.span`
...
`,se={neutral:{color:c("body"),background:"transparent",borderColor:c("buttonBorder"),hover:c("backgroundHover"),active:c("backgroundActive"),floatingBackground:c("overlay"),floatingHover:c("overlayHover"),floatingActive:c("overlayActive")},neutralSecondary:{color:c("body"),background:c("backgroundNeutral"),borderColor:null,hover:c("backgroundNeutralHover"),active:c("backgroundNeutralActive")},primary:{color:c("white"),background:c("blurple"),borderColor:null,hover:c("primaryHover"),active:c("primaryActive")},secondary:{color:c("primary"),background:c("highlight"),borderColor:null,hover:c("highlightHover"),active:null},record:{color:c("white"),background:c("record"),borderColor:null,hover:c("recordHover"),active:c("recordActive")},upgrade:{color:c("body"),background:c("upgrade"),borderColor:null,hover:c("upgradeHover"),active:c("upgradeActive"),focusRing:ae()},danger:{color:c("bodyInverse"),background:c("danger"),borderColor:null,hover:c("dangerHover"),active:c("dangerActive")},ai:{color:c("white"),background:c("ai-primary"),borderColor:null,hover:null,active:null}},nr=e=>({enabled:_.iv`
  ...
  ${e=>e.disabled?nr(e).disabled:nr(e).enabled};
  ${e=>!e.disabled&&`
...
`,el=m.Z.span`
  ${gt};
`,tl=e=>{var t=e,{size:a="medium",children:r,variant:l="neutral",hasFullWidth:n,width:s="auto",icon:d,iconPosition:h="left",iconBefore:v,iconAfter:p,logoSrc:g,hasLoader:f,isDisabled:C,ariaDisabled:E,htmlTag:y="button",interactionName:w,onClick:x,refHandler:H}=t,W=z(t,["size","children","variant","hasFullWidth","width","icon","iconPosition","iconBefore","iconAfter","logoSrc","hasLoader","isDisabled","ariaDisabled","htmlTag","interactionName","onClick","refHandler"]);const k=d&&h==="left"?d:null,P=v||k?o.createElement(ir,{hasLoader:f,paddingLeft:"0",paddingRight:r?or:"0"},o.createElement(U,{icon:v||k,color:"currentColor",size:ee[a].iconSize})):null,j=d&&h==="right"?d:null,I=p||j?o.createElement(ir,{hasLoader:f,paddingLeft:r?or:"0",paddingRight:"unset"},o.createElement(U,{icon:j||p,color:"currentColor",size:ee[a].iconSize})):null,B=(0,o.useCallback)(D=>{w&&(0,Ht.Z)(w),x?.(D)},[x,w]);return o.createElement(J1,L(i({size:a,variant:l,hasFullWidth:n,width:s,icon:d,iconPosition:h,logoSrc:g,disabled:C,ariaDisabled:E,as:y,hasChildren:r,ref:D=>H&&H(D)},W),{onClick:w===void 0?x:B}),f&&o.createElement(q1,null,o.createElement(vt,{color:"currentColor"})),P,g&&o.createElement(Q1,{alt:"",hasSpacing:Boolean(r),src:g,size:a,height:ee[a].height,width:ee[a].height,hasLoader:f}),o.createElement(el,{hasLoader:f},r),I)},Fi=Object.keys(ee),Pi=Object.keys(se),rl=tl,al=m.Z.div`
...
`,ll=e=>{var t=e,{children:a,all:r,y:l,x:n,top:s,right:d,bottom:h,left:v,isInline:p}=t,g=z(t,["children","all","y","x","top","right","bottom","left","isInline"]);return o.createElement(al,i({all:r,top:l||s,bottom:l||h,right:n||d,left:n||v,isInline:p},g),a)},Xe=ll,Je={topLeft:"start",topCenter:"start center",topRight:"start end",centerLeft:"center start",center:"center",centerRight:"center end",bottomLeft:"end start",bottomCenter:"end center",bottomRight:"end"},nl=e=>{if(Array.isArray(e))return e.map(t=>Je[t]);if(typeof e=="object"){const t={};return Object.entries(e).forEach(([a,r])=>t[a]=Je[r]),t}return Je[e]},ol=m.Z.div`
  width: 100%;
  height: 100%;
  display: grid;
  ${e=>J("place-items",nl(e.alignment))};
`,il=e=>{var t=e,{children:a,alignment:r="center",htmlTag:l="div"}=t,n=z(t,["children","alignment","htmlTag"]);return o.createElement(ol,i({alignment:r,as:l},n),a)},Ti=Object.keys(Je),Ee=il,sl=(e,t,a)=>{const r=t||"border",n=`${re(a)} solid ${c(r)}`;if(e)return e==="all"?`border: ${n};`:`border-${e}: ${n};`},cl=m.Z.div`
...
`,Zi=(0,o.forwardRef)((e,t)=>{var a=e,{placeholder:r,onFocus:l,onChange:n,onBlur:s,onKeyDown:d,isDisabled:h,icon:v,type:p="text",value:g,hasError:f,size:C="medium",addOn:E}=a,y=z(a,["placeholder","onFocus","onChange","onBlur","onKeyDown","isDisabled","icon","type","value","hasError","size","addOn"]);const w=o.createElement(hl,i({type:p,placeholder:r,onFocus:l,onChange:n,onBlur:s,onKeyDown:d,disabled:h,icon:v,ref:t,value:g,hasError:f,inputSize:C,addOn:E},y));return v||E?o.createElement(ml,null,v&&o.createElement(vl,{size:C},typeof v=="string"?o.createElement(X,{radius:"50",width:Q[C].iconSize,height:Q[C].iconSize,overflow:"hidden"},o.createElement(Ee,{alignment:"center"},o.createElement(gl,{src:v,alt:"",isDisabled:h}))):o.createElement(U,{icon:v,size:Q[C].iconSize,color:c(h?"disabledContent":"body")})),w,E&&o.createElement(pl,{size:C},E)):w}),fl=null,sr={start:"flex-start",center:"center",end:"flex-end",stretch:"stretch"},cr=!1,Qe=e=>Array.isArray(e)?e:[e],dr=(e,t)=>{if(e.length===t)return e;const a=e[e.length-1];return[...Array(t)].map((r,l)=>e[l]||a)},bl=(e,t)=>{const a=Math.max(Qe(e).length,Qe(t).length),r=dr(Qe(t),a),l=dr(Qe(e),a),n="& > * + *",s=r.map((h,v)=>{const p=`${re(h)} 0 0 0`,g=`0 0 0 ${re(h)}`,f=l[v]==="column"?p:g;return`${n}{ margin: ${f}; }`}),d=l.map(h=>`flex-direction: ${h}`);return Re(s)+Re(d)},Cl=m.Z.div`
  display: flex;
  flex-wrap: wrap;
...
`,ji=e=>{var t=e,{children:a,gap:r,direction:l="row",alignment:n="start",isSpread:s,htmlTag:d="div"}=t,h=z(t,["children","gap","direction","alignment","isSpread","htmlTag"]);return cr||(console.warn(Ea),cr=!0),React12.createElement(Cl,i({gap:r,flexDirection:l,flexAlign:n,isSpread:s,as:d},h),a)},Ni=Object.keys(sr),Ui=null,wl=m.Z.div`
  display: grid;
  ...
  ${e=>jt(e.as)};
`,yl=e=>{var t=e,{children:a,width:r,height:l,minWidth:n,minHeight:s,maxWidth:d,maxHeight:h,gap:v,columns:p,rows:g,alignItems:f="center",justifyContent:C="start",justifyItems:E,alignContent:y,autoFlow:w,htmlTag:x="div",className:H,style:W}=t,k=z(t,["children","width","height","minWidth","minHeight","maxWidth","maxHeight","gap","columns","rows","alignItems","justifyContent","justifyItems","alignContent","autoFlow","htmlTag","className","style"]);return(H||W)&&console.warn(st),o.createElement(wl,i({alignItems:f,as:x,justifyContent:C,justifyItems:E,alignContent:y,gap:v,columns:p,rows:g,width:r,height:l,minWidth:n,minHeight:s,maxWidth:d,maxHeight:h,autoFlow:w},k),a)},Le=yl;function ur(){return o.createElement(pe.Z,{label:"",testId:"ads-refreshed-icon"})}var El=m.Z.div`
  position: relative;
  ::before {
    content: '';
...
`,Ki=({children:e,errorActive:t,errorMessage:a="Oops, that didn't work. Try again."})=>t?React15.createElement(El,null,React15.createElement(Le,{autoFlow:"row",gap:"small"},e,a?React15.createElement(Le,{gap:"xsmall"},React15.createElement(U,{icon:React15.createElement(ur,null),size:2,color:"danger"}),React15.createElement(me,{size:"body-sm",color:"danger"},a)):null)):React15.createElement(React15.Fragment,null,e),Gi=null,zl={start:"flex-start",center:"center",end:"flex-end"},xl=m.Z.div`
  display: flex;
  ${e=>Pt(e.alignment,zl)};
...
`,Rl=e=>{var t=e,{width:a,maxWidth:r,children:l}=t,n=z(t,["width","maxWidth","children"]);return console.warn(Gt),o.createElement($l,i({width:a,maxWidth:r},n),l)},kl=class extends o.Component{render(){return console.warn(Gt),o.createElement(xl,i({},this.props),this.props.children)}};kl.Section=Rl;var Yi=null,Oe={small:{size:u(3),iconSize:2.25,radius:"var(--lns-radius-100)"},medium:{size:u(4),iconSize:3,radius:"var(--lns-radius-150)"},large:{size:u(5),iconSize:4,radius:"var(--lns-radius-175)"}},Ll=m.Z.button`
...
`,hr=o.forwardRef((e,t)=>{var a=e,{altText:r,icon:l,onClick:n,iconColor:s="body",backgroundColor:d,isActive:h,isDisabled:v,size:p="medium"}=a,g=z(a,["altText","icon","onClick","iconColor","backgroundColor","isActive","isDisabled","size"]);return o.createElement(Ll,i({"aria-label":r,onClick:n,isActive:h,disabled:v,size:p,backgroundColor:d,ref:t},g),o.createElement(U,{icon:l,size:Oe[p].iconSize,color:v?"disabledContent":s}))});hr.displayName="IconButton";var pt=hr,Ml=e=>o.createElement("svg",i({width:12,height:9,viewBox:"0 0 12 9",fill:"none"},e),o.createElement("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M11.707.293a1 1 0 010 1.414l-7 7a1 1 0 01-1.414 0l-3-3a1 1 0 011.414-1.414L4 6.586 10.293.293a1 1 0 011.414 0z",fill:"currentColor"})),Hl=e=>o.createElement("svg",i({width:12,height:2,viewBox:"0 0 12 2",fill:"none"},e),o.createElement("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M0 1a1 1 0 011-1h10a1 1 0 110 2H1a1 1 0 01-1-1z",fill:"currentColor"})),Sl=m.Z.div`
  display: block;
  position: relative;
`,_l=m.Z.input`
  height: 100%;
...
`,Dl=o.forwardRef((e,t)=>{var a=e,{onClick:r,size:l="medium",children:n,icon:s,iconPosition:d="left",isActive:h,isDisabled:v,htmlTag:p,offsetSide:g}=a,f=z(a,["onClick","size","children","icon","iconPosition","isActive","isDisabled","htmlTag","offsetSide"]);const C=o.createElement(X,{paddingLeft:d==="right"&&"small",paddingRight:d==="left"&&"small",htmlTag:"span"},o.createElement(U,{icon:s,size:Me[l].iconSize,color:v?"disabledColor":void 0}));return o.createElement(Wl,i({onClick:r,size:l,icon:s,iconPosition:d,disabled:v,isActive:h,as:p,offsetSide:g,ref:t},f),s&&d==="left"&&C,n,s&&d==="right"&&C)});Dl.displayName="TextButton";var Xi=null,ft=e=>{var t,a;const r=(a=(t=e?.())==null?void 0:t.getRootNode)==null?void 0:a.call(t);if(String(r)==="[object ShadowRoot]"){r.createElement=(...n)=>r.ownerDocument.createElement(...n);const l=r.createElement("div");return l.id="a11y-status-message",l.style.display="none",r.appendChild(l),{document:r,addEventListener:r.addEventListener.bind(r),removeEventListener:r.removeEventListener.bind(r)}}return typeof window>"u"?null:window},ye=e=>typeof e=="string"?e:typeof e=="number"||typeof e=="boolean"||typeof e=="bigint"?e.toString():e==null?"":Al(e)?Array.from(e).map(ye).join(""):typeof e=="object"&&"props"in e&&e.props&&e.props.children!==void 0?ye(e.props.children):"",Al=e=>typeof e[Symbol.iterator]=="function";function mr(){return o.createElement("span",{"aria-hidden":!0,"data-testid":"ads-refreshed-icon"},o.createElement("svg",{viewBox:"-2 -2 16 16"},o.createElement("path",{fill:"currentColor",fillRule:"evenodd",d:"M2.03 3.97 6 7.94l3.97-3.97 1.06 1.06-4.5 4.5a.75.75 0 0 1-1.06 0l-4.5-4.5z",clipRule:"evenodd"})))}function Ol(){return o.createElement(Qr.Z,{label:"",testId:"ads-refreshed-icon"})}var bt={left:"bottom-start",right:"bottom-end",topLeft:"top-start",topRight:"top-end",leftSide:"left-start",rightSide:"right-start"},Fl=m.Z.div`
...
`,Zl=m.Z.img`
  ...
  object-fit: cover;
  opacity: ${({isDisabled:e})=>e?.5:1};
`,Ct=e=>{var t=e,{isDisabled:a,isHighlighted:r,isSelected:l,icon:n,hasDivider:s,children:d,menuItemRole:h,keyboardMove:v}=t,p=z(t,["isDisabled","isHighlighted","isSelected","icon","hasDivider","children","menuItemRole","keyboardMove"]);const C=`${n?"auto":""} 1fr ${l?"auto":""}`,E=a?"disabledContent":void 0,y=h?L(i({},p),{role:h}):p;return o.createElement(Tl,i({isHighlighted:r,isDisabled:a,keyboardMove:v,columns:C,hasDivider:s,tabIndex:a?-1:0,"data-highlighted":r||void 0},y),n&&(typeof n=="string"?o.createElement(X,{radius:"50",width:3,height:3,overflow:"hidden"},o.createElement(Ee,{alignment:"center"},o.createElement(Zl,{src:n,alt:"",isDisabled:a}))):o.createElement(U,{icon:n,color:E})),o.createElement(me,{color:E,hasEllipsis:!0},d),l&&o.createElement(U,{icon:o.createElement(Ol,null),color:E}))},jl=e=>{var t=e,{position:a,zIndex:r,minWidth:l,maxWidth:n,maxHeight:s,children:d,role:h,downshiftMenuProps:v=()=>null,search:p}=t,g=z(t,["position","zIndex","minWidth","maxWidth","maxHeight","children","role","downshiftMenuProps","search"]);const f=h?L(i({},v()),{role:h}):i({},v());return o.createElement(Fl,i(i({minWidth:l,maxWidth:n,maxHeight:s,zIndex:r,position:a},f),g),p&&p,o.createElement(Pl,{search:p},d))},ze=jl;function Nl(){return React24.createElement(SearchIcon,{label:"",testId:"ads-refreshed-icon"})}var Ul=m.Z.div`
  padding: ${u(1.5)} ${u(1.5)} 0;
  margin-bottom: ${u(1.5)};
  position: sticky;
  top: 0;
`,Ji=({ariaLabel:e,placeholder:t,value:a,onChange:r,getInputProps:l})=>React25.createElement(Ul,null,React25.createElement(fl,i({"aria-label":e,icon:React25.createElement(Nl,null)},l({placeholder:t,value:a,onChange:r,type:"text"})))),vr=null,Kl=m.Z.div`
  position: relative;
`,Gl=m.Z.button`
  appearance: none;
  font: inherit;
...
`,Jl=m.Z.span`
  ...
  grid-column-start: 1;
  grid-column-end: 3;
`,qe=e=>Array.isArray(e)&&e.length>0&&"group"in e[0],wt=({options:e,selectedOptionValue:t})=>{if(!e||!t)return{icon:null,title:null};if(qe(e))for(const a of e){const r=a.items.find(l=>l.value===t);if(r)return r}else return e.find(r=>r.value===t)||{icon:null,title:null};return{icon:null,title:null}},gr=({options:e,selectedItem:t,selectedOptionValue:a})=>{if(t)return t.icon;if(a)return wt({options:e,selectedOptionValue:a}).icon},Ql=({options:e,selectedItem:t,selectedOptionValue:a,selectPlaceholder:r})=>t?t.title:a?wt({options:e,selectedOptionValue:a}).title:r,pr=({selectedItem:e,getInputProps:t,getToggleButtonProps:a,ariaMenuName:r,isOpen:l})=>{const n=e?`selected value is ${e.title}`:"no value selected",s=a?.()["aria-label"];return{"aria-expanded":l,"aria-activedescendant":t()["aria-activedescendant"],"aria-label":[r,s,n].filter(Boolean).join(", ")}},ql=({getToggleButtonProps:e,inputValue:t,selectedItem:a,selectedOptionValue:r,selectPlaceholder:l,isDisabled:n,options:s,getInputProps:d,ariaMenuName:h,hasError:v,isOpen:p})=>{const g=gr({options:s,selectedItem:a,selectedOptionValue:r}),f=Boolean(g),C=!r&&!a,y=`${f?"auto":""} 1fr auto`,w=n?"disabledContent":void 0;return React26.createElement(Gl,L(i(i({},e()),pr({selectedItem:a,getInputProps:d,getToggleButtonProps:e,ariaMenuName:h,isOpen:p})),{hasValue:t||r,disabled:n,columns:y,hasError:v}),f&&(typeof g=="string"?React26.createElement(X,{radius:"50",width:3,height:3,overflow:"hidden"},React26.createElement(Ee,{alignment:"center"},React26.createElement(Yl,{src:g,alt:"",isDisabled:n}))):React26.createElement(U,{icon:gr({options:s,selectedItem:a,selectedOptionValue:r}),color:w})),React26.createElement(me,{hasEllipsis:!0,color:C?"bodyDimmed":"inherit"},Ql({options:s,selectedItem:a,selectedOptionValue:r,selectPlaceholder:l})),React26.createElement(U,{icon:React26.createElement(mr,null),color:w}))},en=({selectedOptionValue:e,selectedItem:t,trigger:a,getToggleButtonProps:r,options:l,selectPlaceholder:n,isDisabled:s,getInputProps:d,ariaMenuName:h,hasError:v,errorMessage:p,isOpen:g})=>{const f=()=>i(i({},r()),pr({selectedItem:t,getInputProps:d,getToggleButtonProps:r,ariaMenuName:h,isOpen:g})),E=L(i({},(()=>{if(t)return t;if(e)return wt({options:l,selectedOptionValue:e})})()),{placeholder:n,isDisabled:s,hasError:v,errorMessage:p});return a(E,f())},fr=(e,t)=>{if(qe(t))for(const a of t){const r=a.items.find(l=>l.value===e);if(r)return r}else return t.find(a=>a.value===e)},br=(e,t,a,r,l,n,s,d)=>{const h=!a&&e.value===r||a&&a.value===e.value;return React26.createElement(Ct,L(i({key:t,getItemProps:n,icon:e.icon,hidden:e.hidden},n({key:`${e.value}-${t}`,index:t,item:e,disabled:e.isDisabled,"aria-selected":h,onMouseMove:()=>{s&&d(!1)}})),{isDisabled:e.isDisabled,hasDivider:e.hasDivider,isHighlighted:l===t,keyboardMove:s&&l===t,isSelected:h}),e.title)},tn=e=>{var t=e,{options:a,selectedItem:r,selectedOptionValue:l,highlightedIndex:n,getItemProps:s,search:d,keyboardMove:h,setKeyboardMove:v}=t,p=z(t,["options","selectedItem","selectedOptionValue","highlightedIndex","getItemProps","search","keyboardMove","setKeyboardMove"]);if(!qe(a))return React26.createElement(ze,i({search:d},p),a.map((f,C)=>br(f,C,r,l,n,s,h,v)));let g=0;return React26.createElement(ze,i({search:d},p),a.map(f=>{const C=`group-${f.group.replace(/\s+/g,"-")}`;return React26.createElement("li",{key:C},React26.createElement(Xe,{left:"medium",top:"small",bottom:"xsmall"},React26.createElement(me,{id:C,size:"body-sm",fontWeight:"bold"},f.group)),React26.createElement(Xl,{role:"group","aria-labelledby":C},f.items.map(E=>br(E,g++,r,l,n,s,h,v))))}))},Qi=e=>{var t=e,{container:a,onChange:r,menuZIndex:l=1100,menuMaxWidth:n,menuMaxHeight:s=34,menuMinWidth:d,triggerOffset:h=0,ariaMenuName:v,selectedOptionValue:p,onOuterClick:g,options:f,placeholder:C,menuPosition:E="left",isDisabled:y,onOpenChange:w,trigger:x,hasError:H,errorMessage:W="Oops, that didn't work.",search:k}=t,P=z(t,["container","onChange","menuZIndex","menuMaxWidth","menuMaxHeight","menuMinWidth","triggerOffset","ariaMenuName","selectedOptionValue","onOuterClick","options","placeholder","menuPosition","isDisabled","onOpenChange","trigger","hasError","errorMessage","search"]);const j=ft(a),[I,B]=useState(!1),[D,K]=useState(!1),[T,F]=useState(""),S=R=>{const M=R.target.value;F(M)},[G,Z]=useState(fr(p,f)),de={itemToString:R=>R?R.value:"",onChange:R=>{Z(R),r&&r(R||"")},onOuterClick:g,environment:j,selectedItem:G,isOpen:I};j&&(de.environment=j);const{layerProps:$,triggerProps:N,renderLayer:_e,triggerBounds:ue}=useLayer({isOpen:I,container:a,ResizeObserver,placement:bt[E],auto:!0,snap:!0,triggerOffset:h});useEffect2(()=>{const R=fr(p,f);R?.value!==G?.value&&Z(R)},[p,f,G]),useEffect2(()=>{w&&w(I)},[I,w]);const ge=(R,M)=>{if(M.isOpen!==void 0){if(M.type===Downshift.stateChangeTypes.keyDownEscape)return B(!1),{isOpen:!1};B(M.isOpen)}return M},ne=R=>{switch(R.key){case"ArrowDown":case"ArrowUp":case"ArrowLeft":case"ArrowRight":case"Enter":case" ":case"Tab":case"Escape":K(!0);break;default:break}};return f=useMemo(()=>{if(k){if(qe(f)){let R;return k.searchType==="startsWith"?R=f.map(M=>L(i({},M),{items:M.items.filter(he=>ye(he.title).toLowerCase().startsWith(T.toLowerCase()))})):R=f.map(M=>L(i({},M),{items:M.items.filter(he=>ye(he.title).toLowerCase().includes(T.toLowerCase()))})),R.reduce((M,he)=>(he.items.length>0&&M.push(he),M),[])}return k.searchType==="startsWith"?f.filter(R=>ye(R.title).toLowerCase().startsWith(T.toLowerCase())):f.filter(R=>ye(R.title).toLowerCase().includes(T.toLowerCase()))}return f},[f,T,k]),React26.createElement(Kl,i({},P),React26.createElement(Downshift,L(i({},de),{stateReducer:ge}),({getItemProps:R,getInputProps:M,getMenuProps:he,getToggleButtonProps:at,isOpen:V,inputValue:oe,highlightedIndex:kt,selectedItem:Ie})=>React26.createElement("div",{role:"presentation"},React26.createElement("div",i({},N),x?React26.createElement(en,{getToggleButtonProps:()=>i({},at({onKeyDown:ne})),selectedItem:Ie,selectedOptionValue:p,selectPlaceholder:C,isDisabled:y,options:f,trigger:x,getInputProps:M,ariaMenuName:v,hasError:H,errorMessage:W,isOpen:V}):React26.createElement(ql,{getToggleButtonProps:()=>i({},at({onKeyDown:ne})),selectedItem:Ie,selectedOptionValue:p,selectPlaceholder:C,options:f,inputValue:oe,isDisabled:y,getInputProps:M,ariaMenuName:v,hasError:H,isOpen:V})),I&&V&&_e(React26.createElement("div",L(i({},$),{style:L(i({},$.style),{zIndex:l,width:d?"auto":ue?.width})}),React26.createElement(tn,{options:f,selectedItem:Ie,selectedOptionValue:p,highlightedIndex:kt,getItemProps:R,position:E,downshiftMenuProps:()=>he({onKeyDown:ne}),maxWidth:n,maxHeight:s,minWidth:d,search:k&&React26.createElement(vr,{ariaLabel:k.searchPlaceholder,placeholder:k.searchPlaceholder,value:T,onChange:S,getInputProps:M}),keyboardMove:D,setKeyboardMove:K}))),H&&!I&&React26.createElement(Jl,null,W))))},qi=null;function rn(e,t){const a=document;(0,o.useLayoutEffect)(()=>{const r=a?.documentElement,l=a?.body;if(!(a==null||!r||!l)){if(t){const n=window.innerWidth-r.clientWidth,s=parseInt(window.getComputedStyle(l).getPropertyValue("padding-right"),10)||0;switch(e){case"html":{r.style.position="relative",r.style.overflow="hidden",l.style.paddingRight=`${s+n}px`;break}case"body":{l.style.setProperty("position","relative"),l.style.setProperty("overflow","hidden"),l.style.setProperty("padding-right",`${s+n}px`);break}default:return}}return()=>{switch(e){case"html":{r.style.position="",r.style.overflow="",l.style.paddingRight="";break}case"body":{l.style.removeProperty("position"),l.style.removeProperty("overflow"),l.style.removeProperty("padding-right");break}default:return}}}},[a,t,e])}var Cr=rn,wr=300,an=m.Z.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`,ln=m.Z.div`
  overflow: auto;
  height: 100%;
`,yr=o.forwardRef((e,t)=>{var a=e,{children:r,isOpen:l,zIndex:n=1e3,backgroundColor:s="backdropDark"}=a,d=z(a,["children","isOpen","zIndex","backgroundColor"]);const{stage:h,shouldMount:v}=(0,qr.Yz)(l,wr);return Cr("html",l),o.createElement(o.Fragment,null,v&&o.createElement(an,i({ref:t,backgroundColor:s,zIndex:n,style:{transition:`opacity ${wr}ms`,opacity:h==="enter"?1:0}},d),o.createElement(ln,null,r)))});yr.displayName="Backdrop";var nn=yr;function yt(){return o.createElement(ra.Z,{label:"",testId:"ads-refreshed-icon"})}var on="70vh",sn=m.Z.div`
  display: grid;
...
`,Er=e=>typeof e=="number"?b("max-height",e):"max-height: "+e,pn=e=>{var t=e,{children:a,onCloseClick:r,isOpen:l,maxWidth:n=60,maxHeight:s=on,placement:d="center",ariaLabel:h,ariaModal:v,ariaLabelledBy:p,ref:g,removeClose:f,initialFocus:C}=t,E=z(t,["children","onCloseClick","isOpen","maxWidth","maxHeight","placement","ariaLabel","ariaModal","ariaLabelledBy","ref","removeClose","initialFocus"]);const y=w=>{w.key==="Escape"&&(w.preventDefault(),f||r(w))};return(0,o.useEffect)(()=>(window.addEventListener("keydown",y),()=>{window.removeEventListener("keydown",y)}),[l,r]),Cr("html",l),o.createElement(ta(),{active:l,focusTrapOptions:i({clickOutsideDeactivates:!1,allowOutsideClick:!0},C!==void 0?{initialFocus:C}:{})},o.createElement(cn,i({open:l,maxWidth:n,maxHeight:s,placement:d,onClick:w=>w.stopPropagation(),ref:g,"aria-label":h,"aria-modal":v,"aria-labelledby":p},E),!f&&r&&o.createElement(dn,null,o.createElement(pt,{altText:"Close",icon:o.createElement(yt,null),onClick:r})),o.createElement(gn,L(i({},f?{tabIndex:0}:{tabIndex:-1}),{maxHeight:s}),a)))},e0=o.forwardRef((e,t)=>{var a=e,{children:r,id:l,isOpen:n,mainButton:s,secondaryButton:d,alternativeButton:h,title:v,noPadding:p,onCloseClick:g,onBackgroundClick:f,onKeyDown:C,hasDividers:E,maxHeight:y="70vh",maxWidth:w=60,placement:x="center",zIndex:H=1e3,ariaLabel:W,ariaModal:k=!0,ariaLabelledBy:P,initialFocus:j}=a,I=z(a,["children","id","isOpen","mainButton","secondaryButton","alternativeButton","title","noPadding","onCloseClick","onBackgroundClick","onKeyDown","hasDividers","maxHeight","maxWidth","placement","zIndex","ariaLabel","ariaModal","ariaLabelledBy","initialFocus"]),B;const D=(0,o.useRef)(null),K=l?`${l}-modal-title`:"modal-title",T=!!(s||d||h),F=S=>{if(f){S.stopPropagation(),f(S);return}g(S)};return(0,o.useEffect)(()=>{if(!n||!D.current)return;const S=D.current.parentElement;return S?(Array.from(S.children).filter(Z=>Z!==D.current&&Z instanceof HTMLElement).forEach(Z=>{Z.hasAttribute("aria-hidden")||(Z.setAttribute("aria-hidden","true"),Z.setAttribute("data-lens-modal-hidden","true"))}),()=>{document.querySelectorAll("[data-lens-modal-hidden]").forEach(te=>{te.removeAttribute("aria-hidden"),te.removeAttribute("data-lens-modal-hidden")})}):void 0},[n]),o.createElement(nn,i({ref:D,isOpen:n,zIndex:H},I),o.createElement(X,{height:"100%",onClick:F,onKeyDown:C},o.createElement(pn,{ref:t,id:l,isOpen:n,maxHeight:y,maxWidth:w,placement:x,onCloseClick:g,ariaLabel:W,ariaModal:k,ariaLabelledBy:(B=P??K)!=null?B:void 0,initialFocus:j},o.createElement(sn,{rows:`${v?"auto ":""} ${r?"1fr ":""} ${T?"auto":""}`},v&&o.createElement(hn,{bottom:r?"var(--lns-space-medium)":"var(--lns-space-xlarge)"},o.createElement(me,{htmlTag:"h1",variant:"title",id:K},v)),o.createElement(vn,{noPadding:p,hasDividers:E,hasTitle:Boolean(v),hasButtons:T},r&&r),T&&o.createElement(mn,{top:r?"var(--lns-space-xlarge)":0,hasDividers:E},h,o.createElement(un,null,d&&o.createElement(Xe,{right:"small",isInline:!0},d),s))))))}),t0=null,et={neutral:{color:c("inherit"),focusRing:ae(),underline:"inactive"},primary:{color:c("primary"),focusRing:ae(),underline:"inactive"},subtle:{color:c("body"),focusRing:ae(),underline:"hover"}},zr={enabled:_.iv`
    cursor: pointer;
  `,disabled:_.iv`
    pointer-events: none;
    color: ${c("disabledContent")};
...
`,n0=o.forwardRef((e,t)=>{var a=e,{onChange:r,value:l,rows:n=4,isDisabled:s,placeholder:d,size:h="medium",resize:v="both",error:p=null}=a,g=z(a,["onChange","value","rows","isDisabled","placeholder","size","resize","error"]);return o.createElement(o.Fragment,null,o.createElement(Cn,i({disabled:s,onChange:r,placeholder:d,ref:t,rows:n,value:l,size:h,resize:v,error:p},g)),p?o.createElement(o.Fragment,null,o.createElement(Xe,{bottom:"xmsall"}),o.createElement(me,{color:"danger",fontWeight:"regular",size:"body-md"},p)):null)}),o0=null,wn=m.Z.div`
  position: relative;
`,yn=m.Z.ul`
  list-style: none;
  margin: 0;
...
`,En=m.Z.span`
  ...
  grid-column-start: 1;
  grid-column-end: 3;
`,tt=e=>Array.isArray(e)&&e.length>0&&"group"in e[0],$r=({options:e,selectedOptionValue:t})=>{if(!e||!t)return{icon:null,title:null};if(tt(e))for(const a of e){const r=a.items.find(l=>l.value===t);if(r)return r}else return e.find(r=>r.value===t)||{icon:null,title:null};return{icon:null,title:null}},zn=({options:e,selectedItem:t,selectedOptionValue:a})=>{if(t)return t.icon;if(a)return $r({options:e,selectedOptionValue:a}).icon},xn=({options:e,selectedItem:t,selectedOptionValue:a,placeholder:r})=>t?t.title:a?$r({options:e,selectedOptionValue:a}).title:r,$n=({selectedItem:e,getInputProps:t,ariaMenuName:a})=>{const r=e?`selected value is ${e.title}`:"no value selected";return{"aria-activedescendant":t()["aria-activedescendant"],"aria-label":[a,r].filter(Boolean).join(", ")}},Rn=m.Z.button`
  position: relative;
  width: 100%;
  background: none;
  border: none;
...
`,Sn=m.Z.img`
  ...
  object-fit: cover;
  opacity: ${({isDisabled:e})=>e?.5:1};
`,_n=({selectedItem:e,selectedOptionValue:t,placeholder:a,isDisabled:r,options:l,getInputProps:n,ariaMenuName:s,isOpen:d,onInputFocus:h,hasError:v,hasLoader:p,inputValue:g,handleInputValueChange:f,inputRef:C,id:E})=>{const y=zn({options:l,selectedItem:e,selectedOptionValue:t}),w=Boolean(y),x=r?"disabledContent":void 0,H=()=>{r||h()},W=i(i({role:"combobox","aria-autocomplete":"list","aria-haspopup":"listbox","aria-expanded":d},$n({selectedItem:e,getInputProps:n,ariaMenuName:s})),n({id:E,"aria-labelledby":void 0,disabled:r,onFocus:H,onClick:H,value:g,onBlur:()=>{f("")},onChange:P=>f(P.target.value)})),k=!g&&!t;return o.createElement(Rn,{onClick:H,disabled:r},w&&o.createElement(Ln,null,typeof y=="string"?o.createElement(X,{radius:"50",width:3,height:3,overflow:"hidden"},o.createElement(Ee,{alignment:"center"},o.createElement(Sn,{src:y,alt:"",isDisabled:r}))):o.createElement(U,{icon:y,color:x})),o.createElement(kn,L(i({ref:C},W),{hasIcon:w,hasAddOn:!0,hasError:v,isDisabled:r})),!g&&o.createElement(Hn,{hasIcon:w},o.createElement(me,{hasEllipsis:!0,color:k?"bodyDimmed":"inherit"},xn({options:l,selectedItem:e,selectedOptionValue:t,placeholder:a}))),o.createElement(Mn,null,p?o.createElement(vt,{size:"small"}):o.createElement(U,{icon:o.createElement(mr,null),color:x})))},Rr=(e,t)=>{var a;if(tt(t))for(const r of t){const l=r.items.find(n=>n.value===e);if(l)return l}else return(a=t.find(r=>r.value===e))!=null?a:null;return null},In=(e,t)=>(e||null)!=t?.value,kr=(e,t,a,r,l,n)=>{const s=!a&&e.value===r||a&&a.value===e.value;return o.createElement(Ct,L(i({key:t,getItemProps:n,icon:e.icon,hidden:e.hidden},n({key:`${e.value}-${t}`,index:t,item:e,disabled:e.isDisabled,"aria-selected":s})),{isDisabled:e.isDisabled,hasDivider:e.hasDivider,isHighlighted:l===t,isSelected:s}),e.title)},Bn=e=>{var t=e,{options:a,selectedItem:r,selectedOptionValue:l,highlightedIndex:n,getItemProps:s,isLoading:d,loadingMessage:h,emptyResultsMessage:v,hasAvailableOptions:p}=t,g=z(t,["options","selectedItem","selectedOptionValue","highlightedIndex","getItemProps","isLoading","loadingMessage","emptyResultsMessage","hasAvailableOptions"]);const f=h||o.createElement(vt,null),C=v||"No results";if(d)return o.createElement(ze,i({as:"div"},g),o.createElement(X,{padding:"large"},o.createElement(Ee,{alignment:"center"},f)));if(!p)return o.createElement(ze,i({as:"div"},g),o.createElement(X,{padding:"large"},o.createElement(Ee,{alignment:"center"},C)));if(!tt(a))return o.createElement(ze,i({},g),a.map((y,w)=>kr(y,w,r,l,n,s)));let E=0;return o.createElement(ze,i({},g),a.map(y=>{const w=`group-${y.group.replace(/\s+/g,"-")}`;return o.createElement("li",{key:w},o.createElement(Xe,{left:"medium",top:"small",bottom:"xsmall"},o.createElement(me,{id:w,size:"body-sm",fontWeight:"bold",htmlTag:y.headingTag||"h2"},y.group)),o.createElement(yn,{role:"group","aria-labelledby":w},y.items.map(x=>kr(x,E++,r,l,n,s))))}))},Vn=(0,o.forwardRef)((e,t)=>{var a=e,{container:r,onOptionChange:l,onInputValueChange:n,menuZIndex:s=1100,menuMaxWidth:d,menuMaxHeight:h=34,menuMinWidth:v,ariaMenuName:p,selectedOptionValue:g,onOuterClick:f,options:C,placeholder:E,menuPosition:y="left",isDisabled:w,onOpenChange:x,isLoading:H,loadingMessage:W,emptyResultsMessage:k,errorMessage:P,id:j}=a,I=z(a,["container","onOptionChange","onInputValueChange","menuZIndex","menuMaxWidth","menuMaxHeight","menuMinWidth","ariaMenuName","selectedOptionValue","onOuterClick","options","placeholder","menuPosition","isDisabled","onOpenChange","isLoading","loadingMessage","emptyResultsMessage","errorMessage","id"]);const B=ft(r),D=(0,o.useRef)(null),K=(0,o.useCallback)(V=>{D.current=V,t&&(typeof t=="function"?t(V):t.current=V)},[t]),[T,F]=(0,o.useState)(""),[S,G]=(0,o.useState)(!1),[Z,te]=(0,o.useState)(Rr(g,C)),[de,$]=(0,o.useState)(Z),N=V=>{F(V),n&&n(V)},ue={itemToString:V=>V?V.value:"",onChange:V=>{const oe=V||null;$(oe),l&&l(oe)},onOuterClick:f,environment:B,selectedItem:de,isOpen:S};B&&(ue.environment=B);const{layerProps:ge,triggerProps:ne,renderLayer:R,triggerBounds:M}=(0,Pe.sJ)({isOpen:S,container:r,ResizeObserver:_t.Z,placement:bt[y],auto:!0,snap:!0});(0,o.useEffect)(()=>{if(In(g,Z)){const V=Rr(g,C);te(V),$(V),F("")}},[g,C,Z]),(0,o.useEffect)(()=>{var V;x&&x(S),S||(V=D.current)==null||V.blur()},[S,x]);const he=(0,o.useMemo)(()=>Array.isArray(C)?tt(C)?C.some(V=>V.items.length>0):C.length>0:!1,[C]),at=(V,oe)=>{if(oe.isOpen!==void 0){if(oe.type===St.ZP.stateChangeTypes.keyDownEscape)return G(!1),{isOpen:!1};G(oe.isOpen)}return oe};return o.createElement(wn,i({},I),o.createElement(St.ZP,L(i({},ue),{stateReducer:at}),({getItemProps:V,getInputProps:oe,getMenuProps:kt,isOpen:Ie,highlightedIndex:Ei,selectedItem:Xr})=>o.createElement("div",{role:"presentation"},o.createElement("div",i({},ne),o.createElement(_n,{inputRef:K,selectedItem:Xr,selectedOptionValue:g,placeholder:E,isDisabled:w,options:C,getInputProps:oe,ariaMenuName:p,inputValue:T,handleInputValueChange:N,isOpen:S&&Ie,onInputFocus:()=>{G(!0)},hasLoader:H,hasError:Boolean(P),id:j})),S&&Ie&&R(o.createElement("div",L(i({},ge),{style:L(i({},ge.style),{zIndex:s,width:v?"auto":M?.width})}),o.createElement(Bn,{options:C,selectedItem:Xr,selectedOptionValue:g,hasAvailableOptions:he,highlightedIndex:Ei,getItemProps:V,isLoading:H,loadingMessage:W,emptyResultsMessage:k,position:y,downshiftMenuProps:kt,maxWidth:d,maxHeight:h,minWidth:v}))),Boolean(P)&&!S?o.createElement(En,null,P):null)))});Vn.displayName="Typeahead";var i0=null,Wn=({ariaMenuName:e,getInputProps:t,isOpen:a})=>({"aria-activedescendant":t()["aria-activedescendant"],"aria-expanded":a,"aria-label":e||""}),Dn=m.Z.div`
  display: inline-block;
  vertical-align: middle;
`,s0=e=>{var t=e,{ariaMenuName:a,menuPosition:r="left",menuZIndex:l=1100,options:n,trigger:s,triggerCallback:d,isOpen:h,menuMinWidth:v=24,menuMaxWidth:p=48,menuMaxHeight:g,container:f,onOuterClick:C,triggerOffset:E=0,onOpenChange:y,search:w,role:x,menuItemRole:H}=t,W=z(t,["ariaMenuName","menuPosition","menuZIndex","options","trigger","triggerCallback","isOpen","menuMinWidth","menuMaxWidth","menuMaxHeight","container","onOuterClick","triggerOffset","onOpenChange","search","role","menuItemRole"]);const k=ft(f),[P,j]=useState3(!1),[I,B]=useState3(!1),[D,K]=useState3(""),T=$=>{const N=$.target.value;K(N)},F=$=>{switch($.key){case"ArrowDown":case"ArrowUp":case"ArrowLeft":case"ArrowRight":case"Enter":case" ":case"Tab":case"Escape":B(!0);break;default:break}},S=h||P,{layerProps:G,triggerProps:Z,renderLayer:te}=useLayer3({isOpen:S,container:f,placement:bt[r],ResizeObserver:ResizeObserver3,auto:!0,snap:!0,triggerOffset:E});useEffect5(()=>{y&&y(S)},[S,y]);const de=($,N)=>(N.isOpen!==void 0&&j(N.isOpen),N);return n=useMemo3(()=>w?w.searchType==="startsWith"?n.filter($=>ye($.title).toLowerCase().startsWith(D.toLowerCase())):n.filter($=>ye($.title).toLowerCase().includes(D.toLowerCase())):n,[n,D,w]),React33.createElement(Downshift3,{stateReducer:de,itemToString:$=>$?$.title:"",onSelect:$=>$&&!$.disabled&&$.onClick&&$.onClick(),onOuterClick:C,environment:k},({getInputProps:$,getItemProps:N,getMenuProps:_e,getToggleButtonProps:ue,highlightedIndex:ge,isOpen:ne})=>React33.createElement("div",i(i({},W),d?{role:null,"aria-haspopup":null,"aria-expanded":null,"aria-labelledby":null}:{}),React33.createElement("div",i({},Z),d?d(i(i({},ue({onKeyDown:F})),Wn({ariaMenuName:a,getInputProps:$,isOpen:ne}))):React33.createElement(Dn,i({},ue({onKeyDown:F,tabIndex:0})),s)),ne&&te(React33.createElement("div",L(i({},G),{style:L(i({},G.style),{zIndex:l})}),React33.createElement(ze,{position:r,minWidth:v,maxWidth:p,maxHeight:g,downshiftMenuProps:()=>_e({onKeyDown:F}),role:x,search:w&&React33.createElement(vr,{ariaLabel:w.searchPlaceholder,placeholder:w.searchPlaceholder,value:D,onChange:T,getInputProps:$})},n.map((R,M)=>React33.createElement(Ct,i({key:M,isHighlighted:ge===M,keyboardMove:I&&ge===M,isDisabled:R.disabled,isSelected:R.selected,icon:R.icon,hasDivider:R.hasDivider,getItemProps:N,menuItemRole:H,index:M},N({key:M,index:M,item:R,disabled:R.disabled,onMouseMove:()=>{I&&B(!1)}})),R.title)))))))},c0=null,An=m.Z.label`
  display: block;
  position: relative;
...
`,Pn=(0,o.forwardRef)((e,t)=>{var a=e,{isDisabled:r,isChecked:l,onFocus:n,onChange:s,onBlur:d}=a,h=z(a,["isDisabled","isChecked","onFocus","onChange","onBlur"]);return o.createElement(An,{htmlFor:h.id},o.createElement(On,i({type:"radio",disabled:r,checked:l,onFocus:n,onChange:s,onBlur:d,ref:t},h)),o.createElement(Fn,{className:"RadioBox"}))}),Tn=Pn,ce={medium:{switchHeight:16,switchWidth:32,knobOffset:2},large:{switchHeight:20,switchWidth:36,knobOffset:2}},He={knob:{active:{enabled:c("white"),disabled:c("disabledContent")},inactive:{enabled:c("white"),disabled:c("disabledContent")}},track:{active:{enabled:c("blurple"),disabled:c("disabledBackground")},inactive:{enabled:c("grey6"),disabled:c("disabledBackground")}}},Zn=e=>ce[e.switchSize].switchWidth-ce[e.switchSize].switchHeight,Lr=e=>ce[e.switchSize].switchHeight-ce[e.switchSize].knobOffset*2,jn=m.Z.label`
  display: block;
  position: relative;
`,Nn=m.Z.input`
  position: absolute;
...
`,Kn=e=>{var t=e,{isActive:a,isDisabled:r,onChange:l,size:n="medium",ariaLabelledby:s,ariaLabel:d,ariaDescribedby:h}=t,v=z(t,["isActive","isDisabled","onChange","size","ariaLabelledby","ariaLabel","ariaDescribedby"]);if(s&&d)throw new Error("ariaLabelledby and ariaLabel serve the same purpose and therefore cannot be used at the same time. Choose the one that best suites your needs.");return o.createElement(jn,{htmlFor:v.id},o.createElement(Nn,L(i({},v),{checked:a,disabled:r,onChange:l,type:"checkbox",switchSize:n,"aria-labelledby":s,"aria-label":d,"aria-describedby":h,"aria-checked":a})),o.createElement(Un,{className:"SwitchBox",isDisabled:r,isActive:a,switchSize:n}))},Gn=Kn,Mr={row:{wrapper:{display:"grid",gridTemplateColumns:"auto 1fr",alignItems:"center"},label:{marginLeft:"var(--lns-space-small)"},errorMessage:{marginLeft:"var(--lns-space-small)"}},"row-reverse":{wrapper:{display:"grid",gridTemplateColumns:"1fr auto",alignItems:"center"},label:{}},column:{wrapper:{},label:{marginBottom:"var(--lns-space-xsmall)"}}},Yn=m.Z.div`
  ${e=>e.direction&&Mr[e.direction].wrapper};
`,Xn=m.Z.label`
  display: block;
  ${e=>{var t;return e.direction&&((t=Mr[e.direction])==null?void 0:t.label)}};
...
`,oo=e=>{switch(e){case Sr:return"unset";case Et:return u(4);default:return"unset"}},io=e=>{switch(e){case Sr:return u(4);case Et:return"unset";default:return u(4)}},so=m.Z.div`
...
`,co=m.Z.div`
  align-self: center;
`,f0=({children:e,isOpen:t,onCloseClick:a,zIndex:r=1100,duration:l="short",platform:n="web-app"})=>{const s=lo[l];return useEffect8(()=>{const d=setTimeout(()=>{t&&a()},s);return()=>clearTimeout(d)},[t]),React41.createElement(React41.Fragment,null,t&&React41.createElement(so,{role:"presentation",onClick:d=>d.stopPropagation(),zIndex:r,isOpen:t,toastDuration:s,platform:n},React41.createElement(co,{"aria-live":"polite"},e),a&&React41.createElement(pt,{altText:"Close",icon:React41.createElement(yt,null),onClick:a,iconColor:"bodyInverse"})))},b0=null,_r={topLeft:"top-start",topCenter:"top-center",topRight:"top-end",bottomLeft:"bottom-start",bottomCenter:"bottom-center",bottomRight:"bottom-end",leftTop:"left-start",leftCenter:"left-center",leftBottom:"left-end",rightTop:"right-start",rightCenter:"right-center",rightBottom:"right-end"},uo=4,ho=be.small.fontSize*be.small.lineHeight,mo=(uo-ho)/2,vo=m.Z.div`
  background-color: ${c("backgroundInverse")};
  color: ${c("bodyInverse")};
  ${O("150")};
  ${fe("bold")};
...
`;function Co(e){switch(e){case"immediate":return 200;case"long":return 800;default:return 200}}var wo=e=>{var t=e,{ariaLive:a=!1,children:r,content:l,shortcut:n,placement:s="topCenter",keepOpen:d,triggerOffset:h=4,maxWidth:v=26,isInline:p=!0,isDisabled:g,container:f,tabIndex:C=0,zIndex:E=1100,verticalAlign:y="middle",delay:w="immediate",tooltipId:x}=t,H=z(t,["ariaLive","children","content","shortcut","placement","keepOpen","triggerOffset","maxWidth","isInline","isDisabled","container","tabIndex","zIndex","verticalAlign","delay","tooltipId"]);const[W,k]=(0,Pe.XI)({delayEnter:Co(w),delayLeave:200}),[P,j]=(0,o.useState)(!1),[I,B]=(0,o.useState)(!1),[D,K]=(0,o.useState)(!1),T=(0,o.useRef)(),F=!l||g;(0,o.useEffect)(()=>{if(F){B(!1);return}const $=P&&d;(W||$)&&B(!0),!W&&!$&&!D&&B(!1)},[l,g,P,F,d,B,W,D]);const S=()=>{K(!1),F||B(!0)},G=()=>{B(!1),K(!1)};(0,o.useEffect)(()=>{if(!I)return;const $=N=>{N.key==="Escape"&&(N.preventDefault(),G())};return window.addEventListener("keydown",$),()=>{window.removeEventListener("keydown",$)}},[I,B]);const{layerProps:Z,triggerProps:te,renderLayer:de}=(0,Pe.sJ)({isOpen:I,placement:_r[s],ResizeObserver:_t.Z,triggerOffset:h,container:f,auto:!0});return o.createElement(o.Fragment,null,o.createElement(bo,L(i(i({},te),k),{onClick:$=>{$.detail===0&&K(!0)},onFocus:S,onBlur:G,isInline:p,verticalAlign:y,tabIndex:F?-1:C,ref:(0,Pe.lq)(te.ref,T)}),r),a&&o.createElement("span",{className:"srOnly","aria-live":"polite"},I&&l),I&&de(o.createElement("div",L(i({},Z),{style:L(i({},Z.style),{zIndex:E})}),o.createElement(fo,i({maxWidth:v,onMouseEnter:()=>j(!0),onMouseLeave:()=>j(!1),role:"tooltip",id:x},H),o.createElement(Le,{gap:"small"},o.createElement(me,{size:"small",fontWeight:"bold"},l),n&&o.createElement(Le,{gap:"xsmall"},n.map(($,N)=>o.createElement(po,{key:N},$))))))))},C0=Object.keys(_r),yo=wo,Ir=_.iv`
...
`,E0=e=>{var t=e,{variant:a="combined",maxWidth:r,symbolColor:l,wordmarkColor:n="body",brand:s="loom",customId:d=""}=t,h=z(t,["variant","maxWidth","symbolColor","wordmarkColor","brand","customId"]);return React44.createElement(ko,i({variant:a,maxWidth:r},h),a==="combined"&&React44.createElement(Ro,{brand:s,symbolColor:l,wordmarkColor:c(n),customId:d,className:"lns-logoSvg"}),a==="symbol"&&React44.createElement(xo,{brand:s,symbolColor:l,customId:d,className:"lns-logoSvg"}),a==="wordmark"&&React44.createElement($o,{brand:s,wordmarkColor:c(n),className:"lns-logoSvg"}))},z0=null,Lo="https://cdn.loom.com/assets/lens",Dr={small:"40px",medium:"80px"},Mo=m.Z.span`
  animation: ${e=>e.animation};
  background-image: url(${Lo}/${e=>e.brand}-loader.svg);
...
`,x0=({animation:e="spin 2s infinite steps(49) forwards",brand:t="loom",size:a="medium"})=>React45.createElement(Mo,{animation:e,brand:t,size:a}),$0=null,zt="/* emotion-disable-server-rendering-unsafe-selector-warning-please-do-not-use-this-the-warning-exists-for-a-reason */",Ho={border:_.iv`
...
`,Io=e=>{var t=e,{children:a,htmlTag:r="li",className:l,backgroundColor:n,onClick:s,href:d,role:h}=t,v=z(t,["children","htmlTag","className","backgroundColor","onClick","href","role"]);const p=l?` ${l}`:"",g=["div","span","p","h1","h2","h3","h4","h5","h6","section","article","header","footer","main","aside","nav"],f=!r&&s;let C=!1;const E=r||"div";f||(C=g.includes(E));const y=!C||f?{onClick:s,onKeyDown:w=>{w.key==="Enter"&&(w.preventDefault(),s?.(w))}}:{};return React46.createElement(_o,i(i({role:h||(r==="li"?"listitem":void 0),className:`ListRowWrapper${p}`,as:r,backgroundColor:n,href:d},y),v),a)},Bo=e=>e.map(t=>re(t)).join(" "),R0=e=>{var t=e,{children:a,columns:r,gap:l,variant:n="stripe",htmlTag:s="ul"}=t,d=z(t,["children","columns","gap","variant","htmlTag"]);let h=a;return s==="ul"&&(h=React46.Children.map(a,v=>React46.isValidElement(v)&&v.type===Io?React46.cloneElement(v,{htmlTag:"li"}):v)),React46.createElement(So,i({as:s,columns:r&&Bo(r),gap:l,variant:n,role:s==="ul"?"list":void 0},d),h)},k0=null,rt=o.createContext({}),Vo=e=>`calc(-1 * ${re(e)})`,Ar=m.Z.div`
...
`,L0=e=>{var t=e,{children:a,isActive:r,htmlTag:l="button",icon:n,isDisabled:s=!1}=t,d=z(t,["children","isActive","htmlTag","icon","isDisabled"]);const{isPilledDesign:h}=React47.useContext(rt);return h?React47.createElement(Tr,i({as:l,isActive:r,icon:n,role:"tab","aria-selected":r,disabled:s},d),n&&React47.createElement(X,{htmlTag:"span",paddingRight:a&&"small"},React47.createElement(U,{icon:n,color:"currentColor"})),a):React47.createElement(Pr,i({as:l,isActive:r,icon:n,role:"tab","aria-selected":r,disabled:s},d),n&&React47.createElement(X,{htmlTag:"span",paddingRight:a&&"small"},React47.createElement(U,{icon:n,color:"currentColor"})),a)},Wo=e=>{var t=e,{children:a,scrollOffset:r,hasFullTabs:l,isPilledDesign:n,hasBottomBorder:s=!1}=t,d=z(t,["children","scrollOffset","hasFullTabs","isPilledDesign","hasBottomBorder"]);const h=n?React47.createElement(Fr,i({hasFullTabs:l,scrollOffset:r,role:"tablist"},d),a):React47.createElement(Or,i({hasFullTabs:l,scrollOffset:r,hasBottomBorder:s,role:"tablist"},d),a);return r?React47.createElement(Ar,{scrollOffset:r},h):React47.createElement(rt.Provider,{value:{isPilledDesign:n}},h)},Do=({tooltipProps:e,children:t,tooltipId:a})=>e?o.createElement(yo,L(i({},e),{tooltipId:a,tabIndex:-1}),t):t,Zr=o.forwardRef((e,t)=>{var a=e,{tabContent:r,tooltipProps:l,isActive:n,htmlTag:s="button",icon:d,isDisabled:h=!1,onKeyDown:v,onClick:p}=a,g=z(a,["tabContent","tooltipProps","isActive","htmlTag","icon","isDisabled","onKeyDown","onClick"]);const{isPilledDesign:f}=o.useContext(rt),C=(0,o.useId)(),E=i({as:s,isActive:n,icon:d,role:"tab","aria-selected":n,disabled:h,tabIndex:n?0:-1,"aria-describedby":l?C:void 0,onKeyDown:v,onClick:p,ref:t},g);return o.createElement(Do,{tooltipProps:l,tooltipId:C},f?o.createElement(Tr,i({},E),d?o.createElement(X,{htmlTag:"span",paddingRight:r&&"small"},o.createElement(U,{icon:d,color:"currentColor"})):null,r):o.createElement(Pr,i({},E),d?o.createElement(X,{htmlTag:"span",paddingRight:r&&"small"},o.createElement(U,{icon:d,color:"currentColor"})):null,r))});Zr.displayName="TabNew";var Ao=e=>{var t=e,{tabs:a,scrollOffset:r,hasFullTabs:l,isPilledDesign:n,hasBottomBorder:s=!1}=t,d=z(t,["tabs","scrollOffset","hasFullTabs","isPilledDesign","hasBottomBorder"]);const h=useRef5({}),v=useCallback4((E,y)=>{var w;let x=y;switch(E.key){case"ArrowLeft":E.preventDefault(),x=y>0?y-1:a.length-1;break;case"ArrowRight":E.preventDefault(),x=y<a.length-1?y+1:0;break;case"Home":E.preventDefault(),x=0;break;case"End":E.preventDefault(),x=a.length-1;break;default:return}(w=h.current[x])==null||w.focus()},[a.length]),p=useCallback4(E=>y=>{h.current[E]=y},[]),g=useMemo4(()=>a.map((E,y)=>React47.createElement(Zr,i({key:y,ref:p(y),onKeyDown:w=>v(w,y)},E))),[a,v,p]),f=useMemo4(()=>n?React47.createElement(Fr,i({hasFullTabs:l,scrollOffset:r,role:"tablist"},d),g):React47.createElement(Or,i({hasFullTabs:l,scrollOffset:r,hasBottomBorder:s,role:"tablist"},d),g),[g,l,r,s,n,d]),C=React47.createElement(rt.Provider,{value:{isPilledDesign:n}},f);return r?React47.createElement(Ar,{scrollOffset:r},C):C},M0=e=>{var t=e,{children:a,tabs:r}=t,l=z(t,["children","tabs"]);return a&&r&&console.warn("Both children and tabs props are provided. Please use only one of them."),!a&&!r?(console.error("Either children or tabs must be provided."),null):a?React47.createElement(Wo,i({},l),a):React47.createElement(Ao,i({tabs:r},l))},H0=null,Oo=m.Z.div`
  display: inline-grid;
  grid-auto-flow: column;
  align-items: center;
  vertical-align: middle;
  ...
  ${fe("bold")};
  ${b("gap","xsmall")};
`,S0=e=>{var t=e,{color:a,backgroundColor:r,children:l,icon:n,iconPosition:s="left"}=t,d=z(t,["color","backgroundColor","children","icon","iconPosition"]);const h=React48.createElement(X,{htmlTag:"span",paddingLeft:s==="right"&&"xsmall",paddingRight:s==="left"&&"xsmall"},React48.createElement(U,{icon:n,color:"currentColor",size:2}));return React48.createElement(Oo,i({color:a,backgroundColor:r},d),n&&s==="left"&&h,l,n&&s==="right"&&h)},_0=null,Fo={topLeft:"top-start",topCenter:"top",topRight:"top-end",bottomLeft:"bottom-start",bottomCenter:"bottom",bottomRight:"bottom-end",leftTop:"left-start",leftCenter:"left",leftBottom:"left-end",rightTop:"right-start",rightCenter:"right",rightBottom:"right-end"},Po=m.Z.div`
  position: relative;
  width: fit-content;
...
`,V0=e=>{var t=e,{altText:a,illustration:r,color:l="orange",size:n=12}=t,s=z(t,["altText","illustration","color","size"]);return React50.createElement(To,i({"aria-hidden":"true","aria-label":a,color:l,size:n},s),r)},W0=null,Nr=e=>_.iv`
  ${b("width",e.width)};
  ${b("height",e.height)};
...
`,Zo=m.Z.div`
  ...
  ${e=>jt(e.as)};
`,jo=m.Z.div`
  ${e=>Tt("flex-grow",e.grow)};
  ${e=>Tt("flex-shrink",e.shrink)};
  ${e=>e.basis&&b("flex-basis",e.basis)};
  ${e=>Nr(e)};
`,No=e=>{var t=e,{children:a,grow:r,shrink:l,basis:n,width:s,height:d,minWidth:h,minHeight:v,maxWidth:p,maxHeight:g,htmlTag:f="div",className:C,style:E}=t,y=z(t,["children","grow","shrink","basis","width","height","minWidth","minHeight","maxWidth","maxHeight","htmlTag","className","style"]);return(C||E)&&console.warn(st),React51.createElement(jo,i({as:f,grow:r,shrink:l,basis:n,width:s,height:d,minWidth:h,minHeight:v,maxWidth:p,maxHeight:g},y),a)},Uo=e=>{var t=e,{children:a,gap:r="initial",rowGap:l,columnGap:n,alignItems:s="center",justifyContent:d,alignContent:h,wrap:v="wrap",width:p,height:g,minWidth:f,minHeight:C,maxWidth:E,maxHeight:y,htmlTag:w="div",className:x,style:H}=t,W=z(t,["children","gap","rowGap","columnGap","alignItems","justifyContent","alignContent","wrap","width","height","minWidth","minHeight","maxWidth","maxHeight","htmlTag","className","style"]);return(x||H)&&console.warn(st),React51.createElement(Zo,i({as:w,gap:r,rowGap:l,columnGap:n,alignItems:s,justifyContent:d,alignContent:h,wrap:v,width:p,height:g,minWidth:f,minHeight:C,maxWidth:E,maxHeight:y},W),w==="ul"||w==="ol"?Children.map(a,k=>k.type===No||k.type===Uo?cloneElement(k,{htmlTag:"li"}):k):a)},D0=null,Ko=m.Z.div`
...
`,F0=e=>{var t=e,{color:a="body",size:r="medium"}=t,l=z(t,["color","size"]);return React53.createElement(si,i({size:r},l),React53.createElement(xt,{color:a,size:r,delay:0}),React53.createElement(xt,{color:a,size:r,delay:.2}),React53.createElement(xt,{color:a,size:r,delay:.4}))},P0=Object.keys(Se),T0=null,$t={medium:{totalSize:u(3),barHeight:u(2.25)}},Kr={fast:1.2,slow:1.7},ci="linear-gradient(270deg, #565ADD 10.58%, #DC43BE 41.83%, #565ADD 69.23%, #565ADD 96.63%)",di=2,Rt=5,ui=u(.25),hi=e=>$t[e.size||"medium"].barHeight,Fe=e=>$t[e.size||"medium"].totalSize,Gr=e=>Kr[e.speed||"fast"],mi=_.F4`
  0%, 100% {
...
`,fi=m.Z.span`
  ...
  animation:
    ...
    ${mi} ${e=>Gr(e)}s ease-in-out infinite,
    ${vi} ${di}s linear infinite;

  animation-delay: ${e=>-1+e.index*(Gr(e)/Rt)}s;
  position: relative;
`,Z0=e=>{var t=e,{size:a="medium",speed:r="fast",color:l="body"}=t,n=z(t,["size","speed","color"]);const s=Array.from({length:Rt},(d,h)=>React54.createElement(fi,{key:h,index:h,size:a,speed:r,color:l}));return React54.createElement(pi,i({size:a,color:l},n),s)},j0=Object.keys($t),N0=Object.keys(Kr),U0=null,bi=_.F4`
  0% {
    transform: scale(1);
    opacity: 0;
  }
...
`,ve={dot:{size:"8px",borderWidth:"1px",borderColor:c("background")},positioning:{top:"-2px",right:"-2px"},animation:{duration:"2s",timing:"ease-out",iteration:"infinite"}},Yr={blue:c("blue"),orange:c("orange")},Ci=m.Z.span`
  position: relative;
  display: inline-block;
`,wi=m.Z.span`
  position: absolute;
...
`,yi=m.Z.span`
  ...
  width: 100%;
  border-radius: var(--lns-radius-full);
  background-color: ${e=>Yr[e.color||"blue"]};
