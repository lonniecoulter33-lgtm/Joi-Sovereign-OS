...
`,Ee=e=>e&&`font-weight: var(--lns-fontWeight-${e});`,Ca=e=>e&&`var(--lns-fontSetting-${e});`,A=e=>e&&`border-radius: var(--lns-radius-${e});`,Ze=e=>e&&`box-shadow: var(--lns-shadow-${e});`,oe=(e,t)=>{const a=e||c("focusRing");return`box-shadow:${t||""} 0 0 0 2px ${a};`},Je=e=>`
  ...
  ${e=>e.sizeMinMax&&`
    ...
    line-height: clamp(
      ${et(e.sizeMinMax[0])}px,
      ${Qt(et(e.sizeMinMax[0]),et(e.sizeMinMax[1]),496,1200)},
      ${et(e.sizeMinMax[1])}px
    );
  `}
`,$a=e=>{var t=e,{children:a,size:r="body-md",color:l,isInline:n,isDimmed:s,fontWeight:d="regular",hasEllipsis:m,ellipsisLines:v,noWrap:p,variant:g,htmlTag:f="span",alignment:C,sizeMinMax:y,fontSetting:E="normal"}=t,w=x(t,["children","size","color","isInline","isDimmed","fontWeight","hasEllipsis","ellipsisLines","noWrap","variant","htmlTag","alignment","sizeMinMax","fontSetting"]);return s&&console.warn(Ea),r.includes("heading-")&&(d="bold"),o.createElement(xa,i({size:g?vt[g].size:r,color:l,isInline:n,isDimmed:s,fontWeight:g?vt[g].fontWeight:d,hasEllipsis:m,ellipsisLines:v,noWrap:p,variant:g,as:f,alignment:C,sizeMinMax:y,fontSetting:E},w),a)},Ra=["left","right","center"],ue=$a,tt=["top","bottom","left","right"],qt=i({0:"0"},qe),gt=i({0:"0",auto:"auto"},qe),ka=Pt.map(e=>({selector:"c",modifier:e,declarations:[{property:"color",value:`var(--lns-color-${e})`}]})),Ma=Pt.map(e=>({selector:"bgc",modifier:e,declarations:[{property:"background-color",value:`var(--lns-color-${e})`}]})),La=Object.keys(ye).map(e=>({selector:"text",modifier:e,declarations:[{property:"font-size",value:`var(--lns-fontSize-${e})`},{property:"line-height",value:`var(--lns-lineHeight-${e})`},{property:"letter-spacing",value:`var(--lns-letterSpacing-${e})`},e.includes("heading-")||e.includes("xlarge")?{property:"font-weight",value:"var(--lns-fontWeight-bold)"}:{property:"font-weight",value:"var(--lns-fontWeight-regular)"}]})),Ha=Object.keys(Ut).map(e=>({selector:"weight",modifier:e,declarations:[{property:"font-weight",value:`var(--lns-fontWeight-${e})`}]})),_a=Object.entries(vt).map(([e,t])=>({selector:"text",modifier:e,declarations:[{property:"font-size",value:`var(--lns-fontSize-${t.size})`},{property:"line-height",value:`var(--lns-lineHeight-${t.size})`},{property:"font-weight",value:`var(--lns-fontWeight-${t.fontWeight})`}]})),Sa=Ra.map(e=>({selector:"text",modifier:e,declarations:[{property:"text-align",value:e}]})),Ia=Object.keys(ht).map(e=>({selector:"shadow",modifier:e,declarations:[{property:"box-shadow",value:`var(--lns-shadow-${e})`}]})),Ba=Object.keys(Kt).map(e=>({selector:"radius",modifier:e,declarations:[{property:"border-radius",value:`var(--lns-radius-${e})`}]})),je=(e,t,a,r)=>{const l=[];return t.map(n=>{const s=r?`${e.charAt(0)}${n.charAt(0)}`:n;Object.keys(a).map(d=>{l.push({selector:s,property:`${e}${n&&e?`-${n}`:n||""}`,modifier:d,value:d==="auto"||d==="0"?d:`var(--lns-space-${d})`})})}),l},Va=Object.values(je("margin",["",...tt],gt,"shortSides")).map(e=>({selector:e.selector,modifier:e.modifier,declarations:[{property:e.property,value:e.value}]})),Wa=Object.values(je("margin",["x","y"],gt,"shortSides")).map(e=>({selector:e.selector,modifier:e.modifier,declarations:[{property:e.property==="margin-x"?"margin-left":"margin-top",value:e.value},{property:e.property==="margin-x"?"margin-right":"margin-bottom",value:e.value}]})),Da=Object.values(je("padding",["",...tt],qt,"shortSides")).map(e=>({selector:e.selector,modifier:e.modifier,declarations:[{property:e.property,value:e.value}]})),Oa=Object.values(je("padding",["x","y"],qt,"shortSides")).map(e=>({selector:e.selector,modifier:e.modifier,declarations:[{property:e.property==="padding-x"?"padding-left":"padding-top",value:e.value},{property:e.property==="padding-x"?"padding-right":"padding-bottom",value:e.value}]})),Aa=["",...tt].map(e=>{const t="border"+e.replace(e.charAt(0),e.charAt(0).toUpperCase()),a=`border${e&&`-${e}`}`;return{selector:t,declarations:[{property:a,value:"1px solid var(--lns-color-border)"}]}}),Pa=["inline","block","flex","inlineBlock","inlineFlex","none"],Ta=Pa.map(e=>({selector:e,declarations:[{property:"display",value:Qe(e)}]})),Fa=[{selector:"flexWrap",declarations:[{property:"flex-wrap",value:"wrap"}]}],Za=["column","row"],ja=Za.map(e=>({selector:"flexDirection",modifier:e,declarations:[{property:"flex-direction",value:e}]})),Na=["stretch","center","baseline","flexStart","flexEnd","selfStart","selfEnd"],Ua=Na.map(e=>({selector:"items",modifier:e,declarations:[{property:"align-items",value:Qe(e)}]})),Ka=["flexStart","flexEnd","center","spaceBetween","spaceAround","spaceEvenly"],Ga=Ka.map(e=>({selector:"justify",modifier:e,declarations:[{property:"justify-content",value:Qe(e)}]})),Ya=["0","1"],Xa=Ya.map(e=>({selector:"grow",modifier:e,declarations:[{property:"flex-grow",value:e}]})),Ja=["0","1"],Qa=Ja.map(e=>({selector:"shrink",modifier:e,declarations:[{property:"flex-shrink",value:e}]})),qa=["auto","flexStart","flexEnd","center","baseline","stretch"],e1=qa.map(e=>({selector:"self",modifier:e,declarations:[{property:"align-self",value:Qe(e)}]})),t1=["hidden","auto"],r1=t1.map(e=>({selector:"overflow",modifier:e,declarations:[{property:"overflow",value:e}]})),a1=["relative","absolute","sticky","fixed"],l1=a1.map(e=>({selector:e,declarations:[{property:"position",value:e}]})),n1=Object.values(je("",tt,gt)).map(e=>({selector:e.selector,modifier:e.modifier,declarations:[{property:e.property,value:e.value}]})),o1=["auto","full","0"],i1=o1.map(e=>({selector:"width",modifier:e,declarations:[{property:"width",value:e==="full"?"100%":e}]})),s1=[{selector:"minWidth",modifier:"0",declarations:[{property:"min-width",value:"0"}]}],c1=["auto","full","0"],d1=c1.map(e=>({selector:"height",modifier:e,declarations:[{property:"height",value:e==="full"?"100%":e}]})),u1=[{selector:"ellipsis",declarations:[{property:"overflow",value:"hidden"},{property:"text-overflow",value:"ellipsis"},{property:"white-space",value:"nowrap"}]}],h1=[{selector:"srOnly",declarations:[{property:"position",value:"absolute"},{property:"width",value:"1px"},{property:"height",value:"1px"},{property:"padding",value:"0"},{property:"margin",value:"-1px"},{property:"overflow",value:"hidden"},{property:"clip",value:"rect(0, 0, 0, 0)"},{property:"white-space",value:"nowrap"},{property:"border-width",value:"0"}]}],m1="\\:",er=[...ka,...Ia,...Ba,...Ma,...Va,...Wa,...Da,...Oa,...La,...Ha,..._a,...Sa,...Aa,...Ta,...Fa,...ja,...Ua,...Ga,...Xa,...Qa,...e1,...r1,...l1,...n1,...i1,...s1,...d1,...u1,...h1],tr=(e,t)=>{const a=[],r=t?`${t}-`:"";return e.map(l=>{const n=[];l.declarations.map(d=>{n.push(`${d.property}:${d.value}`)});const s=`.${r}${l.selector}${l.modifier?m1:""}${l.modifier?l.modifier:""}{${n.join(";")}}`;a.push(s)}),a.join("")},v1={xs:ze.xsmall,sm:ze.small,md:ze.medium,lg:ze.large},g1=()=>(()=>{const t=[];return t.push(`${tr(er)}`),Object.entries(v1).map(([a,r])=>{t.push(`@media(min-width:${r}){${tr(er,a)}}`)}),t.join("")})(),ie=(e,t)=>{const a={};return Object.entries(t).forEach(([r,l])=>{const s=`--lns-${(e?`${e}-`:"")+r}`;a[s]=l}),a},p1=()=>{const e={};return Object.entries(ye).forEach(([t,a])=>{const r={},l={},n={},s=`fontSize-${t}`,d=`lineHeight-${t}`,m=`letterSpacing-${t}`;r[s]=u(a.fontSize),r[d]=a.lineHeight,r[m]=a.letterSpacing,Object.assign(e,r,l,n)}),e},f1=()=>{const e={};return Object.entries(qe).forEach(([t,a])=>{const r=`space-${t}`;e[r]=u(a)}),e},b1=()=>{const e={};return Object.keys(i(i({},ee),Te)).forEach(t=>{const a=t;e[a]=`hsla(${Y[t].h},${Y[t].s}%,${Y[t].l}%,${Y[t].a})`}),e},C1=()=>{const e=(t,a)=>Object.keys(t).reduce((r,l)=>{const n=t[l],s=`${a}-color-${l}`;return r[s]=n.ads?`var(${n.ads}, hsla(${n.h},${n.s}%,${n.l}%,${n.a}))`:`hsla(${n.h},${n.s}%,${n.l}%,${n.a})`,r},{});return i(i({},e(He.light,"themeLight")),e(He.dark,"themeDark"))},w1=ie(void 0,{unit:`${Se/16}rem`}),E1=ie("fontWeight",Ut),y1=ie("fontSetting",wa),z1=ie(void 0,p1()),x1=ie("radius",Kt),$1=ie("shadow",ht),R1=ie(void 0,f1()),k1=ie(void 0,{formFieldBorderWidth:"1px",formFieldBorderWidthFocus:"2px",formFieldHeight:u(4.5),formFieldRadius:"var(--lns-radius-175)",formFieldHorizontalPadding:u(2),formFieldBorderShadow:`
  ...
  `}),M1=ie("color",b1()),L1=ie(void 0,C1()),H1=ie("gradient",Gt),rr=[w1,z1,x1,$1,R1,k1],_1=()=>Object.assign({},...rr),S1=()=>Object.assign({},E1,...rr,y1),I1=()=>i(i(i({},M1),L1),H1),B1=()=>Object.keys(He.light).map(e=>`--lns-color-${e}: var(--lns-themeLight-color-${e});`),V1=()=>Object.keys(He.dark).map(e=>`--lns-color-${e}: var(--lns-themeDark-color-${e});`),ar=(e=":root")=>`
    ${e||":root"},
    .theme-light,
  ...
  `},D1=e=>{switch(e){case"orange":return{background:"orangeLight",text:"dangerHover"};case"blue":return{background:"blueLight",text:"blueDark"};case"yellow":return{background:"yellowLight",text:"#9E4C00"};case"teal":return{background:"tealLight",text:"tealDark"};default:return{background:"orangeLight",text:"dangerHover"}}},O1=e=>`calc(${e} / 2)`,xe=e=>{let t,a;if(e==="medium")t=u(4),a=u(4);else if(e==="large")t=u(7),a=u(7);else{const l=ne(e);t=l,a=l}const r=O1(t);return{width:t,height:a,fontSize:r}},A1=h.Z.span`
  display: block;
  ...
  width: ${e=>{const{width:t}=xe(e.size);return t}};
  height: ${e=>{const{height:t}=xe(e.size);return t}};
  font-size: ${e=>{const{fontSize:t}=xe(e.size);return t}};
  position: relative;
  z-index: 0;
...
`,P1=h.Z.img`
  ...
  height: ${e=>{const{height:t}=xe(e.size);return t}};
  font-size: ${e=>{const{fontSize:t}=xe(e.size);return t}};
`,Vi=e=>{var t=e,{altText:a="",size:r=4,letter:l,imageSrc:n,children:s,themeColor:d="blue"}=t,m=x(t,["altText","size","letter","imageSrc","children","themeColor"]);const v=()=>{if(s)return s;if(n){const f=xe(r).height,C=xe(r).width;return React3.createElement(P1,{size:r,alt:a,src:n,height:f,width:C})}if(l)return a?React3.createElement("span",{"aria-label":a},l):l},p=l&&!n&&!s,g=D1(d||"blue");return React3.createElement(A1,i({hasBackgroundColor:p,size:r,backgroundColor:g.background,color:g.text},m),v())},Wi=null,lr=(e=":root",t="body")=>`
    ${e} {
      font-size: 100%;
    }
    ${t} {
    ...
    ${g1()}
  `,Di=()=>React4.createElement(Global,{styles:css(lr())}),Oi=null,T1=3,F1=h.Z.span`
  display: block;
  color: ${e=>c(e.color)};
...
`,Z1=e=>{var t=e,{altText:a,icon:r,color:l="body",size:n=T1}=t,s=x(t,["altText","icon","color","size"]);const d=o.useRef(null);return o.createElement(F1,i({ref:d,"aria-label":a,color:l,size:n},s),r)},N=Z1,nr=1,pt=8,ft={small:{totalSize:18},medium:{totalSize:24},large:{totalSize:48}},rt=e=>ft[e.size].totalSize/6,bt=e=>ft[e.size].totalSize,j1=M.F4`
  50% {
    transform: scale(1);
  }
`,N1=h.Z.span`
...
`,K1=h.Z.span`
  ...
  transform: rotate(${e=>e.position*(360/pt)}deg)
    translateY(${e=>bt(e)/2-rt(e)/2}px);

  &:after {
    content: '';
    height: ${e=>rt(e)}px;
    width: ${e=>rt(e)}px;
    border-radius: ${e=>rt(e)}px;
...
`,he={neutral:{color:c("body"),background:"transparent",borderColor:c("buttonBorder"),hover:c("backgroundHover"),active:c("backgroundActive"),floatingBackground:c("overlay"),floatingHover:c("overlayHover"),floatingActive:c("overlayActive")},neutralSecondary:{color:c("body"),background:c("backgroundNeutral"),borderColor:null,hover:c("backgroundNeutralHover"),active:c("backgroundNeutralActive")},primary:{color:c("white"),background:c("blurple"),borderColor:null,hover:c("primaryHover"),active:c("primaryActive")},secondary:{color:c("primary"),background:c("highlight"),borderColor:null,hover:c("highlightHover"),active:null},record:{color:c("white"),background:c("record"),borderColor:null,hover:c("recordHover"),active:c("recordActive")},upgrade:{color:c("body"),background:c("upgrade"),borderColor:null,hover:c("upgradeHover"),active:c("upgradeActive"),focusRing:oe()},danger:{color:c("bodyInverse"),background:c("danger"),borderColor:null,hover:c("dangerHover"),active:c("dangerActive")},ai:{color:c("white"),background:c("ai-primary"),borderColor:null,hover:null,active:null}},or=e=>({enabled:M.iv`
  ...
  appearance: none;
  padding: 0
    ${e=>e.hasChildren?te[e.size].xSpace:0};
  font: inherit;
  ...
  ${e=>de(te[e.size].textSize)};
  ${e=>e.isFloating&&`box-shadow: ${ht.medium}`};
  ${e=>e.disabled?or(e).disabled:or(e).enabled};
  ${e=>!e.disabled&&`
    border: ${he[e.variant].borderColor?`1px solid ${he[e.variant].borderColor}`:"none"};
    background: ${e.isFloating&&e.variant==="neutral"?he[e.variant].floatingBackground:he[e.variant].background};
    background-position: left;
    background-size: 125%;
    color: ${he[e.variant].color};
  `};
  ...
  &:hover {
    transition:
      0.3s background,
      0.3s border-color;
    background: ${e=>e.isFloating&&e.variant==="neutral"?he[e.variant].floatingHover:he[e.variant].hover};
  ...
  &:active {
    transition:
      0s background,
      0s border-color;
    background: ${e=>e.isFloating&&e.variant==="neutral"?he[e.variant].floatingActive:he[e.variant].active};
...
`,el=h.Z.span`
  ${wt};
`,tl=e=>{var t=e,{size:a="medium",children:r,variant:l="neutral",hasFullWidth:n,width:s="auto",icon:d,iconPosition:m="left",iconBefore:v,iconAfter:p,logoSrc:g,hasLoader:f,isDisabled:C,ariaDisabled:y,htmlTag:E="button",interactionName:w,onClick:$,refHandler:S}=t,D=x(t,["size","children","variant","hasFullWidth","width","icon","iconPosition","iconBefore","iconAfter","logoSrc","hasLoader","isDisabled","ariaDisabled","htmlTag","interactionName","onClick","refHandler"]);const L=d&&m==="left"?d:null,T=v||L?o.createElement(sr,{hasLoader:f,paddingLeft:"0",paddingRight:r?ir:"0"},o.createElement(N,{icon:v||L,color:"currentColor",size:te[a].iconSize})):null,j=d&&m==="right"?d:null,B=p||j?o.createElement(sr,{hasLoader:f,paddingLeft:r?ir:"0",paddingRight:"unset"},o.createElement(N,{icon:j||p,color:"currentColor",size:te[a].iconSize})):null,V=(0,o.useCallback)(O=>{w&&(0,fe.Z)(w),$?.(O)},[$,w]);return o.createElement(J1,H(i({size:a,variant:l,hasFullWidth:n,width:s,icon:d,iconPosition:m,logoSrc:g,disabled:C,ariaDisabled:y,as:E,hasChildren:r,ref:O=>S&&S(O)},D),{onClick:w===void 0?$:V}),f&&o.createElement(q1,null,o.createElement(Ct,{color:"currentColor"})),T,g&&o.createElement(Q1,{alt:"",hasSpacing:Boolean(r),src:g,size:a,height:te[a].height,width:te[a].height,hasLoader:f}),o.createElement(el,{hasLoader:f},r),B)},Pi=Object.keys(te),Ti=Object.keys(he),rl=tl,al=h.Z.div`
...
`,ll=e=>{var t=e,{children:a,all:r,y:l,x:n,top:s,right:d,bottom:m,left:v,isInline:p}=t,g=x(t,["children","all","y","x","top","right","bottom","left","isInline"]);return o.createElement(al,i({all:r,top:l||s,bottom:l||m,right:n||d,left:n||v,isInline:p},g),a)},Ne=ll,at={topLeft:"start",topCenter:"start center",topRight:"start end",centerLeft:"center start",center:"center",centerRight:"center end",bottomLeft:"end start",bottomCenter:"end center",bottomRight:"end"},nl=e=>{if(Array.isArray(e))return e.map(t=>at[t]);if(typeof e=="object"){const t={};return Object.entries(e).forEach(([a,r])=>t[a]=at[r]),t}return at[e]},ol=h.Z.div`
  width: 100%;
  height: 100%;
  display: grid;
  ${e=>J("place-items",nl(e.alignment))};
`,il=e=>{var t=e,{children:a,alignment:r="center",htmlTag:l="div"}=t,n=x(t,["children","alignment","htmlTag"]);return o.createElement(ol,i({alignment:r,as:l},n),a)},Fi=Object.keys(at),Re=il,sl=(e,t,a)=>{const r=t||"border",n=`${ne(a)} solid ${c(r)}`;if(e)return e==="all"?`border: ${n};`:`border-${e}: ${n};`},cl=h.Z.div`
...
`,dl=e=>{var t=e,{children:a,backgroundColor:r,backgroundImage:l,contentColor:n,borderColor:s,radius:d,borderSide:m,borderWidth:v="1px",shadow:p,padding:g,paddingX:f,paddingY:C,paddingLeft:y,paddingRight:E,paddingTop:w,paddingBottom:$,margin:S,marginX:D,marginY:L,marginLeft:T,marginRight:j,marginTop:B,marginBottom:V,width:O,height:K,minWidth:F,minHeight:P,maxWidth:I,maxHeight:G,htmlTag:Z="div",position:re,overflow:ve,zIndex:R,top:U,bottom:De,left:ge,right:Ce,refHandler:se}=t,k=x(t,["children","backgroundColor","backgroundImage","contentColor","borderColor","radius","borderSide","borderWidth","shadow","padding","paddingX","paddingY","paddingLeft","paddingRight","paddingTop","paddingBottom","margin","marginX","marginY","marginLeft","marginRight","marginTop","marginBottom","width","height","minWidth","minHeight","maxWidth","maxHeight","htmlTag","position","overflow","zIndex","top","bottom","left","right","refHandler"]);return o.createElement(cl,i({backgroundColor:r,backgroundImage:l,contentColor:n,borderColor:s,radius:d,borderSide:m,shadow:p,padding:g,paddingLeft:f||y,paddingRight:f||E,paddingTop:C||w,paddingBottom:C||$,margin:S,marginLeft:D||T,marginRight:D||j,marginTop:L||B,marginBottom:L||V,width:O,height:K,minWidth:F,minHeight:P,maxWidth:I,maxHeight:G,as:Z,position:re,top:U,bottom:De,left:ge,right:Ce,overflow:ve,zIndex:R,borderWidth:v,ref:_=>se&&se(_)},k),a)},X=dl,Q={small:{height:u(4),width:u(5),iconSize:2,padding:u(1.75),withIconPadding:u(4.5),passwordAdditionalPadding:u(.5),textSize:"small",radius:"var(--lns-radius-150)"},medium:{height:"var(--lns-formFieldHeight)",width:u(6),iconSize:3,padding:"var(--lns-formFieldHorizontalPadding)",withIconPadding:u(5.5),passwordAdditionalPadding:u(.5),textSize:"medium",radius:"var(--lns-radius-175)"},large:{height:u(7),width:u(6),iconSize:3,padding:"var(--lns-formFieldHorizontalPadding)",withIconPadding:u(5.5),passwordAdditionalPadding:u(.5),textSize:"large",radius:"var(--lns-radius-250)"}},ul=e=>{let t=e.addOn?Q[e.inputSize].withIconPadding:Q[e.inputSize].padding;return e.type==="password"&&(t=`calc(${Q[e.inputSize].passwordAdditionalPadding} + ${t})`),t},hl=h.Z.input`
...
`,Zi=(0,o.forwardRef)((e,t)=>{var a=e,{placeholder:r,onFocus:l,onChange:n,onBlur:s,onKeyDown:d,isDisabled:m,icon:v,type:p="text",value:g,hasError:f,size:C="medium",addOn:y}=a,E=x(a,["placeholder","onFocus","onChange","onBlur","onKeyDown","isDisabled","icon","type","value","hasError","size","addOn"]);const w=o.createElement(hl,i({type:p,placeholder:r,onFocus:l,onChange:n,onBlur:s,onKeyDown:d,disabled:m,icon:v,ref:t,value:g,hasError:f,inputSize:C,addOn:y},E));return v||y?o.createElement(ml,null,v&&o.createElement(vl,{size:C},typeof v=="string"?o.createElement(X,{radius:"50",width:Q[C].iconSize,height:Q[C].iconSize,overflow:"hidden"},o.createElement(Re,{alignment:"center"},o.createElement(gl,{src:v,alt:"",isDisabled:m}))):o.createElement(N,{icon:v,size:Q[C].iconSize,color:c(m?"disabledContent":"body")})),w,y&&o.createElement(pl,{size:C},y)):w}),fl=null,cr={start:"flex-start",center:"center",end:"flex-end",stretch:"stretch"},dr=!1,lt=e=>Array.isArray(e)?e:[e],ur=(e,t)=>{if(e.length===t)return e;const a=e[e.length-1];return[...Array(t)].map((r,l)=>e[l]||a)},bl=(e,t)=>{const a=Math.max(lt(e).length,lt(t).length),r=ur(lt(t),a),l=ur(lt(e),a),n="& > * + *",s=r.map((m,v)=>{const p=`${ne(m)} 0 0 0`,g=`0 0 0 ${ne(m)}`,f=l[v]==="column"?p:g;return`${n}{ margin: ${f}; }`}),d=l.map(m=>`flex-direction: ${m}`);return _e(s)+_e(d)},Cl=h.Z.div`
  display: flex;
  flex-wrap: wrap;
...
`,ji=e=>{var t=e,{children:a,gap:r,direction:l="row",alignment:n="start",isSpread:s,htmlTag:d="div"}=t,m=x(t,["children","gap","direction","alignment","isSpread","htmlTag"]);return dr||(console.warn(ya),dr=!0),React12.createElement(Cl,i({gap:r,flexDirection:l,flexAlign:n,isSpread:s,as:d},m),a)},Ni=Object.keys(cr),Ui=null,wl=h.Z.div`
  display: grid;
  ...
  ${e=>Nt(e.as)};
`,El=e=>{var t=e,{children:a,width:r,height:l,minWidth:n,minHeight:s,maxWidth:d,maxHeight:m,gap:v,columns:p,rows:g,alignItems:f="center",justifyContent:C="start",justifyItems:y,alignContent:E,autoFlow:w,htmlTag:$="div",className:S,style:D}=t,L=x(t,["children","width","height","minWidth","minHeight","maxWidth","maxHeight","gap","columns","rows","alignItems","justifyContent","justifyItems","alignContent","autoFlow","htmlTag","className","style"]);return(S||D)&&console.warn(mt),o.createElement(wl,i({alignItems:f,as:$,justifyContent:C,justifyItems:y,alignContent:E,gap:v,columns:p,rows:g,width:r,height:l,minWidth:n,minHeight:s,maxWidth:d,maxHeight:m,autoFlow:w},L),a)},Ie=El;function hr(){return o.createElement(we.Z,{label:"",testId:"ads-refreshed-icon"})}var yl=h.Z.div`
  position: relative;
  ::before {
    content: '';
...
`,Ki=({children:e,errorActive:t,errorMessage:a="Oops, that didn't work. Try again."})=>t?React15.createElement(yl,null,React15.createElement(Ie,{autoFlow:"row",gap:"small"},e,a?React15.createElement(Ie,{gap:"xsmall"},React15.createElement(N,{icon:React15.createElement(hr,null),size:2,color:"danger"}),React15.createElement(ue,{size:"body-sm",color:"danger"},a)):null)):React15.createElement(React15.Fragment,null,e),Gi=null,zl={start:"flex-start",center:"center",end:"flex-end"},xl=h.Z.div`
  display: flex;
  ${e=>Ft(e.alignment,zl)};
...
`,Rl=e=>{var t=e,{width:a,maxWidth:r,children:l}=t,n=x(t,["width","maxWidth","children"]);return console.warn(Yt),o.createElement($l,i({width:a,maxWidth:r},n),l)},kl=class extends o.Component{render(){return console.warn(Yt),o.createElement(xl,i({},this.props),this.props.children)}};kl.Section=Rl;var Yi=null,Ue={small:{size:u(3),iconSize:2.25,radius:"var(--lns-radius-100)"},medium:{size:u(4),iconSize:3,radius:"var(--lns-radius-150)"},large:{size:u(5),iconSize:4,radius:"var(--lns-radius-175)"}},Ml=h.Z.button`
  background-color: ${e=>c(e.isActive?"backgroundActive":e.backgroundColor)||"transparent"};
  border: none;
  appearance: none;
  cursor: pointer;
  padding: 0;
  width: ${e=>Ue[e.size].size};
  height: ${e=>Ue[e.size].size};
  position: relative;
  outline: 1px solid transparent;
  ...
  align-items: center;
  vertical-align: middle;
  border-radius: ${e=>Ue[e.size].radius};
  font: inherit;
...
`,mr=o.forwardRef((e,t)=>{var a=e,{altText:r,icon:l,onClick:n,iconColor:s="body",backgroundColor:d,isActive:m,isDisabled:v,size:p="medium"}=a,g=x(a,["altText","icon","onClick","iconColor","backgroundColor","isActive","isDisabled","size"]);return o.createElement(Ml,i({"aria-label":r,onClick:n,isActive:m,disabled:v,size:p,backgroundColor:d,ref:t},g),o.createElement(N,{icon:l,size:Ue[p].iconSize,color:v?"disabledContent":s}))});mr.displayName="IconButton";var Et=mr,Ll=e=>o.createElement("svg",i({width:12,height:9,viewBox:"0 0 12 9",fill:"none"},e),o.createElement("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M11.707.293a1 1 0 010 1.414l-7 7a1 1 0 01-1.414 0l-3-3a1 1 0 011.414-1.414L4 6.586 10.293.293a1 1 0 011.414 0z",fill:"currentColor"})),Hl=e=>o.createElement("svg",i({width:12,height:2,viewBox:"0 0 12 2",fill:"none"},e),o.createElement("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M0 1a1 1 0 011-1h10a1 1 0 110 2H1a1 1 0 01-1-1z",fill:"currentColor"})),_l=h.Z.div`
  display: block;
  position: relative;
`,Sl=h.Z.input`
  height: 100%;
...
`,Il=h.Z.span`
  ...
  justify-content: center;
  user-select: none;
`,Bl=(0,o.forwardRef)((e,t)=>{var a=e,{isDisabled:r,isChecked:l,isIndeterminate:n,onFocus:s,onChange:d,onBlur:m}=a,v=x(a,["isDisabled","isChecked","isIndeterminate","onFocus","onChange","onBlur"]);const p=(0,o.useRef)(),g=t||p,f=c(r?"disabledContent":"currentColor");return(0,o.useEffect)(()=>{g.current.indeterminate=n}),o.createElement(_l,null,o.createElement(Sl,i({type:"checkbox",disabled:r,checked:l,onFocus:s,onChange:d,onBlur:m,ref:g,"aria-checked":l},v)),o.createElement(Il,{className:"CheckboxBox"},o.createElement(Hl,{className:"Icon IconMinus",color:f}),o.createElement(Ll,{className:"Icon IconCheck",color:f})))}),Vl=Bl,Be={small:{textSize:"small",iconSize:2.25,height:u(3),xSpace:u(1),radius:"var(--lns-radius-100)"},medium:{textSize:"medium",iconSize:3,height:u(4),xSpace:u(1.5),radius:"var(--lns-radius-150)"},large:{textSize:"large",iconSize:4,height:u(6),xSpace:u(3),radius:"var(--lns-radius-200)"}},Wl=h.Z.button`
  ...
  ${e=>de(Be[e.size].textSize)};
  padding: 0 ${e=>Be[e.size].xSpace};
  ${e=>e.offsetSide&&`margin-${e.offsetSide}: calc(-1 * ${Be[e.size].xSpace})`};
...
`,Dl=o.forwardRef((e,t)=>{var a=e,{onClick:r,size:l="medium",children:n,icon:s,iconPosition:d="left",isActive:m,isDisabled:v,htmlTag:p,offsetSide:g}=a,f=x(a,["onClick","size","children","icon","iconPosition","isActive","isDisabled","htmlTag","offsetSide"]);const C=o.createElement(X,{paddingLeft:d==="right"&&"small",paddingRight:d==="left"&&"small",htmlTag:"span"},o.createElement(N,{icon:s,size:Be[l].iconSize,color:v?"disabledColor":void 0}));return o.createElement(Wl,i({onClick:r,size:l,icon:s,iconPosition:d,disabled:v,isActive:m,as:p,offsetSide:g,ref:t},f),s&&d==="left"&&C,n,s&&d==="right"&&C)});Dl.displayName="TextButton";var Xi=null,yt=e=>{var t,a;const r=(a=(t=e?.())==null?void 0:t.getRootNode)==null?void 0:a.call(t);if(String(r)==="[object ShadowRoot]"){r.createElement=(...n)=>r.ownerDocument.createElement(...n);const l=r.createElement("div");return l.id="a11y-status-message",l.style.display="none",r.appendChild(l),{document:r,addEventListener:r.addEventListener.bind(r),removeEventListener:r.removeEventListener.bind(r)}}return typeof window>"u"?null:window},$e=e=>typeof e=="string"?e:typeof e=="number"||typeof e=="boolean"||typeof e=="bigint"?e.toString():e==null?"":Ol(e)?Array.from(e).map($e).join(""):typeof e=="object"&&"props"in e&&e.props&&e.props.children!==void 0?$e(e.props.children):"",Ol=e=>typeof e[Symbol.iterator]=="function";function vr(){return o.createElement("span",{"aria-hidden":!0,"data-testid":"ads-refreshed-icon"},o.createElement("svg",{viewBox:"-2 -2 16 16"},o.createElement("path",{fill:"currentColor",fillRule:"evenodd",d:"M2.03 3.97 6 7.94l3.97-3.97 1.06 1.06-4.5 4.5a.75.75 0 0 1-1.06 0l-4.5-4.5z",clipRule:"evenodd"})))}function Al(){return o.createElement(Qr.Z,{label:"",testId:"ads-refreshed-icon"})}var zt={left:"bottom-start",right:"bottom-end",topLeft:"top-start",topRight:"top-end",leftSide:"left-start",rightSide:"right-start"},Pl=h.Z.div`
...
`,Zl=h.Z.img`
  ...
  object-fit: cover;
  opacity: ${({isDisabled:e})=>e?.5:1};
`,xt=e=>{var t=e,{isDisabled:a,isHighlighted:r,isSelected:l,icon:n,hasDivider:s,children:d,menuItemRole:m,keyboardMove:v}=t,p=x(t,["isDisabled","isHighlighted","isSelected","icon","hasDivider","children","menuItemRole","keyboardMove"]);const C=`${n?"auto":""} 1fr ${l?"auto":""}`,y=a?"disabledContent":void 0,E=m?H(i({},p),{role:m}):p;return o.createElement(Fl,i({isHighlighted:r,isDisabled:a,keyboardMove:v,columns:C,hasDivider:s,tabIndex:a?-1:0,"data-highlighted":r||void 0},E),n&&(typeof n=="string"?o.createElement(X,{radius:"50",width:3,height:3,overflow:"hidden"},o.createElement(Re,{alignment:"center"},o.createElement(Zl,{src:n,alt:"",isDisabled:a}))):o.createElement(N,{icon:n,color:y})),o.createElement(ue,{color:y,hasEllipsis:!0},d),l&&o.createElement(N,{icon:o.createElement(Al,null),color:y}))},jl=e=>{var t=e,{position:a,zIndex:r,minWidth:l,maxWidth:n,maxHeight:s,children:d,role:m,downshiftMenuProps:v=()=>null,search:p}=t,g=x(t,["position","zIndex","minWidth","maxWidth","maxHeight","children","role","downshiftMenuProps","search"]);const f=m?H(i({},v()),{role:m}):i({},v());return o.createElement(Pl,i(i({minWidth:l,maxWidth:n,maxHeight:s,zIndex:r,position:a},f),g),p&&p,o.createElement(Tl,{search:p},d))},ke=jl;function Nl(){return React24.createElement(SearchIcon,{label:"",testId:"ads-refreshed-icon"})}var Ul=h.Z.div`
  padding: ${u(1.5)} ${u(1.5)} 0;
  margin-bottom: ${u(1.5)};
  position: sticky;
  top: 0;
`,Ji=({ariaLabel:e,placeholder:t,value:a,onChange:r,getInputProps:l})=>React25.createElement(Ul,null,React25.createElement(fl,i({"aria-label":e,icon:React25.createElement(Nl,null)},l({placeholder:t,value:a,onChange:r,type:"text"})))),gr=null,Kl=h.Z.div`
  position: relative;
`,Gl=h.Z.button`
  appearance: none;
  font: inherit;
...
`,Jl=h.Z.span`
  ...
  grid-column-start: 1;
  grid-column-end: 3;
`,nt=e=>Array.isArray(e)&&e.length>0&&"group"in e[0],$t=({options:e,selectedOptionValue:t})=>{if(!e||!t)return{icon:null,title:null};if(nt(e))for(const a of e){const r=a.items.find(l=>l.value===t);if(r)return r}else return e.find(r=>r.value===t)||{icon:null,title:null};return{icon:null,title:null}},pr=({options:e,selectedItem:t,selectedOptionValue:a})=>{if(t)return t.icon;if(a)return $t({options:e,selectedOptionValue:a}).icon},Ql=({options:e,selectedItem:t,selectedOptionValue:a,selectPlaceholder:r})=>t?t.title:a?$t({options:e,selectedOptionValue:a}).title:r,fr=({selectedItem:e,getInputProps:t,getToggleButtonProps:a,ariaMenuName:r,isOpen:l})=>{const n=e?`selected value is ${e.title}`:"no value selected",s=a?.()["aria-label"];return{"aria-expanded":l,"aria-activedescendant":t()["aria-activedescendant"],"aria-label":[r,s,n].filter(Boolean).join(", ")}},ql=({getToggleButtonProps:e,inputValue:t,selectedItem:a,selectedOptionValue:r,selectPlaceholder:l,isDisabled:n,options:s,getInputProps:d,ariaMenuName:m,hasError:v,isOpen:p})=>{const g=pr({options:s,selectedItem:a,selectedOptionValue:r}),f=Boolean(g),C=!r&&!a,E=`${f?"auto":""} 1fr auto`,w=n?"disabledContent":void 0;return React26.createElement(Gl,H(i(i({},e()),fr({selectedItem:a,getInputProps:d,getToggleButtonProps:e,ariaMenuName:m,isOpen:p})),{hasValue:t||r,disabled:n,columns:E,hasError:v}),f&&(typeof g=="string"?React26.createElement(X,{radius:"50",width:3,height:3,overflow:"hidden"},React26.createElement(Re,{alignment:"center"},React26.createElement(Yl,{src:g,alt:"",isDisabled:n}))):React26.createElement(N,{icon:pr({options:s,selectedItem:a,selectedOptionValue:r}),color:w})),React26.createElement(ue,{hasEllipsis:!0,color:C?"bodyDimmed":"inherit"},Ql({options:s,selectedItem:a,selectedOptionValue:r,selectPlaceholder:l})),React26.createElement(N,{icon:React26.createElement(vr,null),color:w}))},en=({selectedOptionValue:e,selectedItem:t,trigger:a,getToggleButtonProps:r,options:l,selectPlaceholder:n,isDisabled:s,getInputProps:d,ariaMenuName:m,hasError:v,errorMessage:p,isOpen:g})=>{const f=()=>i(i({},r()),fr({selectedItem:t,getInputProps:d,getToggleButtonProps:r,ariaMenuName:m,isOpen:g})),y=H(i({},(()=>{if(t)return t;if(e)return $t({options:l,selectedOptionValue:e})})()),{placeholder:n,isDisabled:s,hasError:v,errorMessage:p});return a(y,f())},br=(e,t)=>{if(nt(t))for(const a of t){const r=a.items.find(l=>l.value===e);if(r)return r}else return t.find(a=>a.value===e)},Cr=(e,t,a,r,l,n,s,d)=>{const m=!a&&e.value===r||a&&a.value===e.value;return React26.createElement(xt,H(i({key:t,getItemProps:n,icon:e.icon,hidden:e.hidden},n({key:`${e.value}-${t}`,index:t,item:e,disabled:e.isDisabled,"aria-selected":m,onMouseMove:()=>{s&&d(!1)}})),{isDisabled:e.isDisabled,hasDivider:e.hasDivider,isHighlighted:l===t,keyboardMove:s&&l===t,isSelected:m}),e.title)},tn=e=>{var t=e,{options:a,selectedItem:r,selectedOptionValue:l,highlightedIndex:n,getItemProps:s,search:d,keyboardMove:m,setKeyboardMove:v}=t,p=x(t,["options","selectedItem","selectedOptionValue","highlightedIndex","getItemProps","search","keyboardMove","setKeyboardMove"]);if(!nt(a))return React26.createElement(ke,i({search:d},p),a.map((f,C)=>Cr(f,C,r,l,n,s,m,v)));let g=0;return React26.createElement(ke,i({search:d},p),a.map(f=>{const C=`group-${f.group.replace(/\s+/g,"-")}`;return React26.createElement("li",{key:C},React26.createElement(Ne,{left:"medium",top:"small",bottom:"xsmall"},React26.createElement(ue,{id:C,size:"body-sm",fontWeight:"bold"},f.group)),React26.createElement(Xl,{role:"group","aria-labelledby":C},f.items.map(y=>Cr(y,g++,r,l,n,s,m,v))))}))},Qi=e=>{var t=e,{container:a,onChange:r,menuZIndex:l=1100,menuMaxWidth:n,menuMaxHeight:s=34,menuMinWidth:d,triggerOffset:m=0,ariaMenuName:v,selectedOptionValue:p,onOuterClick:g,options:f,placeholder:C,menuPosition:y="left",isDisabled:E,onOpenChange:w,trigger:$,hasError:S,errorMessage:D="Oops, that didn't work.",search:L}=t,T=x(t,["container","onChange","menuZIndex","menuMaxWidth","menuMaxHeight","menuMinWidth","triggerOffset","ariaMenuName","selectedOptionValue","onOuterClick","options","placeholder","menuPosition","isDisabled","onOpenChange","trigger","hasError","errorMessage","search"]);const j=yt(a),[B,V]=useState(!1),[O,K]=useState(!1),[F,P]=useState(""),I=k=>{const _=k.target.value;P(_)},[G,Z]=useState(br(p,f)),ve={itemToString:k=>k?k.value:"",onChange:k=>{Z(k),r&&r(k||"")},onOuterClick:g,environment:j,selectedItem:G,isOpen:B};j&&(ve.environment=j);const{layerProps:R,triggerProps:U,renderLayer:De,triggerBounds:ge}=useLayer({isOpen:B,container:a,ResizeObserver,placement:zt[y],auto:!0,snap:!0,triggerOffset:m});useEffect2(()=>{const k=br(p,f);k?.value!==G?.value&&Z(k)},[p,f,G]),useEffect2(()=>{w&&w(B)},[B,w]);const Ce=(k,_)=>{if(_.isOpen!==void 0){if(_.type===Downshift.stateChangeTypes.keyDownEscape)return V(!1),{isOpen:!1};V(_.isOpen)}return _},se=k=>{switch(k.key){case"ArrowDown":case"ArrowUp":case"ArrowLeft":case"ArrowRight":case"Enter":case" ":case"Tab":case"Escape":K(!0);break;default:break}};return f=useMemo(()=>{if(L){if(nt(f)){let k;return L.searchType==="startsWith"?k=f.map(_=>H(i({},_),{items:_.items.filter(pe=>$e(pe.title).toLowerCase().startsWith(F.toLowerCase()))})):k=f.map(_=>H(i({},_),{items:_.items.filter(pe=>$e(pe.title).toLowerCase().includes(F.toLowerCase()))})),k.reduce((_,pe)=>(pe.items.length>0&&_.push(pe),_),[])}return L.searchType==="startsWith"?f.filter(k=>$e(k.title).toLowerCase().startsWith(F.toLowerCase())):f.filter(k=>$e(k.title).toLowerCase().includes(F.toLowerCase()))}return f},[f,F,L]),React26.createElement(Kl,i({},T),React26.createElement(Downshift,H(i({},ve),{stateReducer:Ce}),({getItemProps:k,getInputProps:_,getMenuProps:pe,getToggleButtonProps:ct,isOpen:W,inputValue:ce,highlightedIndex:St,selectedItem:Oe})=>React26.createElement("div",{role:"presentation"},React26.createElement("div",i({},U),$?React26.createElement(en,{getToggleButtonProps:()=>i({},ct({onKeyDown:se})),selectedItem:Oe,selectedOptionValue:p,selectPlaceholder:C,isDisabled:E,options:f,trigger:$,getInputProps:_,ariaMenuName:v,hasError:S,errorMessage:D,isOpen:W}):React26.createElement(ql,{getToggleButtonProps:()=>i({},ct({onKeyDown:se})),selectedItem:Oe,selectedOptionValue:p,selectPlaceholder:C,options:f,inputValue:ce,isDisabled:E,getInputProps:_,ariaMenuName:v,hasError:S,isOpen:W})),B&&W&&De(React26.createElement("div",H(i({},R),{style:H(i({},R.style),{zIndex:l,width:d?"auto":ge?.width})}),React26.createElement(tn,{options:f,selectedItem:Oe,selectedOptionValue:p,highlightedIndex:St,getItemProps:k,position:y,downshiftMenuProps:()=>pe({onKeyDown:se}),maxWidth:n,maxHeight:s,minWidth:d,search:L&&React26.createElement(gr,{ariaLabel:L.searchPlaceholder,placeholder:L.searchPlaceholder,value:F,onChange:I,getInputProps:_}),keyboardMove:O,setKeyboardMove:K}))),S&&!B&&React26.createElement(Jl,null,D))))},qi=null;function rn(e,t){const a=document;(0,o.useLayoutEffect)(()=>{const r=a?.documentElement,l=a?.body;if(!(a==null||!r||!l)){if(t){const n=window.innerWidth-r.clientWidth,s=parseInt(window.getComputedStyle(l).getPropertyValue("padding-right"),10)||0;switch(e){case"html":{r.style.position="relative",r.style.overflow="hidden",l.style.paddingRight=`${s+n}px`;break}case"body":{l.style.setProperty("position","relative"),l.style.setProperty("overflow","hidden"),l.style.setProperty("padding-right",`${s+n}px`);break}default:return}}return()=>{switch(e){case"html":{r.style.position="",r.style.overflow="",l.style.paddingRight="";break}case"body":{l.style.removeProperty("position"),l.style.removeProperty("overflow"),l.style.removeProperty("padding-right");break}default:return}}}},[a,t,e])}var wr=rn,Er=300,an=h.Z.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`,ln=h.Z.div`
  overflow: auto;
  height: 100%;
`,yr=o.forwardRef((e,t)=>{var a=e,{children:r,isOpen:l,zIndex:n=1e3,backgroundColor:s="backdropDark"}=a,d=x(a,["children","isOpen","zIndex","backgroundColor"]);const{stage:m,shouldMount:v}=(0,qr.Yz)(l,Er);return wr("html",l),o.createElement(o.Fragment,null,v&&o.createElement(an,i({ref:t,backgroundColor:s,zIndex:n,style:{transition:`opacity ${Er}ms`,opacity:m==="enter"?1:0}},d),o.createElement(ln,null,r)))});yr.displayName="Backdrop";var nn=yr;function Rt(){return o.createElement(ra.Z,{label:"",testId:"ads-refreshed-icon"})}var on="70vh",sn=h.Z.div`
  display: grid;
  grid-template-rows: ${e=>e.rows};
  position: relative;
`,cn=h.Z.dialog`
  top: ${e=>ut(ne(e.maxHeight),e.placement).top};
  background-color: ${c("overlay")};
  color: ${c("body")};
...
`,zr=e=>typeof e=="number"?b("max-height",e):"max-height: "+e,pn=e=>{var t=e,{children:a,onCloseClick:r,isOpen:l,maxWidth:n=60,maxHeight:s=on,placement:d="center",ariaLabel:m,ariaModal:v,ariaLabelledBy:p,ref:g,removeClose:f,initialFocus:C}=t,y=x(t,["children","onCloseClick","isOpen","maxWidth","maxHeight","placement","ariaLabel","ariaModal","ariaLabelledBy","ref","removeClose","initialFocus"]);const E=w=>{w.key==="Escape"&&(w.preventDefault(),f||r(w))};return(0,o.useEffect)(()=>(window.addEventListener("keydown",E),()=>{window.removeEventListener("keydown",E)}),[l,r]),wr("html",l),o.createElement(ta(),{active:l,focusTrapOptions:i({clickOutsideDeactivates:!1,allowOutsideClick:!0},C!==void 0?{initialFocus:C}:{})},o.createElement(cn,i({open:l,maxWidth:n,maxHeight:s,placement:d,onClick:w=>w.stopPropagation(),ref:g,"aria-label":m,"aria-modal":v,"aria-labelledby":p},y),!f&&r&&o.createElement(dn,null,o.createElement(Et,{altText:"Close",icon:o.createElement(Rt,null),onClick:r})),o.createElement(gn,H(i({},f?{tabIndex:0}:{tabIndex:-1}),{maxHeight:s}),a)))},e0=o.forwardRef((e,t)=>{var a=e,{children:r,id:l,isOpen:n,mainButton:s,secondaryButton:d,alternativeButton:m,title:v,noPadding:p,onCloseClick:g,onBackgroundClick:f,onKeyDown:C,hasDividers:y,maxHeight:E="70vh",maxWidth:w=60,placement:$="center",zIndex:S=1e3,ariaLabel:D,ariaModal:L=!0,ariaLabelledBy:T,initialFocus:j}=a,B=x(a,["children","id","isOpen","mainButton","secondaryButton","alternativeButton","title","noPadding","onCloseClick","onBackgroundClick","onKeyDown","hasDividers","maxHeight","maxWidth","placement","zIndex","ariaLabel","ariaModal","ariaLabelledBy","initialFocus"]),V;const O=(0,o.useRef)(null),K=l?`${l}-modal-title`:"modal-title",F=!!(s||d||m),P=I=>{if(f){I.stopPropagation(),f(I);return}g(I)};return(0,o.useEffect)(()=>{if(!n||!O.current)return;const I=O.current.parentElement;return I?(Array.from(I.children).filter(Z=>Z!==O.current&&Z instanceof HTMLElement).forEach(Z=>{Z.hasAttribute("aria-hidden")||(Z.setAttribute("aria-hidden","true"),Z.setAttribute("data-lens-modal-hidden","true"))}),()=>{document.querySelectorAll("[data-lens-modal-hidden]").forEach(re=>{re.removeAttribute("aria-hidden"),re.removeAttribute("data-lens-modal-hidden")})}):void 0},[n]),o.createElement(nn,i({ref:O,isOpen:n,zIndex:S},B),o.createElement(X,{height:"100%",onClick:P,onKeyDown:C},o.createElement(pn,{ref:t,id:l,isOpen:n,maxHeight:E,maxWidth:w,placement:$,onCloseClick:g,ariaLabel:D,ariaModal:L,ariaLabelledBy:(V=T??K)!=null?V:void 0,initialFocus:j},o.createElement(sn,{rows:`${v?"auto ":""} ${r?"1fr ":""} ${F?"auto":""}`},v&&o.createElement(hn,{bottom:r?"var(--lns-space-medium)":"var(--lns-space-xlarge)"},o.createElement(ue,{htmlTag:"h1",variant:"title",id:K},v)),o.createElement(vn,{noPadding:p,hasDividers:y,hasTitle:Boolean(v),hasButtons:F},r&&r),F&&o.createElement(mn,{top:r?"var(--lns-space-xlarge)":0,hasDividers:y},m,o.createElement(un,null,d&&o.createElement(Ne,{right:"small",isInline:!0},d),s))))))}),t0=null,ot={neutral:{color:c("inherit"),focusRing:oe(),underline:"inactive"},primary:{color:c("primary"),focusRing:oe(),underline:"inactive"},subtle:{color:c("body"),focusRing:oe(),underline:"hover"}},xr={enabled:M.iv`
    cursor: pointer;
  `,disabled:M.iv`
    pointer-events: none;
    color: ${c("disabledContent")};
...
`,r0=e=>{var t=e,{children:a,href:r,variant:l="primary",htmlTag:n="a",isDisabled:s,noWrap:d}=t,m=x(t,["children","href","variant","htmlTag","isDisabled","noWrap"]);return React30.createElement(bn,i({href:r,variant:l,as:n,disabled:s,noWrap:d},m),a)},a0=Object.keys(ot),l0=null,$r={small:{padding:`${u(1.5)} ${u(1.75)}`,textSize:"small"},medium:{padding:`${u(1.5)} var(--lns-formFieldHorizontalPadding)`,textSize:"medium"}},Cn=h.Z.textarea`
  width: 100%;
  border: none;
  font-family: inherit;
  color: inherit;
...
`,n0=o.forwardRef((e,t)=>{var a=e,{onChange:r,value:l,rows:n=4,isDisabled:s,placeholder:d,size:m="medium",resize:v="both",error:p=null}=a,g=x(a,["onChange","value","rows","isDisabled","placeholder","size","resize","error"]);return o.createElement(o.Fragment,null,o.createElement(Cn,i({disabled:s,onChange:r,placeholder:d,ref:t,rows:n,value:l,size:m,resize:v,error:p},g)),p?o.createElement(o.Fragment,null,o.createElement(Ne,{bottom:"xmsall"}),o.createElement(ue,{color:"danger",fontWeight:"regular",size:"body-md"},p)):null)}),o0=null,wn=h.Z.div`
  position: relative;
`,En=h.Z.ul`
  list-style: none;
  margin: 0;
...
`,_n=h.Z.img`
  ...
  object-fit: cover;
  opacity: ${({isDisabled:e})=>e?.5:1};
`,Sn=({selectedItem:e,selectedOptionValue:t,placeholder:a,isDisabled:r,options:l,getInputProps:n,ariaMenuName:s,isOpen:d,onInputFocus:m,hasError:v,hasLoader:p,inputValue:g,handleInputValueChange:f,inputRef:C,id:y})=>{const E=zn({options:l,selectedItem:e,selectedOptionValue:t}),w=Boolean(E),$=r?"disabledContent":void 0,S=()=>{r||m()},D=i(i({role:"combobox","aria-autocomplete":"list","aria-haspopup":"listbox","aria-expanded":d},$n({selectedItem:e,getInputProps:n,ariaMenuName:s})),n({id:y,"aria-labelledby":void 0,disabled:r,onFocus:S,onClick:S,value:g,onBlur:()=>{f("")},onChange:T=>f(T.target.value)})),L=!g&&!t;return o.createElement(Rn,{onClick:S,disabled:r},w&&o.createElement(Mn,null,typeof E=="string"?o.createElement(X,{radius:"50",width:3,height:3,overflow:"hidden"},o.createElement(Re,{alignment:"center"},o.createElement(_n,{src:E,alt:"",isDisabled:r}))):o.createElement(N,{icon:E,color:$})),o.createElement(kn,H(i({ref:C},D),{hasIcon:w,hasAddOn:!0,hasError:v,isDisabled:r})),!g&&o.createElement(Hn,{hasIcon:w},o.createElement(ue,{hasEllipsis:!0,color:L?"bodyDimmed":"inherit"},xn({options:l,selectedItem:e,selectedOptionValue:t,placeholder:a}))),o.createElement(Ln,null,p?o.createElement(Ct,{size:"small"}):o.createElement(N,{icon:o.createElement(vr,null),color:$})))},kr=(e,t)=>{var a;if(it(t))for(const r of t){const l=r.items.find(n=>n.value===e);if(l)return l}else return(a=t.find(r=>r.value===e))!=null?a:null;return null},In=(e,t)=>(e||null)!=t?.value,Mr=(e,t,a,r,l,n)=>{const s=!a&&e.value===r||a&&a.value===e.value;return o.createElement(xt,H(i({key:t,getItemProps:n,icon:e.icon,hidden:e.hidden},n({key:`${e.value}-${t}`,index:t,item:e,disabled:e.isDisabled,"aria-selected":s})),{isDisabled:e.isDisabled,hasDivider:e.hasDivider,isHighlighted:l===t,isSelected:s}),e.title)},Bn=e=>{var t=e,{options:a,selectedItem:r,selectedOptionValue:l,highlightedIndex:n,getItemProps:s,isLoading:d,loadingMessage:m,emptyResultsMessage:v,hasAvailableOptions:p}=t,g=x(t,["options","selectedItem","selectedOptionValue","highlightedIndex","getItemProps","isLoading","loadingMessage","emptyResultsMessage","hasAvailableOptions"]);const f=m||o.createElement(Ct,null),C=v||"No results";if(d)return o.createElement(ke,i({as:"div"},g),o.createElement(X,{padding:"large"},o.createElement(Re,{alignment:"center"},f)));if(!p)return o.createElement(ke,i({as:"div"},g),o.createElement(X,{padding:"large"},o.createElement(Re,{alignment:"center"},C)));if(!it(a))return o.createElement(ke,i({},g),a.map((E,w)=>Mr(E,w,r,l,n,s)));let y=0;return o.createElement(ke,i({},g),a.map(E=>{const w=`group-${E.group.replace(/\s+/g,"-")}`;return o.createElement("li",{key:w},o.createElement(Ne,{left:"medium",top:"small",bottom:"xsmall"},o.createElement(ue,{id:w,size:"body-sm",fontWeight:"bold",htmlTag:E.headingTag||"h2"},E.group)),o.createElement(En,{role:"group","aria-labelledby":w},E.items.map($=>Mr($,y++,r,l,n,s))))}))},Vn=(0,o.forwardRef)((e,t)=>{var a=e,{container:r,onOptionChange:l,onInputValueChange:n,menuZIndex:s=1100,menuMaxWidth:d,menuMaxHeight:m=34,menuMinWidth:v,ariaMenuName:p,selectedOptionValue:g,onOuterClick:f,options:C,placeholder:y,menuPosition:E="left",isDisabled:w,onOpenChange:$,isLoading:S,loadingMessage:D,emptyResultsMessage:L,errorMessage:T,id:j}=a,B=x(a,["container","onOptionChange","onInputValueChange","menuZIndex","menuMaxWidth","menuMaxHeight","menuMinWidth","ariaMenuName","selectedOptionValue","onOuterClick","options","placeholder","menuPosition","isDisabled","onOpenChange","isLoading","loadingMessage","emptyResultsMessage","errorMessage","id"]);const V=yt(r),O=(0,o.useRef)(null),K=(0,o.useCallback)(W=>{O.current=W,t&&(typeof t=="function"?t(W):t.current=W)},[t]),[F,P]=(0,o.useState)(""),[I,G]=(0,o.useState)(!1),[Z,re]=(0,o.useState)(kr(g,C)),[ve,R]=(0,o.useState)(Z),U=W=>{P(W),n&&n(W)},ge={itemToString:W=>W?W.value:"",onChange:W=>{const ce=W||null;R(ce),l&&l(ce)},onOuterClick:f,environment:V,selectedItem:ve,isOpen:I};V&&(ge.environment=V);const{layerProps:Ce,triggerProps:se,renderLayer:k,triggerBounds:_}=(0,Ge.sJ)({isOpen:I,container:r,ResizeObserver:It.Z,placement:zt[E],auto:!0,snap:!0});(0,o.useEffect)(()=>{if(In(g,Z)){const W=kr(g,C);re(W),R(W),P("")}},[g,C,Z]),(0,o.useEffect)(()=>{var W;$&&$(I),I||(W=O.current)==null||W.blur()},[I,$]);const pe=(0,o.useMemo)(()=>Array.isArray(C)?it(C)?C.some(W=>W.items.length>0):C.length>0:!1,[C]),ct=(W,ce)=>{if(ce.isOpen!==void 0){if(ce.type===Le.ZP.stateChangeTypes.keyDownEscape)return G(!1),{isOpen:!1};G(ce.isOpen)}return ce};return o.createElement(wn,i({},B),o.createElement(Le.ZP,H(i({},ge),{stateReducer:ct}),({getItemProps:W,getInputProps:ce,getMenuProps:St,isOpen:Oe,highlightedIndex:yi,selectedItem:Jr})=>o.createElement("div",{role:"presentation"},o.createElement("div",i({},se),o.createElement(Sn,{inputRef:K,selectedItem:Jr,selectedOptionValue:g,placeholder:y,isDisabled:w,options:C,getInputProps:ce,ariaMenuName:p,inputValue:F,handleInputValueChange:U,isOpen:I&&Oe,onInputFocus:()=>{G(!0)},hasLoader:S,hasError:Boolean(T),id:j})),I&&Oe&&k(o.createElement("div",H(i({},Ce),{style:H(i({},Ce.style),{zIndex:s,width:v?"auto":_?.width})}),o.createElement(Bn,{options:C,selectedItem:Jr,selectedOptionValue:g,hasAvailableOptions:pe,highlightedIndex:yi,getItemProps:W,isLoading:S,loadingMessage:D,emptyResultsMessage:L,position:E,downshiftMenuProps:St,maxWidth:d,maxHeight:m,minWidth:v}))),Boolean(T)&&!I?o.createElement(yn,null,T):null)))});Vn.displayName="Typeahead";var i0=null,Wn=({ariaMenuName:e,getInputProps:t,isOpen:a})=>({"aria-activedescendant":t()["aria-activedescendant"],"aria-expanded":a,"aria-label":e||""}),Dn=h.Z.div`
  display: inline-block;
  vertical-align: middle;
`,s0=e=>{var t=e,{ariaMenuName:a,menuPosition:r="left",menuZIndex:l=1100,options:n,trigger:s,triggerCallback:d,isOpen:m,menuMinWidth:v=24,menuMaxWidth:p=48,menuMaxHeight:g,container:f,onOuterClick:C,triggerOffset:y=0,onOpenChange:E,search:w,role:$,menuItemRole:S}=t,D=x(t,["ariaMenuName","menuPosition","menuZIndex","options","trigger","triggerCallback","isOpen","menuMinWidth","menuMaxWidth","menuMaxHeight","container","onOuterClick","triggerOffset","onOpenChange","search","role","menuItemRole"]);const L=yt(f),[T,j]=useState3(!1),[B,V]=useState3(!1),[O,K]=useState3(""),F=R=>{const U=R.target.value;K(U)},P=R=>{switch(R.key){case"ArrowDown":case"ArrowUp":case"ArrowLeft":case"ArrowRight":case"Enter":case" ":case"Tab":case"Escape":V(!0);break;default:break}},I=m||T,{layerProps:G,triggerProps:Z,renderLayer:re}=useLayer3({isOpen:I,container:f,placement:zt[r],ResizeObserver:ResizeObserver3,auto:!0,snap:!0,triggerOffset:y});useEffect5(()=>{E&&E(I)},[I,E]);const ve=(R,U)=>(U.isOpen!==void 0&&j(U.isOpen),U);return n=useMemo3(()=>w?w.searchType==="startsWith"?n.filter(R=>$e(R.title).toLowerCase().startsWith(O.toLowerCase())):n.filter(R=>$e(R.title).toLowerCase().includes(O.toLowerCase())):n,[n,O,w]),React33.createElement(Downshift3,{stateReducer:ve,itemToString:R=>R?R.title:"",onSelect:R=>R&&!R.disabled&&R.onClick&&R.onClick(),onOuterClick:C,environment:L},({getInputProps:R,getItemProps:U,getMenuProps:De,getToggleButtonProps:ge,highlightedIndex:Ce,isOpen:se})=>React33.createElement("div",i(i({},D),d?{role:null,"aria-haspopup":null,"aria-expanded":null,"aria-labelledby":null}:{}),React33.createElement("div",i({},Z),d?d(i(i({},ge({onKeyDown:P})),Wn({ariaMenuName:a,getInputProps:R,isOpen:se}))):React33.createElement(Dn,i({},ge({onKeyDown:P,tabIndex:0})),s)),se&&re(React33.createElement("div",H(i({},G),{style:H(i({},G.style),{zIndex:l})}),React33.createElement(ke,{position:r,minWidth:v,maxWidth:p,maxHeight:g,downshiftMenuProps:()=>De({onKeyDown:P}),role:$,search:w&&React33.createElement(gr,{ariaLabel:w.searchPlaceholder,placeholder:w.searchPlaceholder,value:O,onChange:F,getInputProps:R})},n.map((k,_)=>React33.createElement(xt,i({key:_,isHighlighted:Ce===_,keyboardMove:B&&Ce===_,isDisabled:k.disabled,isSelected:k.selected,icon:k.icon,hasDivider:k.hasDivider,getItemProps:U,menuItemRole:S,index:_},U({key:_,index:_,item:k,disabled:k.disabled,onMouseMove:()=>{B&&V(!1)}})),k.title)))))))},c0=null,On=h.Z.label`
  display: block;
  position: relative;
...
`,Tn=(0,o.forwardRef)((e,t)=>{var a=e,{isDisabled:r,isChecked:l,onFocus:n,onChange:s,onBlur:d}=a,m=x(a,["isDisabled","isChecked","onFocus","onChange","onBlur"]);return o.createElement(On,{htmlFor:m.id},o.createElement(An,i({type:"radio",disabled:r,checked:l,onFocus:n,onChange:s,onBlur:d,ref:t},m)),o.createElement(Pn,{className:"RadioBox"}))}),Fn=Tn,me={medium:{switchHeight:16,switchWidth:32,knobOffset:2},large:{switchHeight:20,switchWidth:36,knobOffset:2}},Ve={knob:{active:{enabled:c("white"),disabled:c("disabledContent")},inactive:{enabled:c("white"),disabled:c("disabledContent")}},track:{active:{enabled:c("blurple"),disabled:c("disabledBackground")},inactive:{enabled:c("grey6"),disabled:c("disabledBackground")}}},Zn=e=>me[e.switchSize].switchWidth-me[e.switchSize].switchHeight,Lr=e=>me[e.switchSize].switchHeight-me[e.switchSize].knobOffset*2,jn=h.Z.label`
  display: block;
  position: relative;
`,Nn=h.Z.input`
  position: absolute;
  ...
  &:not(:checked) {
    & + .SwitchBox {
      background-color: ${Ve.track.inactive.enabled};
    }
    &:disabled + .SwitchBox {
      background-color: ${Ve.track.inactive.disabled};
    }
  }
  &:checked {
    & + .SwitchBox {
      background-color: ${Ve.track.active.enabled};
    }
    &:disabled + .SwitchBox {
      background-color: ${Ve.track.active.disabled};
    }
    & + .SwitchBox:after {
...
`,Un=h.Z.div`
  ...
  &:after {
    ...
    border-radius: var(--lns-radius-full);
    transition: 0.15s;
    background-color: ${e=>e.isDisabled?Ve.knob.active.disabled:Ve.knob.active.enabled};
  }
`,Kn=e=>{var t=e,{isActive:a,isDisabled:r,onChange:l,size:n="medium",ariaLabelledby:s,ariaLabel:d,ariaDescribedby:m}=t,v=x(t,["isActive","isDisabled","onChange","size","ariaLabelledby","ariaLabel","ariaDescribedby"]);if(s&&d)throw new Error("ariaLabelledby and ariaLabel serve the same purpose and therefore cannot be used at the same time. Choose the one that best suites your needs.");return o.createElement(jn,{htmlFor:v.id},o.createElement(Nn,H(i({},v),{checked:a,disabled:r,onChange:l,type:"checkbox",switchSize:n,"aria-labelledby":s,"aria-label":d,"aria-describedby":m,"aria-checked":a})),o.createElement(Un,{className:"SwitchBox",isDisabled:r,isActive:a,switchSize:n}))},Gn=Kn,Hr={row:{wrapper:{display:"grid",gridTemplateColumns:"auto 1fr",alignItems:"center"},label:{marginLeft:"var(--lns-space-small)"},errorMessage:{marginLeft:"var(--lns-space-small)"}},"row-reverse":{wrapper:{display:"grid",gridTemplateColumns:"1fr auto",alignItems:"center"},label:{}},column:{wrapper:{},label:{marginBottom:"var(--lns-space-xsmall)"}}},Yn=h.Z.div`
...
`,Qn=[Fn,Vl,Gn],qn=e=>Qn.includes(e),d0=e=>{var t=e,{label:a,children:r,errorMessage:l,labelFor:n,direction:s="column"}=t,d=x(t,["label","children","errorMessage","labelFor","direction"]);const m=React36.Children.toArray(r).some(p=>isValidElement(p)&&typeof p.type!="string"&&qn(p.type)),v=a&&React36.createElement(Xn,{direction:s,htmlFor:n,isLabelClickable:m},a);return React36.createElement(Yn,i({direction:s},d),s==="row"&&React36.createElement(React36.Fragment,null,r,v),s==="column"&&React36.createElement(React36.Fragment,null,v,r),s==="row-reverse"&&React36.createElement(React36.Fragment,null,v,r),l&&React36.createElement(Jn,null,l))},u0=null;function h0(e,t){React37.useEffect(()=>{const a=r=>{!e.current||e.current.contains(r.target)||t(r)};return document.addEventListener("mousedown",a),document.addEventListener("touchstart",a),()=>{document.removeEventListener("mousedown",a),document.removeEventListener("touchstart",a)}},[e,t])}function m0(e){const[t,a]=useState4(!1),r=useCallback3(n=>{const s=e.current;n.type==="focusin"&&n.target===s&&a(!0)},[e]),l=useCallback3(n=>{const s=e.current;n.type==="focusout"&&n.target===s&&a(!1)},[e]);return useEffect6(()=>(document.addEventListener("focusin",r),document.addEventListener("focusout",l),()=>{document.removeEventListener("focusin",r),document.removeEventListener("focusout",l)}),[r,l]),Boolean(t)}function v0(e){const t=document;useLayoutEffect2(()=>{const a=t?.documentElement,r=t?.body;if(!(t==null||!a||!r))return e&&(r.style.setProperty("padding-top","3.25rem"),r.style.setProperty("transition","padding-top 350ms")),()=>{r.style.removeProperty("padding-top")}},[t,e])}var eo=null;function to(){return o.createElement(aa.Z,{label:"",testId:"ads-refreshed-icon"})}var ro=e=>o.createElement("svg",i({viewBox:"0 0 24 24",fill:"none"},e),o.createElement("path",{fill:"currentColor",fillRule:"evenodd",clipRule:"evenodd",d:"M7.42 2.293A1 1 0 0 1 8.127 2h7.245a1 1 0 0 1 .708.293l5.127 5.127a1 1 0 0 1 .293.707v7.245a1 1 0 0 1-.293.708l-5.127 5.127a1 1 0 0 1-.707.293H8.128a1 1 0 0 1-.708-.293L2.293 16.08A1 1 0 0 1 2 15.373V8.128a1 1 0 0 1 .293-.708L7.42 2.293ZM8.542 4 4 8.542v6.416L8.542 19.5h6.416l4.542-4.542V8.542L14.958 4H8.542Zm2.208 11.25a1 1 0 0 1 1-1h.009a1 1 0 1 1 0 2h-.009a1 1 0 0 1-1-1Zm2-7a1 1 0 1 0-2 0v3.5a1 1 0 1 0 2 0v-3.5Z"})),Me={info:{bgColor:"var(--lns-color-blurple)",icon:o.createElement(to,null),color:"var(--lns-color-white)",fontFamily:"inherit"},warning:{bgColor:"var(--lns-color-warning)",icon:o.createElement(ro,null),color:"var(--lns-color-grey8)",fontFamily:"inherit"},error:{bgColor:"var(--lns-color-danger)",icon:o.createElement(hr,null),color:"var(--lns-color-white)",fontFamily:"inherit"},internal:{icon:o.createElement("span",{role:"img"},"\u{1F514}"),color:"var(--lns-color-tealLight)",bgColor:"var(--lns-color-grey8)",fontFamily:"var(--lns-fontFamily-code)"}},_r=350,ao=h.Z.aside`
  ...
  ${e=>`background-color: ${Me[e.severity].bgColor}`};
  ${e=>`font-family: ${Me[e.severity].fontFamily}`};

  ${e=>`color: ${Me[e.severity].color}`};
  position: fixed;
...
`,g0=({children:e,onCloseClick:t,isOpen:a,severity:r="info",id:l})=>{var n,s,d;useEffect7(()=>{if(!a)return;const v=p=>{p.key==="Escape"&&(p.preventDefault(),t&&t())};return window.addEventListener("keydown",v),()=>{window.removeEventListener("keydown",v)}},[a,t]),eo(a);const m=r==="internal";return a?React40.createElement(ao,{isOpen:a,severity:r,id:l},React40.createElement(Ie,{alignItems:{default:"start",small:"center"},justifyContent:"space-between",autoFlow:m?"column":void 0,columns:m?void 0:["1fr auto"]},React40.createElement(X,{paddingY:{default:"xsmall",xsmall:0},paddingLeft:m?void 0:{default:0,medium:u(3.5)},width:"100%"},React40.createElement(Ie,{autoFlow:"column",gap:m?"medium":"small",justifyContent:"center"},(n=Me[r])!=null&&n.icon?React40.createElement(Re,{alignment:"topLeft"},React40.createElement(N,{icon:Me[r].icon,color:(s=Me[r].color)!=null?s:"var(--lns-color-white)"})):null," ",e))),t&&React40.createElement(Et,{iconColor:(d=Me[r].color)!=null?d:"var(--lns-color-white)",tabIndex:0,altText:"Close",icon:React40.createElement(Rt,null),onClick:t})):null},p0=null,Sr="web-app",kt="chrome-extension",lo={short:3e3,long:8e3},no=(e,t)=>M.F4`
  0% {
    opacity: 0;
...
`,oo=e=>{switch(e){case Sr:return"unset";case kt:return u(4);default:return"unset"}},io=e=>{switch(e){case Sr:return u(4);case kt:return"unset";default:return u(4)}},so=h.Z.div`
...
`,go=h.Z.div`
  ...
  padding-left: ${u(.5)};
  padding-right: ${u(.5)};
`,po=({children:e})=>o.createElement(go,null,e),fo=e=>{var t=e,{children:a,maxWidth:r,onMouseEnter:l,onMouseLeave:n,layerProps:s,zIndex:d}=t,m=x(t,["children","maxWidth","onMouseEnter","onMouseLeave","layerProps","zIndex"]);return o.createElement(vo,i(i({maxWidth:r,onMouseEnter:l,onMouseLeave:n,zIndex:d},s),m),a)},bo=h.Z.div`
  display: ${e=>e.isInline?"inline-block":"block"};
...
`;function Co(e){switch(e){case"immediate":return 200;case"long":return 800;default:return 200}}var wo=e=>{var t=e,{ariaLive:a=!1,children:r,content:l,shortcut:n,placement:s="topCenter",keepOpen:d,triggerOffset:m=4,maxWidth:v=26,isInline:p=!0,isDisabled:g,container:f,tabIndex:C=0,zIndex:y=1100,verticalAlign:E="middle",delay:w="immediate",tooltipId:$}=t,S=x(t,["ariaLive","children","content","shortcut","placement","keepOpen","triggerOffset","maxWidth","isInline","isDisabled","container","tabIndex","zIndex","verticalAlign","delay","tooltipId"]);const[D,L]=(0,Ge.XI)({delayEnter:Co(w),delayLeave:200}),[T,j]=(0,o.useState)(!1),[B,V]=(0,o.useState)(!1),[O,K]=(0,o.useState)(!1),F=(0,o.useRef)(),P=!l||g;(0,o.useEffect)(()=>{if(P){V(!1);return}const R=T&&d;(D||R)&&V(!0),!D&&!R&&!O&&V(!1)},[l,g,T,P,d,V,D,O]);const I=()=>{K(!1),P||V(!0)},G=()=>{V(!1),K(!1)};(0,o.useEffect)(()=>{if(!B)return;const R=U=>{U.key==="Escape"&&(U.preventDefault(),G())};return window.addEventListener("keydown",R),()=>{window.removeEventListener("keydown",R)}},[B,V]);const{layerProps:Z,triggerProps:re,renderLayer:ve}=(0,Ge.sJ)({isOpen:B,placement:Ir[s],ResizeObserver:It.Z,triggerOffset:m,container:f,auto:!0});return o.createElement(o.Fragment,null,o.createElement(bo,H(i(i({},re),L),{onClick:R=>{R.detail===0&&K(!0)},onFocus:I,onBlur:G,isInline:p,verticalAlign:E,tabIndex:P?-1:C,ref:(0,Ge.lq)(re.ref,F)}),r),a&&o.createElement("span",{className:"srOnly","aria-live":"polite"},B&&l),B&&ve(o.createElement("div",H(i({},Z),{style:H(i({},Z.style),{zIndex:y})}),o.createElement(fo,i({maxWidth:v,onMouseEnter:()=>j(!0),onMouseLeave:()=>j(!1),role:"tooltip",id:$},S),o.createElement(Ie,{gap:"small"},o.createElement(ue,{size:"small",fontWeight:"bold"},l),n&&o.createElement(Ie,{gap:"xsmall"},n.map((R,U)=>o.createElement(po,{key:U},R))))))))},C0=Object.keys(Ir),Eo=wo,Br=M.iv`
...
`,y0=e=>{var t=e,{variant:a="combined",maxWidth:r,symbolColor:l,wordmarkColor:n="body",brand:s="loom",customId:d=""}=t,m=x(t,["variant","maxWidth","symbolColor","wordmarkColor","brand","customId"]);return React44.createElement(ko,i({variant:a,maxWidth:r},m),a==="combined"&&React44.createElement(Ro,{brand:s,symbolColor:l,wordmarkColor:c(n),customId:d,className:"lns-logoSvg"}),a==="symbol"&&React44.createElement(xo,{brand:s,symbolColor:l,customId:d,className:"lns-logoSvg"}),a==="wordmark"&&React44.createElement($o,{brand:s,wordmarkColor:c(n),className:"lns-logoSvg"}))},z0=null,Mo="https://cdn.loom.com/assets/lens",Or={small:"40px",medium:"80px"},Lo=h.Z.span`
...
`,x0=({animation:e="spin 2s infinite steps(49) forwards",brand:t="loom",size:a="medium"})=>React45.createElement(Lo,{animation:e,brand:t,size:a}),$0=null,Mt="/* emotion-disable-server-rendering-unsafe-selector-warning-please-do-not-use-this-the-warning-exists-for-a-reason */",Ho={border:M.iv`
...
`,Io=e=>{var t=e,{children:a,htmlTag:r="li",className:l,backgroundColor:n,onClick:s,href:d,role:m}=t,v=x(t,["children","htmlTag","className","backgroundColor","onClick","href","role"]);const p=l?` ${l}`:"",g=["div","span","p","h1","h2","h3","h4","h5","h6","section","article","header","footer","main","aside","nav"],f=!r&&s;let C=!1;const y=r||"div";f||(C=g.includes(y));const E=!C||f?{onClick:s,onKeyDown:w=>{w.key==="Enter"&&(w.preventDefault(),s?.(w))}}:{};return React46.createElement(So,i(i({role:m||(r==="li"?"listitem":void 0),className:`ListRowWrapper${p}`,as:r,backgroundColor:n,href:d},E),v),a)},Bo=e=>e.map(t=>ne(t)).join(" "),R0=e=>{var t=e,{children:a,columns:r,gap:l,variant:n="stripe",htmlTag:s="ul"}=t,d=x(t,["children","columns","gap","variant","htmlTag"]);let m=a;return s==="ul"&&(m=React46.Children.map(a,v=>React46.isValidElement(v)&&v.type===Io?React46.cloneElement(v,{htmlTag:"li"}):v)),React46.createElement(_o,i({as:s,columns:r&&Bo(r),gap:l,variant:n,role:s==="ul"?"list":void 0},d),m)},k0=null,st=o.createContext({}),Vo=e=>`calc(-1 * ${ne(e)})`,Ar=h.Z.div`
...
`,M0=e=>{var t=e,{children:a,isActive:r,htmlTag:l="button",icon:n,isDisabled:s=!1}=t,d=x(t,["children","isActive","htmlTag","icon","isDisabled"]);const{isPilledDesign:m}=React47.useContext(st);return m?React47.createElement(Zr,i({as:l,isActive:r,icon:n,role:"tab","aria-selected":r,disabled:s},d),n&&React47.createElement(X,{htmlTag:"span",paddingRight:a&&"small"},React47.createElement(N,{icon:n,color:"currentColor"})),a):React47.createElement(Fr,i({as:l,isActive:r,icon:n,role:"tab","aria-selected":r,disabled:s},d),n&&React47.createElement(X,{htmlTag:"span",paddingRight:a&&"small"},React47.createElement(N,{icon:n,color:"currentColor"})),a)},Wo=e=>{var t=e,{children:a,scrollOffset:r,hasFullTabs:l,isPilledDesign:n,hasBottomBorder:s=!1}=t,d=x(t,["children","scrollOffset","hasFullTabs","isPilledDesign","hasBottomBorder"]);const m=n?React47.createElement(Tr,i({hasFullTabs:l,scrollOffset:r,role:"tablist"},d),a):React47.createElement(Pr,i({hasFullTabs:l,scrollOffset:r,hasBottomBorder:s,role:"tablist"},d),a);return r?React47.createElement(Ar,{scrollOffset:r},m):React47.createElement(st.Provider,{value:{isPilledDesign:n}},m)},Do=({tooltipProps:e,children:t,tooltipId:a})=>e?o.createElement(Eo,H(i({},e),{tooltipId:a,tabIndex:-1}),t):t,jr=o.forwardRef((e,t)=>{var a=e,{tabContent:r,tooltipProps:l,isActive:n,htmlTag:s="button",icon:d,isDisabled:m=!1,onKeyDown:v,onClick:p}=a,g=x(a,["tabContent","tooltipProps","isActive","htmlTag","icon","isDisabled","onKeyDown","onClick"]);const{isPilledDesign:f}=o.useContext(st),C=(0,o.useId)(),y=i({as:s,isActive:n,icon:d,role:"tab","aria-selected":n,disabled:m,tabIndex:n?0:-1,"aria-describedby":l?C:void 0,onKeyDown:v,onClick:p,ref:t},g);return o.createElement(Do,{tooltipProps:l,tooltipId:C},f?o.createElement(Zr,i({},y),d?o.createElement(X,{htmlTag:"span",paddingRight:r&&"small"},o.createElement(N,{icon:d,color:"currentColor"})):null,r):o.createElement(Fr,i({},y),d?o.createElement(X,{htmlTag:"span",paddingRight:r&&"small"},o.createElement(N,{icon:d,color:"currentColor"})):null,r))});jr.displayName="TabNew";var Oo=e=>{var t=e,{tabs:a,scrollOffset:r,hasFullTabs:l,isPilledDesign:n,hasBottomBorder:s=!1}=t,d=x(t,["tabs","scrollOffset","hasFullTabs","isPilledDesign","hasBottomBorder"]);const m=useRef5({}),v=useCallback4((y,E)=>{var w;let $=E;switch(y.key){case"ArrowLeft":y.preventDefault(),$=E>0?E-1:a.length-1;break;case"ArrowRight":y.preventDefault(),$=E<a.length-1?E+1:0;break;case"Home":y.preventDefault(),$=0;break;case"End":y.preventDefault(),$=a.length-1;break;default:return}(w=m.current[$])==null||w.focus()},[a.length]),p=useCallback4(y=>E=>{m.current[y]=E},[]),g=useMemo4(()=>a.map((y,E)=>React47.createElement(jr,i({key:E,ref:p(E),onKeyDown:w=>v(w,E)},y))),[a,v,p]),f=useMemo4(()=>n?React47.createElement(Tr,i({hasFullTabs:l,scrollOffset:r,role:"tablist"},d),g):React47.createElement(Pr,i({hasFullTabs:l,scrollOffset:r,hasBottomBorder:s,role:"tablist"},d),g),[g,l,r,s,n,d]),C=React47.createElement(st.Provider,{value:{isPilledDesign:n}},f);return r?React47.createElement(Ar,{scrollOffset:r},C):C},L0=e=>{var t=e,{children:a,tabs:r}=t,l=x(t,["children","tabs"]);return a&&r&&console.warn("Both children and tabs props are provided. Please use only one of them."),!a&&!r?(console.error("Either children or tabs must be provided."),null):a?React47.createElement(Wo,i({},l),a):React47.createElement(Oo,i({tabs:r},l))},H0=null,Ao=h.Z.div`
  ...
  ${Ee("bold")};
  ${b("gap","xsmall")};
`,_0=e=>{var t=e,{color:a,backgroundColor:r,children:l,icon:n,iconPosition:s="left"}=t,d=x(t,["color","backgroundColor","children","icon","iconPosition"]);const m=React48.createElement(X,{htmlTag:"span",paddingLeft:s==="right"&&"xsmall",paddingRight:s==="left"&&"xsmall"},React48.createElement(N,{icon:n,color:"currentColor",size:2}));return React48.createElement(Ao,i({color:a,backgroundColor:r},d),n&&s==="left"&&m,l,n&&s==="right"&&m)},S0=null,Po={topLeft:"top-start",topCenter:"top",topRight:"top-end",bottomLeft:"bottom-start",bottomCenter:"bottom",bottomRight:"bottom-end",leftTop:"left-start",leftCenter:"left",leftBottom:"left-end",rightTop:"right-start",rightCenter:"right",rightBottom:"right-end"},To=h.Z.div`
  position: relative;
  width: fit-content;
...
`,Nr=h.Z.div`
  ${e=>e.zIndex&&`z-index: ${e.zIndex}`};
`,I0=e=>{var t=e,{children:a,content:r,offset:l=.5,boundaryOffset:n=.5,isOpen:s,zIndex:d=500,childrenZIndex:m=1,placement:v="topCenter",rootId:p,boundaryElement:g="body",transitionDuration:f=0,transitionDelay:C=0}=t,y=x(t,["children","content","offset","boundaryOffset","isOpen","zIndex","childrenZIndex","placement","rootId","boundaryElement","transitionDuration","transitionDelay"]);const E=l*Se,w=n*Se,$=typeof window<"u",S=p&&$?document.getElementById(p):void 0,{stage:D,shouldMount:L}=useTransition2(s,f+C),T=()=>g==="body"&&$?document.body:g,{x:j,y:B,reference:V,floating:O,strategy:K,update:F,refs:P}=useFloating({placement:Po[v],middleware:[shift({padding:w,boundary:g?T():void 0,limiter:limitShift()}),flip({fallbackPlacements:["top","bottom"],fallbackStrategy:"initialPlacement"}),floatingUiOffset(E)],strategy:"fixed"});useEffect10(()=>{if(!(!P.reference.current||!P.floating.current))return autoUpdate(P.reference.current,P.floating.current,F)},[P.reference,P.floating,F,L]);const I={zIndex:d,ref:O,style:{position:K,top:B??"",left:j??"",transition:`opacity ${f}ms ${C}ms`,opacity:D==="enter"?1:0}};return React49.createElement(To,H(i({ref:V},y),{childrenZIndex:m}),a,L&&React49.createElement(React49.Fragment,null,!S&&React49.createElement(Nr,i({},I),r),S&&ReactDOM.createPortal(React49.createElement(Nr,i({},I),r),S)))},B0=null,Fo=h.Z.span`
  display: block;
...
`,V0=e=>{var t=e,{altText:a,illustration:r,color:l="orange",size:n=12}=t,s=x(t,["altText","illustration","color","size"]);return React50.createElement(Fo,i({"aria-hidden":"true","aria-label":a,color:l,size:n},s),r)},W0=null,Ur=e=>M.iv`
  ${b("width",e.width)};
  ${b("height",e.height)};
...
`,jo=h.Z.div`
  ...
  ${e=>Ur(e)};
`,No=e=>{var t=e,{children:a,grow:r,shrink:l,basis:n,width:s,height:d,minWidth:m,minHeight:v,maxWidth:p,maxHeight:g,htmlTag:f="div",className:C,style:y}=t,E=x(t,["children","grow","shrink","basis","width","height","minWidth","minHeight","maxWidth","maxHeight","htmlTag","className","style"]);return(C||y)&&console.warn(mt),React51.createElement(jo,i({as:f,grow:r,shrink:l,basis:n,width:s,height:d,minWidth:m,minHeight:v,maxWidth:p,maxHeight:g},E),a)},Uo=e=>{var t=e,{children:a,gap:r="initial",rowGap:l,columnGap:n,alignItems:s="center",justifyContent:d,alignContent:m,wrap:v="wrap",width:p,height:g,minWidth:f,minHeight:C,maxWidth:y,maxHeight:E,htmlTag:w="div",className:$,style:S}=t,D=x(t,["children","gap","rowGap","columnGap","alignItems","justifyContent","alignContent","wrap","width","height","minWidth","minHeight","maxWidth","maxHeight","htmlTag","className","style"]);return($||S)&&console.warn(mt),React51.createElement(Zo,i({as:w,gap:r,rowGap:l,columnGap:n,alignItems:s,justifyContent:d,alignContent:m,wrap:v,width:p,height:g,minWidth:f,minHeight:C,maxWidth:y,maxHeight:E},D),w==="ul"||w==="ol"?Children.map(a,L=>L.type===No||L.type===Uo?cloneElement(L,{htmlTag:"li"}):L):a)},D0=null,Ko=h.Z.div`
...
`,P0=e=>{var t=e,{color:a="body",size:r="medium"}=t,l=x(t,["color","size"]);return React53.createElement(si,i({size:r},l),React53.createElement(Lt,{color:a,size:r,delay:0}),React53.createElement(Lt,{color:a,size:r,delay:.2}),React53.createElement(Lt,{color:a,size:r,delay:.4}))},T0=Object.keys(We),F0=null,Ht={medium:{totalSize:u(3),barHeight:u(2.25)}},Gr={fast:1.2,slow:1.7},ci="linear-gradient(270deg, #565ADD 10.58%, #DC43BE 41.83%, #565ADD 69.23%, #565ADD 96.63%)",di=2,_t=5,ui=u(.25),hi=e=>Ht[e.size||"medium"].barHeight,Ke=e=>Ht[e.size||"medium"].totalSize,Yr=e=>Gr[e.speed||"fast"],mi=M.F4`
  0%, 100% {
...
`,fi=h.Z.span`
  ...
  background-size: ${e=>Ke(e)}
    ${e=>Ke(e)};
  background-position: ${e=>{const a=(e.index+1)/(_t+1)-.5;return`calc(${Ke(e)} * ${a}) center`}};
  ...
  position: relative;
`,Z0=e=>{var t=e,{size:a="medium",speed:r="fast",color:l="body"}=t,n=x(t,["size","speed","color"]);const s=Array.from({length:_t},(d,m)=>React54.createElement(fi,{key:m,index:m,size:a,speed:r,color:l}));return React54.createElement(pi,i({size:a,color:l},n),s)},j0=Object.keys(Ht),N0=Object.keys(Gr),U0=null,bi=M.F4`
  0% {
    transform: scale(1);
    opacity: 0;
  }
...
`,be={dot:{size:"8px",borderWidth:"1px",borderColor:c("background")},positioning:{top:"-2px",right:"-2px"},animation:{duration:"2s",timing:"ease-out",iteration:"infinite"}},Xr={blue:c("blue"),orange:c("orange")},Ci=h.Z.span`
  position: relative;
  display: inline-block;
`,wi=h.Z.span`
  position: absolute;
  height: ${be.dot.size};
  width: ${be.dot.size};
  top: ${be.positioning.top};
  right: ${be.positioning.right};
`,Ei=h.Z.span`
  position: absolute;
  height: 100%;
  width: 100%;
  ...
  border: ${be.dot.borderWidth} solid
    ${be.dot.borderColor};
