"use strict";(global.webpackChunk_loomhq_desktop_monorepo=global.webpackChunk_loomhq_desktop_monorepo||[]).push([[6679,3780,9724],{862953:(_e,S,w)=>{var $;$={value:!0},$=void 0;var G=o(w(275271)),ce=o(w(774586));function o(Q){return Q&&Q.__esModule?Q:{default:Q}}const h=Q=>G.default.createElement(ce.default,Object.assign({dangerouslySetGlyph:'<path fill="currentcolor" fill-rule="evenodd" d="M7 2.5a4.5 4.5 0 1 0 0 9 4.5 4.5 0 0 0 0-9M1 7a6 6 0 1 1 10.74 3.68l3.29 3.29-1.06 1.06-3.29-3.29A6 6 0 0 1 1 7" clip-rule="evenodd"/>'},Q));h.displayName="SearchIcon";var ie=$=h},450630:(_e,S,w)=>{w.d(S,{Ni:()=>o.T,Xn:()=>o.w,F4:()=>re});var $=w(908866),G=w(275271),ce=w(117267),o=w(156052),h=w(908308),ie=w(586997),Q=w(853434),ye=w(669957),Ie=function(Y,j){var O=arguments;if(j==null||!hasOwnProperty.call(j,"css"))return createElement.apply(void 0,O);var T=O.length,q=new Array(T);q[0]=Emotion,q[1]=createEmotionProps(Y,j);for(var X=2;X<T;X++)q[X]=O[X];return createElement.apply(null,q)},it=!1,xt=null,pe=function(de){(0,$.Z)(Y,de);function Y(O,T,q){return de.call(this,O,T,q)||this}var j=Y.prototype;return j.componentDidMount=function(){this.sheet=new Q.m({key:this.props.cache.key+"-global",nonce:this.props.cache.sheet.nonce,container:this.props.cache.sheet.container});var T=document.querySelector("style[data-emotion-"+this.props.cache.key+'="'+this.props.serialized.name+'"]');T!==null&&this.sheet.tags.push(T),this.props.cache.sheet.tags.length&&(this.sheet.before=this.props.cache.sheet.tags[0]),this.insertStyles()},j.componentDidUpdate=function(T){T.serialized.name!==this.props.serialized.name&&this.insertStyles()},j.insertStyles=function(){if(this.props.serialized.next!==void 0&&(0,h.M)(this.props.cache,this.props.serialized.next,!0),this.sheet.tags.length){var T=this.sheet.tags[this.sheet.tags.length-1].nextElementSibling;this.sheet.before=T,this.sheet.flush()}this.props.cache.insert("",this.props.serialized,this.sheet,!1)},j.componentWillUnmount=function(){this.sheet.flush()},j.render=function(){return null},Y}(G.Component),re=function(){var Y=ye.Z.apply(void 0,arguments),j="animation-"+Y.name;return{name:j,styles:"@keyframes "+j+"{"+Y.styles+"}",anim:1,toString:function(){return"_EMO_"+this.name+"_"+this.styles+"_EMO_"}}},se=function de(Y){for(var j=Y.length,O=0,T="";O<j;O++){var q=Y[O];if(q!=null){var X=void 0;switch(typeof q){case"boolean":break;case"object":{if(Array.isArray(q))X=de(q);else{X="";for(var Be in q)q[Be]&&Be&&(X&&(X+=" "),X+=Be)}break}default:X=q}X&&(T&&(T+=" "),T+=X)}}return T};function $t(de,Y,j){var O=[],T=(0,h.f)(de,O,j);return O.length<2?j:T+Y(O)}var Rt=function(){return null},Yt=(0,o.w)(function(de,Y){return(0,G.createElement)(o.T.Consumer,null,function(j){var O=!1,T=function(){for(var i=arguments.length,R=new Array(i),y=0;y<i;y++)R[y]=arguments[y];var je=(0,ie.O)(R,Y.registered);return(0,h.M)(Y,je,!1),Y.key+"-"+je.name},q=function(){for(var i=arguments.length,R=new Array(i),y=0;y<i;y++)R[y]=arguments[y];return $t(Y.registered,T,se(R))},X={css:T,cx:q,theme:j},Be=de.children(X);O=!0;var st=(0,G.createElement)(Rt,null);return(0,G.createElement)(G.Fragment,null,st,Be)})})},667919:(_e,S,w)=>{w.d(S,{c:()=>G});var $=w(275271);function G(){return $.createElement("span",{"aria-hidden":!0,"data-testid":"ads-refreshed-icon"},$.createElement("svg",{viewBox:"0 0 24 24"},$.createElement("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M2.00302 3.37486C0.971444 5.16161 1.57735 7.44442 3.35512 8.48554L8.93106 11.9999L3.35511 15.5142C1.57735 16.5553 0.971446 18.8381 2.00302 20.6249C3.03856 22.4185 5.33202 23.033 7.12562 21.9975C8.91922 20.9619 9.53375 18.6685 8.49821 16.8749C8.20609 16.3689 7.81387 15.9568 7.36101 15.649L11.041 13.3297L11.0423 13.3305L13.1522 12.0007L13.1509 11.9999L22.3506 6.2016L21.1509 4.29812L11.041 10.6701L7.361 8.3507C7.81387 8.04297 8.20609 7.63083 8.49821 7.12486C9.53375 5.33127 8.91922 3.0378 7.12562 2.00227C5.33202 0.966734 3.03856 1.58127 2.00302 3.37486ZM3.95158 4.49986C3.53737 5.2173 3.78318 6.13469 4.50062 6.5489C5.21806 6.96311 6.13544 6.7173 6.54966 5.99986C6.96387 5.28242 6.71806 4.36504 6.00062 3.95082C5.28318 3.53661 4.36579 3.78242 3.95158 4.49986ZM4.50062 17.4508C3.78318 17.865 3.53737 18.7824 3.95158 19.4999C4.36579 20.2173 5.28318 20.4631 6.00062 20.0489C6.71806 19.6347 6.96387 18.7173 6.54966 17.9999C6.13544 17.2824 5.21806 17.0366 4.50062 17.4508Z",fill:"currentColor"}),$.createElement("path",{d:"M15.2621 13.3305L13.1522 14.6603L21.1509 19.7016L22.3506 17.7981L15.2621 13.3305Z",fill:"currentColor"})))}var ce=Object.defineProperty,o=Object.defineProperties,h=Object.getOwnPropertyDescriptors,ie=Object.getOwnPropertySymbols,Q=Object.prototype.hasOwnProperty,ye=Object.prototype.propertyIsEnumerable,Ie=(pe,re,se)=>re in pe?ce(pe,re,{enumerable:!0,configurable:!0,writable:!0,value:se}):pe[re]=se,it=(pe,re)=>{for(var se in re||(re={}))Q.call(re,se)&&Ie(pe,se,re[se]);if(ie)for(var se of ie(re))ye.call(re,se)&&Ie(pe,se,re[se]);return pe},xt=(pe,re)=>o(pe,h(re))},183780:(_e,S,w)=>{w.d(S,{ggW:()=>Te,zxk:()=>i1,W20:()=>oe,JO$:()=>ee,LZC:()=>nt,xvT:()=>xe,Ut4:()=>fr});var $=w(738067),G=w(66292),ce=w.n(G),o=w(275271),h=w(992671),ie=w(485800),Q=w(582805),ye=w(66333),Ie=w(797981),it=w(773023),xt=w(484285),pe=w(862953),re=w(12131),se=w(566172),$t=w.n(se),Rt=w(407770),Yt=w(306317),de=w(957530),Y=w(230967),j=w(854831),O=Object.defineProperty,T=Object.defineProperties,q=Object.getOwnPropertyDescriptors,X=Object.getOwnPropertySymbols,Be=Object.prototype.hasOwnProperty,st=Object.prototype.propertyIsEnumerable,ct=(e,t,a)=>t in e?O(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a,i=(e,t)=>{for(var a in t||(t={}))Be.call(t,a)&&ct(e,a,t[a]);if(X)for(var a of X(t))st.call(t,a)&&ct(e,a,t[a]);return e},R=(e,t)=>T(e,q(t)),y=(e,t)=>{var a={};for(var r in e)Be.call(e,r)&&t.indexOf(r)<0&&(a[r]=e[r]);if(e!=null&&X)for(var r of X(e))t.indexOf(r)<0&&st.call(e,r)&&(a[r]=e[r]);return a},je=(e,t)=>Math.round(e*t/100),Xt=(e,t)=>R(i({},e),{l:e.l-je(e.l,t)}),Mi=(e,t)=>R(i({},e),{l:e.l+je(e.l,t)}),Li=(e,t)=>R(i({},e),{s:e.s+je(e.s,t)}),qe=(e,t)=>R(i({},e),{a:t}),ua=15.8,ha=31.6,ma=.14,va=.46,ga=.9,pa=.8,Jt=.25,fa=.06,ba=.15,Ca=.3,wa=.45,me={red:{h:4,s:64,l:48,a:1},blurpleLight:{h:214.3,s:91.3,l:95.5,a:1},blurpleMedium:{h:216.5,s:92,l:90.2,a:1},blurple:{h:215.4,s:80,l:47.65,a:1},blurpleDark:{h:215.9,s:79.9,l:41,a:1},blurpleStrong:{h:216.3,s:69.2,l:22.9,a:1},offWhite:{h:0,s:0,l:97.25,a:1},blueLight:{h:216.5,s:92,l:90.2,a:1},blue:{h:215.4,s:80,l:47.65,a:1},blueDark:{h:216.3,s:69.2,l:23,a:1},magenta:{h:323,s:42,l:48,a:1},orangeLight:{h:4,s:100,l:91.2,a:1},orange:{h:11,s:100,l:62.2,a:1},orangeDark:{h:10.9,s:100,l:42.2,a:1},tealLight:{h:155,s:70,l:84,a:1},teal:{h:155,s:62,l:32,a:1},tealDark:{h:155,s:55,l:19,a:1},yellowLight:{h:43,s:93,l:82,a:1},yellow:{h:45.5,s:96,l:57,a:1},yellowDark:{h:39.8,s:100,l:49.4,a:1}},et={grey8:{h:228,s:6,l:17,a:1},grey7:{h:223,s:6,l:24.5,a:1},grey6:{h:224,s:5,l:44,a:1},grey5:{h:224,s:5,l:57,a:1},grey4:{h:223,s:5,l:73,a:1},grey3:{h:225,s:6,l:87.5,a:1},grey2:{h:210,s:7,l:94.5,a:1},grey1:{h:0,s:0,l:97.25,a:1},white:{h:0,s:0,l:100,a:1}},Qt={record:me.orange,recordHover:Xt(me.orange,ua),recordActive:Xt(me.orange,ha),backdropDark:qe(et.grey8,ga),backdropTwilight:qe(me.blurpleStrong,pa),highlight:qe(me.blurple,ba),highlightHover:qe(me.blurple,Ca),highlightActive:qe(me.blurple,wa),warning:{h:45.5,s:96,l:57,a:1,ads:"--ds-background-warning-bold"}},Ne={light:R(i({primary:me.blurple,primaryHover:me.blurpleDark,primaryActive:me.blurpleStrong,body:{h:228,s:6,l:17,a:1,ads:"--ds-text"},bodyDimmed:{h:224,s:5,l:44,a:1,ads:"--ds-text-subtlest"},bodyInverse:{h:0,s:0,l:100,a:1,ads:"--ds-text-inverse"},background:{h:0,s:0,l:100,a:1,ads:"--ds-surface"},backgroundHover:{h:209,s:75.6,l:8,a:.08,ads:"--ds-background-neutral-subtle-hovered"},backgroundActive:{h:225.5,s:56.9,l:10,a:.14,ads:"--ds-background-neutral-subtle-pressed"},backgroundSecondary:{h:0,s:0,l:97.25,a:1,ads:"--ds-surface-sunken"},backgroundSecondary2:{h:0,s:0,l:97.25,a:1,ads:"--ds-surface-sunken"},backgroundNeutral:{h:209,s:76,l:8,a:.08,ads:"--ds-background-neutral"},backgroundNeutralHover:{h:226,s:57,l:1,a:.14,ads:"--ds-background-neutral-hovered"},backgroundNeutralActive:{h:223,s:61,l:8,a:.28,ads:"--ds-background-neutral-pressed"},backgroundInverse:{h:228,s:6,l:17,a:1,ads:"--ds-background-neutral-bold"},focusRing:{h:216.1,s:81.4,l:60,a:1,ads:"--ds-border-focused"},overlay:{h:0,s:0,l:100,a:1,ads:"--ds-surface-overlay"},overlayHover:et.grey2,overlayActive:et.grey3,backdrop:{h:224,s:72,l:7,a:va,ads:"--ds-blanket"},border:{h:225.5,s:57,l:10,a:ma,ads:"--ds-border"}},Qt),{info:{h:215,s:80.25,l:47.65,a:1,ads:"--ds-background-information-bold"},success:{h:155,s:62,l:32,a:1,ads:"--ds-background-accent-green-bolder"},danger:{h:4,s:64,l:48,a:1,ads:"--ds-background-danger-bold"},dangerHover:{h:4.3,s:65.7,l:41.2,a:1,ads:"--ds-background-danger-bold-hovered"},dangerActive:{h:4.5,s:56.3,l:23.3,a:1,ads:"--ds-background-danger-bold-pressed"},disabledContent:{h:223,s:5,l:73,a:1,ads:"--ds-text-disabled"},disabledBackground:{h:0,s:0,l:9,a:.03,ads:"--ds-background-disabled"},formFieldBorder:{h:223.6,s:5,l:57,a:1,ads:"--ds-border-input"},formFieldBackground:{h:0,s:0,l:100,a:1,ads:"--ds-background-input"},buttonBorder:{h:252,s:13,l:46,a:Jt,ads:"--ds-border"},tabBackground:{h:209,s:75.6,l:8,a:fa,ads:"--ds-background-neutral"},upgrade:{h:277.5,s:89,l:96.5,a:1,ads:"--ds-background-discovery"},upgradeHover:{h:277,s:86,l:91.6,a:1,ads:"--ds-background-discovery-hovered"},upgradeActive:{h:278.6,s:84.5,l:79.8,a:1,ads:"--ds-background-discovery-pressed"},discoveryBackground:{h:278.6,s:48.4,l:52.2,a:1,ads:"--ds-background-discovery-bold"},discoveryLightBackground:{h:277.5,s:89,l:96.5,a:1,ads:"--ds-background-discovery"},discoveryTitle:{h:228,s:6,l:17,a:1,ads:"--ds-text"},discoveryHighlight:{h:277.5,s:89,l:96.5,a:1,ads:"--ds-background-discovery"}}),dark:R(i({primary:{h:216.3,s:83.2,l:67.3,a:1},primaryHover:{h:216.1,s:85.1,l:76.3,a:1},primaryActive:{h:216.5,s:92,l:90.2,a:1},body:{h:225,s:4.3,l:81.6,a:1,ads:"--ds-text"},bodyDimmed:{h:217.5,s:4,l:60.4,a:1,ads:"--ds-text-subtlest"},bodyInverse:{h:240,s:3,l:12.5,a:1,ads:"--ds-text-inverse"},background:{h:240,s:3,l:12.5,a:1,ads:"--ds-surface"},backgroundHover:{h:240,s:12.6,l:83,a:.07,ads:"--ds-background-neutral-subtle-hovered"},backgroundActive:{h:236,s:36.6,l:92,a:.12,ads:"--ds-background-neutral-subtle-pressed"},backgroundSecondary:{h:210,s:4,l:9.8,a:1,ads:"--ds-surface-sunken"},backgroundSecondary2:{h:210,s:4,l:9.8,a:1,ads:"--ds-surface-sunken"},backgroundNeutral:{h:240,s:12.6,l:83,a:.07,ads:"--ds-background-neutral"},backgroundNeutralHover:{h:236,s:36.6,l:92,a:.12,ads:"--ds-background-neutral-hovered"},backgroundNeutralActive:{h:226,s:49,l:93,a:.25,ads:"--ds-background-neutral-pressed"},backgroundInverse:{h:225,s:4.3,l:81.6,a:1,ads:"--ds-background-neutral-bold"},focusRing:{h:216.1,s:85.1,l:76.3,a:1,ads:"--ds-background-accent-blue-subtle-hovered"},overlay:{h:225,s:4,l:17.6,a:1,ads:"--ds-surface-overlay"},overlayHover:{h:225,s:4,l:19.61,a:1,ads:"--ds-surface-overlay-hovered"},overlayActive:{h:225,s:4.69,l:25.1,a:1,ads:"--ds-surface-overlay-pressed"},backdrop:{h:210,s:11,l:7,a:.6,ads:"--ds-blanket"},border:{h:236,s:36.6,l:92,a:.12,ads:"--ds-border"}},Qt),{info:{h:216.3,s:83,l:67.25,a:1,ads:"--ds-background-information-bold"},success:{h:155,s:57,l:55,a:1,ads:"--ds-background-accent-green-bolder"},danger:{h:3.75,s:91,l:69,a:1,ads:"--ds-background-danger-bold"},dangerHover:{h:4,s:96,l:78,a:1,ads:"--ds-background-danger-bold-hovered"},dangerActive:{h:4,s:100,l:91.2,a:1,ads:"--ds-background-danger-bold-pressed"},disabledContent:{h:225,s:5,l:33,a:1,ads:"--ds-text-disabled"},disabledBackground:{h:0,s:0,l:1,a:.46,ads:"--ds-background-disabled"},formFieldBorder:{h:222,s:4,l:51.4,a:1,ads:"--ds-border-input"},formFieldBackground:{h:225,s:5,l:15,a:1,ads:"--ds-background-input"},buttonBorder:{h:0,s:0,l:100,a:Jt,ads:"--ds-border"},tabBackground:{h:240,s:12.6,l:83,a:.07,ads:"--ds-background-neutral"},upgrade:{h:277.8,s:27.3,l:19.4,a:1,ads:"--ds-background-discovery"},upgradeHover:{h:278,s:44.2,l:25.3,a:1,ads:"--ds-background-discovery-hovered"},upgradeActive:{h:278,s:45,l:44.7,a:1,ads:"--ds-background-discovery-pressed"},discoveryBackground:{h:278.5,s:84.5,l:72.2,a:1,ads:"--ds-background-discovery-bold"},discoveryLightBackground:{h:277.8,s:27.3,l:19.4,a:1,ads:"--ds-background-discovery"},discoveryTitle:{h:225,s:4.3,l:81.6,a:1,ads:"--ds-text"},discoveryHighlight:{h:277.8,s:27.3,l:19.4,a:1,ads:"--ds-background-discovery"}})},le=i(i({},me),et),qt=[...Object.keys(le),...Object.keys(Ne.light)],ki=(e,t)=>`hsla(${le[e].h},${le[e].s}%,${le[e].l}%,${t})`,_i=(e,t,a)=>{const r=()=>{if(t==="dark")return le[e].l-le[e].l*a;if(t==="light")return le[e].l+le[e].l*a};return`hsla(${le[e].h},${le[e].s}%,${Math.round(r())}%,${le[e].a})`},c=e=>{if(e)return e in le||e in Ne.light?`var(--lns-color-${e})`:e in ir?`var(--lns-gradient-${e})`:e};function Ea(e,t,a){const r=React.useCallback(()=>typeof window>"u"?a:t[e.findIndex(s=>matchMedia(s).matches)]||a,[a,e,t]),[n,l]=React.useState(r);return React.useEffect(()=>{const s=_debounce(()=>l(r),150);return window.addEventListener("resize",s),()=>window.removeEventListener("resize",s)},[r]),n}var u=e=>e&&`calc(${e} * var(--lns-unit, ${Ke}px))`,fe=e=>{if(e in mt)return`var(--lns-space-${e})`;if(e&&isNaN(e))return`${e}`;if(e===0)return"0";if(e)return`${u(e)}`},b=(e,t)=>{if(t||t===0){if(Array.isArray(t)){const a=t.map(r=>`${e}: ${fe(r)}`);return Ue(a)}if(typeof t=="object"){const a={};return Object.entries(t).forEach(([r,n])=>a[r]=fe(n)),tt(e,a)}return`${e}: ${fe(t)};`}},er=(e,t,a)=>`@media(${e}: ${t}){${a}}`,Ue=e=>{const t=Object.values(Ve)[0],a=er("max-width",t,e[0]),r=e.reduce((n,l,s)=>{const d=`${Object.values(Ve)[s]}`;return n+er("min-width",d,l)},"");return a+r},tt=(e,t)=>{const a=[];return t.default&&a.push(`${e}: ${t.default};`),delete t.default,Object.entries(t).forEach(([r,n])=>{const l=r in Ve?Ve[r]:r;a.push(`@media(min-width: ${l}){ ${e}: ${n} }`)}),a.join(" ")},ue=(e,t)=>{if(Array.isArray(t)){const a=t.map(r=>`${e}: ${r};`);return Ue(a)}return typeof t=="object"?tt(e,t):`${e}: ${t};`},tr=(e,t)=>{if(e){if(Array.isArray(e)){const a=[];return e.map(r=>{a.push(t[r])}),ue("align-items",a)}return`align-items ${t[e]};`}},ya=(e,t,a)=>{if(Array.isArray(a)){const r=a.map(n=>{const l=n===!0?t[0]:t[1];return`${e}: ${l};`});return Ue(r)}return`${e}: ${t[0]};`},rr=(e,t)=>{if(t||t===0){if(Array.isArray(t)){const a=t.map(r=>`${e}: ${r}`);return Ue(a)}return typeof t=="object"&&!Array.isArray(t)?tt(e,t):`${e}: ${t};`}},dt=e=>Array.isArray(e)?e.map(t=>fe(t)).join(" "):e,Hi=e=>{if(e){if(typeof e=="object"&&!Array.isArray(e)){const t={};return Object.entries(e).forEach(([a,r])=>t[a]=dt(r)),tt("grid-template-columns",t)}return`grid-template-columns: ${dt(e)};`}},ar=(e,t)=>{if(e){if(typeof e=="object"&&!Array.isArray(e)){const a={};return Object.entries(e).forEach(([r,n])=>a[r]=dt(n)),tt(`grid-template-${t}`,a)}return`grid-template-${t}: ${dt(e)};`}},Si=({children:e,queries:t,values:a,defaultValue:r})=>{const n=Ea(t,a,r);return e(n)},ze=e=>e&&`
  font-size: var(--lns-fontSize-${e});
  line-height: var(--lns-lineHeight-${e});
  letter-spacing: var(--lns-letterSpacing-${e});
`,Oe=e=>e&&`font-weight: var(--lns-fontWeight-${e});`,za=e=>e&&`var(--lns-fontSetting-${e});`,F=e=>e&&`border-radius: var(--lns-radius-${e});`,rt=e=>e&&`box-shadow: var(--lns-shadow-${e});`,be=(e,t)=>{const a=e||c("focusRing");return`box-shadow:${t||""} 0 0 0 2px ${a};`},ut=e=>`
  ...
  ${e=>e.sizeMinMax&&`
    ...
    line-height: clamp(
      ${vt(e.sizeMinMax[0])}px,
      ${ur(vt(e.sizeMinMax[0]),vt(e.sizeMinMax[1]),496,1200)},
      ${vt(e.sizeMinMax[1])}px
    );
  `}
`,ka=e=>{var t=e,{children:a,size:r="body-md",color:n,isInline:l,isDimmed:s,fontWeight:d="regular",hasEllipsis:m,ellipsisLines:v,noWrap:p,variant:g,htmlTag:f="span",alignment:C,sizeMinMax:x,fontSetting:z="normal"}=t,E=y(t,["children","size","color","isInline","isDimmed","fontWeight","hasEllipsis","ellipsisLines","noWrap","variant","htmlTag","alignment","sizeMinMax","fontSetting"]);return s&&console.warn($a),r.includes("heading-")&&(d="bold"),o.createElement(La,i({size:g?_t[g].size:r,color:n,isInline:l,isDimmed:s,fontWeight:g?_t[g].fontWeight:d,hasEllipsis:m,ellipsisLines:v,noWrap:p,variant:g,as:f,alignment:C,sizeMinMax:x,fontSetting:z},E),a)},_a=["left","right","center"],xe=ka,gt=["top","bottom","left","right"],hr=i({0:"0"},mt),Ht=i({0:"0",auto:"auto"},mt),Ha=qt.map(e=>({selector:"c",modifier:e,declarations:[{property:"color",value:`var(--lns-color-${e})`}]})),Sa=qt.map(e=>({selector:"bgc",modifier:e,declarations:[{property:"background-color",value:`var(--lns-color-${e})`}]})),Ia=Object.keys(De).map(e=>({selector:"text",modifier:e,declarations:[{property:"font-size",value:`var(--lns-fontSize-${e})`},{property:"line-height",value:`var(--lns-lineHeight-${e})`},{property:"letter-spacing",value:`var(--lns-letterSpacing-${e})`},e.includes("heading-")||e.includes("xlarge")?{property:"font-weight",value:"var(--lns-fontWeight-bold)"}:{property:"font-weight",value:"var(--lns-fontWeight-regular)"}]})),Ba=Object.keys(lr).map(e=>({selector:"weight",modifier:e,declarations:[{property:"font-weight",value:`var(--lns-fontWeight-${e})`}]})),Oa=Object.entries(_t).map(([e,t])=>({selector:"text",modifier:e,declarations:[{property:"font-size",value:`var(--lns-fontSize-${t.size})`},{property:"line-height",value:`var(--lns-lineHeight-${t.size})`},{property:"font-weight",value:`var(--lns-fontWeight-${t.fontWeight})`}]})),Da=_a.map(e=>({selector:"text",modifier:e,declarations:[{property:"text-align",value:e}]})),Va=Object.keys(Lt).map(e=>({selector:"shadow",modifier:e,declarations:[{property:"box-shadow",value:`var(--lns-shadow-${e})`}]})),Wa=Object.keys(or).map(e=>({selector:"radius",modifier:e,declarations:[{property:"border-radius",value:`var(--lns-radius-${e})`}]})),at=(e,t,a,r)=>{const n=[];return t.map(l=>{const s=r?`${e.charAt(0)}${l.charAt(0)}`:l;Object.keys(a).map(d=>{n.push({selector:s,property:`${e}${l&&e?`-${l}`:l||""}`,modifier:d,value:d==="auto"||d==="0"?d:`var(--lns-space-${d})`})})}),n},Pa=Object.values(at("margin",["",...gt],Ht,"shortSides")).map(e=>({selector:e.selector,modifier:e.modifier,declarations:[{property:e.property,value:e.value}]})),Aa=Object.values(at("margin",["x","y"],Ht,"shortSides")).map(e=>({selector:e.selector,modifier:e.modifier,declarations:[{property:e.property==="margin-x"?"margin-left":"margin-top",value:e.value},{property:e.property==="margin-x"?"margin-right":"margin-bottom",value:e.value}]})),Ta=Object.values(at("padding",["",...gt],hr,"shortSides")).map(e=>({selector:e.selector,modifier:e.modifier,declarations:[{property:e.property,value:e.value}]})),Fa=Object.values(at("padding",["x","y"],hr,"shortSides")).map(e=>({selector:e.selector,modifier:e.modifier,declarations:[{property:e.property==="padding-x"?"padding-left":"padding-top",value:e.value},{property:e.property==="padding-x"?"padding-right":"padding-bottom",value:e.value}]})),Za=["",...gt].map(e=>{const t="border"+e.replace(e.charAt(0),e.charAt(0).toUpperCase()),a=`border${e&&`-${e}`}`;return{selector:t,declarations:[{property:a,value:"1px solid var(--lns-color-border)"}]}}),ja=["inline","block","flex","inlineBlock","inlineFlex","none"],Na=ja.map(e=>({selector:e,declarations:[{property:"display",value:ht(e)}]})),Ua=[{selector:"flexWrap",declarations:[{property:"flex-wrap",value:"wrap"}]}],Ka=["column","row"],Ga=Ka.map(e=>({selector:"flexDirection",modifier:e,declarations:[{property:"flex-direction",value:e}]})),Ya=["stretch","center","baseline","flexStart","flexEnd","selfStart","selfEnd"],Xa=Ya.map(e=>({selector:"items",modifier:e,declarations:[{property:"align-items",value:ht(e)}]})),Ja=["flexStart","flexEnd","center","spaceBetween","spaceAround","spaceEvenly"],Qa=Ja.map(e=>({selector:"justify",modifier:e,declarations:[{property:"justify-content",value:ht(e)}]})),qa=["0","1"],en=qa.map(e=>({selector:"grow",modifier:e,declarations:[{property:"flex-grow",value:e}]})),tn=["0","1"],rn=tn.map(e=>({selector:"shrink",modifier:e,declarations:[{property:"flex-shrink",value:e}]})),an=["auto","flexStart","flexEnd","center","baseline","stretch"],nn=an.map(e=>({selector:"self",modifier:e,declarations:[{property:"align-self",value:ht(e)}]})),ln=["hidden","auto"],on=ln.map(e=>({selector:"overflow",modifier:e,declarations:[{property:"overflow",value:e}]})),sn=["relative","absolute","sticky","fixed"],cn=sn.map(e=>({selector:e,declarations:[{property:"position",value:e}]})),dn=Object.values(at("",gt,Ht)).map(e=>({selector:e.selector,modifier:e.modifier,declarations:[{property:e.property,value:e.value}]})),un=["auto","full","0"],hn=un.map(e=>({selector:"width",modifier:e,declarations:[{property:"width",value:e==="full"?"100%":e}]})),mn=[{selector:"minWidth",modifier:"0",declarations:[{property:"min-width",value:"0"}]}],vn=["auto","full","0"],gn=vn.map(e=>({selector:"height",modifier:e,declarations:[{property:"height",value:e==="full"?"100%":e}]})),pn=[{selector:"ellipsis",declarations:[{property:"overflow",value:"hidden"},{property:"text-overflow",value:"ellipsis"},{property:"white-space",value:"nowrap"}]}],fn=[{selector:"srOnly",declarations:[{property:"position",value:"absolute"},{property:"width",value:"1px"},{property:"height",value:"1px"},{property:"padding",value:"0"},{property:"margin",value:"-1px"},{property:"overflow",value:"hidden"},{property:"clip",value:"rect(0, 0, 0, 0)"},{property:"white-space",value:"nowrap"},{property:"border-width",value:"0"}]}],bn="\\:",mr=[...Ha,...Va,...Wa,...Sa,...Pa,...Aa,...Ta,...Fa,...Ia,...Ba,...Oa,...Da,...Za,...Na,...Ua,...Ga,...Xa,...Qa,...en,...rn,...nn,...on,...cn,...dn,...hn,...mn,...gn,...pn,...fn],vr=(e,t)=>{const a=[],r=t?`${t}-`:"";return e.map(n=>{const l=[];n.declarations.map(d=>{l.push(`${d.property}:${d.value}`)});const s=`.${r}${n.selector}${n.modifier?bn:""}${n.modifier?n.modifier:""}{${l.join(";")}}`;a.push(s)}),a.join("")},Cn={xs:Ve.xsmall,sm:Ve.small,md:Ve.medium,lg:Ve.large},wn=()=>(()=>{const t=[];return t.push(`${vr(mr)}`),Object.entries(Cn).map(([a,r])=>{t.push(`@media(min-width:${r}){${vr(mr,a)}}`)}),t.join("")})(),Ce=(e,t)=>{const a={};return Object.entries(t).forEach(([r,n])=>{const s=`--lns-${(e?`${e}-`:"")+r}`;a[s]=n}),a},En=()=>{const e={};return Object.entries(De).forEach(([t,a])=>{const r={},n={},l={},s=`fontSize-${t}`,d=`lineHeight-${t}`,m=`letterSpacing-${t}`;r[s]=u(a.fontSize),r[d]=a.lineHeight,r[m]=a.letterSpacing,Object.assign(e,r,n,l)}),e},yn=()=>{const e={};return Object.entries(mt).forEach(([t,a])=>{const r=`space-${t}`;e[r]=u(a)}),e},zn=()=>{const e={};return Object.keys(i(i({},me),et)).forEach(t=>{const a=t;e[a]=`hsla(${le[t].h},${le[t].s}%,${le[t].l}%,${le[t].a})`}),e},xn=()=>{const e=(t,a)=>Object.keys(t).reduce((r,n)=>{const l=t[n],s=`${a}-color-${n}`;return r[s]=l.ads?`var(${l.ads}, hsla(${l.h},${l.s}%,${l.l}%,${l.a}))`:`hsla(${l.h},${l.s}%,${l.l}%,${l.a})`,r},{});return i(i({},e(Ne.light,"themeLight")),e(Ne.dark,"themeDark"))},$n=Ce(void 0,{unit:`${Ke/16}rem`}),Rn=Ce("fontWeight",lr),Mn=Ce("fontSetting",xa),Ln=Ce(void 0,En()),kn=Ce("radius",or),_n=Ce("shadow",Lt),Hn=Ce(void 0,yn()),Sn=Ce(void 0,{formFieldBorderWidth:"1px",formFieldBorderWidthFocus:"2px",formFieldHeight:u(4.5),formFieldRadius:"var(--lns-radius-175)",formFieldHorizontalPadding:u(2),formFieldBorderShadow:`
  ...
  `}),In=Ce("color",zn()),Bn=Ce(void 0,xn()),On=Ce("gradient",ir),gr=[$n,Ln,kn,_n,Hn,Sn],Dn=()=>Object.assign({},...gr),Vn=()=>Object.assign({},Rn,...gr,Mn),Wn=()=>i(i(i({},In),Bn),On),Pn=()=>Object.keys(Ne.light).map(e=>`--lns-color-${e}: var(--lns-themeLight-color-${e});`),An=()=>Object.keys(Ne.dark).map(e=>`--lns-color-${e}: var(--lns-themeDark-color-${e});`),pr=(e=":root")=>`
    ${e||":root"},
    .theme-light,
  ...
  `,Ii=()=>{const e=document.createElement("style");e.innerHTML=pr(),document.head.appendChild(e)},Bi=()=>Object.entries(Dn()).map(t=>`${t[0]}:${t[1]};`).join(""),Tn=e=>{const t=[],a=e||":root";return Object.entries(Vn()).forEach(r=>{t.push(`${r[0]}:${r[1]};`)}),Object.entries(Wn()).forEach(r=>{t.push(`${r[0]}:${r[1]};`)}),`
    ${a} {
      ${t.join("")}
    }
  `},Fn=e=>{switch(e){case"orange":return{background:"orangeLight",text:"dangerHover"};case"blue":return{background:"blueLight",text:"blueDark"};case"yellow":return{background:"yellowLight",text:"#9E4C00"};case"teal":return{background:"tealLight",text:"tealDark"};default:return{background:"orangeLight",text:"dangerHover"}}},Zn=e=>`calc(${e} / 2)`,We=e=>{let t,a;if(e==="medium")t=u(4),a=u(4);else if(e==="large")t=u(7),a=u(7);else{const n=fe(e);t=n,a=n}const r=Zn(t);return{width:t,height:a,fontSize:r}},jn=h.Z.span`
  display: block;
...
`,Nn=h.Z.img`
  ...
  height: ${e=>{const{height:t}=We(e.size);return t}};
  font-size: ${e=>{const{fontSize:t}=We(e.size);return t}};
`,Oi=e=>{var t=e,{altText:a="",size:r=4,letter:n,imageSrc:l,children:s,themeColor:d="blue"}=t,m=y(t,["altText","size","letter","imageSrc","children","themeColor"]);const v=()=>{if(s)return s;if(l){const f=We(r).height,C=We(r).width;return React3.createElement(Nn,{size:r,alt:a,src:l,height:f,width:C})}if(n)return a?React3.createElement("span",{"aria-label":a},n):n},p=n&&!l&&!s,g=Fn(d||"blue");return React3.createElement(jn,i({hasBackgroundColor:p,size:r,backgroundColor:g.background,color:g.text},m),v())},Di=null,fr=(e=":root",t="body")=>`
    ${e} {
      font-size: 100%;
    }
    ${t} {
    ...
    ${wn()}
  `,Vi=()=>React4.createElement(Global,{styles:css(fr())}),Wi=null,Un=3,Kn=h.Z.span`
  display: block;
  color: ${e=>c(e.color)};
...
`,Gn=e=>{var t=e,{altText:a,icon:r,color:n="body",size:l=Un}=t,s=y(t,["altText","icon","color","size"]);const d=o.useRef(null);return o.createElement(Kn,i({ref:d,"aria-label":a,color:n,size:l},s),r)},ee=Gn,br=1,St=8,It={small:{totalSize:18},medium:{totalSize:24},large:{totalSize:48}},pt=e=>It[e.size].totalSize/6,Bt=e=>It[e.size].totalSize,Yn=$.F4`
  50% {
    transform: scale(1);
  }
`,Xn=h.Z.span`
...
`,Qn=h.Z.span`
  grid-area: stack;
  place-self: center;
  transform: rotate(${e=>e.position*(360/St)}deg)
    translateY(${e=>Bt(e)/2-pt(e)/2}px);

  &:after {
    content: '';
    height: ${e=>pt(e)}px;
    width: ${e=>pt(e)}px;
    border-radius: ${e=>pt(e)}px;
    background-color: ${e=>c(e.color)};
    display: block;
    transform: scale(0.65);
    animation: ${Yn} ${br}s
      ${e=>e.position*br/St}s ease-in-out infinite;
  }
`,qn=({position:e,color:t,size:a})=>o.createElement(Qn,{color:t,position:e,size:a}),e1=e=>{var t=e,{color:a="body",size:r="medium"}=t,n=y(t,["color","size"]);let l;const s=[];for(l=0;l<St;l++)s.push(o.createElement(qn,{color:a,position:l,size:r,key:l}));return o.createElement(Xn,i({size:r},n),o.createElement(Jn,null,s))},Pi=Object.keys(It),Ot=e1,ve={small:{height:u(4),textSize:"small",iconSize:2,xSpace:u(1.5),radius:"var(--lns-radius-150)"},medium:{height:u(4.5),textSize:"medium",iconSize:3,xSpace:u(2),radius:"var(--lns-radius-175)"},large:{height:u(7),textSize:"large",iconSize:4,xSpace:u(2.5),radius:"var(--lns-radius-250)"}},Dt=e=>$.iv`
  ${e.hasLoader&&"display: none"};
`,$e={neutral:{color:c("body"),background:"transparent",borderColor:c("buttonBorder"),hover:c("backgroundHover"),active:c("backgroundActive"),floatingBackground:c("overlay"),floatingHover:c("overlayHover"),floatingActive:c("overlayActive")},neutralSecondary:{color:c("body"),background:c("backgroundNeutral"),borderColor:null,hover:c("backgroundNeutralHover"),active:c("backgroundNeutralActive")},primary:{color:c("white"),background:c("blurple"),borderColor:null,hover:c("primaryHover"),active:c("primaryActive")},secondary:{color:c("primary"),background:c("highlight"),borderColor:null,hover:c("highlightHover"),active:null},record:{color:c("white"),background:c("record"),borderColor:null,hover:c("recordHover"),active:c("recordActive")},upgrade:{color:c("body"),background:c("upgrade"),borderColor:null,hover:c("upgradeHover"),active:c("upgradeActive"),focusRing:be()},danger:{color:c("bodyInverse"),background:c("danger"),borderColor:null,hover:c("dangerHover"),active:c("dangerActive")},ai:{color:c("white"),background:c("ai-primary"),borderColor:null,hover:null,active:null}},Cr=e=>({enabled:$.iv`
    cursor: pointer;
  `,disabled:$.iv`
  ...
  `}),wr=u(1),r1=h.Z.button`
  appearance: none;
  padding: 0
    ${e=>e.hasChildren?ve[e.size].xSpace:0};
  font: inherit;
  ...
  ${e=>ze(ve[e.size].textSize)};
  ${e=>e.isFloating&&`box-shadow: ${Lt.medium}`};
  ${e=>e.disabled?Cr(e).disabled:Cr(e).enabled};
  ${e=>!e.disabled&&`
    border: ${$e[e.variant].borderColor?`1px solid ${$e[e.variant].borderColor}`:"none"};
    background: ${e.isFloating&&e.variant==="neutral"?$e[e.variant].floatingBackground:$e[e.variant].background};
    background-position: left;
    background-size: 125%;
    color: ${$e[e.variant].color};
  `};
  ...
  &:hover {
    transition:
      0.3s background,
      0.3s border-color;
    background: ${e=>e.isFloating&&e.variant==="neutral"?$e[e.variant].floatingHover:$e[e.variant].hover};
  ...
  &:active {
    transition:
      0s background,
      0s border-color;
    background: ${e=>e.isFloating&&e.variant==="neutral"?$e[e.variant].floatingActive:$e[e.variant].active};
    background-position: right;
  }

  &:focus-visible {
    ${e=>e["aria-expanded"]?"outline: none;":ut()};
  }
...
`,l1=h.Z.span`
  ${Dt};
`,o1=e=>{var t=e,{size:a="medium",children:r,variant:n="neutral",hasFullWidth:l,width:s="auto",icon:d,iconPosition:m="left",iconBefore:v,iconAfter:p,logoSrc:g,hasLoader:f,isDisabled:C,ariaDisabled:x,htmlTag:z="button",interactionName:E,onClick:M,refHandler:I}=t,P=y(t,["size","children","variant","hasFullWidth","width","icon","iconPosition","iconBefore","iconAfter","logoSrc","hasLoader","isDisabled","ariaDisabled","htmlTag","interactionName","onClick","refHandler"]);const _=d&&m==="left"?d:null,N=v||_?o.createElement(Er,{hasLoader:f,paddingLeft:"0",paddingRight:r?wr:"0"},o.createElement(ee,{icon:v||_,color:"currentColor",size:ve[a].iconSize})):null,J=d&&m==="right"?d:null,D=p||J?o.createElement(Er,{hasLoader:f,paddingLeft:r?wr:"0",paddingRight:"unset"},o.createElement(ee,{icon:J||p,color:"currentColor",size:ve[a].iconSize})):null,V=(0,o.useCallback)(A=>{E&&(0,ie.Z)(E),M?.(A)},[M,E]);return o.createElement(r1,R(i({size:a,variant:n,hasFullWidth:l,width:s,icon:d,iconPosition:m,logoSrc:g,disabled:C,ariaDisabled:x,as:z,hasChildren:r,ref:A=>I&&I(A)},P),{onClick:E===void 0?M:V}),f&&o.createElement(n1,null,o.createElement(Ot,{color:"currentColor"})),N,g&&o.createElement(a1,{alt:"",hasSpacing:Boolean(r),src:g,size:a,height:ve[a].height,width:ve[a].height,hasLoader:f}),o.createElement(l1,{hasLoader:f},r),D)},Ai=Object.keys(ve),Ti=Object.keys($e),i1=o1,s1=h.Z.div`
...
`,c1=e=>{var t=e,{children:a,all:r,y:n,x:l,top:s,right:d,bottom:m,left:v,isInline:p}=t,g=y(t,["children","all","y","x","top","right","bottom","left","isInline"]);return o.createElement(s1,i({all:r,top:n||s,bottom:n||m,right:l||d,left:l||v,isInline:p},g),a)},nt=c1,ft={topLeft:"start",topCenter:"start center",topRight:"start end",centerLeft:"center start",center:"center",centerRight:"center end",bottomLeft:"end start",bottomCenter:"end center",bottomRight:"end"},d1=e=>{if(Array.isArray(e))return e.map(t=>ft[t]);if(typeof e=="object"){const t={};return Object.entries(e).forEach(([a,r])=>t[a]=ft[r]),t}return ft[e]},u1=h.Z.div`
  width: 100%;
  height: 100%;
  display: grid;
  ${e=>ue("place-items",d1(e.alignment))};
`,h1=e=>{var t=e,{children:a,alignment:r="center",htmlTag:n="div"}=t,l=y(t,["children","alignment","htmlTag"]);return o.createElement(u1,i({alignment:r,as:n},l),a)},Fi=Object.keys(ft),Ae=h1,m1=(e,t,a)=>{const r=t||"border",l=`${fe(a)} solid ${c(r)}`;if(e)return e==="all"?`border: ${l};`:`border-${e}: ${l};`},v1=h.Z.div`
...
`,g1=e=>{var t=e,{children:a,backgroundColor:r,backgroundImage:n,contentColor:l,borderColor:s,radius:d,borderSide:m,borderWidth:v="1px",shadow:p,padding:g,paddingX:f,paddingY:C,paddingLeft:x,paddingRight:z,paddingTop:E,paddingBottom:M,margin:I,marginX:P,marginY:_,marginLeft:N,marginRight:J,marginTop:D,marginBottom:V,width:A,height:ae,minWidth:U,minHeight:Z,maxWidth:B,maxHeight:ne,htmlTag:K="div",position:ge,overflow:Me,zIndex:L,top:te,bottom:Je,left:Le,right:Se,refHandler:we}=t,k=y(t,["children","backgroundColor","backgroundImage","contentColor","borderColor","radius","borderSide","borderWidth","shadow","padding","paddingX","paddingY","paddingLeft","paddingRight","paddingTop","paddingBottom","margin","marginX","marginY","marginLeft","marginRight","marginTop","marginBottom","width","height","minWidth","minHeight","maxWidth","maxHeight","htmlTag","position","overflow","zIndex","top","bottom","left","right","refHandler"]);return o.createElement(v1,i({backgroundColor:r,backgroundImage:n,contentColor:l,borderColor:s,radius:d,borderSide:m,shadow:p,padding:g,paddingLeft:f||x,paddingRight:f||z,paddingTop:C||E,paddingBottom:C||M,margin:I,marginLeft:P||N,marginRight:P||J,marginTop:_||D,marginBottom:_||V,width:A,height:ae,minWidth:U,minHeight:Z,maxWidth:B,maxHeight:ne,as:K,position:ge,top:te,bottom:Je,left:Le,right:Se,overflow:Me,zIndex:L,borderWidth:v,ref:H=>we&&we(H)},k),a)},oe=g1,he={small:{height:u(4),width:u(5),iconSize:2,padding:u(1.75),withIconPadding:u(4.5),passwordAdditionalPadding:u(.5),textSize:"small",radius:"var(--lns-radius-150)"},medium:{height:"var(--lns-formFieldHeight)",width:u(6),iconSize:3,padding:"var(--lns-formFieldHorizontalPadding)",withIconPadding:u(5.5),passwordAdditionalPadding:u(.5),textSize:"medium",radius:"var(--lns-radius-175)"},large:{height:u(7),width:u(6),iconSize:3,padding:"var(--lns-formFieldHorizontalPadding)",withIconPadding:u(5.5),passwordAdditionalPadding:u(.5),textSize:"large",radius:"var(--lns-radius-250)"}},p1=e=>{let t=e.addOn?he[e.inputSize].withIconPadding:he[e.inputSize].padding;return e.type==="password"&&(t=`calc(${he[e.inputSize].passwordAdditionalPadding} + ${t})`),t},f1=h.Z.input`
  -webkit-appearance: none;
  font-family: inherit;
  width: 100%;
  height: ${e=>he[e.inputSize].height};
  border: none;
  color: inherit;
  ...
  padding-top: 0;
  padding-bottom: 0;
  padding-left: ${e=>e.icon?he[e.inputSize].withIconPadding:he[e.inputSize].padding};
  padding-right: ${e=>p1(e)};
  border-radius: ${e=>he[e.inputSize].radius};
...
`,Zi=(0,o.forwardRef)((e,t)=>{var a=e,{placeholder:r,onFocus:n,onChange:l,onBlur:s,onKeyDown:d,isDisabled:m,icon:v,type:p="text",value:g,hasError:f,size:C="medium",addOn:x}=a,z=y(a,["placeholder","onFocus","onChange","onBlur","onKeyDown","isDisabled","icon","type","value","hasError","size","addOn"]);const E=o.createElement(f1,i({type:p,placeholder:r,onFocus:n,onChange:l,onBlur:s,onKeyDown:d,disabled:m,icon:v,ref:t,value:g,hasError:f,inputSize:C,addOn:x},z));return v||x?o.createElement(b1,null,v&&o.createElement(C1,{size:C},typeof v=="string"?o.createElement(oe,{radius:"50",width:he[C].iconSize,height:he[C].iconSize,overflow:"hidden"},o.createElement(Ae,{alignment:"center"},o.createElement(w1,{src:v,alt:"",isDisabled:m}))):o.createElement(ee,{icon:v,size:he[C].iconSize,color:c(m?"disabledContent":"body")})),E,x&&o.createElement(E1,{size:C},x)):E}),y1=null,yr={start:"flex-start",center:"center",end:"flex-end",stretch:"stretch"},zr=!1,bt=e=>Array.isArray(e)?e:[e],xr=(e,t)=>{if(e.length===t)return e;const a=e[e.length-1];return[...Array(t)].map((r,n)=>e[n]||a)},z1=(e,t)=>{const a=Math.max(bt(e).length,bt(t).length),r=xr(bt(t),a),n=xr(bt(e),a),l="& > * + *",s=r.map((m,v)=>{const p=`${fe(m)} 0 0 0`,g=`0 0 0 ${fe(m)}`,f=n[v]==="column"?p:g;return`${l}{ margin: ${f}; }`}),d=n.map(m=>`flex-direction: ${m}`);return Ue(s)+Ue(d)},x1=h.Z.div`
  display: flex;
  flex-wrap: wrap;
  ${e=>z1(e.flexDirection,e.gap)};
  ${e=>tr(e.flexAlign,yr)};
...
`,ji=e=>{var t=e,{children:a,gap:r,direction:n="row",alignment:l="start",isSpread:s,htmlTag:d="div"}=t,m=y(t,["children","gap","direction","alignment","isSpread","htmlTag"]);return zr||(console.warn(Ra),zr=!0),React12.createElement(x1,i({gap:r,flexDirection:n,flexAlign:l,isSpread:s,as:d},m),a)},Ni=Object.keys(yr),Ui=null,$1=h.Z.div`
  display: grid;
  ${e=>ue("align-items",e.alignItems)};
  ${e=>ue("justify-content",e.justifyContent)};
  ${e=>e.justifyItems&&ue("justify-items",e.justifyItems)};
  ${e=>e.alignContent&&ue("align-content",e.alignContent)};
  ...
  ${e=>e.autoFlow&&ue("grid-auto-flow",e.autoFlow)};
  ${e=>e.columns&&e.autoFlow&&ue("grid-auto-flow",e.autoFlow)};
  ${e=>nr(e.as)};
`,R1=e=>{var t=e,{children:a,width:r,height:n,minWidth:l,minHeight:s,maxWidth:d,maxHeight:m,gap:v,columns:p,rows:g,alignItems:f="center",justifyContent:C="start",justifyItems:x,alignContent:z,autoFlow:E,htmlTag:M="div",className:I,style:P}=t,_=y(t,["children","width","height","minWidth","minHeight","maxWidth","maxHeight","gap","columns","rows","alignItems","justifyContent","justifyItems","alignContent","autoFlow","htmlTag","className","style"]);return(I||P)&&console.warn(kt),o.createElement($1,i({alignItems:f,as:M,justifyContent:C,justifyItems:x,alignContent:z,gap:v,columns:p,rows:g,width:r,height:n,minWidth:l,minHeight:s,maxWidth:d,maxHeight:m,autoFlow:E},_),a)},Te=R1;function $r(){return o.createElement(Q.Z,{label:"",testId:"ads-refreshed-icon"})}var M1=h.Z.div`
  position: relative;
  ::before {
    content: '';
...
`,Ki=({children:e,errorActive:t,errorMessage:a="Oops, that didn't work. Try again."})=>t?React15.createElement(M1,null,React15.createElement(Te,{autoFlow:"row",gap:"small"},e,a?React15.createElement(Te,{gap:"xsmall"},React15.createElement(ee,{icon:React15.createElement($r,null),size:2,color:"danger"}),React15.createElement(xe,{size:"body-sm",color:"danger"},a)):null)):React15.createElement(React15.Fragment,null,e),Gi=null,L1={start:"flex-start",center:"center",end:"flex-end"},k1=h.Z.div`
  display: flex;
  ${e=>tr(e.alignment,L1)};
...
`,H1=e=>{var t=e,{width:a,maxWidth:r,children:n}=t,l=y(t,["width","maxWidth","children"]);return console.warn(sr),o.createElement(_1,i({width:a,maxWidth:r},l),n)},S1=class extends o.Component{render(){return console.warn(sr),o.createElement(k1,i({},this.props),this.props.children)}};S1.Section=H1;var Yi=null,lt={small:{size:u(3),iconSize:2.25,radius:"var(--lns-radius-100)"},medium:{size:u(4),iconSize:3,radius:"var(--lns-radius-150)"},large:{size:u(5),iconSize:4,radius:"var(--lns-radius-175)"}},I1=h.Z.button`
  background-color: ${e=>c(e.isActive?"backgroundActive":e.backgroundColor)||"transparent"};
  border: none;
  appearance: none;
  cursor: pointer;
  padding: 0;
  width: ${e=>lt[e.size].size};
  height: ${e=>lt[e.size].size};
  position: relative;
  outline: 1px solid transparent;
  ...
  align-items: center;
  vertical-align: middle;
  border-radius: ${e=>lt[e.size].radius};
  font: inherit;
...
`,Rr=o.forwardRef((e,t)=>{var a=e,{altText:r,icon:n,onClick:l,iconColor:s="body",backgroundColor:d,isActive:m,isDisabled:v,size:p="medium"}=a,g=y(a,["altText","icon","onClick","iconColor","backgroundColor","isActive","isDisabled","size"]);return o.createElement(I1,i({"aria-label":r,onClick:l,isActive:m,disabled:v,size:p,backgroundColor:d,ref:t},g),o.createElement(ee,{icon:n,size:lt[p].iconSize,color:v?"disabledContent":s}))});Rr.displayName="IconButton";var Vt=Rr,B1=e=>o.createElement("svg",i({width:12,height:9,viewBox:"0 0 12 9",fill:"none"},e),o.createElement("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M11.707.293a1 1 0 010 1.414l-7 7a1 1 0 01-1.414 0l-3-3a1 1 0 011.414-1.414L4 6.586 10.293.293a1 1 0 011.414 0z",fill:"currentColor"})),O1=e=>o.createElement("svg",i({width:12,height:2,viewBox:"0 0 12 2",fill:"none"},e),o.createElement("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M0 1a1 1 0 011-1h10a1 1 0 110 2H1a1 1 0 01-1-1z",fill:"currentColor"})),D1=h.Z.div`
  display: block;
  position: relative;
`,V1=h.Z.input`
  height: 100%;
...
`,W1=h.Z.span`
  ...
  justify-content: center;
  user-select: none;
`,P1=(0,o.forwardRef)((e,t)=>{var a=e,{isDisabled:r,isChecked:n,isIndeterminate:l,onFocus:s,onChange:d,onBlur:m}=a,v=y(a,["isDisabled","isChecked","isIndeterminate","onFocus","onChange","onBlur"]);const p=(0,o.useRef)(),g=t||p,f=c(r?"disabledContent":"currentColor");return(0,o.useEffect)(()=>{g.current.indeterminate=l}),o.createElement(D1,null,o.createElement(V1,i({type:"checkbox",disabled:r,checked:n,onFocus:s,onChange:d,onBlur:m,ref:g,"aria-checked":n},v)),o.createElement(W1,{className:"CheckboxBox"},o.createElement(O1,{className:"Icon IconMinus",color:f}),o.createElement(B1,{className:"Icon IconCheck",color:f})))}),A1=P1,Ge={small:{textSize:"small",iconSize:2.25,height:u(3),xSpace:u(1),radius:"var(--lns-radius-100)"},medium:{textSize:"medium",iconSize:3,height:u(4),xSpace:u(1.5),radius:"var(--lns-radius-150)"},large:{textSize:"large",iconSize:4,height:u(6),xSpace:u(3),radius:"var(--lns-radius-200)"}},T1=h.Z.button`
...
`,F1=o.forwardRef((e,t)=>{var a=e,{onClick:r,size:n="medium",children:l,icon:s,iconPosition:d="left",isActive:m,isDisabled:v,htmlTag:p,offsetSide:g}=a,f=y(a,["onClick","size","children","icon","iconPosition","isActive","isDisabled","htmlTag","offsetSide"]);const C=o.createElement(oe,{paddingLeft:d==="right"&&"small",paddingRight:d==="left"&&"small",htmlTag:"span"},o.createElement(ee,{icon:s,size:Ge[n].iconSize,color:v?"disabledColor":void 0}));return o.createElement(T1,i({onClick:r,size:n,icon:s,iconPosition:d,disabled:v,isActive:m,as:p,offsetSide:g,ref:t},f),s&&d==="left"&&C,l,s&&d==="right"&&C)});F1.displayName="TextButton";var Xi=null,Wt=e=>{var t,a;const r=(a=(t=e?.())==null?void 0:t.getRootNode)==null?void 0:a.call(t);if(String(r)==="[object ShadowRoot]"){r.createElement=(...l)=>r.ownerDocument.createElement(...l);const n=r.createElement("div");return n.id="a11y-status-message",n.style.display="none",r.appendChild(n),{document:r,addEventListener:r.addEventListener.bind(r),removeEventListener:r.removeEventListener.bind(r)}}return typeof window>"u"?null:window},Pe=e=>typeof e=="string"?e:typeof e=="number"||typeof e=="boolean"||typeof e=="bigint"?e.toString():e==null?"":Z1(e)?Array.from(e).map(Pe).join(""):typeof e=="object"&&"props"in e&&e.props&&e.props.children!==void 0?Pe(e.props.children):"",Z1=e=>typeof e[Symbol.iterator]=="function";function Mr(){return o.createElement("span",{"aria-hidden":!0,"data-testid":"ads-refreshed-icon"},o.createElement("svg",{viewBox:"-2 -2 16 16"},o.createElement("path",{fill:"currentColor",fillRule:"evenodd",d:"M2.03 3.97 6 7.94l3.97-3.97 1.06 1.06-4.5 4.5a.75.75 0 0 1-1.06 0l-4.5-4.5z",clipRule:"evenodd"})))}function j1(){return o.createElement(xt.Z,{label:"",testId:"ads-refreshed-icon"})}var Pt={left:"bottom-start",right:"bottom-end",topLeft:"top-start",topRight:"top-end",leftSide:"left-start",rightSide:"right-start"},N1=h.Z.div`
...
`,G1=h.Z.img`
  ...
  object-fit: cover;
  opacity: ${({isDisabled:e})=>e?.5:1};
`,At=e=>{var t=e,{isDisabled:a,isHighlighted:r,isSelected:n,icon:l,hasDivider:s,children:d,menuItemRole:m,keyboardMove:v}=t,p=y(t,["isDisabled","isHighlighted","isSelected","icon","hasDivider","children","menuItemRole","keyboardMove"]);const C=`${l?"auto":""} 1fr ${n?"auto":""}`,x=a?"disabledContent":void 0,z=m?R(i({},p),{role:m}):p;return o.createElement(K1,i({isHighlighted:r,isDisabled:a,keyboardMove:v,columns:C,hasDivider:s,tabIndex:a?-1:0,"data-highlighted":r||void 0},z),l&&(typeof l=="string"?o.createElement(oe,{radius:"50",width:3,height:3,overflow:"hidden"},o.createElement(Ae,{alignment:"center"},o.createElement(G1,{src:l,alt:"",isDisabled:a}))):o.createElement(ee,{icon:l,color:x})),o.createElement(xe,{color:x,hasEllipsis:!0},d),n&&o.createElement(ee,{icon:o.createElement(j1,null),color:x}))},Y1=e=>{var t=e,{position:a,zIndex:r,minWidth:n,maxWidth:l,maxHeight:s,children:d,role:m,downshiftMenuProps:v=()=>null,search:p}=t,g=y(t,["position","zIndex","minWidth","maxWidth","maxHeight","children","role","downshiftMenuProps","search"]);const f=m?R(i({},v()),{role:m}):i({},v());return o.createElement(N1,i(i({minWidth:n,maxWidth:l,maxHeight:s,zIndex:r,position:a},f),g),p&&p,o.createElement(U1,{search:p},d))},Fe=Y1;function X1(){return React24.createElement(SearchIcon,{label:"",testId:"ads-refreshed-icon"})}var J1=h.Z.div`
  padding: ${u(1.5)} ${u(1.5)} 0;
  margin-bottom: ${u(1.5)};
  position: sticky;
  top: 0;
`,Ji=({ariaLabel:e,placeholder:t,value:a,onChange:r,getInputProps:n})=>React25.createElement(J1,null,React25.createElement(y1,i({"aria-label":e,icon:React25.createElement(X1,null)},n({placeholder:t,value:a,onChange:r,type:"text"})))),Lr=null,Q1=h.Z.div`
  position: relative;
`,q1=h.Z.button`
  appearance: none;
  font: inherit;
...
`,rl=h.Z.span`
  ...
  grid-column-start: 1;
  grid-column-end: 3;
`,Ct=e=>Array.isArray(e)&&e.length>0&&"group"in e[0],Tt=({options:e,selectedOptionValue:t})=>{if(!e||!t)return{icon:null,title:null};if(Ct(e))for(const a of e){const r=a.items.find(n=>n.value===t);if(r)return r}else return e.find(r=>r.value===t)||{icon:null,title:null};return{icon:null,title:null}},kr=({options:e,selectedItem:t,selectedOptionValue:a})=>{if(t)return t.icon;if(a)return Tt({options:e,selectedOptionValue:a}).icon},al=({options:e,selectedItem:t,selectedOptionValue:a,selectPlaceholder:r})=>t?t.title:a?Tt({options:e,selectedOptionValue:a}).title:r,_r=({selectedItem:e,getInputProps:t,getToggleButtonProps:a,ariaMenuName:r,isOpen:n})=>{const l=e?`selected value is ${e.title}`:"no value selected",s=a?.()["aria-label"];return{"aria-expanded":n,"aria-activedescendant":t()["aria-activedescendant"],"aria-label":[r,s,l].filter(Boolean).join(", ")}},nl=({getToggleButtonProps:e,inputValue:t,selectedItem:a,selectedOptionValue:r,selectPlaceholder:n,isDisabled:l,options:s,getInputProps:d,ariaMenuName:m,hasError:v,isOpen:p})=>{const g=kr({options:s,selectedItem:a,selectedOptionValue:r}),f=Boolean(g),C=!r&&!a,z=`${f?"auto":""} 1fr auto`,E=l?"disabledContent":void 0;return React26.createElement(q1,R(i(i({},e()),_r({selectedItem:a,getInputProps:d,getToggleButtonProps:e,ariaMenuName:m,isOpen:p})),{hasValue:t||r,disabled:l,columns:z,hasError:v}),f&&(typeof g=="string"?React26.createElement(oe,{radius:"50",width:3,height:3,overflow:"hidden"},React26.createElement(Ae,{alignment:"center"},React26.createElement(el,{src:g,alt:"",isDisabled:l}))):React26.createElement(ee,{icon:kr({options:s,selectedItem:a,selectedOptionValue:r}),color:E})),React26.createElement(xe,{hasEllipsis:!0,color:C?"bodyDimmed":"inherit"},al({options:s,selectedItem:a,selectedOptionValue:r,selectPlaceholder:n})),React26.createElement(ee,{icon:React26.createElement(Mr,null),color:E}))},ll=({selectedOptionValue:e,selectedItem:t,trigger:a,getToggleButtonProps:r,options:n,selectPlaceholder:l,isDisabled:s,getInputProps:d,ariaMenuName:m,hasError:v,errorMessage:p,isOpen:g})=>{const f=()=>i(i({},r()),_r({selectedItem:t,getInputProps:d,getToggleButtonProps:r,ariaMenuName:m,isOpen:g})),x=R(i({},(()=>{if(t)return t;if(e)return Tt({options:n,selectedOptionValue:e})})()),{placeholder:l,isDisabled:s,hasError:v,errorMessage:p});return a(x,f())},Hr=(e,t)=>{if(Ct(t))for(const a of t){const r=a.items.find(n=>n.value===e);if(r)return r}else return t.find(a=>a.value===e)},Sr=(e,t,a,r,n,l,s,d)=>{const m=!a&&e.value===r||a&&a.value===e.value;return React26.createElement(At,R(i({key:t,getItemProps:l,icon:e.icon,hidden:e.hidden},l({key:`${e.value}-${t}`,index:t,item:e,disabled:e.isDisabled,"aria-selected":m,onMouseMove:()=>{s&&d(!1)}})),{isDisabled:e.isDisabled,hasDivider:e.hasDivider,isHighlighted:n===t,keyboardMove:s&&n===t,isSelected:m}),e.title)},ol=e=>{var t=e,{options:a,selectedItem:r,selectedOptionValue:n,highlightedIndex:l,getItemProps:s,search:d,keyboardMove:m,setKeyboardMove:v}=t,p=y(t,["options","selectedItem","selectedOptionValue","highlightedIndex","getItemProps","search","keyboardMove","setKeyboardMove"]);if(!Ct(a))return React26.createElement(Fe,i({search:d},p),a.map((f,C)=>Sr(f,C,r,n,l,s,m,v)));let g=0;return React26.createElement(Fe,i({search:d},p),a.map(f=>{const C=`group-${f.group.replace(/\s+/g,"-")}`;return React26.createElement("li",{key:C},React26.createElement(nt,{left:"medium",top:"small",bottom:"xsmall"},React26.createElement(xe,{id:C,size:"body-sm",fontWeight:"bold"},f.group)),React26.createElement(tl,{role:"group","aria-labelledby":C},f.items.map(x=>Sr(x,g++,r,n,l,s,m,v))))}))},Qi=e=>{var t=e,{container:a,onChange:r,menuZIndex:n=1100,menuMaxWidth:l,menuMaxHeight:s=34,menuMinWidth:d,triggerOffset:m=0,ariaMenuName:v,selectedOptionValue:p,onOuterClick:g,options:f,placeholder:C,menuPosition:x="left",isDisabled:z,onOpenChange:E,trigger:M,hasError:I,errorMessage:P="Oops, that didn't work.",search:_}=t,N=y(t,["container","onChange","menuZIndex","menuMaxWidth","menuMaxHeight","menuMinWidth","triggerOffset","ariaMenuName","selectedOptionValue","onOuterClick","options","placeholder","menuPosition","isDisabled","onOpenChange","trigger","hasError","errorMessage","search"]);const J=Wt(a),[D,V]=useState(!1),[A,ae]=useState(!1),[U,Z]=useState(""),B=k=>{const H=k.target.value;Z(H)},[ne,K]=useState(Hr(p,f)),Me={itemToString:k=>k?k.value:"",onChange:k=>{K(k),r&&r(k||"")},onOuterClick:g,environment:J,selectedItem:ne,isOpen:D};J&&(Me.environment=J);const{layerProps:L,triggerProps:te,renderLayer:Je,triggerBounds:Le}=useLayer({isOpen:D,container:a,ResizeObserver,placement:Pt[x],auto:!0,snap:!0,triggerOffset:m});useEffect2(()=>{const k=Hr(p,f);k?.value!==ne?.value&&K(k)},[p,f,ne]),useEffect2(()=>{E&&E(D)},[D,E]);const Se=(k,H)=>{if(H.isOpen!==void 0){if(H.type===Downshift.stateChangeTypes.keyDownEscape)return V(!1),{isOpen:!1};V(H.isOpen)}return H},we=k=>{switch(k.key){case"ArrowDown":case"ArrowUp":case"ArrowLeft":case"ArrowRight":case"Enter":case" ":case"Tab":case"Escape":ae(!0);break;default:break}};return f=useMemo(()=>{if(_){if(Ct(f)){let k;return _.searchType==="startsWith"?k=f.map(H=>R(i({},H),{items:H.items.filter(ke=>Pe(ke.title).toLowerCase().startsWith(U.toLowerCase()))})):k=f.map(H=>R(i({},H),{items:H.items.filter(ke=>Pe(ke.title).toLowerCase().includes(U.toLowerCase()))})),k.reduce((H,ke)=>(ke.items.length>0&&H.push(ke),H),[])}return _.searchType==="startsWith"?f.filter(k=>Pe(k.title).toLowerCase().startsWith(U.toLowerCase())):f.filter(k=>Pe(k.title).toLowerCase().includes(U.toLowerCase()))}return f},[f,U,_]),React26.createElement(Q1,i({},N),React26.createElement(Downshift,R(i({},Me),{stateReducer:Se}),({getItemProps:k,getInputProps:H,getMenuProps:ke,getToggleButtonProps:zt,isOpen:W,inputValue:Ee,highlightedIndex:Gt,selectedItem:Qe})=>React26.createElement("div",{role:"presentation"},React26.createElement("div",i({},te),M?React26.createElement(ll,{getToggleButtonProps:()=>i({},zt({onKeyDown:we})),selectedItem:Qe,selectedOptionValue:p,selectPlaceholder:C,isDisabled:z,options:f,trigger:M,getInputProps:H,ariaMenuName:v,hasError:I,errorMessage:P,isOpen:W}):React26.createElement(nl,{getToggleButtonProps:()=>i({},zt({onKeyDown:we})),selectedItem:Qe,selectedOptionValue:p,selectPlaceholder:C,options:f,inputValue:Ee,isDisabled:z,getInputProps:H,ariaMenuName:v,hasError:I,isOpen:W})),D&&W&&Je(React26.createElement("div",R(i({},L),{style:R(i({},L.style),{zIndex:n,width:d?"auto":Le?.width})}),React26.createElement(ol,{options:f,selectedItem:Qe,selectedOptionValue:p,highlightedIndex:Gt,getItemProps:k,position:x,downshiftMenuProps:()=>ke({onKeyDown:we}),maxWidth:l,maxHeight:s,minWidth:d,search:_&&React26.createElement(Lr,{ariaLabel:_.searchPlaceholder,placeholder:_.searchPlaceholder,value:U,onChange:B,getInputProps:H}),keyboardMove:A,setKeyboardMove:ae}))),I&&!D&&React26.createElement(rl,null,P))))},qi=null;function il(e,t){const a=document;(0,o.useLayoutEffect)(()=>{const r=a?.documentElement,n=a?.body;if(!(a==null||!r||!n)){if(t){const l=window.innerWidth-r.clientWidth,s=parseInt(window.getComputedStyle(n).getPropertyValue("padding-right"),10)||0;switch(e){case"html":{r.style.position="relative",r.style.overflow="hidden",n.style.paddingRight=`${s+l}px`;break}case"body":{n.style.setProperty("position","relative"),n.style.setProperty("overflow","hidden"),n.style.setProperty("padding-right",`${s+l}px`);break}default:return}}return()=>{switch(e){case"html":{r.style.position="",r.style.overflow="",n.style.paddingRight="";break}case"body":{n.style.removeProperty("position"),n.style.removeProperty("overflow"),n.style.removeProperty("padding-right");break}default:return}}}},[a,t,e])}var Ir=il,Br=300,sl=h.Z.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`,cl=h.Z.div`
  overflow: auto;
  height: 100%;
`,Or=o.forwardRef((e,t)=>{var a=e,{children:r,isOpen:n,zIndex:l=1e3,backgroundColor:s="backdropDark"}=a,d=y(a,["children","isOpen","zIndex","backgroundColor"]);const{stage:m,shouldMount:v}=(0,re.Yz)(n,Br);return Ir("html",n),o.createElement(o.Fragment,null,v&&o.createElement(sl,i({ref:t,backgroundColor:s,zIndex:l,style:{transition:`opacity ${Br}ms`,opacity:m==="enter"?1:0}},d),o.createElement(cl,null,r)))});Or.displayName="Backdrop";var dl=Or;function Ft(){return o.createElement(Rt.Z,{label:"",testId:"ads-refreshed-icon"})}var ul="70vh",hl=h.Z.div`
  display: grid;
  grid-template-rows: ${e=>e.rows};
  position: relative;
`,ml=h.Z.dialog`
  top: ${e=>Mt(fe(e.maxHeight),e.placement).top};
  background-color: ${c("overlay")};
  color: ${c("body")};
  bottom: ${e=>Mt(e.maxHeight,e.placement).bottom};
  ${rt("large")};
  ${F("xlarge")};
  ...
  ${e=>b("max-width",e.maxWidth)};
  margin: 0 auto;
  position: ${e=>Mt(e.maxHeight,e.placement).position};
  overflow: auto;
  width: 100%;
...
`,Dr=e=>typeof e=="number"?b("max-height",e):"max-height: "+e,wl=e=>{var t=e,{children:a,onCloseClick:r,isOpen:n,maxWidth:l=60,maxHeight:s=ul,placement:d="center",ariaLabel:m,ariaModal:v,ariaLabelledBy:p,ref:g,removeClose:f,initialFocus:C}=t,x=y(t,["children","onCloseClick","isOpen","maxWidth","maxHeight","placement","ariaLabel","ariaModal","ariaLabelledBy","ref","removeClose","initialFocus"]);const z=E=>{E.key==="Escape"&&(E.preventDefault(),f||r(E))};return(0,o.useEffect)(()=>(window.addEventListener("keydown",z),()=>{window.removeEventListener("keydown",z)}),[n,r]),Ir("html",n),o.createElement($t(),{active:n,focusTrapOptions:i({clickOutsideDeactivates:!1,allowOutsideClick:!0},C!==void 0?{initialFocus:C}:{})},o.createElement(ml,i({open:n,maxWidth:l,maxHeight:s,placement:d,onClick:E=>E.stopPropagation(),ref:g,"aria-label":m,"aria-modal":v,"aria-labelledby":p},x),!f&&r&&o.createElement(vl,null,o.createElement(Vt,{altText:"Close",icon:o.createElement(Ft,null),onClick:r})),o.createElement(Cl,R(i({},f?{tabIndex:0}:{tabIndex:-1}),{maxHeight:s}),a)))},e0=o.forwardRef((e,t)=>{var a=e,{children:r,id:n,isOpen:l,mainButton:s,secondaryButton:d,alternativeButton:m,title:v,noPadding:p,onCloseClick:g,onBackgroundClick:f,onKeyDown:C,hasDividers:x,maxHeight:z="70vh",maxWidth:E=60,placement:M="center",zIndex:I=1e3,ariaLabel:P,ariaModal:_=!0,ariaLabelledBy:N,initialFocus:J}=a,D=y(a,["children","id","isOpen","mainButton","secondaryButton","alternativeButton","title","noPadding","onCloseClick","onBackgroundClick","onKeyDown","hasDividers","maxHeight","maxWidth","placement","zIndex","ariaLabel","ariaModal","ariaLabelledBy","initialFocus"]),V;const A=(0,o.useRef)(null),ae=n?`${n}-modal-title`:"modal-title",U=!!(s||d||m),Z=B=>{if(f){B.stopPropagation(),f(B);return}g(B)};return(0,o.useEffect)(()=>{if(!l||!A.current)return;const B=A.current.parentElement;return B?(Array.from(B.children).filter(K=>K!==A.current&&K instanceof HTMLElement).forEach(K=>{K.hasAttribute("aria-hidden")||(K.setAttribute("aria-hidden","true"),K.setAttribute("data-lens-modal-hidden","true"))}),()=>{document.querySelectorAll("[data-lens-modal-hidden]").forEach(ge=>{ge.removeAttribute("aria-hidden"),ge.removeAttribute("data-lens-modal-hidden")})}):void 0},[l]),o.createElement(dl,i({ref:A,isOpen:l,zIndex:I},D),o.createElement(oe,{height:"100%",onClick:Z,onKeyDown:C},o.createElement(wl,{ref:t,id:n,isOpen:l,maxHeight:z,maxWidth:E,placement:M,onCloseClick:g,ariaLabel:P,ariaModal:_,ariaLabelledBy:(V=N??ae)!=null?V:void 0,initialFocus:J},o.createElement(hl,{rows:`${v?"auto ":""} ${r?"1fr ":""} ${U?"auto":""}`},v&&o.createElement(pl,{bottom:r?"var(--lns-space-medium)":"var(--lns-space-xlarge)"},o.createElement(xe,{htmlTag:"h1",variant:"title",id:ae},v)),o.createElement(bl,{noPadding:p,hasDividers:x,hasTitle:Boolean(v),hasButtons:U},r&&r),U&&o.createElement(fl,{top:r?"var(--lns-space-xlarge)":0,hasDividers:x},m,o.createElement(gl,null,d&&o.createElement(nt,{right:"small",isInline:!0},d),s))))))}),t0=null,wt={neutral:{color:c("inherit"),focusRing:be(),underline:"inactive"},primary:{color:c("primary"),focusRing:be(),underline:"inactive"},subtle:{color:c("body"),focusRing:be(),underline:"hover"}},Vr={enabled:$.iv`
    cursor: pointer;
  `,disabled:$.iv`
    pointer-events: none;
    color: ${c("disabledContent")};
...
`,r0=e=>{var t=e,{children:a,href:r,variant:n="primary",htmlTag:l="a",isDisabled:s,noWrap:d}=t,m=y(t,["children","href","variant","htmlTag","isDisabled","noWrap"]);return React30.createElement(yl,i({href:r,variant:n,as:l,disabled:s,noWrap:d},m),a)},a0=Object.keys(wt),n0=null,Wr={small:{padding:`${u(1.5)} ${u(1.75)}`,textSize:"small"},medium:{padding:`${u(1.5)} var(--lns-formFieldHorizontalPadding)`,textSize:"medium"}},zl=h.Z.textarea`
  width: 100%;
  border: none;
  font-family: inherit;
  color: inherit;
...
`,l0=o.forwardRef((e,t)=>{var a=e,{onChange:r,value:n,rows:l=4,isDisabled:s,placeholder:d,size:m="medium",resize:v="both",error:p=null}=a,g=y(a,["onChange","value","rows","isDisabled","placeholder","size","resize","error"]);return o.createElement(o.Fragment,null,o.createElement(zl,i({disabled:s,onChange:r,placeholder:d,ref:t,rows:l,value:n,size:m,resize:v,error:p},g)),p?o.createElement(o.Fragment,null,o.createElement(nt,{bottom:"xmsall"}),o.createElement(xe,{color:"danger",fontWeight:"regular",size:"body-md"},p)):null)}),o0=null,xl=h.Z.div`
  position: relative;
`,$l=h.Z.ul`
  list-style: none;
  margin: 0;
...
`,Rl=h.Z.span`
  ...
  grid-column-start: 1;
  grid-column-end: 3;
`,Et=e=>Array.isArray(e)&&e.length>0&&"group"in e[0],Pr=({options:e,selectedOptionValue:t})=>{if(!e||!t)return{icon:null,title:null};if(Et(e))for(const a of e){const r=a.items.find(n=>n.value===t);if(r)return r}else return e.find(r=>r.value===t)||{icon:null,title:null};return{icon:null,title:null}},Ml=({options:e,selectedItem:t,selectedOptionValue:a})=>{if(t)return t.icon;if(a)return Pr({options:e,selectedOptionValue:a}).icon},Ll=({options:e,selectedItem:t,selectedOptionValue:a,placeholder:r})=>t?t.title:a?Pr({options:e,selectedOptionValue:a}).title:r,kl=({selectedItem:e,getInputProps:t,ariaMenuName:a})=>{const r=e?`selected value is ${e.title}`:"no value selected";return{"aria-activedescendant":t()["aria-activedescendant"],"aria-label":[a,r].filter(Boolean).join(", ")}},_l=h.Z.button`
  position: relative;
  width: 100%;
  background: none;
  border: none;
...
`,Ol=h.Z.img`
  ...
  object-fit: cover;
  opacity: ${({isDisabled:e})=>e?.5:1};
`,Dl=({selectedItem:e,selectedOptionValue:t,placeholder:a,isDisabled:r,options:n,getInputProps:l,ariaMenuName:s,isOpen:d,onInputFocus:m,hasError:v,hasLoader:p,inputValue:g,handleInputValueChange:f,inputRef:C,id:x})=>{const z=Ml({options:n,selectedItem:e,selectedOptionValue:t}),E=Boolean(z),M=r?"disabledContent":void 0,I=()=>{r||m()},P=i(i({role:"combobox","aria-autocomplete":"list","aria-haspopup":"listbox","aria-expanded":d},kl({selectedItem:e,getInputProps:l,ariaMenuName:s})),l({id:x,"aria-labelledby":void 0,disabled:r,onFocus:I,onClick:I,value:g,onBlur:()=>{f("")},onChange:N=>f(N.target.value)})),_=!g&&!t;return o.createElement(_l,{onClick:I,disabled:r},E&&o.createElement(Sl,null,typeof z=="string"?o.createElement(oe,{radius:"50",width:3,height:3,overflow:"hidden"},o.createElement(Ae,{alignment:"center"},o.createElement(Ol,{src:z,alt:"",isDisabled:r}))):o.createElement(ee,{icon:z,color:M})),o.createElement(Hl,R(i({ref:C},P),{hasIcon:E,hasAddOn:!0,hasError:v,isDisabled:r})),!g&&o.createElement(Bl,{hasIcon:E},o.createElement(xe,{hasEllipsis:!0,color:_?"bodyDimmed":"inherit"},Ll({options:n,selectedItem:e,selectedOptionValue:t,placeholder:a}))),o.createElement(Il,null,p?o.createElement(Ot,{size:"small"}):o.createElement(ee,{icon:o.createElement(Mr,null),color:M})))},Ar=(e,t)=>{var a;if(Et(t))for(const r of t){const n=r.items.find(l=>l.value===e);if(n)return n}else return(a=t.find(r=>r.value===e))!=null?a:null;return null},Vl=(e,t)=>(e||null)!=t?.value,Tr=(e,t,a,r,n,l)=>{const s=!a&&e.value===r||a&&a.value===e.value;return o.createElement(At,R(i({key:t,getItemProps:l,icon:e.icon,hidden:e.hidden},l({key:`${e.value}-${t}`,index:t,item:e,disabled:e.isDisabled,"aria-selected":s})),{isDisabled:e.isDisabled,hasDivider:e.hasDivider,isHighlighted:n===t,isSelected:s}),e.title)},Wl=e=>{var t=e,{options:a,selectedItem:r,selectedOptionValue:n,highlightedIndex:l,getItemProps:s,isLoading:d,loadingMessage:m,emptyResultsMessage:v,hasAvailableOptions:p}=t,g=y(t,["options","selectedItem","selectedOptionValue","highlightedIndex","getItemProps","isLoading","loadingMessage","emptyResultsMessage","hasAvailableOptions"]);const f=m||o.createElement(Ot,null),C=v||"No results";if(d)return o.createElement(Fe,i({as:"div"},g),o.createElement(oe,{padding:"large"},o.createElement(Ae,{alignment:"center"},f)));if(!p)return o.createElement(Fe,i({as:"div"},g),o.createElement(oe,{padding:"large"},o.createElement(Ae,{alignment:"center"},C)));if(!Et(a))return o.createElement(Fe,i({},g),a.map((z,E)=>Tr(z,E,r,n,l,s)));let x=0;return o.createElement(Fe,i({},g),a.map(z=>{const E=`group-${z.group.replace(/\s+/g,"-")}`;return o.createElement("li",{key:E},o.createElement(nt,{left:"medium",top:"small",bottom:"xsmall"},o.createElement(xe,{id:E,size:"body-sm",fontWeight:"bold",htmlTag:z.headingTag||"h2"},z.group)),o.createElement($l,{role:"group","aria-labelledby":E},z.items.map(M=>Tr(M,x++,r,n,l,s))))}))},Pl=(0,o.forwardRef)((e,t)=>{var a=e,{container:r,onOptionChange:n,onInputValueChange:l,menuZIndex:s=1100,menuMaxWidth:d,menuMaxHeight:m=34,menuMinWidth:v,ariaMenuName:p,selectedOptionValue:g,onOuterClick:f,options:C,placeholder:x,menuPosition:z="left",isDisabled:E,onOpenChange:M,isLoading:I,loadingMessage:P,emptyResultsMessage:_,errorMessage:N,id:J}=a,D=y(a,["container","onOptionChange","onInputValueChange","menuZIndex","menuMaxWidth","menuMaxHeight","menuMinWidth","ariaMenuName","selectedOptionValue","onOuterClick","options","placeholder","menuPosition","isDisabled","onOpenChange","isLoading","loadingMessage","emptyResultsMessage","errorMessage","id"]);const V=Wt(r),A=(0,o.useRef)(null),ae=(0,o.useCallback)(W=>{A.current=W,t&&(typeof t=="function"?t(W):t.current=W)},[t]),[U,Z]=(0,o.useState)(""),[B,ne]=(0,o.useState)(!1),[K,ge]=(0,o.useState)(Ar(g,C)),[Me,L]=(0,o.useState)(K),te=W=>{Z(W),l&&l(W)},Le={itemToString:W=>W?W.value:"",onChange:W=>{const Ee=W||null;L(Ee),n&&n(Ee)},onOuterClick:f,environment:V,selectedItem:Me,isOpen:B};V&&(Le.environment=V);const{layerProps:Se,triggerProps:we,renderLayer:k,triggerBounds:H}=(0,Ie.sJ)({isOpen:B,container:r,ResizeObserver:it.Z,placement:Pt[z],auto:!0,snap:!0});(0,o.useEffect)(()=>{if(Vl(g,K)){const W=Ar(g,C);ge(W),L(W),Z("")}},[g,C,K]),(0,o.useEffect)(()=>{var W;M&&M(B),B||(W=A.current)==null||W.blur()},[B,M]);const ke=(0,o.useMemo)(()=>Array.isArray(C)?Et(C)?C.some(W=>W.items.length>0):C.length>0:!1,[C]),zt=(W,Ee)=>{if(Ee.isOpen!==void 0){if(Ee.type===ye.ZP.stateChangeTypes.keyDownEscape)return ne(!1),{isOpen:!1};ne(Ee.isOpen)}return Ee};return o.createElement(xl,i({},D),o.createElement(ye.ZP,R(i({},Le),{stateReducer:zt}),({getItemProps:W,getInputProps:Ee,getMenuProps:Gt,isOpen:Qe,highlightedIndex:Ri,selectedItem:da})=>o.createElement("div",{role:"presentation"},o.createElement("div",i({},we),o.createElement(Dl,{inputRef:ae,selectedItem:da,selectedOptionValue:g,placeholder:x,isDisabled:E,options:C,getInputProps:Ee,ariaMenuName:p,inputValue:U,handleInputValueChange:te,isOpen:B&&Qe,onInputFocus:()=>{ne(!0)},hasLoader:I,hasError:Boolean(N),id:J})),B&&Qe&&k(o.createElement("div",R(i({},Se),{style:R(i({},Se.style),{zIndex:s,width:v?"auto":H?.width})}),o.createElement(Wl,{options:C,selectedItem:da,selectedOptionValue:g,hasAvailableOptions:ke,highlightedIndex:Ri,getItemProps:W,isLoading:I,loadingMessage:P,emptyResultsMessage:_,position:z,downshiftMenuProps:Gt,maxWidth:d,maxHeight:m,minWidth:v}))),Boolean(N)&&!B?o.createElement(Rl,null,N):null)))});Pl.displayName="Typeahead";var i0=null,Al=({ariaMenuName:e,getInputProps:t,isOpen:a})=>({"aria-activedescendant":t()["aria-activedescendant"],"aria-expanded":a,"aria-label":e||""}),Tl=h.Z.div`
  display: inline-block;
  vertical-align: middle;
`,s0=e=>{var t=e,{ariaMenuName:a,menuPosition:r="left",menuZIndex:n=1100,options:l,trigger:s,triggerCallback:d,isOpen:m,menuMinWidth:v=24,menuMaxWidth:p=48,menuMaxHeight:g,container:f,onOuterClick:C,triggerOffset:x=0,onOpenChange:z,search:E,role:M,menuItemRole:I}=t,P=y(t,["ariaMenuName","menuPosition","menuZIndex","options","trigger","triggerCallback","isOpen","menuMinWidth","menuMaxWidth","menuMaxHeight","container","onOuterClick","triggerOffset","onOpenChange","search","role","menuItemRole"]);const _=Wt(f),[N,J]=useState3(!1),[D,V]=useState3(!1),[A,ae]=useState3(""),U=L=>{const te=L.target.value;ae(te)},Z=L=>{switch(L.key){case"ArrowDown":case"ArrowUp":case"ArrowLeft":case"ArrowRight":case"Enter":case" ":case"Tab":case"Escape":V(!0);break;default:break}},B=m||N,{layerProps:ne,triggerProps:K,renderLayer:ge}=useLayer3({isOpen:B,container:f,placement:Pt[r],ResizeObserver:ResizeObserver3,auto:!0,snap:!0,triggerOffset:x});useEffect5(()=>{z&&z(B)},[B,z]);const Me=(L,te)=>(te.isOpen!==void 0&&J(te.isOpen),te);return l=useMemo3(()=>E?E.searchType==="startsWith"?l.filter(L=>Pe(L.title).toLowerCase().startsWith(A.toLowerCase())):l.filter(L=>Pe(L.title).toLowerCase().includes(A.toLowerCase())):l,[l,A,E]),React33.createElement(Downshift3,{stateReducer:Me,itemToString:L=>L?L.title:"",onSelect:L=>L&&!L.disabled&&L.onClick&&L.onClick(),onOuterClick:C,environment:_},({getInputProps:L,getItemProps:te,getMenuProps:Je,getToggleButtonProps:Le,highlightedIndex:Se,isOpen:we})=>React33.createElement("div",i(i({},P),d?{role:null,"aria-haspopup":null,"aria-expanded":null,"aria-labelledby":null}:{}),React33.createElement("div",i({},K),d?d(i(i({},Le({onKeyDown:Z})),Al({ariaMenuName:a,getInputProps:L,isOpen:we}))):React33.createElement(Tl,i({},Le({onKeyDown:Z,tabIndex:0})),s)),we&&ge(React33.createElement("div",R(i({},ne),{style:R(i({},ne.style),{zIndex:n})}),React33.createElement(Fe,{position:r,minWidth:v,maxWidth:p,maxHeight:g,downshiftMenuProps:()=>Je({onKeyDown:Z}),role:M,search:E&&React33.createElement(Lr,{ariaLabel:E.searchPlaceholder,placeholder:E.searchPlaceholder,value:A,onChange:U,getInputProps:L})},l.map((k,H)=>React33.createElement(At,i({key:H,isHighlighted:Se===H,keyboardMove:D&&Se===H,isDisabled:k.disabled,isSelected:k.selected,icon:k.icon,hasDivider:k.hasDivider,getItemProps:te,menuItemRole:I,index:H},te({key:H,index:H,item:k,disabled:k.disabled,onMouseMove:()=>{D&&V(!1)}})),k.title)))))))},c0=null,Fl=h.Z.label`
  display: block;
  position: relative;
...
`,Nl=(0,o.forwardRef)((e,t)=>{var a=e,{isDisabled:r,isChecked:n,onFocus:l,onChange:s,onBlur:d}=a,m=y(a,["isDisabled","isChecked","onFocus","onChange","onBlur"]);return o.createElement(Fl,{htmlFor:m.id},o.createElement(Zl,i({type:"radio",disabled:r,checked:n,onFocus:l,onChange:s,onBlur:d,ref:t},m)),o.createElement(jl,{className:"RadioBox"}))}),Ul=Nl,Re={medium:{switchHeight:16,switchWidth:32,knobOffset:2},large:{switchHeight:20,switchWidth:36,knobOffset:2}},Ye={knob:{active:{enabled:c("white"),disabled:c("disabledContent")},inactive:{enabled:c("white"),disabled:c("disabledContent")}},track:{active:{enabled:c("blurple"),disabled:c("disabledBackground")},inactive:{enabled:c("grey6"),disabled:c("disabledBackground")}}},Kl=e=>Re[e.switchSize].switchWidth-Re[e.switchSize].switchHeight,Fr=e=>Re[e.switchSize].switchHeight-Re[e.switchSize].knobOffset*2,Gl=h.Z.label`
  display: block;
  position: relative;
`,Yl=h.Z.input`
  position: absolute;
  ...
  z-index: 1;
  margin: 0;
  width: ${e=>Re[e.switchSize].switchWidth}px;
  height: ${e=>Re[e.switchSize].switchHeight}px;
...
`,Xl=h.Z.div`
  ...
  &:after {
    content: '';
    position: absolute;
    top: ${e=>Re[e.switchSize].knobOffset}px;
    left: ${e=>Re[e.switchSize].knobOffset}px;
    width: ${e=>Fr(e)}px;
    height: ${e=>Fr(e)}px;
    border-radius: var(--lns-radius-full);
    transition: 0.15s;
...
`,Jl=e=>{var t=e,{isActive:a,isDisabled:r,onChange:n,size:l="medium",ariaLabelledby:s,ariaLabel:d,ariaDescribedby:m}=t,v=y(t,["isActive","isDisabled","onChange","size","ariaLabelledby","ariaLabel","ariaDescribedby"]);if(s&&d)throw new Error("ariaLabelledby and ariaLabel serve the same purpose and therefore cannot be used at the same time. Choose the one that best suites your needs.");return o.createElement(Gl,{htmlFor:v.id},o.createElement(Yl,R(i({},v),{checked:a,disabled:r,onChange:n,type:"checkbox",switchSize:l,"aria-labelledby":s,"aria-label":d,"aria-describedby":m,"aria-checked":a})),o.createElement(Xl,{className:"SwitchBox",isDisabled:r,isActive:a,switchSize:l}))},Ql=Jl,Zr={row:{wrapper:{display:"grid",gridTemplateColumns:"auto 1fr",alignItems:"center"},label:{marginLeft:"var(--lns-space-small)"},errorMessage:{marginLeft:"var(--lns-space-small)"}},"row-reverse":{wrapper:{display:"grid",gridTemplateColumns:"1fr auto",alignItems:"center"},label:{}},column:{wrapper:{},label:{marginBottom:"var(--lns-space-xsmall)"}}},ql=h.Z.div`
...
`,g0=({children:e,onCloseClick:t,isOpen:a,severity:r="info",id:n})=>{var l,s,d;useEffect7(()=>{if(!a)return;const v=p=>{p.key==="Escape"&&(p.preventDefault(),t&&t())};return window.addEventListener("keydown",v),()=>{window.removeEventListener("keydown",v)}},[a,t]),no(a);const m=r==="internal";return a?React40.createElement(io,{isOpen:a,severity:r,id:n},React40.createElement(Te,{alignItems:{default:"start",small:"center"},justifyContent:"space-between",autoFlow:m?"column":void 0,columns:m?void 0:["1fr auto"]},React40.createElement(oe,{paddingY:{default:"xsmall",xsmall:0},paddingLeft:m?void 0:{default:0,medium:u(3.5)},width:"100%"},React40.createElement(Te,{autoFlow:"column",gap:m?"medium":"small",justifyContent:"center"},(l=Ze[r])!=null&&l.icon?React40.createElement(Ae,{alignment:"topLeft"},React40.createElement(ee,{icon:Ze[r].icon,color:(s=Ze[r].color)!=null?s:"var(--lns-color-white)"})):null," ",e))),t&&React40.createElement(Vt,{iconColor:(d=Ze[r].color)!=null?d:"var(--lns-color-white)",tabIndex:0,altText:"Close",icon:React40.createElement(Ft,null),onClick:t})):null},p0=null,Nr="web-app",Zt="chrome-extension",so={short:3e3,long:8e3},co=(e,t)=>$.F4`
  0% {
    opacity: 0;
    transform: translate(-50%, ${u(t===Zt?-8:8)});
  }
...
`,uo=e=>{switch(e){case Nr:return"unset";case Zt:return u(4);default:return"unset"}},ho=e=>{switch(e){case Nr:return u(4);case Zt:return"unset";default:return u(4)}},mo=h.Z.div`
...
`,vo=h.Z.div`
  align-self: center;
`,f0=({children:e,isOpen:t,onCloseClick:a,zIndex:r=1100,duration:n="short",platform:l="web-app"})=>{const s=so[n];return useEffect8(()=>{const d=setTimeout(()=>{t&&a()},s);return()=>clearTimeout(d)},[t]),React41.createElement(React41.Fragment,null,t&&React41.createElement(mo,{role:"presentation",onClick:d=>d.stopPropagation(),zIndex:r,isOpen:t,toastDuration:s,platform:l},React41.createElement(vo,{"aria-live":"polite"},e),a&&React41.createElement(Vt,{altText:"Close",icon:React41.createElement(Ft,null),onClick:a,iconColor:"bodyInverse"})))},b0=null,Ur={topLeft:"top-start",topCenter:"top-center",topRight:"top-end",bottomLeft:"bottom-start",bottomCenter:"bottom-center",bottomRight:"bottom-end",leftTop:"left-start",leftCenter:"left-center",leftBottom:"left-end",rightTop:"right-start",rightCenter:"right-center",rightBottom:"right-end"},go=4,po=De.small.fontSize*De.small.lineHeight,fo=(go-po)/2,bo=h.Z.div`
  background-color: ${c("backgroundInverse")};
  color: ${c("bodyInverse")};
  ${F("150")};
  ${Oe("bold")};
...
`,Co=h.Z.div`
  ...
  padding-left: ${u(.5)};
  padding-right: ${u(.5)};
`,wo=({children:e})=>o.createElement(Co,null,e),Eo=e=>{var t=e,{children:a,maxWidth:r,onMouseEnter:n,onMouseLeave:l,layerProps:s,zIndex:d}=t,m=y(t,["children","maxWidth","onMouseEnter","onMouseLeave","layerProps","zIndex"]);return o.createElement(bo,i(i({maxWidth:r,onMouseEnter:n,onMouseLeave:l,zIndex:d},s),m),a)},yo=h.Z.div`
  display: ${e=>e.isInline?"inline-block":"block"};
...
`;function zo(e){switch(e){case"immediate":return 200;case"long":return 800;default:return 200}}var xo=e=>{var t=e,{ariaLive:a=!1,children:r,content:n,shortcut:l,placement:s="topCenter",keepOpen:d,triggerOffset:m=4,maxWidth:v=26,isInline:p=!0,isDisabled:g,container:f,tabIndex:C=0,zIndex:x=1100,verticalAlign:z="middle",delay:E="immediate",tooltipId:M}=t,I=y(t,["ariaLive","children","content","shortcut","placement","keepOpen","triggerOffset","maxWidth","isInline","isDisabled","container","tabIndex","zIndex","verticalAlign","delay","tooltipId"]);const[P,_]=(0,Ie.XI)({delayEnter:zo(E),delayLeave:200}),[N,J]=(0,o.useState)(!1),[D,V]=(0,o.useState)(!1),[A,ae]=(0,o.useState)(!1),U=(0,o.useRef)(),Z=!n||g;(0,o.useEffect)(()=>{if(Z){V(!1);return}const L=N&&d;(P||L)&&V(!0),!P&&!L&&!A&&V(!1)},[n,g,N,Z,d,V,P,A]);const B=()=>{ae(!1),Z||V(!0)},ne=()=>{V(!1),ae(!1)};(0,o.useEffect)(()=>{if(!D)return;const L=te=>{te.key==="Escape"&&(te.preventDefault(),ne())};return window.addEventListener("keydown",L),()=>{window.removeEventListener("keydown",L)}},[D,V]);const{layerProps:K,triggerProps:ge,renderLayer:Me}=(0,Ie.sJ)({isOpen:D,placement:Ur[s],ResizeObserver:it.Z,triggerOffset:m,container:f,auto:!0});return o.createElement(o.Fragment,null,o.createElement(yo,R(i(i({},ge),_),{onClick:L=>{L.detail===0&&ae(!0)},onFocus:B,onBlur:ne,isInline:p,verticalAlign:z,tabIndex:Z?-1:C,ref:(0,Ie.lq)(ge.ref,U)}),r),a&&o.createElement("span",{className:"srOnly","aria-live":"polite"},D&&n),D&&Me(o.createElement("div",R(i({},K),{style:R(i({},K.style),{zIndex:x})}),o.createElement(Eo,i({maxWidth:v,onMouseEnter:()=>J(!0),onMouseLeave:()=>J(!1),role:"tooltip",id:M},I),o.createElement(Te,{gap:"small"},o.createElement(xe,{size:"small",fontWeight:"bold"},n),l&&o.createElement(Te,{gap:"xsmall"},l.map((L,te)=>o.createElement(wo,{key:te},L))))))))},C0=Object.keys(Ur),$o=xo,Kr=$.iv`
...
`,y0=e=>{var t=e,{variant:a="combined",maxWidth:r,symbolColor:n,wordmarkColor:l="body",brand:s="loom",customId:d=""}=t,m=y(t,["variant","maxWidth","symbolColor","wordmarkColor","brand","customId"]);return React44.createElement(Ho,i({variant:a,maxWidth:r},m),a==="combined"&&React44.createElement(_o,{brand:s,symbolColor:n,wordmarkColor:c(l),customId:d,className:"lns-logoSvg"}),a==="symbol"&&React44.createElement(Lo,{brand:s,symbolColor:n,customId:d,className:"lns-logoSvg"}),a==="wordmark"&&React44.createElement(ko,{brand:s,wordmarkColor:c(l),className:"lns-logoSvg"}))},z0=null,So="https://cdn.loom.com/assets/lens",Jr={small:"40px",medium:"80px"},Io=h.Z.span`
  animation: ${e=>e.animation};
  background-image: url(${So}/${e=>e.brand}-loader.svg);
...
`,x0=({animation:e="spin 2s infinite steps(49) forwards",brand:t="loom",size:a="medium"})=>React45.createElement(Io,{animation:e,brand:t,size:a}),$0=null,jt="/* emotion-disable-server-rendering-unsafe-selector-warning-please-do-not-use-this-the-warning-exists-for-a-reason */",Bo={border:$.iv`
...
`,Vo=e=>{var t=e,{children:a,htmlTag:r="li",className:n,backgroundColor:l,onClick:s,href:d,role:m}=t,v=y(t,["children","htmlTag","className","backgroundColor","onClick","href","role"]);const p=n?` ${n}`:"",g=["div","span","p","h1","h2","h3","h4","h5","h6","section","article","header","footer","main","aside","nav"],f=!r&&s;let C=!1;const x=r||"div";f||(C=g.includes(x));const z=!C||f?{onClick:s,onKeyDown:E=>{E.key==="Enter"&&(E.preventDefault(),s?.(E))}}:{};return React46.createElement(Do,i(i({role:m||(r==="li"?"listitem":void 0),className:`ListRowWrapper${p}`,as:r,backgroundColor:l,href:d},z),v),a)},Wo=e=>e.map(t=>fe(t)).join(" "),R0=e=>{var t=e,{children:a,columns:r,gap:n,variant:l="stripe",htmlTag:s="ul"}=t,d=y(t,["children","columns","gap","variant","htmlTag"]);let m=a;return s==="ul"&&(m=React46.Children.map(a,v=>React46.isValidElement(v)&&v.type===Vo?React46.cloneElement(v,{htmlTag:"li"}):v)),React46.createElement(Oo,i({as:s,columns:r&&Wo(r),gap:n,variant:l,role:s==="ul"?"list":void 0},d),m)},M0=null,yt=o.createContext({}),Po=e=>`calc(-1 * ${fe(e)})`,Qr=h.Z.div`
  ${e=>e.scrollOffset&&`margin: 0 ${Po(e.scrollOffset)};
  `};
`,qr=h.Z.div`
...
`,L0=e=>{var t=e,{children:a,isActive:r,htmlTag:n="button",icon:l,isDisabled:s=!1}=t,d=y(t,["children","isActive","htmlTag","icon","isDisabled"]);const{isPilledDesign:m}=React47.useContext(yt);return m?React47.createElement(ra,i({as:n,isActive:r,icon:l,role:"tab","aria-selected":r,disabled:s},d),l&&React47.createElement(oe,{htmlTag:"span",paddingRight:a&&"small"},React47.createElement(ee,{icon:l,color:"currentColor"})),a):React47.createElement(ta,i({as:n,isActive:r,icon:l,role:"tab","aria-selected":r,disabled:s},d),l&&React47.createElement(oe,{htmlTag:"span",paddingRight:a&&"small"},React47.createElement(ee,{icon:l,color:"currentColor"})),a)},Ao=e=>{var t=e,{children:a,scrollOffset:r,hasFullTabs:n,isPilledDesign:l,hasBottomBorder:s=!1}=t,d=y(t,["children","scrollOffset","hasFullTabs","isPilledDesign","hasBottomBorder"]);const m=l?React47.createElement(ea,i({hasFullTabs:n,scrollOffset:r,role:"tablist"},d),a):React47.createElement(qr,i({hasFullTabs:n,scrollOffset:r,hasBottomBorder:s,role:"tablist"},d),a);return r?React47.createElement(Qr,{scrollOffset:r},m):React47.createElement(yt.Provider,{value:{isPilledDesign:l}},m)},To=({tooltipProps:e,children:t,tooltipId:a})=>e?o.createElement($o,R(i({},e),{tooltipId:a,tabIndex:-1}),t):t,aa=o.forwardRef((e,t)=>{var a=e,{tabContent:r,tooltipProps:n,isActive:l,htmlTag:s="button",icon:d,isDisabled:m=!1,onKeyDown:v,onClick:p}=a,g=y(a,["tabContent","tooltipProps","isActive","htmlTag","icon","isDisabled","onKeyDown","onClick"]);const{isPilledDesign:f}=o.useContext(yt),C=(0,o.useId)(),x=i({as:s,isActive:l,icon:d,role:"tab","aria-selected":l,disabled:m,tabIndex:l?0:-1,"aria-describedby":n?C:void 0,onKeyDown:v,onClick:p,ref:t},g);return o.createElement(To,{tooltipProps:n,tooltipId:C},f?o.createElement(ra,i({},x),d?o.createElement(oe,{htmlTag:"span",paddingRight:r&&"small"},o.createElement(ee,{icon:d,color:"currentColor"})):null,r):o.createElement(ta,i({},x),d?o.createElement(oe,{htmlTag:"span",paddingRight:r&&"small"},o.createElement(ee,{icon:d,color:"currentColor"})):null,r))});aa.displayName="TabNew";var Fo=e=>{var t=e,{tabs:a,scrollOffset:r,hasFullTabs:n,isPilledDesign:l,hasBottomBorder:s=!1}=t,d=y(t,["tabs","scrollOffset","hasFullTabs","isPilledDesign","hasBottomBorder"]);const m=useRef5({}),v=useCallback4((x,z)=>{var E;let M=z;switch(x.key){case"ArrowLeft":x.preventDefault(),M=z>0?z-1:a.length-1;break;case"ArrowRight":x.preventDefault(),M=z<a.length-1?z+1:0;break;case"Home":x.preventDefault(),M=0;break;case"End":x.preventDefault(),M=a.length-1;break;default:return}(E=m.current[M])==null||E.focus()},[a.length]),p=useCallback4(x=>z=>{m.current[x]=z},[]),g=useMemo4(()=>a.map((x,z)=>React47.createElement(aa,i({key:z,ref:p(z),onKeyDown:E=>v(E,z)},x))),[a,v,p]),f=useMemo4(()=>l?React47.createElement(ea,i({hasFullTabs:n,scrollOffset:r,role:"tablist"},d),g):React47.createElement(qr,i({hasFullTabs:n,scrollOffset:r,hasBottomBorder:s,role:"tablist"},d),g),[g,n,r,s,l,d]),C=React47.createElement(yt.Provider,{value:{isPilledDesign:l}},f);return r?React47.createElement(Qr,{scrollOffset:r},C):C},k0=e=>{var t=e,{children:a,tabs:r}=t,n=y(t,["children","tabs"]);return a&&r&&console.warn("Both children and tabs props are provided. Please use only one of them."),!a&&!r?(console.error("Either children or tabs must be provided."),null):a?React47.createElement(Ao,i({},n),a):React47.createElement(Fo,i({tabs:r},n))},_0=null,Zo=h.Z.div`
  display: inline-grid;
  grid-auto-flow: column;
  align-items: center;
  vertical-align: middle;
  ...
  ${Oe("bold")};
  ${b("gap","xsmall")};
`,H0=e=>{var t=e,{color:a,backgroundColor:r,children:n,icon:l,iconPosition:s="left"}=t,d=y(t,["color","backgroundColor","children","icon","iconPosition"]);const m=React48.createElement(oe,{htmlTag:"span",paddingLeft:s==="right"&&"xsmall",paddingRight:s==="left"&&"xsmall"},React48.createElement(ee,{icon:l,color:"currentColor",size:2}));return React48.createElement(Zo,i({color:a,backgroundColor:r},d),l&&s==="left"&&m,n,l&&s==="right"&&m)},S0=null,jo={topLeft:"top-start",topCenter:"top",topRight:"top-end",bottomLeft:"bottom-start",bottomCenter:"bottom",bottomRight:"bottom-end",leftTop:"left-start",leftCenter:"left",leftBottom:"left-end",rightTop:"right-start",rightCenter:"right",rightBottom:"right-end"},No=h.Z.div`
  position: relative;
  width: fit-content;
...
`,na=h.Z.div`
  ${e=>e.zIndex&&`z-index: ${e.zIndex}`};
`,I0=e=>{var t=e,{children:a,content:r,offset:n=.5,boundaryOffset:l=.5,isOpen:s,zIndex:d=500,childrenZIndex:m=1,placement:v="topCenter",rootId:p,boundaryElement:g="body",transitionDuration:f=0,transitionDelay:C=0}=t,x=y(t,["children","content","offset","boundaryOffset","isOpen","zIndex","childrenZIndex","placement","rootId","boundaryElement","transitionDuration","transitionDelay"]);const z=n*Ke,E=l*Ke,M=typeof window<"u",I=p&&M?document.getElementById(p):void 0,{stage:P,shouldMount:_}=useTransition2(s,f+C),N=()=>g==="body"&&M?document.body:g,{x:J,y:D,reference:V,floating:A,strategy:ae,update:U,refs:Z}=useFloating({placement:jo[v],middleware:[shift({padding:E,boundary:g?N():void 0,limiter:limitShift()}),flip({fallbackPlacements:["top","bottom"],fallbackStrategy:"initialPlacement"}),floatingUiOffset(z)],strategy:"fixed"});useEffect10(()=>{if(!(!Z.reference.current||!Z.floating.current))return autoUpdate(Z.reference.current,Z.floating.current,U)},[Z.reference,Z.floating,U,_]);const B={zIndex:d,ref:A,style:{position:ae,top:D??"",left:J??"",transition:`opacity ${f}ms ${C}ms`,opacity:P==="enter"?1:0}};return React49.createElement(No,R(i({ref:V},x),{childrenZIndex:m}),a,_&&React49.createElement(React49.Fragment,null,!I&&React49.createElement(na,i({},B),r),I&&ReactDOM.createPortal(React49.createElement(na,i({},B),r),I)))},B0=null,Uo=h.Z.span`
  display: block;
...
`,O0=e=>{var t=e,{altText:a,illustration:r,color:n="orange",size:l=12}=t,s=y(t,["altText","illustration","color","size"]);return React50.createElement(Uo,i({"aria-hidden":"true","aria-label":a,color:n,size:l},s),r)},D0=null,la=e=>$.iv`
  ${b("width",e.width)};
  ${b("height",e.height)};
...
`,Ko=h.Z.div`
  display: flex;
  ${e=>ue("align-items",e.alignItems)};
  ${e=>e.justifyContent&&ue("justify-content",e.justifyContent)};
  ${e=>e.alignContent&&ue("align-content",e.alignContent)};
  ${e=>ue("flex-wrap",e.wrap)};
  ${e=>e.direction&&ue("flex-direction",e.direction)};
  ${e=>e.gap&&b("gap",e.gap)};
...
`,Go=h.Z.div`
  ...
  ${e=>la(e)};
`,Yo=e=>{var t=e,{children:a,grow:r,shrink:n,basis:l,width:s,height:d,minWidth:m,minHeight:v,maxWidth:p,maxHeight:g,htmlTag:f="div",className:C,style:x}=t,z=y(t,["children","grow","shrink","basis","width","height","minWidth","minHeight","maxWidth","maxHeight","htmlTag","className","style"]);return(C||x)&&console.warn(kt),React51.createElement(Go,i({as:f,grow:r,shrink:n,basis:l,width:s,height:d,minWidth:m,minHeight:v,maxWidth:p,maxHeight:g},z),a)},Xo=e=>{var t=e,{children:a,gap:r="initial",rowGap:n,columnGap:l,alignItems:s="center",justifyContent:d,alignContent:m,wrap:v="wrap",width:p,height:g,minWidth:f,minHeight:C,maxWidth:x,maxHeight:z,htmlTag:E="div",className:M,style:I}=t,P=y(t,["children","gap","rowGap","columnGap","alignItems","justifyContent","alignContent","wrap","width","height","minWidth","minHeight","maxWidth","maxHeight","htmlTag","className","style"]);return(M||I)&&console.warn(kt),React51.createElement(Ko,i({as:E,gap:r,rowGap:n,columnGap:l,alignItems:s,justifyContent:d,alignContent:m,wrap:v,width:p,height:g,minWidth:f,minHeight:C,maxWidth:x,maxHeight:z},P),E==="ul"||E==="ol"?Children.map(a,_=>_.type===Yo||_.type===Xo?cloneElement(_,{htmlTag:"li"}):_):a)},V0=null,Jo=h.Z.div`
...
`,ni=({swatches:e,currentColor:t,onSwatchClick:a})=>{const r=e.includes(t)&&t;return React52.createElement(ri,null,e.map(n=>React52.createElement(ai,{key:n,color:n,selected:r,onClick:()=>a(n),role:"button",tabIndex:0,onKeyDown:l=>{l.key==="Enter"&&(l.preventDefault(),a(n))}})))},li=({color:e,setColor:t})=>React52.createElement(Jo,null,React52.createElement(HexColorPicker,{color:e,onChange:t}),React52.createElement(qo,null,React52.createElement(HexColorInput,{prefixed:!0,color:e,onChange:t}),React52.createElement(ei,{color:e}))),W0=e=>{var t=e,{defaultColor:a="#ffffff",confirmButton:r,swatches:n,onChange:l}=t,s=y(t,["defaultColor","confirmButton","swatches","onChange"]);const[d,m]=useState6(a||"#FFFFFF"),v=g=>{m(g),l(g)},p=g=>{v(g)};return React52.createElement(Qo,i({},s),n&&React52.createElement(ni,{swatches:n,currentColor:d,onSwatchClick:p}),React52.createElement(li,{color:d,setColor:v}),r&&React52.createElement(ti,null,r))},P0=null,oi=2,Xe={small:{totalSize:u(2.25),height:u(.5625),dotSize:u(.375),gap:u(.25)},medium:{totalSize:u(3),height:u(.75),dotSize:u(.5),gap:u(.375)},large:{totalSize:u(6),height:u(1.5),dotSize:u(1),gap:u(.75)}},ii=e=>Xe[e.size].totalSize,si=e=>Xe[e.size].height,oa=e=>Xe[e.size].dotSize,ci=e=>Xe[e.size].gap,di=e=>Xe[e.size].dotSize,ui=e=>$.F4`
  0%, 40%, 100% {
    transform: translateY(50%);
  }
  20% {
...
`,A0=e=>{var t=e,{color:a="body",size:r="medium"}=t,n=y(t,["color","size"]);return React53.createElement(hi,i({size:r},n),React53.createElement(Nt,{color:a,size:r,delay:0}),React53.createElement(Nt,{color:a,size:r,delay:.2}),React53.createElement(Nt,{color:a,size:r,delay:.4}))},T0=Object.keys(Xe),F0=null,Ut={medium:{totalSize:u(3),barHeight:u(2.25)}},ia={fast:1.2,slow:1.7},mi="linear-gradient(270deg, #565ADD 10.58%, #DC43BE 41.83%, #565ADD 69.23%, #565ADD 96.63%)",vi=2,Kt=5,gi=u(.25),pi=e=>Ut[e.size||"medium"].barHeight,ot=e=>Ut[e.size||"medium"].totalSize,sa=e=>ia[e.speed||"fast"],fi=$.F4`
  0%, 100% {
...
`,Ei=h.Z.span`
  ...
  background-size: ${e=>ot(e)}
    ${e=>ot(e)};
  background-position: ${e=>{const a=(e.index+1)/(Kt+1)-.5;return`calc(${ot(e)} * ${a}) center`}};
  opacity: 0; /* Ensure it starts invisible */
  transform: scaleY(0.3);
  transform-origin: center;
  animation:
    ${Ci} 50ms ease-out forwards,
    ${fi} ${e=>sa(e)}s ease-in-out infinite,
    ${bi} ${vi}s linear infinite;

  animation-delay: ${e=>-1+e.index*(sa(e)/Kt)}s;
  position: relative;
`,Z0=e=>{var t=e,{size:a="medium",speed:r="fast",color:n="body"}=t,l=y(t,["size","speed","color"]);const s=Array.from({length:Kt},(d,m)=>React54.createElement(Ei,{key:m,index:m,size:a,speed:r,color:n}));return React54.createElement(wi,i({size:a,color:n},l),s)},j0=Object.keys(Ut),N0=Object.keys(ia),U0=null,yi=$.F4`
  0% {
    transform: scale(1);
    opacity: 0;
  }
...
`,He={dot:{size:"8px",borderWidth:"1px",borderColor:c("background")},positioning:{top:"-2px",right:"-2px"},animation:{duration:"2s",timing:"ease-out",iteration:"infinite"}},ca={blue:c("blue"),orange:c("orange")},zi=h.Z.span`
  position: relative;
  display: inline-block;
`,xi=h.Z.span`
  position: absolute;
