...
`,Te=e=>e&&`font-weight: var(--lns-fontWeight-${e});`,za=e=>e&&`var(--lns-fontSetting-${e});`,X=e=>e&&`border-radius: var(--lns-radius-${e});`,ct=e=>e&&`box-shadow: var(--lns-shadow-${e});`,Me=(e,t)=>{const a=e||c("focusRing");return`box-shadow:${t||""} 0 0 0 2px ${a};`},vt=e=>`
  ...
  `}
`,La=e=>{var t=e,{children:a,size:r="body-md",color:n,isInline:o,isDimmed:s,fontWeight:d="regular",hasEllipsis:m,ellipsisLines:v,noWrap:p,variant:g,htmlTag:f="span",alignment:C,sizeMinMax:x,fontSetting:z="normal"}=t,y=E(t,["children","size","color","isInline","isDimmed","fontWeight","hasEllipsis","ellipsisLines","noWrap","variant","htmlTag","alignment","sizeMinMax","fontSetting"]);return s&&console.warn($a),r.includes("heading-")&&(d="bold"),l.createElement(ka,i({size:g?St[g].size:r,color:n,isInline:o,isDimmed:s,fontWeight:g?St[g].fontWeight:d,hasEllipsis:m,ellipsisLines:v,noWrap:p,variant:g,as:f,alignment:C,sizeMinMax:x,fontSetting:z},y),a)},_a=["left","right","center"],Ie=La,bt=["top","bottom","left","right"],hr=i({0:"0"},pt),It=i({0:"0",auto:"auto"},pt),Ha=qt.map(e=>({selector:"c",modifier:e,declarations:[{property:"color",value:`var(--lns-color-${e})`}]})),Sa=qt.map(e=>({selector:"bgc",modifier:e,declarations:[{property:"background-color",value:`var(--lns-color-${e})`}]})),Ia=Object.keys(Fe).map(e=>({selector:"text",modifier:e,declarations:[{property:"font-size",value:`var(--lns-fontSize-${e})`},{property:"line-height",value:`var(--lns-lineHeight-${e})`},{property:"letter-spacing",value:`var(--lns-letterSpacing-${e})`},e.includes("heading-")||e.includes("xlarge")?{property:"font-weight",value:"var(--lns-fontWeight-bold)"}:{property:"font-weight",value:"var(--lns-fontWeight-regular)"}]})),Ba=Object.keys(lr).map(e=>({selector:"weight",modifier:e,declarations:[{property:"font-weight",value:`var(--lns-fontWeight-${e})`}]})),Oa=Object.entries(St).map(([e,t])=>({selector:"text",modifier:e,declarations:[{property:"font-size",value:`var(--lns-fontSize-${t.size})`},{property:"line-height",value:`var(--lns-lineHeight-${t.size})`},{property:"font-weight",value:`var(--lns-fontWeight-${t.fontWeight})`}]})),Da=_a.map(e=>({selector:"text",modifier:e,declarations:[{property:"text-align",value:e}]})),Va=Object.keys(_t).map(e=>({selector:"shadow",modifier:e,declarations:[{property:"box-shadow",value:`var(--lns-shadow-${e})`}]})),Wa=Object.keys(or).map(e=>({selector:"radius",modifier:e,declarations:[{property:"border-radius",value:`var(--lns-radius-${e})`}]})),dt=(e,t,a,r)=>{const n=[];return t.map(o=>{const s=r?`${e.charAt(0)}${o.charAt(0)}`:o;Object.keys(a).map(d=>{n.push({selector:s,property:`${e}${o&&e?`-${o}`:o||""}`,modifier:d,value:d==="auto"||d==="0"?d:`var(--lns-space-${d})`})})}),n},Pa=Object.values(dt("margin",["",...bt],It,"shortSides")).map(e=>({selector:e.selector,modifier:e.modifier,declarations:[{property:e.property,value:e.value}]})),Aa=Object.values(dt("margin",["x","y"],It,"shortSides")).map(e=>({selector:e.selector,modifier:e.modifier,declarations:[{property:e.property==="margin-x"?"margin-left":"margin-top",value:e.value},{property:e.property==="margin-x"?"margin-right":"margin-bottom",value:e.value}]})),Ta=Object.values(dt("padding",["",...bt],hr,"shortSides")).map(e=>({selector:e.selector,modifier:e.modifier,declarations:[{property:e.property,value:e.value}]})),Fa=Object.values(dt("padding",["x","y"],hr,"shortSides")).map(e=>({selector:e.selector,modifier:e.modifier,declarations:[{property:e.property==="padding-x"?"padding-left":"padding-top",value:e.value},{property:e.property==="padding-x"?"padding-right":"padding-bottom",value:e.value}]})),Za=["",...bt].map(e=>{const t="border"+e.replace(e.charAt(0),e.charAt(0).toUpperCase()),a=`border${e&&`-${e}`}`;return{selector:t,declarations:[{property:a,value:"1px solid var(--lns-color-border)"}]}}),ja=["inline","block","flex","inlineBlock","inlineFlex","none"],Na=ja.map(e=>({selector:e,declarations:[{property:"display",value:gt(e)}]})),Ua=[{selector:"flexWrap",declarations:[{property:"flex-wrap",value:"wrap"}]}],Ka=["column","row"],Ga=Ka.map(e=>({selector:"flexDirection",modifier:e,declarations:[{property:"flex-direction",value:e}]})),Ya=["stretch","center","baseline","flexStart","flexEnd","selfStart","selfEnd"],Xa=Ya.map(e=>({selector:"items",modifier:e,declarations:[{property:"align-items",value:gt(e)}]})),Ja=["flexStart","flexEnd","center","spaceBetween","spaceAround","spaceEvenly"],Qa=Ja.map(e=>({selector:"justify",modifier:e,declarations:[{property:"justify-content",value:gt(e)}]})),qa=["0","1"],en=qa.map(e=>({selector:"grow",modifier:e,declarations:[{property:"flex-grow",value:e}]})),tn=["0","1"],rn=tn.map(e=>({selector:"shrink",modifier:e,declarations:[{property:"flex-shrink",value:e}]})),an=["auto","flexStart","flexEnd","center","baseline","stretch"],nn=an.map(e=>({selector:"self",modifier:e,declarations:[{property:"align-self",value:gt(e)}]})),ln=["hidden","auto"],on=ln.map(e=>({selector:"overflow",modifier:e,declarations:[{property:"overflow",value:e}]})),sn=["relative","absolute","sticky","fixed"],cn=sn.map(e=>({selector:e,declarations:[{property:"position",value:e}]})),dn=Object.values(dt("",bt,It)).map(e=>({selector:e.selector,modifier:e.modifier,declarations:[{property:e.property,value:e.value}]})),un=["auto","full","0"],hn=un.map(e=>({selector:"width",modifier:e,declarations:[{property:"width",value:e==="full"?"100%":e}]})),mn=[{selector:"minWidth",modifier:"0",declarations:[{property:"min-width",value:"0"}]}],vn=["auto","full","0"],gn=vn.map(e=>({selector:"height",modifier:e,declarations:[{property:"height",value:e==="full"?"100%":e}]})),pn=[{selector:"ellipsis",declarations:[{property:"overflow",value:"hidden"},{property:"text-overflow",value:"ellipsis"},{property:"white-space",value:"nowrap"}]}],fn=[{selector:"srOnly",declarations:[{property:"position",value:"absolute"},{property:"width",value:"1px"},{property:"height",value:"1px"},{property:"padding",value:"0"},{property:"margin",value:"-1px"},{property:"overflow",value:"hidden"},{property:"clip",value:"rect(0, 0, 0, 0)"},{property:"white-space",value:"nowrap"},{property:"border-width",value:"0"}]}],bn="\\:",mr=[...Ha,...Va,...Wa,...Sa,...Pa,...Aa,...Ta,...Fa,...Ia,...Ba,...Oa,...Da,...Za,...Na,...Ua,...Ga,...Xa,...Qa,...en,...rn,...nn,...on,...cn,...dn,...hn,...mn,...gn,...pn,...fn],vr=(e,t)=>{const a=[],r=t?`${t}-`:"";return e.map(n=>{const o=[];n.declarations.map(d=>{o.push(`${d.property}:${d.value}`)});const s=`.${r}${n.selector}${n.modifier?bn:""}${n.modifier?n.modifier:""}{${o.join(";")}}`;a.push(s)}),a.join("")},Cn={xs:Ze.xsmall,sm:Ze.small,md:Ze.medium,lg:Ze.large},wn=()=>(()=>{const t=[];return t.push(`${vr(mr)}`),Object.entries(Cn).map(([a,r])=>{t.push(`@media(min-width:${r}){${vr(mr,a)}}`)}),t.join("")})(),ke=(e,t)=>{const a={};return Object.entries(t).forEach(([r,n])=>{const s=`--lns-${(e?`${e}-`:"")+r}`;a[s]=n}),a},En=()=>{const e={};return Object.entries(Fe).forEach(([t,a])=>{const r={},n={},o={},s=`fontSize-${t}`,d=`lineHeight-${t}`,m=`letterSpacing-${t}`;r[s]=u(a.fontSize),r[d]=a.lineHeight,r[m]=a.letterSpacing,Object.assign(e,r,n,o)}),e},yn=()=>{const e={};return Object.entries(pt).forEach(([t,a])=>{const r=`space-${t}`;e[r]=u(a)}),e},zn=()=>{const e={};return Object.keys(i(i({},ze),it)).forEach(t=>{const a=t;e[a]=`hsla(${ge[t].h},${ge[t].s}%,${ge[t].l}%,${ge[t].a})`}),e},xn=()=>{const e=(t,a)=>Object.keys(t).reduce((r,n)=>{const o=t[n],s=`${a}-color-${n}`;return r[s]=o.ads?`var(${o.ads}, hsla(${o.h},${o.s}%,${o.l}%,${o.a}))`:`hsla(${o.h},${o.s}%,${o.l}%,${o.a})`,r},{});return i(i({},e(Qe.light,"themeLight")),e(Qe.dark,"themeDark"))},$n=ke(void 0,{unit:`${et/16}rem`}),Rn=ke("fontWeight",lr),Mn=ke("fontSetting",xa),kn=ke(void 0,En()),Ln=ke("radius",or),_n=ke("shadow",_t),Hn=ke(void 0,yn()),Sn=ke(void 0,{formFieldBorderWidth:"1px",formFieldBorderWidthFocus:"2px",formFieldHeight:u(4.5),formFieldRadius:"var(--lns-radius-175)",formFieldHorizontalPadding:u(2),formFieldBorderShadow:`
  ...
  `}),In=ke("color",zn()),Bn=ke(void 0,xn()),On=ke("gradient",ir),gr=[$n,kn,Ln,_n,Hn,Sn],Dn=()=>Object.assign({},...gr),Vn=()=>Object.assign({},Rn,...gr,Mn),Wn=()=>i(i(i({},In),Bn),On),Pn=()=>Object.keys(Qe.light).map(e=>`--lns-color-${e}: var(--lns-themeLight-color-${e});`),An=()=>Object.keys(Qe.dark).map(e=>`--lns-color-${e}: var(--lns-themeDark-color-${e});`),pr=(e=":root")=>`
    ${e||":root"},
    .theme-light,
...
`,Nn=h.Z.img`
  ...
  height: ${e=>{const{height:t}=je(e.size);return t}};
  font-size: ${e=>{const{fontSize:t}=je(e.size);return t}};
`,Vi=e=>{var t=e,{altText:a="",size:r=4,letter:n,imageSrc:o,children:s,themeColor:d="blue"}=t,m=E(t,["altText","size","letter","imageSrc","children","themeColor"]);const v=()=>{if(s)return s;if(o){const f=je(r).height,C=je(r).width;return React3.createElement(Nn,{size:r,alt:a,src:o,height:f,width:C})}if(n)return a?React3.createElement("span",{"aria-label":a},n):n},p=n&&!o&&!s,g=Fn(d||"blue");return React3.createElement(jn,i({hasBackgroundColor:p,size:r,backgroundColor:g.background,color:g.text},m),v())},Wi=null,fr=(e=":root",t="body")=>`
    ${e} {
      font-size: 100%;
    }
    ${t} {
    ...
    ${wn()}
  `,Pi=()=>React4.createElement(Global,{styles:css(fr())}),Ai=null,Un=3,Kn=h.Z.span`
  display: block;
  color: ${e=>c(e.color)};
...
`,Gn=e=>{var t=e,{altText:a,icon:r,color:n="body",size:o=Un}=t,s=E(t,["altText","icon","color","size"]);const d=l.useRef(null);return l.createElement(Kn,i({ref:d,"aria-label":a,color:n,size:o},s),r)},ce=Gn,br=1,Bt=8,Ot={small:{totalSize:18},medium:{totalSize:24},large:{totalSize:48}},Ct=e=>Ot[e.size].totalSize/6,Dt=e=>Ot[e.size].totalSize,Yn=R.F4`
  50% {
    transform: scale(1);
  }
`,Xn=h.Z.span`
...
`,Qn=h.Z.span`
  grid-area: stack;
  place-self: center;
  transform: rotate(${e=>e.position*(360/Bt)}deg)
  ...
  &:after {
    ...
    animation: ${Yn} ${br}s
      ${e=>e.position*br/Bt}s ease-in-out infinite;
  }
`,qn=({position:e,color:t,size:a})=>l.createElement(Qn,{color:t,position:e,size:a}),el=e=>{var t=e,{color:a="body",size:r="medium"}=t,n=E(t,["color","size"]);let o;const s=[];for(o=0;o<Bt;o++)s.push(l.createElement(qn,{color:a,position:o,size:r,key:o}));return l.createElement(Xn,i({size:r},n),l.createElement(Jn,null,s))},Ti=Object.keys(Ot),Vt=el,xe={small:{height:u(4),textSize:"small",iconSize:2,xSpace:u(1.5),radius:"var(--lns-radius-150)"},medium:{height:u(4.5),textSize:"medium",iconSize:3,xSpace:u(2),radius:"var(--lns-radius-175)"},large:{height:u(7),textSize:"large",iconSize:4,xSpace:u(2.5),radius:"var(--lns-radius-250)"}},Wt=e=>R.iv`
...
`,Be={neutral:{color:c("body"),background:"transparent",borderColor:c("buttonBorder"),hover:c("backgroundHover"),active:c("backgroundActive"),floatingBackground:c("overlay"),floatingHover:c("overlayHover"),floatingActive:c("overlayActive")},neutralSecondary:{color:c("body"),background:c("backgroundNeutral"),borderColor:null,hover:c("backgroundNeutralHover"),active:c("backgroundNeutralActive")},primary:{color:c("white"),background:c("blurple"),borderColor:null,hover:c("primaryHover"),active:c("primaryActive")},secondary:{color:c("primary"),background:c("highlight"),borderColor:null,hover:c("highlightHover"),active:null},record:{color:c("white"),background:c("record"),borderColor:null,hover:c("recordHover"),active:c("recordActive")},upgrade:{color:c("body"),background:c("upgrade"),borderColor:null,hover:c("upgradeHover"),active:c("upgradeActive"),focusRing:Me()},danger:{color:c("bodyInverse"),background:c("danger"),borderColor:null,hover:c("dangerHover"),active:c("dangerActive")},ai:{color:c("white"),background:c("ai-primary"),borderColor:null,hover:null,active:null}},Cr=e=>({enabled:R.iv`
  ...
  ${e=>e.isFloating&&`box-shadow: ${_t.medium}`};
...
`,ll=h.Z.span`
  ${Wt};
`,ol=e=>{var t=e,{size:a="medium",children:r,variant:n="neutral",hasFullWidth:o,width:s="auto",icon:d,iconPosition:m="left",iconBefore:v,iconAfter:p,logoSrc:g,hasLoader:f,isDisabled:C,ariaDisabled:x,htmlTag:z="button",interactionName:y,onClick:L,refHandler:P}=t,N=E(t,["size","children","variant","hasFullWidth","width","icon","iconPosition","iconBefore","iconAfter","logoSrc","hasLoader","isDisabled","ariaDisabled","htmlTag","interactionName","onClick","refHandler"]);const I=d&&m==="left"?d:null,ae=v||I?l.createElement(Er,{hasLoader:f,paddingLeft:"0",paddingRight:r?wr:"0"},l.createElement(ce,{icon:v||I,color:"currentColor",size:xe[a].iconSize})):null,oe=d&&m==="right"?d:null,F=p||oe?l.createElement(Er,{hasLoader:f,paddingLeft:r?wr:"0",paddingRight:"unset"},l.createElement(ce,{icon:oe||p,color:"currentColor",size:xe[a].iconSize})):null,Z=(0,l.useCallback)(U=>{y&&(0,pe.Z)(y),L?.(U)},[L,y]);return l.createElement(rl,k(i({size:a,variant:n,hasFullWidth:o,width:s,icon:d,iconPosition:m,logoSrc:g,disabled:C,ariaDisabled:x,as:z,hasChildren:r,ref:U=>P&&P(U)},N),{onClick:y===void 0?L:Z}),f&&l.createElement(nl,null,l.createElement(Vt,{color:"currentColor"})),ae,g&&l.createElement(al,{alt:"",hasSpacing:Boolean(r),src:g,size:a,height:xe[a].height,width:xe[a].height,hasLoader:f}),l.createElement(ll,{hasLoader:f},r),F)},Fi=Object.keys(xe),Zi=Object.keys(Be),il=ol,sl=h.Z.div`
...
`,cl=e=>{var t=e,{children:a,all:r,y:n,x:o,top:s,right:d,bottom:m,left:v,isInline:p}=t,g=E(t,["children","all","y","x","top","right","bottom","left","isInline"]);return l.createElement(sl,i({all:r,top:n||s,bottom:n||m,right:o||d,left:o||v,isInline:p},g),a)},wt=cl,Et={topLeft:"start",topCenter:"start center",topRight:"start end",centerLeft:"center start",center:"center",centerRight:"center end",bottomLeft:"end start",bottomCenter:"end center",bottomRight:"end"},dl=e=>{if(Array.isArray(e))return e.map(t=>Et[t]);if(typeof e=="object"){const t={};return Object.entries(e).forEach(([a,r])=>t[a]=Et[r]),t}return Et[e]},ul=h.Z.div`
  width: 100%;
  height: 100%;
  display: grid;
  ${e=>we("place-items",dl(e.alignment))};
`,hl=e=>{var t=e,{children:a,alignment:r="center",htmlTag:n="div"}=t,o=E(t,["children","alignment","htmlTag"]);return l.createElement(ul,i({alignment:r,as:n},o),a)},ji=Object.keys(Et),Ge=hl,ml=(e,t,a)=>{const r=t||"border",o=`${Re(a)} solid ${c(r)}`;if(e)return e==="all"?`border: ${o};`:`border-${e}: ${o};`},vl=h.Z.div`
  ...
  ${e=>ml(e.borderSide,e.borderColor,e.borderWidth)};
  ${e=>X(e.radius)};
  ${e=>ct(e.shadow)};
  ${e=>b("width",e.width)};
  ${e=>b("height",e.height)};
...
`,gl=e=>{var t=e,{children:a,backgroundColor:r,backgroundImage:n,contentColor:o,borderColor:s,radius:d,borderSide:m,borderWidth:v="1px",shadow:p,padding:g,paddingX:f,paddingY:C,paddingLeft:x,paddingRight:z,paddingTop:y,paddingBottom:L,margin:P,marginX:N,marginY:I,marginLeft:ae,marginRight:oe,marginTop:F,marginBottom:Z,width:U,height:ue,minWidth:ne,minHeight:J,maxWidth:A,maxHeight:he,htmlTag:le="div",position:$e,overflow:De,zIndex:_,top:se,bottom:nt,left:Ve,right:Ae,refHandler:Le}=t,H=E(t,["children","backgroundColor","backgroundImage","contentColor","borderColor","radius","borderSide","borderWidth","shadow","padding","paddingX","paddingY","paddingLeft","paddingRight","paddingTop","paddingBottom","margin","marginX","marginY","marginLeft","marginRight","marginTop","marginBottom","width","height","minWidth","minHeight","maxWidth","maxHeight","htmlTag","position","overflow","zIndex","top","bottom","left","right","refHandler"]);return l.createElement(vl,i({backgroundColor:r,backgroundImage:n,contentColor:o,borderColor:s,radius:d,borderSide:m,shadow:p,padding:g,paddingLeft:f||x,paddingRight:f||z,paddingTop:C||y,paddingBottom:C||L,margin:P,marginLeft:N||ae,marginRight:N||oe,marginTop:I||F,marginBottom:I||Z,width:U,height:ue,minWidth:ne,minHeight:J,maxWidth:A,maxHeight:he,as:le,position:$e,top:se,bottom:nt,left:Ve,right:Ae,overflow:De,zIndex:_,borderWidth:v,ref:D=>Le&&Le(D)},H),a)},fe=gl,Ee={small:{height:u(4),width:u(5),iconSize:2,padding:u(1.75),withIconPadding:u(4.5),passwordAdditionalPadding:u(.5),textSize:"small",radius:"var(--lns-radius-150)"},medium:{height:"var(--lns-formFieldHeight)",width:u(6),iconSize:3,padding:"var(--lns-formFieldHorizontalPadding)",withIconPadding:u(5.5),passwordAdditionalPadding:u(.5),textSize:"medium",radius:"var(--lns-radius-175)"},large:{height:u(7),width:u(6),iconSize:3,padding:"var(--lns-formFieldHorizontalPadding)",withIconPadding:u(5.5),passwordAdditionalPadding:u(.5),textSize:"large",radius:"var(--lns-radius-250)"}},pl=e=>{let t=e.addOn?Ee[e.inputSize].withIconPadding:Ee[e.inputSize].padding;return e.type==="password"&&(t=`calc(${Ee[e.inputSize].passwordAdditionalPadding} + ${t})`),t},fl=h.Z.input`
...
`,Ni=(0,l.forwardRef)((e,t)=>{var a=e,{placeholder:r,onFocus:n,onChange:o,onBlur:s,onKeyDown:d,isDisabled:m,icon:v,type:p="text",value:g,hasError:f,size:C="medium",addOn:x}=a,z=E(a,["placeholder","onFocus","onChange","onBlur","onKeyDown","isDisabled","icon","type","value","hasError","size","addOn"]);const y=l.createElement(fl,i({type:p,placeholder:r,onFocus:n,onChange:o,onBlur:s,onKeyDown:d,disabled:m,icon:v,ref:t,value:g,hasError:f,inputSize:C,addOn:x},z));return v||x?l.createElement(bl,null,v&&l.createElement(Cl,{size:C},typeof v=="string"?l.createElement(fe,{radius:"50",width:Ee[C].iconSize,height:Ee[C].iconSize,overflow:"hidden"},l.createElement(Ge,{alignment:"center"},l.createElement(wl,{src:v,alt:"",isDisabled:m}))):l.createElement(ce,{icon:v,size:Ee[C].iconSize,color:c(m?"disabledContent":"body")})),y,x&&l.createElement(El,{size:C},x)):y}),yl=null,yr={start:"flex-start",center:"center",end:"flex-end",stretch:"stretch"},zr=!1,yt=e=>Array.isArray(e)?e:[e],xr=(e,t)=>{if(e.length===t)return e;const a=e[e.length-1];return[...Array(t)].map((r,n)=>e[n]||a)},zl=(e,t)=>{const a=Math.max(yt(e).length,yt(t).length),r=xr(yt(t),a),n=xr(yt(e),a),o="& > * + *",s=r.map((m,v)=>{const p=`${Re(m)} 0 0 0`,g=`0 0 0 ${Re(m)}`,f=n[v]==="column"?p:g;return`${o}{ margin: ${f}; }`}),d=n.map(m=>`flex-direction: ${m}`);return qe(s)+qe(d)},xl=h.Z.div`
  display: flex;
  flex-wrap: wrap;
...
`,Ui=e=>{var t=e,{children:a,gap:r,direction:n="row",alignment:o="start",isSpread:s,htmlTag:d="div"}=t,m=E(t,["children","gap","direction","alignment","isSpread","htmlTag"]);return zr||(console.warn(Ra),zr=!0),React12.createElement(xl,i({gap:r,flexDirection:n,flexAlign:o,isSpread:s,as:d},m),a)},Ki=Object.keys(yr),Gi=null,$l=h.Z.div`
  display: grid;
  ...
  ${e=>nr(e.as)};
`,Rl=e=>{var t=e,{children:a,width:r,height:n,minWidth:o,minHeight:s,maxWidth:d,maxHeight:m,gap:v,columns:p,rows:g,alignItems:f="center",justifyContent:C="start",justifyItems:x,alignContent:z,autoFlow:y,htmlTag:L="div",className:P,style:N}=t,I=E(t,["children","width","height","minWidth","minHeight","maxWidth","maxHeight","gap","columns","rows","alignItems","justifyContent","justifyItems","alignContent","autoFlow","htmlTag","className","style"]);return(P||N)&&console.warn(Ht),l.createElement($l,i({alignItems:f,as:L,justifyContent:C,justifyItems:x,alignContent:z,gap:v,columns:p,rows:g,width:r,height:n,minWidth:o,minHeight:s,maxWidth:d,maxHeight:m,autoFlow:y},I),a)},Ye=Rl;function $r(){return l.createElement(ee.Z,{label:"",testId:"ads-refreshed-icon"})}var Ml=h.Z.div`
  position: relative;
  ::before {
    content: '';
...
`,Yi=({children:e,errorActive:t,errorMessage:a="Oops, that didn't work. Try again."})=>t?React15.createElement(Ml,null,React15.createElement(Ye,{autoFlow:"row",gap:"small"},e,a?React15.createElement(Ye,{gap:"xsmall"},React15.createElement(ce,{icon:React15.createElement($r,null),size:2,color:"danger"}),React15.createElement(Ie,{size:"body-sm",color:"danger"},a)):null)):React15.createElement(React15.Fragment,null,e),Xi=null,kl={start:"flex-start",center:"center",end:"flex-end"},Ll=h.Z.div`
  display: flex;
  ${e=>tr(e.alignment,kl)};
...
`,Hl=e=>{var t=e,{width:a,maxWidth:r,children:n}=t,o=E(t,["width","maxWidth","children"]);return console.warn(sr),l.createElement(_l,i({width:a,maxWidth:r},o),n)},Sl=class extends l.Component{render(){return console.warn(sr),l.createElement(Ll,i({},this.props),this.props.children)}};Sl.Section=Hl;var Ji=null,ut={small:{size:u(3),iconSize:2.25,radius:"var(--lns-radius-100)"},medium:{size:u(4),iconSize:3,radius:"var(--lns-radius-150)"},large:{size:u(5),iconSize:4,radius:"var(--lns-radius-175)"}},Il=h.Z.button`
...
`,Rr=l.forwardRef((e,t)=>{var a=e,{altText:r,icon:n,onClick:o,iconColor:s="body",backgroundColor:d,isActive:m,isDisabled:v,size:p="medium"}=a,g=E(a,["altText","icon","onClick","iconColor","backgroundColor","isActive","isDisabled","size"]);return l.createElement(Il,i({"aria-label":r,onClick:o,isActive:m,disabled:v,size:p,backgroundColor:d,ref:t},g),l.createElement(ce,{icon:n,size:ut[p].iconSize,color:v?"disabledContent":s}))});Rr.displayName="IconButton";var zt=Rr,Bl=e=>l.createElement("svg",i({width:12,height:9,viewBox:"0 0 12 9",fill:"none"},e),l.createElement("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M11.707.293a1 1 0 010 1.414l-7 7a1 1 0 01-1.414 0l-3-3a1 1 0 011.414-1.414L4 6.586 10.293.293a1 1 0 011.414 0z",fill:"currentColor"})),Ol=e=>l.createElement("svg",i({width:12,height:2,viewBox:"0 0 12 2",fill:"none"},e),l.createElement("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M0 1a1 1 0 011-1h10a1 1 0 110 2H1a1 1 0 01-1-1z",fill:"currentColor"})),Dl=h.Z.div`
  display: block;
  position: relative;
`,Vl=h.Z.input`
  height: 100%;
...
`,Wl=h.Z.span`
  ...
  justify-content: center;
  user-select: none;
`,Pl=(0,l.forwardRef)((e,t)=>{var a=e,{isDisabled:r,isChecked:n,isIndeterminate:o,onFocus:s,onChange:d,onBlur:m}=a,v=E(a,["isDisabled","isChecked","isIndeterminate","onFocus","onChange","onBlur"]);const p=(0,l.useRef)(),g=t||p,f=c(r?"disabledContent":"currentColor");return(0,l.useEffect)(()=>{g.current.indeterminate=o}),l.createElement(Dl,null,l.createElement(Vl,i({type:"checkbox",disabled:r,checked:n,onFocus:s,onChange:d,onBlur:m,ref:g,"aria-checked":n},v)),l.createElement(Wl,{className:"CheckboxBox"},l.createElement(Ol,{className:"Icon IconMinus",color:f}),l.createElement(Bl,{className:"Icon IconCheck",color:f})))}),Al=Pl,tt={small:{textSize:"small",iconSize:2.25,height:u(3),xSpace:u(1),radius:"var(--lns-radius-100)"},medium:{textSize:"medium",iconSize:3,height:u(4),xSpace:u(1.5),radius:"var(--lns-radius-150)"},large:{textSize:"large",iconSize:4,height:u(6),xSpace:u(3),radius:"var(--lns-radius-200)"}},Tl=h.Z.button`
...
`,Fl=l.forwardRef((e,t)=>{var a=e,{onClick:r,size:n="medium",children:o,icon:s,iconPosition:d="left",isActive:m,isDisabled:v,htmlTag:p,offsetSide:g}=a,f=E(a,["onClick","size","children","icon","iconPosition","isActive","isDisabled","htmlTag","offsetSide"]);const C=l.createElement(fe,{paddingLeft:d==="right"&&"small",paddingRight:d==="left"&&"small",htmlTag:"span"},l.createElement(ce,{icon:s,size:tt[n].iconSize,color:v?"disabledColor":void 0}));return l.createElement(Tl,i({onClick:r,size:n,icon:s,iconPosition:d,disabled:v,isActive:m,as:p,offsetSide:g,ref:t},f),s&&d==="left"&&C,o,s&&d==="right"&&C)});Fl.displayName="TextButton";var Qi=null,Pt=e=>{var t,a;const r=(a=(t=e?.())==null?void 0:t.getRootNode)==null?void 0:a.call(t);if(String(r)==="[object ShadowRoot]"){r.createElement=(...o)=>r.ownerDocument.createElement(...o);const n=r.createElement("div");return n.id="a11y-status-message",n.style.display="none",r.appendChild(n),{document:r,addEventListener:r.addEventListener.bind(r),removeEventListener:r.removeEventListener.bind(r)}}return typeof window>"u"?null:window},Ne=e=>typeof e=="string"?e:typeof e=="number"||typeof e=="boolean"||typeof e=="bigint"?e.toString():e==null?"":Zl(e)?Array.from(e).map(Ne).join(""):typeof e=="object"&&"props"in e&&e.props&&e.props.children!==void 0?Ne(e.props.children):"",Zl=e=>typeof e[Symbol.iterator]=="function";function Mr(){return l.createElement("span",{"aria-hidden":!0,"data-testid":"ads-refreshed-icon"},l.createElement("svg",{viewBox:"-2 -2 16 16"},l.createElement("path",{fill:"currentColor",fillRule:"evenodd",d:"M2.03 3.97 6 7.94l3.97-3.97 1.06 1.06-4.5 4.5a.75.75 0 0 1-1.06 0l-4.5-4.5z",clipRule:"evenodd"})))}function jl(){return l.createElement(M.Z,{label:"",testId:"ads-refreshed-icon"})}var At={left:"bottom-start",right:"bottom-end",topLeft:"top-start",topRight:"top-end",leftSide:"left-start",rightSide:"right-start"},Nl=h.Z.div`
...
`,Gl=h.Z.img`
  ...
  object-fit: cover;
  opacity: ${({isDisabled:e})=>e?.5:1};
`,Tt=e=>{var t=e,{isDisabled:a,isHighlighted:r,isSelected:n,icon:o,hasDivider:s,children:d,menuItemRole:m,keyboardMove:v}=t,p=E(t,["isDisabled","isHighlighted","isSelected","icon","hasDivider","children","menuItemRole","keyboardMove"]);const C=`${o?"auto":""} 1fr ${n?"auto":""}`,x=a?"disabledContent":void 0,z=m?k(i({},p),{role:m}):p;return l.createElement(Kl,i({isHighlighted:r,isDisabled:a,keyboardMove:v,columns:C,hasDivider:s,tabIndex:a?-1:0,"data-highlighted":r||void 0},z),o&&(typeof o=="string"?l.createElement(fe,{radius:"50",width:3,height:3,overflow:"hidden"},l.createElement(Ge,{alignment:"center"},l.createElement(Gl,{src:o,alt:"",isDisabled:a}))):l.createElement(ce,{icon:o,color:x})),l.createElement(Ie,{color:x,hasEllipsis:!0},d),n&&l.createElement(ce,{icon:l.createElement(jl,null),color:x}))},Yl=e=>{var t=e,{position:a,zIndex:r,minWidth:n,maxWidth:o,maxHeight:s,children:d,role:m,downshiftMenuProps:v=()=>null,search:p}=t,g=E(t,["position","zIndex","minWidth","maxWidth","maxHeight","children","role","downshiftMenuProps","search"]);const f=m?k(i({},v()),{role:m}):i({},v());return l.createElement(Nl,i(i({minWidth:n,maxWidth:o,maxHeight:s,zIndex:r,position:a},f),g),p&&p,l.createElement(Ul,{search:p},d))},Xe=Yl;function Xl(){return React24.createElement(SearchIcon,{label:"",testId:"ads-refreshed-icon"})}var Jl=h.Z.div`
  padding: ${u(1.5)} ${u(1.5)} 0;
  margin-bottom: ${u(1.5)};
  position: sticky;
  top: 0;
`,qi=({ariaLabel:e,placeholder:t,value:a,onChange:r,getInputProps:n})=>React25.createElement(Jl,null,React25.createElement(yl,i({"aria-label":e,icon:React25.createElement(Xl,null)},n({placeholder:t,value:a,onChange:r,type:"text"})))),kr=null,Ql=h.Z.div`
  position: relative;
`,ql=h.Z.button`
  appearance: none;
  font: inherit;
...
`,ro=h.Z.span`
  ...
  grid-column-start: 1;
  grid-column-end: 3;
`,xt=e=>Array.isArray(e)&&e.length>0&&"group"in e[0],Ft=({options:e,selectedOptionValue:t})=>{if(!e||!t)return{icon:null,title:null};if(xt(e))for(const a of e){const r=a.items.find(n=>n.value===t);if(r)return r}else return e.find(r=>r.value===t)||{icon:null,title:null};return{icon:null,title:null}},Lr=({options:e,selectedItem:t,selectedOptionValue:a})=>{if(t)return t.icon;if(a)return Ft({options:e,selectedOptionValue:a}).icon},ao=({options:e,selectedItem:t,selectedOptionValue:a,selectPlaceholder:r})=>t?t.title:a?Ft({options:e,selectedOptionValue:a}).title:r,_r=({selectedItem:e,getInputProps:t,getToggleButtonProps:a,ariaMenuName:r,isOpen:n})=>{const o=e?`selected value is ${e.title}`:"no value selected",s=a?.()["aria-label"];return{"aria-expanded":n,"aria-activedescendant":t()["aria-activedescendant"],"aria-label":[r,s,o].filter(Boolean).join(", ")}},no=({getToggleButtonProps:e,inputValue:t,selectedItem:a,selectedOptionValue:r,selectPlaceholder:n,isDisabled:o,options:s,getInputProps:d,ariaMenuName:m,hasError:v,isOpen:p})=>{const g=Lr({options:s,selectedItem:a,selectedOptionValue:r}),f=Boolean(g),C=!r&&!a,z=`${f?"auto":""} 1fr auto`,y=o?"disabledContent":void 0;return React26.createElement(ql,k(i(i({},e()),_r({selectedItem:a,getInputProps:d,getToggleButtonProps:e,ariaMenuName:m,isOpen:p})),{hasValue:t||r,disabled:o,columns:z,hasError:v}),f&&(typeof g=="string"?React26.createElement(fe,{radius:"50",width:3,height:3,overflow:"hidden"},React26.createElement(Ge,{alignment:"center"},React26.createElement(eo,{src:g,alt:"",isDisabled:o}))):React26.createElement(ce,{icon:Lr({options:s,selectedItem:a,selectedOptionValue:r}),color:y})),React26.createElement(Ie,{hasEllipsis:!0,color:C?"bodyDimmed":"inherit"},ao({options:s,selectedItem:a,selectedOptionValue:r,selectPlaceholder:n})),React26.createElement(ce,{icon:React26.createElement(Mr,null),color:y}))},lo=({selectedOptionValue:e,selectedItem:t,trigger:a,getToggleButtonProps:r,options:n,selectPlaceholder:o,isDisabled:s,getInputProps:d,ariaMenuName:m,hasError:v,errorMessage:p,isOpen:g})=>{const f=()=>i(i({},r()),_r({selectedItem:t,getInputProps:d,getToggleButtonProps:r,ariaMenuName:m,isOpen:g})),x=k(i({},(()=>{if(t)return t;if(e)return Ft({options:n,selectedOptionValue:e})})()),{placeholder:o,isDisabled:s,hasError:v,errorMessage:p});return a(x,f())},Hr=(e,t)=>{if(xt(t))for(const a of t){const r=a.items.find(n=>n.value===e);if(r)return r}else return t.find(a=>a.value===e)},Sr=(e,t,a,r,n,o,s,d)=>{const m=!a&&e.value===r||a&&a.value===e.value;return React26.createElement(Tt,k(i({key:t,getItemProps:o,icon:e.icon,hidden:e.hidden},o({key:`${e.value}-${t}`,index:t,item:e,disabled:e.isDisabled,"aria-selected":m,onMouseMove:()=>{s&&d(!1)}})),{isDisabled:e.isDisabled,hasDivider:e.hasDivider,isHighlighted:n===t,keyboardMove:s&&n===t,isSelected:m}),e.title)},oo=e=>{var t=e,{options:a,selectedItem:r,selectedOptionValue:n,highlightedIndex:o,getItemProps:s,search:d,keyboardMove:m,setKeyboardMove:v}=t,p=E(t,["options","selectedItem","selectedOptionValue","highlightedIndex","getItemProps","search","keyboardMove","setKeyboardMove"]);if(!xt(a))return React26.createElement(Xe,i({search:d},p),a.map((f,C)=>Sr(f,C,r,n,o,s,m,v)));let g=0;return React26.createElement(Xe,i({search:d},p),a.map(f=>{const C=`group-${f.group.replace(/\s+/g,"-")}`;return React26.createElement("li",{key:C},React26.createElement(wt,{left:"medium",top:"small",bottom:"xsmall"},React26.createElement(Ie,{id:C,size:"body-sm",fontWeight:"bold"},f.group)),React26.createElement(to,{role:"group","aria-labelledby":C},f.items.map(x=>Sr(x,g++,r,n,o,s,m,v))))}))},e0=e=>{var t=e,{container:a,onChange:r,menuZIndex:n=1100,menuMaxWidth:o,menuMaxHeight:s=34,menuMinWidth:d,triggerOffset:m=0,ariaMenuName:v,selectedOptionValue:p,onOuterClick:g,options:f,placeholder:C,menuPosition:x="left",isDisabled:z,onOpenChange:y,trigger:L,hasError:P,errorMessage:N="Oops, that didn't work.",search:I}=t,ae=E(t,["container","onChange","menuZIndex","menuMaxWidth","menuMaxHeight","menuMinWidth","triggerOffset","ariaMenuName","selectedOptionValue","onOuterClick","options","placeholder","menuPosition","isDisabled","onOpenChange","trigger","hasError","errorMessage","search"]);const oe=Pt(a),[F,Z]=useState(!1),[U,ue]=useState(!1),[ne,J]=useState(""),A=H=>{const D=H.target.value;J(D)},[he,le]=useState(Hr(p,f)),De={itemToString:H=>H?H.value:"",onChange:H=>{le(H),r&&r(H||"")},onOuterClick:g,environment:oe,selectedItem:he,isOpen:F};oe&&(De.environment=oe);const{layerProps:_,triggerProps:se,renderLayer:nt,triggerBounds:Ve}=useLayer({isOpen:F,container:a,ResizeObserver,placement:At[x],auto:!0,snap:!0,triggerOffset:m});useEffect2(()=>{const H=Hr(p,f);H?.value!==he?.value&&le(H)},[p,f,he]),useEffect2(()=>{y&&y(F)},[F,y]);const Ae=(H,D)=>{if(D.isOpen!==void 0){if(D.type===Downshift.stateChangeTypes.keyDownEscape)return Z(!1),{isOpen:!1};Z(D.isOpen)}return D},Le=H=>{switch(H.key){case"ArrowDown":case"ArrowUp":case"ArrowLeft":case"ArrowRight":case"Enter":case" ":case"Tab":case"Escape":ue(!0);break;default:break}};return f=useMemo(()=>{if(I){if(xt(f)){let H;return I.searchType==="startsWith"?H=f.map(D=>k(i({},D),{items:D.items.filter(We=>Ne(We.title).toLowerCase().startsWith(ne.toLowerCase()))})):H=f.map(D=>k(i({},D),{items:D.items.filter(We=>Ne(We.title).toLowerCase().includes(ne.toLowerCase()))})),H.reduce((D,We)=>(We.items.length>0&&D.push(We),D),[])}return I.searchType==="startsWith"?f.filter(H=>Ne(H.title).toLowerCase().startsWith(ne.toLowerCase())):f.filter(H=>Ne(H.title).toLowerCase().includes(ne.toLowerCase()))}return f},[f,ne,I]),React26.createElement(Ql,i({},ae),React26.createElement(Downshift,k(i({},De),{stateReducer:Ae}),({getItemProps:H,getInputProps:D,getMenuProps:We,getToggleButtonProps:kt,isOpen:j,inputValue:_e,highlightedIndex:Yt,selectedItem:lt})=>React26.createElement("div",{role:"presentation"},React26.createElement("div",i({},se),L?React26.createElement(lo,{getToggleButtonProps:()=>i({},kt({onKeyDown:Le})),selectedItem:lt,selectedOptionValue:p,selectPlaceholder:C,isDisabled:z,options:f,trigger:L,getInputProps:D,ariaMenuName:v,hasError:P,errorMessage:N,isOpen:j}):React26.createElement(no,{getToggleButtonProps:()=>i({},kt({onKeyDown:Le})),selectedItem:lt,selectedOptionValue:p,selectPlaceholder:C,options:f,inputValue:_e,isDisabled:z,getInputProps:D,ariaMenuName:v,hasError:P,isOpen:j})),F&&j&&nt(React26.createElement("div",k(i({},_),{style:k(i({},_.style),{zIndex:n,width:d?"auto":Ve?.width})}),React26.createElement(oo,{options:f,selectedItem:lt,selectedOptionValue:p,highlightedIndex:Yt,getItemProps:H,position:x,downshiftMenuProps:()=>We({onKeyDown:Le}),maxWidth:o,maxHeight:s,minWidth:d,search:I&&React26.createElement(kr,{ariaLabel:I.searchPlaceholder,placeholder:I.searchPlaceholder,value:ne,onChange:A,getInputProps:D}),keyboardMove:U,setKeyboardMove:ue}))),P&&!F&&React26.createElement(ro,null,N))))},t0=null;function io(e,t){const a=document;(0,l.useLayoutEffect)(()=>{const r=a?.documentElement,n=a?.body;if(!(a==null||!r||!n)){if(t){const o=window.innerWidth-r.clientWidth,s=parseInt(window.getComputedStyle(n).getPropertyValue("padding-right"),10)||0;switch(e){case"html":{r.style.position="relative",r.style.overflow="hidden",n.style.paddingRight=`${s+o}px`;break}case"body":{n.style.setProperty("position","relative"),n.style.setProperty("overflow","hidden"),n.style.setProperty("padding-right",`${s+o}px`);break}default:return}}return()=>{switch(e){case"html":{r.style.position="",r.style.overflow="",n.style.paddingRight="";break}case"body":{n.style.removeProperty("position"),n.style.removeProperty("overflow"),n.style.removeProperty("padding-right");break}default:return}}}},[a,t,e])}var Ir=io,Br=300,so=h.Z.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`,co=h.Z.div`
  overflow: auto;
  height: 100%;
`,Or=l.forwardRef((e,t)=>{var a=e,{children:r,isOpen:n,zIndex:o=1e3,backgroundColor:s="backdropDark"}=a,d=E(a,["children","isOpen","zIndex","backgroundColor"]);const{stage:m,shouldMount:v}=(0,ie.Yz)(n,Br);return Ir("html",n),l.createElement(l.Fragment,null,v&&l.createElement(so,i({ref:t,backgroundColor:s,zIndex:o,style:{transition:`opacity ${Br}ms`,opacity:m==="enter"?1:0}},d),l.createElement(co,null,r)))});Or.displayName="Backdrop";var uo=Or;function Zt(){return l.createElement(re.Z,{label:"",testId:"ads-refreshed-icon"})}var ho="70vh",mo=h.Z.div`
  display: grid;
  grid-template-rows: ${e=>e.rows};
  position: relative;
`,vo=h.Z.dialog`
  top: ${e=>Lt(Re(e.maxHeight),e.placement).top};
  background-color: ${c("overlay")};
  color: ${c("body")};
...
`,Dr=e=>typeof e=="number"?b("max-height",e):"max-height: "+e,Eo=e=>{var t=e,{children:a,onCloseClick:r,isOpen:n,maxWidth:o=60,maxHeight:s=ho,placement:d="center",ariaLabel:m,ariaModal:v,ariaLabelledBy:p,ref:g,removeClose:f,initialFocus:C}=t,x=E(t,["children","onCloseClick","isOpen","maxWidth","maxHeight","placement","ariaLabel","ariaModal","ariaLabelledBy","ref","removeClose","initialFocus"]);const z=y=>{y.key==="Escape"&&(y.preventDefault(),f||r(y))};return(0,l.useEffect)(()=>(window.addEventListener("keydown",z),()=>{window.removeEventListener("keydown",z)}),[n,r]),Ir("html",n),l.createElement(te(),{active:n,focusTrapOptions:i({clickOutsideDeactivates:!1,allowOutsideClick:!0},C!==void 0?{initialFocus:C}:{})},l.createElement(vo,i({open:n,maxWidth:o,maxHeight:s,placement:d,onClick:y=>y.stopPropagation(),ref:g,"aria-label":m,"aria-modal":v,"aria-labelledby":p},x),!f&&r&&l.createElement(go,null,l.createElement(zt,{altText:"Close",icon:l.createElement(Zt,null),onClick:r})),l.createElement(wo,k(i({},f?{tabIndex:0}:{tabIndex:-1}),{maxHeight:s}),a)))},r0=l.forwardRef((e,t)=>{var a=e,{children:r,id:n,isOpen:o,mainButton:s,secondaryButton:d,alternativeButton:m,title:v,noPadding:p,onCloseClick:g,onBackgroundClick:f,onKeyDown:C,hasDividers:x,maxHeight:z="70vh",maxWidth:y=60,placement:L="center",zIndex:P=1e3,ariaLabel:N,ariaModal:I=!0,ariaLabelledBy:ae,initialFocus:oe}=a,F=E(a,["children","id","isOpen","mainButton","secondaryButton","alternativeButton","title","noPadding","onCloseClick","onBackgroundClick","onKeyDown","hasDividers","maxHeight","maxWidth","placement","zIndex","ariaLabel","ariaModal","ariaLabelledBy","initialFocus"]),Z;const U=(0,l.useRef)(null),ue=n?`${n}-modal-title`:"modal-title",ne=!!(s||d||m),J=A=>{if(f){A.stopPropagation(),f(A);return}g(A)};return(0,l.useEffect)(()=>{if(!o||!U.current)return;const A=U.current.parentElement;return A?(Array.from(A.children).filter(le=>le!==U.current&&le instanceof HTMLElement).forEach(le=>{le.hasAttribute("aria-hidden")||(le.setAttribute("aria-hidden","true"),le.setAttribute("data-lens-modal-hidden","true"))}),()=>{document.querySelectorAll("[data-lens-modal-hidden]").forEach($e=>{$e.removeAttribute("aria-hidden"),$e.removeAttribute("data-lens-modal-hidden")})}):void 0},[o]),l.createElement(uo,i({ref:U,isOpen:o,zIndex:P},F),l.createElement(fe,{height:"100%",onClick:J,onKeyDown:C},l.createElement(Eo,{ref:t,id:n,isOpen:o,maxHeight:z,maxWidth:y,placement:L,onCloseClick:g,ariaLabel:N,ariaModal:I,ariaLabelledBy:(Z=ae??ue)!=null?Z:void 0,initialFocus:oe},l.createElement(mo,{rows:`${v?"auto ":""} ${r?"1fr ":""} ${ne?"auto":""}`},v&&l.createElement(fo,{bottom:r?"var(--lns-space-medium)":"var(--lns-space-xlarge)"},l.createElement(Ie,{htmlTag:"h1",variant:"title",id:ue},v)),l.createElement(Co,{noPadding:p,hasDividers:x,hasTitle:Boolean(v),hasButtons:ne},r&&r),ne&&l.createElement(bo,{top:r?"var(--lns-space-xlarge)":0,hasDividers:x},m,l.createElement(po,null,d&&l.createElement(wt,{right:"small",isInline:!0},d),s))))))}),a0=null,$t={neutral:{color:c("inherit"),focusRing:Me(),underline:"inactive"},primary:{color:c("primary"),focusRing:Me(),underline:"inactive"},subtle:{color:c("body"),focusRing:Me(),underline:"hover"}},Vr={enabled:R.iv`
    cursor: pointer;
  `,disabled:R.iv`
    pointer-events: none;
    color: ${c("disabledContent")};
  `},yo={isButton:R.iv`
    ...
    font: inherit;
  `},zo=h.Z.a`
  ${e=>!e.disabled&&`color: ${$t[e.variant].color}`};
  ${e=>e.disabled?Vr.disabled:Vr.enabled};
  ${e=>e.as==="button"&&yo.isButton};
  ${e=>`text-decoration: ${$t[e.variant].underline==="inactive"?"underline":"none"}`};
  ...
  ${e=>e.noWrap&&R.iv`
    ...
    `}
  &:hover {
    ${e=>`text-decoration: ${$t[e.variant].underline==="hover"?"underline":"none"}`};
  }
  &:focus,
  &:focus-visible {
    outline: 1px solid transparent;
...
`,n0=e=>{var t=e,{children:a,href:r,variant:n="primary",htmlTag:o="a",isDisabled:s,noWrap:d}=t,m=E(t,["children","href","variant","htmlTag","isDisabled","noWrap"]);return React30.createElement(zo,i({href:r,variant:n,as:o,disabled:s,noWrap:d},m),a)},l0=Object.keys($t),o0=null,Wr={small:{padding:`${u(1.5)} ${u(1.75)}`,textSize:"small"},medium:{padding:`${u(1.5)} var(--lns-formFieldHorizontalPadding)`,textSize:"medium"}},xo=h.Z.textarea`
  width: 100%;
  border: none;
  font-family: inherit;
  color: inherit;
...
`,i0=l.forwardRef((e,t)=>{var a=e,{onChange:r,value:n,rows:o=4,isDisabled:s,placeholder:d,size:m="medium",resize:v="both",error:p=null}=a,g=E(a,["onChange","value","rows","isDisabled","placeholder","size","resize","error"]);return l.createElement(l.Fragment,null,l.createElement(xo,i({disabled:s,onChange:r,placeholder:d,ref:t,rows:o,value:n,size:m,resize:v,error:p},g)),p?l.createElement(l.Fragment,null,l.createElement(wt,{bottom:"xmsall"}),l.createElement(Ie,{color:"danger",fontWeight:"regular",size:"body-md"},p)):null)}),s0=null,$o=h.Z.div`
  position: relative;
`,Ro=h.Z.ul`
  list-style: none;
  margin: 0;
...
`,Mo=h.Z.span`
  ...
  grid-column-start: 1;
  grid-column-end: 3;
`,Rt=e=>Array.isArray(e)&&e.length>0&&"group"in e[0],Pr=({options:e,selectedOptionValue:t})=>{if(!e||!t)return{icon:null,title:null};if(Rt(e))for(const a of e){const r=a.items.find(n=>n.value===t);if(r)return r}else return e.find(r=>r.value===t)||{icon:null,title:null};return{icon:null,title:null}},ko=({options:e,selectedItem:t,selectedOptionValue:a})=>{if(t)return t.icon;if(a)return Pr({options:e,selectedOptionValue:a}).icon},Lo=({options:e,selectedItem:t,selectedOptionValue:a,placeholder:r})=>t?t.title:a?Pr({options:e,selectedOptionValue:a}).title:r,_o=({selectedItem:e,getInputProps:t,ariaMenuName:a})=>{const r=e?`selected value is ${e.title}`:"no value selected";return{"aria-activedescendant":t()["aria-activedescendant"],"aria-label":[a,r].filter(Boolean).join(", ")}},Ho=h.Z.button`
  position: relative;
  width: 100%;
  background: none;
  border: none;
...
`,Do=h.Z.img`
  ...
  object-fit: cover;
  opacity: ${({isDisabled:e})=>e?.5:1};
`,Vo=({selectedItem:e,selectedOptionValue:t,placeholder:a,isDisabled:r,options:n,getInputProps:o,ariaMenuName:s,isOpen:d,onInputFocus:m,hasError:v,hasLoader:p,inputValue:g,handleInputValueChange:f,inputRef:C,id:x})=>{const z=ko({options:n,selectedItem:e,selectedOptionValue:t}),y=Boolean(z),L=r?"disabledContent":void 0,P=()=>{r||m()},N=i(i({role:"combobox","aria-autocomplete":"list","aria-haspopup":"listbox","aria-expanded":d},_o({selectedItem:e,getInputProps:o,ariaMenuName:s})),o({id:x,"aria-labelledby":void 0,disabled:r,onFocus:P,onClick:P,value:g,onBlur:()=>{f("")},onChange:ae=>f(ae.target.value)})),I=!g&&!t;return l.createElement(Ho,{onClick:P,disabled:r},y&&l.createElement(Io,null,typeof z=="string"?l.createElement(fe,{radius:"50",width:3,height:3,overflow:"hidden"},l.createElement(Ge,{alignment:"center"},l.createElement(Do,{src:z,alt:"",isDisabled:r}))):l.createElement(ce,{icon:z,color:L})),l.createElement(So,k(i({ref:C},N),{hasIcon:y,hasAddOn:!0,hasError:v,isDisabled:r})),!g&&l.createElement(Oo,{hasIcon:y},l.createElement(Ie,{hasEllipsis:!0,color:I?"bodyDimmed":"inherit"},Lo({options:n,selectedItem:e,selectedOptionValue:t,placeholder:a}))),l.createElement(Bo,null,p?l.createElement(Vt,{size:"small"}):l.createElement(ce,{icon:l.createElement(Mr,null),color:L})))},Ar=(e,t)=>{var a;if(Rt(t))for(const r of t){const n=r.items.find(o=>o.value===e);if(n)return n}else return(a=t.find(r=>r.value===e))!=null?a:null;return null},Wo=(e,t)=>(e||null)!=t?.value,Tr=(e,t,a,r,n,o)=>{const s=!a&&e.value===r||a&&a.value===e.value;return l.createElement(Tt,k(i({key:t,getItemProps:o,icon:e.icon,hidden:e.hidden},o({key:`${e.value}-${t}`,index:t,item:e,disabled:e.isDisabled,"aria-selected":s})),{isDisabled:e.isDisabled,hasDivider:e.hasDivider,isHighlighted:n===t,isSelected:s}),e.title)},Po=e=>{var t=e,{options:a,selectedItem:r,selectedOptionValue:n,highlightedIndex:o,getItemProps:s,isLoading:d,loadingMessage:m,emptyResultsMessage:v,hasAvailableOptions:p}=t,g=E(t,["options","selectedItem","selectedOptionValue","highlightedIndex","getItemProps","isLoading","loadingMessage","emptyResultsMessage","hasAvailableOptions"]);const f=m||l.createElement(Vt,null),C=v||"No results";if(d)return l.createElement(Xe,i({as:"div"},g),l.createElement(fe,{padding:"large"},l.createElement(Ge,{alignment:"center"},f)));if(!p)return l.createElement(Xe,i({as:"div"},g),l.createElement(fe,{padding:"large"},l.createElement(Ge,{alignment:"center"},C)));if(!Rt(a))return l.createElement(Xe,i({},g),a.map((z,y)=>Tr(z,y,r,n,o,s)));let x=0;return l.createElement(Xe,i({},g),a.map(z=>{const y=`group-${z.group.replace(/\s+/g,"-")}`;return l.createElement("li",{key:y},l.createElement(wt,{left:"medium",top:"small",bottom:"xsmall"},l.createElement(Ie,{id:y,size:"body-sm",fontWeight:"bold",htmlTag:z.headingTag||"h2"},z.group)),l.createElement(Ro,{role:"group","aria-labelledby":y},z.items.map(L=>Tr(L,x++,r,n,o,s))))}))},Ao=(0,l.forwardRef)((e,t)=>{var a=e,{container:r,onOptionChange:n,onInputValueChange:o,menuZIndex:s=1100,menuMaxWidth:d,menuMaxHeight:m=34,menuMinWidth:v,ariaMenuName:p,selectedOptionValue:g,onOuterClick:f,options:C,placeholder:x,menuPosition:z="left",isDisabled:y,onOpenChange:L,isLoading:P,loadingMessage:N,emptyResultsMessage:I,errorMessage:ae,id:oe}=a,F=E(a,["container","onOptionChange","onInputValueChange","menuZIndex","menuMaxWidth","menuMaxHeight","menuMinWidth","ariaMenuName","selectedOptionValue","onOuterClick","options","placeholder","menuPosition","isDisabled","onOpenChange","isLoading","loadingMessage","emptyResultsMessage","errorMessage","id"]);const Z=Pt(r),U=(0,l.useRef)(null),ue=(0,l.useCallback)(j=>{U.current=j,t&&(typeof t=="function"?t(j):t.current=j)},[t]),[ne,J]=(0,l.useState)(""),[A,he]=(0,l.useState)(!1),[le,$e]=(0,l.useState)(Ar(g,C)),[De,_]=(0,l.useState)(le),se=j=>{J(j),o&&o(j)},Ve={itemToString:j=>j?j.value:"",onChange:j=>{const _e=j||null;_(_e),n&&n(_e)},onOuterClick:f,environment:Z,selectedItem:De,isOpen:A};Z&&(Ve.environment=Z);const{layerProps:Ae,triggerProps:Le,renderLayer:H,triggerBounds:D}=(0,S.sJ)({isOpen:A,container:r,ResizeObserver:$.Z,placement:At[z],auto:!0,snap:!0});(0,l.useEffect)(()=>{if(Wo(g,le)){const j=Ar(g,C);$e(j),_(j),J("")}},[g,C,le]),(0,l.useEffect)(()=>{var j;L&&L(A),A||(j=U.current)==null||j.blur()},[A,L]);const We=(0,l.useMemo)(()=>Array.isArray(C)?Rt(C)?C.some(j=>j.items.length>0):C.length>0:!1,[C]),kt=(j,_e)=>{if(_e.isOpen!==void 0){if(_e.type===T.ZP.stateChangeTypes.keyDownEscape)return he(!1),{isOpen:!1};he(_e.isOpen)}return _e};return l.createElement($o,i({},F),l.createElement(T.ZP,k(i({},Ve),{stateReducer:kt}),({getItemProps:j,getInputProps:_e,getMenuProps:Yt,isOpen:lt,highlightedIndex:ki,selectedItem:da})=>l.createElement("div",{role:"presentation"},l.createElement("div",i({},Le),l.createElement(Vo,{inputRef:ue,selectedItem:da,selectedOptionValue:g,placeholder:x,isDisabled:y,options:C,getInputProps:_e,ariaMenuName:p,inputValue:ne,handleInputValueChange:se,isOpen:A&&lt,onInputFocus:()=>{he(!0)},hasLoader:P,hasError:Boolean(ae),id:oe})),A&&lt&&H(l.createElement("div",k(i({},Ae),{style:k(i({},Ae.style),{zIndex:s,width:v?"auto":D?.width})}),l.createElement(Po,{options:C,selectedItem:da,selectedOptionValue:g,hasAvailableOptions:We,highlightedIndex:ki,getItemProps:j,isLoading:P,loadingMessage:N,emptyResultsMessage:I,position:z,downshiftMenuProps:Yt,maxWidth:d,maxHeight:m,minWidth:v}))),Boolean(ae)&&!A?l.createElement(Mo,null,ae):null)))});Ao.displayName="Typeahead";var c0=null,To=({ariaMenuName:e,getInputProps:t,isOpen:a})=>({"aria-activedescendant":t()["aria-activedescendant"],"aria-expanded":a,"aria-label":e||""}),Fo=h.Z.div`
  display: inline-block;
  vertical-align: middle;
`,d0=e=>{var t=e,{ariaMenuName:a,menuPosition:r="left",menuZIndex:n=1100,options:o,trigger:s,triggerCallback:d,isOpen:m,menuMinWidth:v=24,menuMaxWidth:p=48,menuMaxHeight:g,container:f,onOuterClick:C,triggerOffset:x=0,onOpenChange:z,search:y,role:L,menuItemRole:P}=t,N=E(t,["ariaMenuName","menuPosition","menuZIndex","options","trigger","triggerCallback","isOpen","menuMinWidth","menuMaxWidth","menuMaxHeight","container","onOuterClick","triggerOffset","onOpenChange","search","role","menuItemRole"]);const I=Pt(f),[ae,oe]=useState3(!1),[F,Z]=useState3(!1),[U,ue]=useState3(""),ne=_=>{const se=_.target.value;ue(se)},J=_=>{switch(_.key){case"ArrowDown":case"ArrowUp":case"ArrowLeft":case"ArrowRight":case"Enter":case" ":case"Tab":case"Escape":Z(!0);break;default:break}},A=m||ae,{layerProps:he,triggerProps:le,renderLayer:$e}=useLayer3({isOpen:A,container:f,placement:At[r],ResizeObserver:ResizeObserver3,auto:!0,snap:!0,triggerOffset:x});useEffect5(()=>{z&&z(A)},[A,z]);const De=(_,se)=>(se.isOpen!==void 0&&oe(se.isOpen),se);return o=useMemo3(()=>y?y.searchType==="startsWith"?o.filter(_=>Ne(_.title).toLowerCase().startsWith(U.toLowerCase())):o.filter(_=>Ne(_.title).toLowerCase().includes(U.toLowerCase())):o,[o,U,y]),React33.createElement(Downshift3,{stateReducer:De,itemToString:_=>_?_.title:"",onSelect:_=>_&&!_.disabled&&_.onClick&&_.onClick(),onOuterClick:C,environment:I},({getInputProps:_,getItemProps:se,getMenuProps:nt,getToggleButtonProps:Ve,highlightedIndex:Ae,isOpen:Le})=>React33.createElement("div",i(i({},N),d?{role:null,"aria-haspopup":null,"aria-expanded":null,"aria-labelledby":null}:{}),React33.createElement("div",i({},le),d?d(i(i({},Ve({onKeyDown:J})),To({ariaMenuName:a,getInputProps:_,isOpen:Le}))):React33.createElement(Fo,i({},Ve({onKeyDown:J,tabIndex:0})),s)),Le&&$e(React33.createElement("div",k(i({},he),{style:k(i({},he.style),{zIndex:n})}),React33.createElement(Xe,{position:r,minWidth:v,maxWidth:p,maxHeight:g,downshiftMenuProps:()=>nt({onKeyDown:J}),role:L,search:y&&React33.createElement(kr,{ariaLabel:y.searchPlaceholder,placeholder:y.searchPlaceholder,value:U,onChange:ne,getInputProps:_})},o.map((H,D)=>React33.createElement(Tt,i({key:D,isHighlighted:Ae===D,keyboardMove:F&&Ae===D,isDisabled:H.disabled,isSelected:H.selected,icon:H.icon,hasDivider:H.hasDivider,getItemProps:se,menuItemRole:P,index:D},se({key:D,index:D,item:H,disabled:H.disabled,onMouseMove:()=>{F&&Z(!1)}})),H.title)))))))},u0=null,Zo=h.Z.label`
  display: block;
  position: relative;
...
`,Uo=(0,l.forwardRef)((e,t)=>{var a=e,{isDisabled:r,isChecked:n,onFocus:o,onChange:s,onBlur:d}=a,m=E(a,["isDisabled","isChecked","onFocus","onChange","onBlur"]);return l.createElement(Zo,{htmlFor:m.id},l.createElement(jo,i({type:"radio",disabled:r,checked:n,onFocus:o,onChange:s,onBlur:d,ref:t},m)),l.createElement(No,{className:"RadioBox"}))}),Ko=Uo,Oe={medium:{switchHeight:16,switchWidth:32,knobOffset:2},large:{switchHeight:20,switchWidth:36,knobOffset:2}},rt={knob:{active:{enabled:c("white"),disabled:c("disabledContent")},inactive:{enabled:c("white"),disabled:c("disabledContent")}},track:{active:{enabled:c("blurple"),disabled:c("disabledBackground")},inactive:{enabled:c("grey6"),disabled:c("disabledBackground")}}},Go=e=>Oe[e.switchSize].switchWidth-Oe[e.switchSize].switchHeight,Fr=e=>Oe[e.switchSize].switchHeight-Oe[e.switchSize].knobOffset*2,Yo=h.Z.label`
  display: block;
  position: relative;
`,Xo=h.Z.input`
  position: absolute;
  ...
  &:checked {
    ...
    & + .SwitchBox:after {
      transform: translateX(${e=>Go(e)}px);
    }
  }
  &:disabled {
    pointer-events: none;
...
`,Qo=e=>{var t=e,{isActive:a,isDisabled:r,onChange:n,size:o="medium",ariaLabelledby:s,ariaLabel:d,ariaDescribedby:m}=t,v=E(t,["isActive","isDisabled","onChange","size","ariaLabelledby","ariaLabel","ariaDescribedby"]);if(s&&d)throw new Error("ariaLabelledby and ariaLabel serve the same purpose and therefore cannot be used at the same time. Choose the one that best suites your needs.");return l.createElement(Yo,{htmlFor:v.id},l.createElement(Xo,k(i({},v),{checked:a,disabled:r,onChange:n,type:"checkbox",switchSize:o,"aria-labelledby":s,"aria-label":d,"aria-describedby":m,"aria-checked":a})),l.createElement(Jo,{className:"SwitchBox",isDisabled:r,isActive:a,switchSize:o}))},qo=Qo,Zr={row:{wrapper:{display:"grid",gridTemplateColumns:"auto 1fr",alignItems:"center"},label:{marginLeft:"var(--lns-space-small)"},errorMessage:{marginLeft:"var(--lns-space-small)"}},"row-reverse":{wrapper:{display:"grid",gridTemplateColumns:"1fr auto",alignItems:"center"},label:{}},column:{wrapper:{},label:{marginBottom:"var(--lns-space-xsmall)"}}},e1=h.Z.div`
...
`,r1=h.Z.span`
  ...
  grid-column-start: 1;
  grid-column-end: 3;
`,a1=[Ko,Al,qo],n1=e=>a1.includes(e),h0=e=>{var t=e,{label:a,children:r,errorMessage:n,labelFor:o,direction:s="column"}=t,d=E(t,["label","children","errorMessage","labelFor","direction"]);const m=React36.Children.toArray(r).some(p=>isValidElement(p)&&typeof p.type!="string"&&n1(p.type)),v=a&&React36.createElement(t1,{direction:s,htmlFor:o,isLabelClickable:m},a);return React36.createElement(e1,i({direction:s},d),s==="row"&&React36.createElement(React36.Fragment,null,r,v),s==="column"&&React36.createElement(React36.Fragment,null,v,r),s==="row-reverse"&&React36.createElement(React36.Fragment,null,v,r),n&&React36.createElement(r1,null,n))},m0=null;function v0(e,t){React37.useEffect(()=>{const a=r=>{!e.current||e.current.contains(r.target)||t(r)};return document.addEventListener("mousedown",a),document.addEventListener("touchstart",a),()=>{document.removeEventListener("mousedown",a),document.removeEventListener("touchstart",a)}},[e,t])}function g0(e){const[t,a]=useState4(!1),r=useCallback3(o=>{const s=e.current;o.type==="focusin"&&o.target===s&&a(!0)},[e]),n=useCallback3(o=>{const s=e.current;o.type==="focusout"&&o.target===s&&a(!1)},[e]);return useEffect6(()=>(document.addEventListener("focusin",r),document.addEventListener("focusout",n),()=>{document.removeEventListener("focusin",r),document.removeEventListener("focusout",n)}),[r,n]),Boolean(t)}function p0(e){const t=document;useLayoutEffect2(()=>{const a=t?.documentElement,r=t?.body;if(!(t==null||!a||!r))return e&&(r.style.setProperty("padding-top","3.25rem"),r.style.setProperty("transition","padding-top 350ms")),()=>{r.style.removeProperty("padding-top")}},[t,e])}var l1=null;function o1(){return l.createElement(ve.Z,{label:"",testId:"ads-refreshed-icon"})}var i1=e=>l.createElement("svg",i({viewBox:"0 0 24 24",fill:"none"},e),l.createElement("path",{fill:"currentColor",fillRule:"evenodd",clipRule:"evenodd",d:"M7.42 2.293A1 1 0 0 1 8.127 2h7.245a1 1 0 0 1 .708.293l5.127 5.127a1 1 0 0 1 .293.707v7.245a1 1 0 0 1-.293.708l-5.127 5.127a1 1 0 0 1-.707.293H8.128a1 1 0 0 1-.708-.293L2.293 16.08A1 1 0 0 1 2 15.373V8.128a1 1 0 0 1 .293-.708L7.42 2.293ZM8.542 4 4 8.542v6.416L8.542 19.5h6.416l4.542-4.542V8.542L14.958 4H8.542Zm2.208 11.25a1 1 0 0 1 1-1h.009a1 1 0 1 1 0 2h-.009a1 1 0 0 1-1-1Zm2-7a1 1 0 1 0-2 0v3.5a1 1 0 1 0 2 0v-3.5Z"})),Je={info:{bgColor:"var(--lns-color-blurple)",icon:l.createElement(o1,null),color:"var(--lns-color-white)",fontFamily:"inherit"},warning:{bgColor:"var(--lns-color-warning)",icon:l.createElement(i1,null),color:"var(--lns-color-grey8)",fontFamily:"inherit"},error:{bgColor:"var(--lns-color-danger)",icon:l.createElement($r,null),color:"var(--lns-color-white)",fontFamily:"inherit"},internal:{icon:l.createElement("span",{role:"img"},"\u{1F514}"),color:"var(--lns-color-tealLight)",bgColor:"var(--lns-color-grey8)",fontFamily:"var(--lns-fontFamily-code)"}},jr=350,s1=h.Z.aside`
...
`,f0=({children:e,onCloseClick:t,isOpen:a,severity:r="info",id:n})=>{var o,s,d;useEffect7(()=>{if(!a)return;const v=p=>{p.key==="Escape"&&(p.preventDefault(),t&&t())};return window.addEventListener("keydown",v),()=>{window.removeEventListener("keydown",v)}},[a,t]),l1(a);const m=r==="internal";return a?React40.createElement(s1,{isOpen:a,severity:r,id:n},React40.createElement(Ye,{alignItems:{default:"start",small:"center"},justifyContent:"space-between",autoFlow:m?"column":void 0,columns:m?void 0:["1fr auto"]},React40.createElement(fe,{paddingY:{default:"xsmall",xsmall:0},paddingLeft:m?void 0:{default:0,medium:u(3.5)},width:"100%"},React40.createElement(Ye,{autoFlow:"column",gap:m?"medium":"small",justifyContent:"center"},(o=Je[r])!=null&&o.icon?React40.createElement(Ge,{alignment:"topLeft"},React40.createElement(ce,{icon:Je[r].icon,color:(s=Je[r].color)!=null?s:"var(--lns-color-white)"})):null," ",e))),t&&React40.createElement(zt,{iconColor:(d=Je[r].color)!=null?d:"var(--lns-color-white)",tabIndex:0,altText:"Close",icon:React40.createElement(Zt,null),onClick:t})):null},b0=null,Nr="web-app",jt="chrome-extension",c1={short:3e3,long:8e3},d1=(e,t)=>R.F4`
  0% {
    opacity: 0;
...
`,u1=e=>{switch(e){case Nr:return"unset";case jt:return u(4);default:return"unset"}},h1=e=>{switch(e){case Nr:return u(4);case jt:return"unset";default:return u(4)}},m1=h.Z.div`
  animation: ${e=>d1(e.toastDuration,e.platform)}
    ${e=>e.toastDuration}ms forwards;
  background-color: ${c("backgroundInverse")};
  ${X("250")};
  top: ${e=>u1(e.platform)};
  bottom: ${e=>h1(e.platform)};
  ${ct("large")};
  color: ${c("bodyInverse")};
  display: grid;
  grid-auto-flow: column;
...
`,v1=h.Z.div`
  align-self: center;
`,C0=({children:e,isOpen:t,onCloseClick:a,zIndex:r=1100,duration:n="short",platform:o="web-app"})=>{const s=c1[n];return useEffect8(()=>{const d=setTimeout(()=>{t&&a()},s);return()=>clearTimeout(d)},[t]),React41.createElement(React41.Fragment,null,t&&React41.createElement(m1,{role:"presentation",onClick:d=>d.stopPropagation(),zIndex:r,isOpen:t,toastDuration:s,platform:o},React41.createElement(v1,{"aria-live":"polite"},e),a&&React41.createElement(zt,{altText:"Close",icon:React41.createElement(Zt,null),onClick:a,iconColor:"bodyInverse"})))},w0=null,Ur={topLeft:"top-start",topCenter:"top-center",topRight:"top-end",bottomLeft:"bottom-start",bottomCenter:"bottom-center",bottomRight:"bottom-end",leftTop:"left-start",leftCenter:"left-center",leftBottom:"left-end",rightTop:"right-start",rightCenter:"right-center",rightBottom:"right-end"},g1=4,p1=Fe.small.fontSize*Fe.small.lineHeight,f1=(g1-p1)/2,b1=h.Z.div`
  background-color: ${c("backgroundInverse")};
  color: ${c("bodyInverse")};
  ${X("150")};
  ${Te("bold")};
...
`,C1=h.Z.div`
  ...
  padding-left: ${u(.5)};
  padding-right: ${u(.5)};
`,w1=({children:e})=>l.createElement(C1,null,e),E1=e=>{var t=e,{children:a,maxWidth:r,onMouseEnter:n,onMouseLeave:o,layerProps:s,zIndex:d}=t,m=E(t,["children","maxWidth","onMouseEnter","onMouseLeave","layerProps","zIndex"]);return l.createElement(b1,i(i({maxWidth:r,onMouseEnter:n,onMouseLeave:o,zIndex:d},s),m),a)},y1=h.Z.div`
  display: ${e=>e.isInline?"inline-block":"block"};
...
`;function z1(e){switch(e){case"immediate":return 200;case"long":return 800;default:return 200}}var x1=e=>{var t=e,{ariaLive:a=!1,children:r,content:n,shortcut:o,placement:s="topCenter",keepOpen:d,triggerOffset:m=4,maxWidth:v=26,isInline:p=!0,isDisabled:g,container:f,tabIndex:C=0,zIndex:x=1100,verticalAlign:z="middle",delay:y="immediate",tooltipId:L}=t,P=E(t,["ariaLive","children","content","shortcut","placement","keepOpen","triggerOffset","maxWidth","isInline","isDisabled","container","tabIndex","zIndex","verticalAlign","delay","tooltipId"]);const[N,I]=(0,S.XI)({delayEnter:z1(y),delayLeave:200}),[ae,oe]=(0,l.useState)(!1),[F,Z]=(0,l.useState)(!1),[U,ue]=(0,l.useState)(!1),ne=(0,l.useRef)(),J=!n||g;(0,l.useEffect)(()=>{if(J){Z(!1);return}const _=ae&&d;(N||_)&&Z(!0),!N&&!_&&!U&&Z(!1)},[n,g,ae,J,d,Z,N,U]);const A=()=>{ue(!1),J||Z(!0)},he=()=>{Z(!1),ue(!1)};(0,l.useEffect)(()=>{if(!F)return;const _=se=>{se.key==="Escape"&&(se.preventDefault(),he())};return window.addEventListener("keydown",_),()=>{window.removeEventListener("keydown",_)}},[F,Z]);const{layerProps:le,triggerProps:$e,renderLayer:De}=(0,S.sJ)({isOpen:F,placement:Ur[s],ResizeObserver:$.Z,triggerOffset:m,container:f,auto:!0});return l.createElement(l.Fragment,null,l.createElement(y1,k(i(i({},$e),I),{onClick:_=>{_.detail===0&&ue(!0)},onFocus:A,onBlur:he,isInline:p,verticalAlign:z,tabIndex:J?-1:C,ref:(0,S.lq)($e.ref,ne)}),r),a&&l.createElement("span",{className:"srOnly","aria-live":"polite"},F&&n),F&&De(l.createElement("div",k(i({},le),{style:k(i({},le.style),{zIndex:x})}),l.createElement(E1,i({maxWidth:v,onMouseEnter:()=>oe(!0),onMouseLeave:()=>oe(!1),role:"tooltip",id:L},P),l.createElement(Ye,{gap:"small"},l.createElement(Ie,{size:"small",fontWeight:"bold"},n),o&&l.createElement(Ye,{gap:"xsmall"},o.map((_,se)=>l.createElement(w1,{key:se},_))))))))},E0=Object.keys(Ur),$1=x1,Kr=R.iv`
...
`,x0=e=>{var t=e,{variant:a="combined",maxWidth:r,symbolColor:n,wordmarkColor:o="body",brand:s="loom",customId:d=""}=t,m=E(t,["variant","maxWidth","symbolColor","wordmarkColor","brand","customId"]);return React44.createElement(H1,i({variant:a,maxWidth:r},m),a==="combined"&&React44.createElement(_1,{brand:s,symbolColor:n,wordmarkColor:c(o),customId:d,className:"lns-logoSvg"}),a==="symbol"&&React44.createElement(k1,{brand:s,symbolColor:n,customId:d,className:"lns-logoSvg"}),a==="wordmark"&&React44.createElement(L1,{brand:s,wordmarkColor:c(o),className:"lns-logoSvg"}))},$0=null,S1="https://cdn.loom.com/assets/lens",Jr={small:"40px",medium:"80px"},I1=h.Z.span`
  animation: ${e=>e.animation};
  background-image: url(${S1}/${e=>e.brand}-loader.svg);
...
`,B1=({animation:e="spin 2s infinite steps(49) forwards",brand:t="loom",size:a="medium"})=>l.createElement(I1,{animation:e,brand:t,size:a}),O1=B1,Nt="/* emotion-disable-server-rendering-unsafe-selector-warning-please-do-not-use-this-the-warning-exists-for-a-reason */",D1={border:R.iv`
...
`,P1=e=>{var t=e,{children:a,htmlTag:r="li",className:n,backgroundColor:o,onClick:s,href:d,role:m}=t,v=E(t,["children","htmlTag","className","backgroundColor","onClick","href","role"]);const p=n?` ${n}`:"",g=["div","span","p","h1","h2","h3","h4","h5","h6","section","article","header","footer","main","aside","nav"],f=!r&&s;let C=!1;const x=r||"div";f||(C=g.includes(x));const z=!C||f?{onClick:s,onKeyDown:y=>{y.key==="Enter"&&(y.preventDefault(),s?.(y))}}:{};return React46.createElement(W1,i(i({role:m||(r==="li"?"listitem":void 0),className:`ListRowWrapper${p}`,as:r,backgroundColor:o,href:d},z),v),a)},A1=e=>e.map(t=>Re(t)).join(" "),R0=e=>{var t=e,{children:a,columns:r,gap:n,variant:o="stripe",htmlTag:s="ul"}=t,d=E(t,["children","columns","gap","variant","htmlTag"]);let m=a;return s==="ul"&&(m=React46.Children.map(a,v=>React46.isValidElement(v)&&v.type===P1?React46.cloneElement(v,{htmlTag:"li"}):v)),React46.createElement(V1,i({as:s,columns:r&&A1(r),gap:n,variant:o,role:s==="ul"?"list":void 0},d),m)},M0=null,Mt=l.createContext({}),T1=e=>`calc(-1 * ${Re(e)})`,Qr=h.Z.div`
  ${e=>e.scrollOffset&&`margin: 0 ${T1(e.scrollOffset)};
  `};
`,qr=h.Z.div`
...
`,k0=e=>{var t=e,{children:a,isActive:r,htmlTag:n="button",icon:o,isDisabled:s=!1}=t,d=E(t,["children","isActive","htmlTag","icon","isDisabled"]);const{isPilledDesign:m}=React47.useContext(Mt);return m?React47.createElement(ra,i({as:n,isActive:r,icon:o,role:"tab","aria-selected":r,disabled:s},d),o&&React47.createElement(fe,{htmlTag:"span",paddingRight:a&&"small"},React47.createElement(ce,{icon:o,color:"currentColor"})),a):React47.createElement(ta,i({as:n,isActive:r,icon:o,role:"tab","aria-selected":r,disabled:s},d),o&&React47.createElement(fe,{htmlTag:"span",paddingRight:a&&"small"},React47.createElement(ce,{icon:o,color:"currentColor"})),a)},F1=e=>{var t=e,{children:a,scrollOffset:r,hasFullTabs:n,isPilledDesign:o,hasBottomBorder:s=!1}=t,d=E(t,["children","scrollOffset","hasFullTabs","isPilledDesign","hasBottomBorder"]);const m=o?React47.createElement(ea,i({hasFullTabs:n,scrollOffset:r,role:"tablist"},d),a):React47.createElement(qr,i({hasFullTabs:n,scrollOffset:r,hasBottomBorder:s,role:"tablist"},d),a);return r?React47.createElement(Qr,{scrollOffset:r},m):React47.createElement(Mt.Provider,{value:{isPilledDesign:o}},m)},Z1=({tooltipProps:e,children:t,tooltipId:a})=>e?l.createElement($1,k(i({},e),{tooltipId:a,tabIndex:-1}),t):t,aa=l.forwardRef((e,t)=>{var a=e,{tabContent:r,tooltipProps:n,isActive:o,htmlTag:s="button",icon:d,isDisabled:m=!1,onKeyDown:v,onClick:p}=a,g=E(a,["tabContent","tooltipProps","isActive","htmlTag","icon","isDisabled","onKeyDown","onClick"]);const{isPilledDesign:f}=l.useContext(Mt),C=(0,l.useId)(),x=i({as:s,isActive:o,icon:d,role:"tab","aria-selected":o,disabled:m,tabIndex:o?0:-1,"aria-describedby":n?C:void 0,onKeyDown:v,onClick:p,ref:t},g);return l.createElement(Z1,{tooltipProps:n,tooltipId:C},f?l.createElement(ra,i({},x),d?l.createElement(fe,{htmlTag:"span",paddingRight:r&&"small"},l.createElement(ce,{icon:d,color:"currentColor"})):null,r):l.createElement(ta,i({},x),d?l.createElement(fe,{htmlTag:"span",paddingRight:r&&"small"},l.createElement(ce,{icon:d,color:"currentColor"})):null,r))});aa.displayName="TabNew";var j1=e=>{var t=e,{tabs:a,scrollOffset:r,hasFullTabs:n,isPilledDesign:o,hasBottomBorder:s=!1}=t,d=E(t,["tabs","scrollOffset","hasFullTabs","isPilledDesign","hasBottomBorder"]);const m=useRef5({}),v=useCallback4((x,z)=>{var y;let L=z;switch(x.key){case"ArrowLeft":x.preventDefault(),L=z>0?z-1:a.length-1;break;case"ArrowRight":x.preventDefault(),L=z<a.length-1?z+1:0;break;case"Home":x.preventDefault(),L=0;break;case"End":x.preventDefault(),L=a.length-1;break;default:return}(y=m.current[L])==null||y.focus()},[a.length]),p=useCallback4(x=>z=>{m.current[x]=z},[]),g=useMemo4(()=>a.map((x,z)=>React47.createElement(aa,i({key:z,ref:p(z),onKeyDown:y=>v(y,z)},x))),[a,v,p]),f=useMemo4(()=>o?React47.createElement(ea,i({hasFullTabs:n,scrollOffset:r,role:"tablist"},d),g):React47.createElement(qr,i({hasFullTabs:n,scrollOffset:r,hasBottomBorder:s,role:"tablist"},d),g),[g,n,r,s,o,d]),C=React47.createElement(Mt.Provider,{value:{isPilledDesign:o}},f);return r?React47.createElement(Qr,{scrollOffset:r},C):C},L0=e=>{var t=e,{children:a,tabs:r}=t,n=E(t,["children","tabs"]);return a&&r&&console.warn("Both children and tabs props are provided. Please use only one of them."),!a&&!r?(console.error("Either children or tabs must be provided."),null):a?React47.createElement(F1,i({},n),a):React47.createElement(j1,i({tabs:r},n))},_0=null,N1=h.Z.div`
  display: inline-grid;
  grid-auto-flow: column;
  align-items: center;
  vertical-align: middle;
  ...
  ${Te("bold")};
  ${b("gap","xsmall")};
`,H0=e=>{var t=e,{color:a,backgroundColor:r,children:n,icon:o,iconPosition:s="left"}=t,d=E(t,["color","backgroundColor","children","icon","iconPosition"]);const m=React48.createElement(fe,{htmlTag:"span",paddingLeft:s==="right"&&"xsmall",paddingRight:s==="left"&&"xsmall"},React48.createElement(ce,{icon:o,color:"currentColor",size:2}));return React48.createElement(N1,i({color:a,backgroundColor:r},d),o&&s==="left"&&m,n,o&&s==="right"&&m)},S0=null,U1={topLeft:"top-start",topCenter:"top",topRight:"top-end",bottomLeft:"bottom-start",bottomCenter:"bottom",bottomRight:"bottom-end",leftTop:"left-start",leftCenter:"left",leftBottom:"left-end",rightTop:"right-start",rightCenter:"right",rightBottom:"right-end"},K1=h.Z.div`
  position: relative;
  width: fit-content;
...
`,na=h.Z.div`
  ${e=>e.zIndex&&`z-index: ${e.zIndex}`};
`,I0=e=>{var t=e,{children:a,content:r,offset:n=.5,boundaryOffset:o=.5,isOpen:s,zIndex:d=500,childrenZIndex:m=1,placement:v="topCenter",rootId:p,boundaryElement:g="body",transitionDuration:f=0,transitionDelay:C=0}=t,x=E(t,["children","content","offset","boundaryOffset","isOpen","zIndex","childrenZIndex","placement","rootId","boundaryElement","transitionDuration","transitionDelay"]);const z=n*et,y=o*et,L=typeof window<"u",P=p&&L?document.getElementById(p):void 0,{stage:N,shouldMount:I}=useTransition2(s,f+C),ae=()=>g==="body"&&L?document.body:g,{x:oe,y:F,reference:Z,floating:U,strategy:ue,update:ne,refs:J}=useFloating({placement:U1[v],middleware:[shift({padding:y,boundary:g?ae():void 0,limiter:limitShift()}),flip({fallbackPlacements:["top","bottom"],fallbackStrategy:"initialPlacement"}),floatingUiOffset(z)],strategy:"fixed"});useEffect10(()=>{if(!(!J.reference.current||!J.floating.current))return autoUpdate(J.reference.current,J.floating.current,ne)},[J.reference,J.floating,ne,I]);const A={zIndex:d,ref:U,style:{position:ue,top:F??"",left:oe??"",transition:`opacity ${f}ms ${C}ms`,opacity:N==="enter"?1:0}};return React49.createElement(K1,k(i({ref:Z},x),{childrenZIndex:m}),a,I&&React49.createElement(React49.Fragment,null,!P&&React49.createElement(na,i({},A),r),P&&ReactDOM.createPortal(React49.createElement(na,i({},A),r),P)))},B0=null,G1=h.Z.span`
  display: block;
...
`,O0=e=>{var t=e,{altText:a,illustration:r,color:n="orange",size:o=12}=t,s=E(t,["altText","illustration","color","size"]);return React50.createElement(G1,i({"aria-hidden":"true","aria-label":a,color:n,size:o},s),r)},D0=null,la=e=>R.iv`
  ${b("width",e.width)};
  ${b("height",e.height)};
...
`,X1=h.Z.div`
  ...
  ${e=>la(e)};
`,J1=e=>{var t=e,{children:a,grow:r,shrink:n,basis:o,width:s,height:d,minWidth:m,minHeight:v,maxWidth:p,maxHeight:g,htmlTag:f="div",className:C,style:x}=t,z=E(t,["children","grow","shrink","basis","width","height","minWidth","minHeight","maxWidth","maxHeight","htmlTag","className","style"]);return(C||x)&&console.warn(Ht),React51.createElement(X1,i({as:f,grow:r,shrink:n,basis:o,width:s,height:d,minWidth:m,minHeight:v,maxWidth:p,maxHeight:g},z),a)},Q1=e=>{var t=e,{children:a,gap:r="initial",rowGap:n,columnGap:o,alignItems:s="center",justifyContent:d,alignContent:m,wrap:v="wrap",width:p,height:g,minWidth:f,minHeight:C,maxWidth:x,maxHeight:z,htmlTag:y="div",className:L,style:P}=t,N=E(t,["children","gap","rowGap","columnGap","alignItems","justifyContent","alignContent","wrap","width","height","minWidth","minHeight","maxWidth","maxHeight","htmlTag","className","style"]);return(L||P)&&console.warn(Ht),React51.createElement(Y1,i({as:y,gap:r,rowGap:n,columnGap:o,alignItems:s,justifyContent:d,alignContent:m,wrap:v,width:p,height:g,minWidth:f,minHeight:C,maxWidth:x,maxHeight:z},N),y==="ul"||y==="ol"?Children.map(a,I=>I.type===J1||I.type===Q1?cloneElement(I,{htmlTag:"li"}):I):a)},V0=null,q1=h.Z.div`
...
`,oi=({swatches:e,currentColor:t,onSwatchClick:a})=>{const r=e.includes(t)&&t;return React52.createElement(ni,null,e.map(n=>React52.createElement(li,{key:n,color:n,selected:r,onClick:()=>a(n),role:"button",tabIndex:0,onKeyDown:o=>{o.key==="Enter"&&(o.preventDefault(),a(n))}})))},ii=({color:e,setColor:t})=>React52.createElement(q1,null,React52.createElement(HexColorPicker,{color:e,onChange:t}),React52.createElement(ti,null,React52.createElement(HexColorInput,{prefixed:!0,color:e,onChange:t}),React52.createElement(ri,{color:e}))),W0=e=>{var t=e,{defaultColor:a="#ffffff",confirmButton:r,swatches:n,onChange:o}=t,s=E(t,["defaultColor","confirmButton","swatches","onChange"]);const[d,m]=useState6(a||"#FFFFFF"),v=g=>{m(g),o(g)},p=g=>{v(g)};return React52.createElement(ei,i({},s),n&&React52.createElement(oi,{swatches:n,currentColor:d,onSwatchClick:p}),React52.createElement(ii,{color:d,setColor:v}),r&&React52.createElement(ai,null,r))},P0=null,si=2,at={small:{totalSize:u(2.25),height:u(.5625),dotSize:u(.375),gap:u(.25)},medium:{totalSize:u(3),height:u(.75),dotSize:u(.5),gap:u(.375)},large:{totalSize:u(6),height:u(1.5),dotSize:u(1),gap:u(.75)}},ci=e=>at[e.size].totalSize,di=e=>at[e.size].height,oa=e=>at[e.size].dotSize,ui=e=>at[e.size].gap,hi=e=>at[e.size].dotSize,mi=e=>R.F4`
  0%, 40%, 100% {
    transform: translateY(50%);
  }
  20% {
...
`,Ut=h.Z.span`
  ...
  background-color: ${e=>c(e.color)};
  transform: translateY(50%);
  animation: ${e=>mi(hi(e))} ${si}s
    ease-in-out infinite;
  animation-fill-mode: both;
  animation-delay: ${e=>e.delay}s;
`,A0=e=>{var t=e,{color:a="body",size:r="medium"}=t,n=E(t,["color","size"]);return React53.createElement(vi,i({size:r},n),React53.createElement(Ut,{color:a,size:r,delay:0}),React53.createElement(Ut,{color:a,size:r,delay:.2}),React53.createElement(Ut,{color:a,size:r,delay:.4}))},T0=Object.keys(at),F0=null,Kt={medium:{totalSize:u(3),barHeight:u(2.25)}},ia={fast:1.2,slow:1.7},gi="linear-gradient(270deg, #565ADD 10.58%, #DC43BE 41.83%, #565ADD 69.23%, #565ADD 96.63%)",pi=2,Gt=5,fi=u(.25),bi=e=>Kt[e.size||"medium"].barHeight,ht=e=>Kt[e.size||"medium"].totalSize,sa=e=>ia[e.speed||"fast"],Ci=R.F4`
  0%, 100% {
...
`,zi=h.Z.span`
  width: ${fi};
  height: ${e=>bi(e)};
  background: ${e=>e.color==="ai-primary"?gi:c(e.color)};
  ...
  animation:
    ${Ei} 50ms ease-out forwards,
    ${Ci} ${e=>sa(e)}s ease-in-out infinite,
    ${wi} ${pi}s linear infinite;

  animation-delay: ${e=>-1+e.index*(sa(e)/Gt)}s;
  position: relative;
`,Z0=e=>{var t=e,{size:a="medium",speed:r="fast",color:n="body"}=t,o=E(t,["size","speed","color"]);const s=Array.from({length:Gt},(d,m)=>React54.createElement(zi,{key:m,index:m,size:a,speed:r,color:n}));return React54.createElement(yi,i({size:a,color:n},o),s)},j0=Object.keys(Kt),N0=Object.keys(ia),U0=null,xi=R.F4`
  0% {
    transform: scale(1);
    opacity: 0;
  }
...
`,Pe={dot:{size:"8px",borderWidth:"1px",borderColor:c("background")},positioning:{top:"-2px",right:"-2px"},animation:{duration:"2s",timing:"ease-out",iteration:"infinite"}},ca={blue:c("blue"),orange:c("orange")},$i=h.Z.span`
  position: relative;
  display: inline-block;
`,Ri=h.Z.span`
  position: absolute;
