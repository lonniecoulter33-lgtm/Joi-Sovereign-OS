(global.webpackChunk_loomhq_desktop_monorepo=global.webpackChunk_loomhq_desktop_monorepo||[]).push([[1027,3780,4576,9724],{889612:(se,_,C)=>{"use strict";var $;$={value:!0},$=void 0;var I=o(C(275271)),J=o(C(774586));function o(O){return O&&O.__esModule?O:{default:O}}const h=O=>I.default.createElement(J.default,Object.assign({dangerouslySetGlyph:'<path fill="currentcolor" fill-rule="evenodd" d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0m4.03 5.03L9.06 8l2.97 2.97-1.06 1.06L8 9.06l-2.97 2.97-1.06-1.06L6.94 8 3.97 5.03l1.06-1.06L8 6.94l2.97-2.97z" clip-rule="evenodd"/>'},O));h.displayName="CrossCircleIcon";var ie=$=h},862953:(se,_,C)=>{"use strict";var $;$={value:!0},$=void 0;var I=o(C(275271)),J=o(C(774586));function o(O){return O&&O.__esModule?O:{default:O}}const h=O=>I.default.createElement(J.default,Object.assign({dangerouslySetGlyph:'<path fill="currentcolor" fill-rule="evenodd" d="M7 2.5a4.5 4.5 0 1 0 0 9 4.5 4.5 0 0 0 0-9M1 7a6 6 0 1 1 10.74 3.68l3.29 3.29-1.06 1.06-3.29-3.29A6 6 0 0 1 1 7" clip-rule="evenodd"/>'},O));h.displayName="SearchIcon";var ie=$=h},450630:(se,_,C)=>{"use strict";C.d(_,{Ni:()=>o.T,Xn:()=>o.w,iv:()=>ze.Z,xB:()=>ae,F4:()=>zt});var $=C(908866),I=C(275271),J=C(117267),o=C(156052),h=C(908308),ie=C(586997),O=C(853434),ze=C(669957),Fe=function(K,j){var V=arguments;if(j==null||!hasOwnProperty.call(j,"css"))return createElement.apply(void 0,V);var T=V.length,Q=new Array(T);Q[0]=Emotion,Q[1]=createEmotionProps(K,j);for(var q=2;q<T;q++)Q[q]=V[q];return createElement.apply(null,Q)},he=!1,ae=(0,o.w)(function(de,K){var j=de.styles;if(typeof j=="function")return(0,I.createElement)(o.T.Consumer,null,function(T){var Q=(0,ie.O)([j(T)]);return(0,I.createElement)(ce,{serialized:Q,cache:K})});var V=(0,ie.O)([j]);return(0,I.createElement)(ce,{serialized:V,cache:K})}),ce=function(de){(0,$.Z)(K,de);function K(V,T,Q){return de.call(this,V,T,Q)||this}var j=K.prototype;return j.componentDidMount=function(){this.sheet=new O.m({key:this.props.cache.key+"-global",nonce:this.props.cache.sheet.nonce,container:this.props.cache.sheet.container});var T=document.querySelector("style[data-emotion-"+this.props.cache.key+'="'+this.props.serialized.name+'"]');T!==null&&this.sheet.tags.push(T),this.props.cache.sheet.tags.length&&(this.sheet.before=this.props.cache.sheet.tags[0]),this.insertStyles()},j.componentDidUpdate=function(T){T.serialized.name!==this.props.serialized.name&&this.insertStyles()},j.insertStyles=function(){if(this.props.serialized.next!==void 0&&(0,h.M)(this.props.cache,this.props.serialized.next,!0),this.sheet.tags.length){var T=this.sheet.tags[this.sheet.tags.length-1].nextElementSibling;this.sheet.before=T,this.sheet.flush()}this.props.cache.insert("",this.props.serialized,this.sheet,!1)},j.componentWillUnmount=function(){this.sheet.flush()},j.render=function(){return null},K}(I.Component),zt=function(){var K=ze.Z.apply(void 0,arguments),j="animation-"+K.name;return{name:j,styles:"@keyframes "+j+"{"+K.styles+"}",anim:1,toString:function(){return"_EMO_"+this.name+"_"+this.styles+"_EMO_"}}},xt=function de(K){for(var j=K.length,V=0,T="";V<j;V++){var Q=K[V];if(Q!=null){var q=void 0;switch(typeof Q){case"boolean":break;case"object":{if(Array.isArray(Q))q=de(Q);else{q="";for(var Ie in Q)Q[Ie]&&Ie&&(q&&(q+=" "),q+=Ie)}break}default:q=Q}q&&(T&&(T+=" "),T+=q)}}return T};function $t(de,K,j){var V=[],T=(0,h.f)(de,V,j);return V.length<2?j:T+K(V)}var Rt=function(){return null},Yt=(0,o.w)(function(de,K){return(0,I.createElement)(o.T.Consumer,null,function(j){var V=!1,T=function(){for(var i=arguments.length,R=new Array(i),y=0;y<i;y++)R[y]=arguments[y];var Ze=(0,ie.O)(R,K.registered);return(0,h.M)(K,Ze,!1),K.key+"-"+Ze.name},Q=function(){for(var i=arguments.length,R=new Array(i),y=0;y<i;y++)R[y]=arguments[y];return $t(K.registered,T,xt(R))},q={css:T,cx:Q,theme:j},Ie=de.children(q);V=!0;var it=(0,I.createElement)(Rt,null);return(0,I.createElement)(I.Fragment,null,it,Ie)})})},182560:(se,_,C)=>{"use strict";var $=Object.defineProperty,I=Object.defineProperties,J=Object.getOwnPropertyDescriptors,o=Object.getOwnPropertySymbols,h=Object.prototype.hasOwnProperty,ie=Object.prototype.propertyIsEnumerable,O=(he,ae,ce)=>ae in he?$(he,ae,{enumerable:!0,configurable:!0,writable:!0,value:ce}):he[ae]=ce,ze=(he,ae)=>{for(var ce in ae||(ae={}))h.call(ae,ce)&&O(he,ce,ae[ce]);if(o)for(var ce of o(ae))ie.call(ae,ce)&&O(he,ce,ae[ce]);return he},Fe=(he,ae)=>I(he,J(ae))},295579:(se,_,C)=>{"use strict";C.d(_,{M:()=>J});var $=C(306317),I=C(275271);function J(){return I.createElement($.Z,{label:"",testId:"ads-refreshed-icon"})}var o=C(182560)},910491:(se,_,C)=>{"use strict";var $=C(889612),I=C(275271);function J(){return React.createElement(CrossCircleIcon,{label:"",testId:"ads-refreshed-icon"})}var o=C(182560)},183780:(se,_,C)=>{"use strict";C.d(_,{JO$:()=>te,LZC:()=>nt,xvT:()=>$e,Ut4:()=>fr});var $=C(738067),I=C(66292),J=C.n(I),o=C(275271),h=C(992671),ie=C(485800),O=C(582805),ze=C(66333),Fe=C(797981),he=C(773023),ae=C(484285),ce=C(862953),zt=C(12131),xt=C(566172),$t=C.n(xt),Rt=C(407770),Yt=C(306317),de=C(957530),K=C(230967),j=C(854831),V=Object.defineProperty,T=Object.defineProperties,Q=Object.getOwnPropertyDescriptors,q=Object.getOwnPropertySymbols,Ie=Object.prototype.hasOwnProperty,it=Object.prototype.propertyIsEnumerable,st=(e,t,a)=>t in e?V(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a,i=(e,t)=>{for(var a in t||(t={}))Ie.call(t,a)&&st(e,a,t[a]);if(q)for(var a of q(t))it.call(t,a)&&st(e,a,t[a]);return e},R=(e,t)=>T(e,Q(t)),y=(e,t)=>{var a={};for(var r in e)Ie.call(e,r)&&t.indexOf(r)<0&&(a[r]=e[r]);if(e!=null&&q)for(var r of q(e))t.indexOf(r)<0&&it.call(e,r)&&(a[r]=e[r]);return a},Ze=(e,t)=>Math.round(e*t/100),Xt=(e,t)=>R(i({},e),{l:e.l-Ze(e.l,t)}),$i=(e,t)=>R(i({},e),{l:e.l+Ze(e.l,t)}),Ri=(e,t)=>R(i({},e),{s:e.s+Ze(e.s,t)}),qe=(e,t)=>R(i({},e),{a:t}),ua=15.8,ha=31.6,ma=.14,va=.46,ga=.9,pa=.8,Jt=.25,fa=.06,ba=.15,Ca=.3,wa=.45,ge={red:{h:4,s:64,l:48,a:1},blurpleLight:{h:214.3,s:91.3,l:95.5,a:1},blurpleMedium:{h:216.5,s:92,l:90.2,a:1},blurple:{h:215.4,s:80,l:47.65,a:1},blurpleDark:{h:215.9,s:79.9,l:41,a:1},blurpleStrong:{h:216.3,s:69.2,l:22.9,a:1},offWhite:{h:0,s:0,l:97.25,a:1},blueLight:{h:216.5,s:92,l:90.2,a:1},blue:{h:215.4,s:80,l:47.65,a:1},blueDark:{h:216.3,s:69.2,l:23,a:1},magenta:{h:323,s:42,l:48,a:1},orangeLight:{h:4,s:100,l:91.2,a:1},orange:{h:11,s:100,l:62.2,a:1},orangeDark:{h:10.9,s:100,l:42.2,a:1},tealLight:{h:155,s:70,l:84,a:1},teal:{h:155,s:62,l:32,a:1},tealDark:{h:155,s:55,l:19,a:1},yellowLight:{h:43,s:93,l:82,a:1},yellow:{h:45.5,s:96,l:57,a:1},yellowDark:{h:39.8,s:100,l:49.4,a:1}},et={grey8:{h:228,s:6,l:17,a:1},grey7:{h:223,s:6,l:24.5,a:1},grey6:{h:224,s:5,l:44,a:1},grey5:{h:224,s:5,l:57,a:1},grey4:{h:223,s:5,l:73,a:1},grey3:{h:225,s:6,l:87.5,a:1},grey2:{h:210,s:7,l:94.5,a:1},grey1:{h:0,s:0,l:97.25,a:1},white:{h:0,s:0,l:100,a:1}},Qt={record:ge.orange,recordHover:Xt(ge.orange,ua),recordActive:Xt(ge.orange,ha),backdropDark:qe(et.grey8,ga),backdropTwilight:qe(ge.blurpleStrong,pa),highlight:qe(ge.blurple,ba),highlightHover:qe(ge.blurple,Ca),highlightActive:qe(ge.blurple,wa),warning:{h:45.5,s:96,l:57,a:1,ads:"--ds-background-warning-bold"}},je={light:R(i({primary:ge.blurple,primaryHover:ge.blurpleDark,primaryActive:ge.blurpleStrong,body:{h:228,s:6,l:17,a:1,ads:"--ds-text"},bodyDimmed:{h:224,s:5,l:44,a:1,ads:"--ds-text-subtlest"},bodyInverse:{h:0,s:0,l:100,a:1,ads:"--ds-text-inverse"},background:{h:0,s:0,l:100,a:1,ads:"--ds-surface"},backgroundHover:{h:209,s:75.6,l:8,a:.08,ads:"--ds-background-neutral-subtle-hovered"},backgroundActive:{h:225.5,s:56.9,l:10,a:.14,ads:"--ds-background-neutral-subtle-pressed"},backgroundSecondary:{h:0,s:0,l:97.25,a:1,ads:"--ds-surface-sunken"},backgroundSecondary2:{h:0,s:0,l:97.25,a:1,ads:"--ds-surface-sunken"},backgroundNeutral:{h:209,s:76,l:8,a:.08,ads:"--ds-background-neutral"},backgroundNeutralHover:{h:226,s:57,l:1,a:.14,ads:"--ds-background-neutral-hovered"},backgroundNeutralActive:{h:223,s:61,l:8,a:.28,ads:"--ds-background-neutral-pressed"},backgroundInverse:{h:228,s:6,l:17,a:1,ads:"--ds-background-neutral-bold"},focusRing:{h:216.1,s:81.4,l:60,a:1,ads:"--ds-border-focused"},overlay:{h:0,s:0,l:100,a:1,ads:"--ds-surface-overlay"},overlayHover:et.grey2,overlayActive:et.grey3,backdrop:{h:224,s:72,l:7,a:va,ads:"--ds-blanket"},border:{h:225.5,s:57,l:10,a:ma,ads:"--ds-border"}},Qt),{info:{h:215,s:80.25,l:47.65,a:1,ads:"--ds-background-information-bold"},success:{h:155,s:62,l:32,a:1,ads:"--ds-background-accent-green-bolder"},danger:{h:4,s:64,l:48,a:1,ads:"--ds-background-danger-bold"},dangerHover:{h:4.3,s:65.7,l:41.2,a:1,ads:"--ds-background-danger-bold-hovered"},dangerActive:{h:4.5,s:56.3,l:23.3,a:1,ads:"--ds-background-danger-bold-pressed"},disabledContent:{h:223,s:5,l:73,a:1,ads:"--ds-text-disabled"},disabledBackground:{h:0,s:0,l:9,a:.03,ads:"--ds-background-disabled"},formFieldBorder:{h:223.6,s:5,l:57,a:1,ads:"--ds-border-input"},formFieldBackground:{h:0,s:0,l:100,a:1,ads:"--ds-background-input"},buttonBorder:{h:252,s:13,l:46,a:Jt,ads:"--ds-border"},tabBackground:{h:209,s:75.6,l:8,a:fa,ads:"--ds-background-neutral"},upgrade:{h:277.5,s:89,l:96.5,a:1,ads:"--ds-background-discovery"},upgradeHover:{h:277,s:86,l:91.6,a:1,ads:"--ds-background-discovery-hovered"},upgradeActive:{h:278.6,s:84.5,l:79.8,a:1,ads:"--ds-background-discovery-pressed"},discoveryBackground:{h:278.6,s:48.4,l:52.2,a:1,ads:"--ds-background-discovery-bold"},discoveryLightBackground:{h:277.5,s:89,l:96.5,a:1,ads:"--ds-background-discovery"},discoveryTitle:{h:228,s:6,l:17,a:1,ads:"--ds-text"},discoveryHighlight:{h:277.5,s:89,l:96.5,a:1,ads:"--ds-background-discovery"}}),dark:R(i({primary:{h:216.3,s:83.2,l:67.3,a:1},primaryHover:{h:216.1,s:85.1,l:76.3,a:1},primaryActive:{h:216.5,s:92,l:90.2,a:1},body:{h:225,s:4.3,l:81.6,a:1,ads:"--ds-text"},bodyDimmed:{h:217.5,s:4,l:60.4,a:1,ads:"--ds-text-subtlest"},bodyInverse:{h:240,s:3,l:12.5,a:1,ads:"--ds-text-inverse"},background:{h:240,s:3,l:12.5,a:1,ads:"--ds-surface"},backgroundHover:{h:240,s:12.6,l:83,a:.07,ads:"--ds-background-neutral-subtle-hovered"},backgroundActive:{h:236,s:36.6,l:92,a:.12,ads:"--ds-background-neutral-subtle-pressed"},backgroundSecondary:{h:210,s:4,l:9.8,a:1,ads:"--ds-surface-sunken"},backgroundSecondary2:{h:210,s:4,l:9.8,a:1,ads:"--ds-surface-sunken"},backgroundNeutral:{h:240,s:12.6,l:83,a:.07,ads:"--ds-background-neutral"},backgroundNeutralHover:{h:236,s:36.6,l:92,a:.12,ads:"--ds-background-neutral-hovered"},backgroundNeutralActive:{h:226,s:49,l:93,a:.25,ads:"--ds-background-neutral-pressed"},backgroundInverse:{h:225,s:4.3,l:81.6,a:1,ads:"--ds-background-neutral-bold"},focusRing:{h:216.1,s:85.1,l:76.3,a:1,ads:"--ds-background-accent-blue-subtle-hovered"},overlay:{h:225,s:4,l:17.6,a:1,ads:"--ds-surface-overlay"},overlayHover:{h:225,s:4,l:19.61,a:1,ads:"--ds-surface-overlay-hovered"},overlayActive:{h:225,s:4.69,l:25.1,a:1,ads:"--ds-surface-overlay-pressed"},backdrop:{h:210,s:11,l:7,a:.6,ads:"--ds-blanket"},border:{h:236,s:36.6,l:92,a:.12,ads:"--ds-border"}},Qt),{info:{h:216.3,s:83,l:67.25,a:1,ads:"--ds-background-information-bold"},success:{h:155,s:57,l:55,a:1,ads:"--ds-background-accent-green-bolder"},danger:{h:3.75,s:91,l:69,a:1,ads:"--ds-background-danger-bold"},dangerHover:{h:4,s:96,l:78,a:1,ads:"--ds-background-danger-bold-hovered"},dangerActive:{h:4,s:100,l:91.2,a:1,ads:"--ds-background-danger-bold-pressed"},disabledContent:{h:225,s:5,l:33,a:1,ads:"--ds-text-disabled"},disabledBackground:{h:0,s:0,l:1,a:.46,ads:"--ds-background-disabled"},formFieldBorder:{h:222,s:4,l:51.4,a:1,ads:"--ds-border-input"},formFieldBackground:{h:225,s:5,l:15,a:1,ads:"--ds-background-input"},buttonBorder:{h:0,s:0,l:100,a:Jt,ads:"--ds-border"},tabBackground:{h:240,s:12.6,l:83,a:.07,ads:"--ds-background-neutral"},upgrade:{h:277.8,s:27.3,l:19.4,a:1,ads:"--ds-background-discovery"},upgradeHover:{h:278,s:44.2,l:25.3,a:1,ads:"--ds-background-discovery-hovered"},upgradeActive:{h:278,s:45,l:44.7,a:1,ads:"--ds-background-discovery-pressed"},discoveryBackground:{h:278.5,s:84.5,l:72.2,a:1,ads:"--ds-background-discovery-bold"},discoveryLightBackground:{h:277.8,s:27.3,l:19.4,a:1,ads:"--ds-background-discovery"},discoveryTitle:{h:225,s:4.3,l:81.6,a:1,ads:"--ds-text"},discoveryHighlight:{h:277.8,s:27.3,l:19.4,a:1,ads:"--ds-background-discovery"}})},oe=i(i({},ge),et),qt=[...Object.keys(oe),...Object.keys(je.light)],Mi=(e,t)=>`hsla(${oe[e].h},${oe[e].s}%,${oe[e].l}%,${t})`,ki=(e,t,a)=>{const r=()=>{if(t==="dark")return oe[e].l-oe[e].l*a;if(t==="light")return oe[e].l+oe[e].l*a};return`hsla(${oe[e].h},${oe[e].s}%,${Math.round(r())}%,${oe[e].a})`},c=e=>{if(e)return e in oe||e in je.light?`var(--lns-color-${e})`:e in ir?`var(--lns-gradient-${e})`:e};function Ea(e,t,a){const r=React.useCallback(()=>typeof window>"u"?a:t[e.findIndex(s=>matchMedia(s).matches)]||a,[a,e,t]),[n,l]=React.useState(r);return React.useEffect(()=>{const s=_debounce(()=>l(r),150);return window.addEventListener("resize",s),()=>window.removeEventListener("resize",s)},[r]),n}var u=e=>e&&`calc(${e} * var(--lns-unit, ${Ue}px))`,be=e=>{if(e in ht)return`var(--lns-space-${e})`;if(e&&isNaN(e))return`${e}`;if(e===0)return"0";if(e)return`${u(e)}`},b=(e,t)=>{if(t||t===0){if(Array.isArray(t)){const a=t.map(r=>`${e}: ${be(r)}`);return Ne(a)}if(typeof t=="object"){const a={};return Object.entries(t).forEach(([r,n])=>a[r]=be(n)),tt(e,a)}return`${e}: ${be(t)};`}},er=(e,t,a)=>`@media(${e}: ${t}){${a}}`,Ne=e=>{const t=Object.values(Oe)[0],a=er("max-width",t,e[0]),r=e.reduce((n,l,s)=>{const d=`${Object.values(Oe)[s]}`;return n+er("min-width",d,l)},"");return a+r},tt=(e,t)=>{const a=[];return t.default&&a.push(`${e}: ${t.default};`),delete t.default,Object.entries(t).forEach(([r,n])=>{const l=r in Oe?Oe[r]:r;a.push(`@media(min-width: ${l}){ ${e}: ${n} }`)}),a.join(" ")},me=(e,t)=>{if(Array.isArray(t)){const a=t.map(r=>`${e}: ${r};`);return Ne(a)}return typeof t=="object"?tt(e,t):`${e}: ${t};`},tr=(e,t)=>{if(e){if(Array.isArray(e)){const a=[];return e.map(r=>{a.push(t[r])}),me("align-items",a)}return`align-items ${t[e]};`}},ya=(e,t,a)=>{if(Array.isArray(a)){const r=a.map(n=>{const l=n===!0?t[0]:t[1];return`${e}: ${l};`});return Ne(r)}return`${e}: ${t[0]};`},rr=(e,t)=>{if(t||t===0){if(Array.isArray(t)){const a=t.map(r=>`${e}: ${r}`);return Ne(a)}return typeof t=="object"&&!Array.isArray(t)?tt(e,t):`${e}: ${t};`}},ct=e=>Array.isArray(e)?e.map(t=>be(t)).join(" "):e,Li=e=>{if(e){if(typeof e=="object"&&!Array.isArray(e)){const t={};return Object.entries(e).forEach(([a,r])=>t[a]=ct(r)),tt("grid-template-columns",t)}return`grid-template-columns: ${ct(e)};`}},ar=(e,t)=>{if(e){if(typeof e=="object"&&!Array.isArray(e)){const a={};return Object.entries(e).forEach(([r,n])=>a[r]=ct(n)),tt(`grid-template-${t}`,a)}return`grid-template-${t}: ${ct(e)};`}},_i=({children:e,queries:t,values:a,defaultValue:r})=>{const n=Ea(t,a,r);return e(n)},xe=e=>e&&`
  font-size: var(--lns-fontSize-${e});
  line-height: var(--lns-lineHeight-${e});
  letter-spacing: var(--lns-letterSpacing-${e});
`,Be=e=>e&&`font-weight: var(--lns-fontWeight-${e});`,za=e=>e&&`var(--lns-fontSetting-${e});`,N=e=>e&&`border-radius: var(--lns-radius-${e});`,rt=e=>e&&`box-shadow: var(--lns-shadow-${e});`,Ce=(e,t)=>{const a=e||c("focusRing");return`box-shadow:${t||""} 0 0 0 2px ${a};`},dt=e=>`
  ...
  ${e=>e.sizeMinMax&&`
    ...
    line-height: clamp(
      ${mt(e.sizeMinMax[0])}px,
      ${ur(mt(e.sizeMinMax[0]),mt(e.sizeMinMax[1]),496,1200)},
      ${mt(e.sizeMinMax[1])}px
    );
  `}
`,La=e=>{var t=e,{children:a,size:r="body-md",color:n,isInline:l,isDimmed:s,fontWeight:d="regular",hasEllipsis:m,ellipsisLines:v,noWrap:p,variant:g,htmlTag:f="span",alignment:w,sizeMinMax:x,fontSetting:z="normal"}=t,E=y(t,["children","size","color","isInline","isDimmed","fontWeight","hasEllipsis","ellipsisLines","noWrap","variant","htmlTag","alignment","sizeMinMax","fontSetting"]);return s&&console.warn($a),r.includes("heading-")&&(d="bold"),o.createElement(ka,i({size:g?_t[g].size:r,color:n,isInline:l,isDimmed:s,fontWeight:g?_t[g].fontWeight:d,hasEllipsis:m,ellipsisLines:v,noWrap:p,variant:g,as:f,alignment:w,sizeMinMax:x,fontSetting:z},E),a)},_a=["left","right","center"],$e=La,vt=["top","bottom","left","right"],hr=i({0:"0"},ht),Ht=i({0:"0",auto:"auto"},ht),Ha=qt.map(e=>({selector:"c",modifier:e,declarations:[{property:"color",value:`var(--lns-color-${e})`}]})),Sa=qt.map(e=>({selector:"bgc",modifier:e,declarations:[{property:"background-color",value:`var(--lns-color-${e})`}]})),Ia=Object.keys(De).map(e=>({selector:"text",modifier:e,declarations:[{property:"font-size",value:`var(--lns-fontSize-${e})`},{property:"line-height",value:`var(--lns-lineHeight-${e})`},{property:"letter-spacing",value:`var(--lns-letterSpacing-${e})`},e.includes("heading-")||e.includes("xlarge")?{property:"font-weight",value:"var(--lns-fontWeight-bold)"}:{property:"font-weight",value:"var(--lns-fontWeight-regular)"}]})),Ba=Object.keys(lr).map(e=>({selector:"weight",modifier:e,declarations:[{property:"font-weight",value:`var(--lns-fontWeight-${e})`}]})),Da=Object.entries(_t).map(([e,t])=>({selector:"text",modifier:e,declarations:[{property:"font-size",value:`var(--lns-fontSize-${t.size})`},{property:"line-height",value:`var(--lns-lineHeight-${t.size})`},{property:"font-weight",value:`var(--lns-fontWeight-${t.fontWeight})`}]})),Oa=_a.map(e=>({selector:"text",modifier:e,declarations:[{property:"text-align",value:e}]})),Va=Object.keys(kt).map(e=>({selector:"shadow",modifier:e,declarations:[{property:"box-shadow",value:`var(--lns-shadow-${e})`}]})),Wa=Object.keys(or).map(e=>({selector:"radius",modifier:e,declarations:[{property:"border-radius",value:`var(--lns-radius-${e})`}]})),at=(e,t,a,r)=>{const n=[];return t.map(l=>{const s=r?`${e.charAt(0)}${l.charAt(0)}`:l;Object.keys(a).map(d=>{n.push({selector:s,property:`${e}${l&&e?`-${l}`:l||""}`,modifier:d,value:d==="auto"||d==="0"?d:`var(--lns-space-${d})`})})}),n},Pa=Object.values(at("margin",["",...vt],Ht,"shortSides")).map(e=>({selector:e.selector,modifier:e.modifier,declarations:[{property:e.property,value:e.value}]})),Aa=Object.values(at("margin",["x","y"],Ht,"shortSides")).map(e=>({selector:e.selector,modifier:e.modifier,declarations:[{property:e.property==="margin-x"?"margin-left":"margin-top",value:e.value},{property:e.property==="margin-x"?"margin-right":"margin-bottom",value:e.value}]})),Ta=Object.values(at("padding",["",...vt],hr,"shortSides")).map(e=>({selector:e.selector,modifier:e.modifier,declarations:[{property:e.property,value:e.value}]})),Fa=Object.values(at("padding",["x","y"],hr,"shortSides")).map(e=>({selector:e.selector,modifier:e.modifier,declarations:[{property:e.property==="padding-x"?"padding-left":"padding-top",value:e.value},{property:e.property==="padding-x"?"padding-right":"padding-bottom",value:e.value}]})),Za=["",...vt].map(e=>{const t="border"+e.replace(e.charAt(0),e.charAt(0).toUpperCase()),a=`border${e&&`-${e}`}`;return{selector:t,declarations:[{property:a,value:"1px solid var(--lns-color-border)"}]}}),ja=["inline","block","flex","inlineBlock","inlineFlex","none"],Na=ja.map(e=>({selector:e,declarations:[{property:"display",value:ut(e)}]})),Ua=[{selector:"flexWrap",declarations:[{property:"flex-wrap",value:"wrap"}]}],Ka=["column","row"],Ga=Ka.map(e=>({selector:"flexDirection",modifier:e,declarations:[{property:"flex-direction",value:e}]})),Ya=["stretch","center","baseline","flexStart","flexEnd","selfStart","selfEnd"],Xa=Ya.map(e=>({selector:"items",modifier:e,declarations:[{property:"align-items",value:ut(e)}]})),Ja=["flexStart","flexEnd","center","spaceBetween","spaceAround","spaceEvenly"],Qa=Ja.map(e=>({selector:"justify",modifier:e,declarations:[{property:"justify-content",value:ut(e)}]})),qa=["0","1"],en=qa.map(e=>({selector:"grow",modifier:e,declarations:[{property:"flex-grow",value:e}]})),tn=["0","1"],rn=tn.map(e=>({selector:"shrink",modifier:e,declarations:[{property:"flex-shrink",value:e}]})),an=["auto","flexStart","flexEnd","center","baseline","stretch"],nn=an.map(e=>({selector:"self",modifier:e,declarations:[{property:"align-self",value:ut(e)}]})),ln=["hidden","auto"],on=ln.map(e=>({selector:"overflow",modifier:e,declarations:[{property:"overflow",value:e}]})),sn=["relative","absolute","sticky","fixed"],cn=sn.map(e=>({selector:e,declarations:[{property:"position",value:e}]})),dn=Object.values(at("",vt,Ht)).map(e=>({selector:e.selector,modifier:e.modifier,declarations:[{property:e.property,value:e.value}]})),un=["auto","full","0"],hn=un.map(e=>({selector:"width",modifier:e,declarations:[{property:"width",value:e==="full"?"100%":e}]})),mn=[{selector:"minWidth",modifier:"0",declarations:[{property:"min-width",value:"0"}]}],vn=["auto","full","0"],gn=vn.map(e=>({selector:"height",modifier:e,declarations:[{property:"height",value:e==="full"?"100%":e}]})),pn=[{selector:"ellipsis",declarations:[{property:"overflow",value:"hidden"},{property:"text-overflow",value:"ellipsis"},{property:"white-space",value:"nowrap"}]}],fn=[{selector:"srOnly",declarations:[{property:"position",value:"absolute"},{property:"width",value:"1px"},{property:"height",value:"1px"},{property:"padding",value:"0"},{property:"margin",value:"-1px"},{property:"overflow",value:"hidden"},{property:"clip",value:"rect(0, 0, 0, 0)"},{property:"white-space",value:"nowrap"},{property:"border-width",value:"0"}]}],bn="\\:",mr=[...Ha,...Va,...Wa,...Sa,...Pa,...Aa,...Ta,...Fa,...Ia,...Ba,...Da,...Oa,...Za,...Na,...Ua,...Ga,...Xa,...Qa,...en,...rn,...nn,...on,...cn,...dn,...hn,...mn,...gn,...pn,...fn],vr=(e,t)=>{const a=[],r=t?`${t}-`:"";return e.map(n=>{const l=[];n.declarations.map(d=>{l.push(`${d.property}:${d.value}`)});const s=`.${r}${n.selector}${n.modifier?bn:""}${n.modifier?n.modifier:""}{${l.join(";")}}`;a.push(s)}),a.join("")},Cn={xs:Oe.xsmall,sm:Oe.small,md:Oe.medium,lg:Oe.large},wn=()=>(()=>{const t=[];return t.push(`${vr(mr)}`),Object.entries(Cn).map(([a,r])=>{t.push(`@media(min-width:${r}){${vr(mr,a)}}`)}),t.join("")})(),we=(e,t)=>{const a={};return Object.entries(t).forEach(([r,n])=>{const s=`--lns-${(e?`${e}-`:"")+r}`;a[s]=n}),a},En=()=>{const e={};return Object.entries(De).forEach(([t,a])=>{const r={},n={},l={},s=`fontSize-${t}`,d=`lineHeight-${t}`,m=`letterSpacing-${t}`;r[s]=u(a.fontSize),r[d]=a.lineHeight,r[m]=a.letterSpacing,Object.assign(e,r,n,l)}),e},yn=()=>{const e={};return Object.entries(ht).forEach(([t,a])=>{const r=`space-${t}`;e[r]=u(a)}),e},zn=()=>{const e={};return Object.keys(i(i({},ge),et)).forEach(t=>{const a=t;e[a]=`hsla(${oe[t].h},${oe[t].s}%,${oe[t].l}%,${oe[t].a})`}),e},xn=()=>{const e=(t,a)=>Object.keys(t).reduce((r,n)=>{const l=t[n],s=`${a}-color-${n}`;return r[s]=l.ads?`var(${l.ads}, hsla(${l.h},${l.s}%,${l.l}%,${l.a}))`:`hsla(${l.h},${l.s}%,${l.l}%,${l.a})`,r},{});return i(i({},e(je.light,"themeLight")),e(je.dark,"themeDark"))},$n=we(void 0,{unit:`${Ue/16}rem`}),Rn=we("fontWeight",lr),Mn=we("fontSetting",xa),kn=we(void 0,En()),Ln=we("radius",or),_n=we("shadow",kt),Hn=we(void 0,yn()),Sn=we(void 0,{formFieldBorderWidth:"1px",formFieldBorderWidthFocus:"2px",formFieldHeight:u(4.5),formFieldRadius:"var(--lns-radius-175)",formFieldHorizontalPadding:u(2),formFieldBorderShadow:`
  ...
  `}),In=we("color",zn()),Bn=we(void 0,xn()),Dn=we("gradient",ir),gr=[$n,kn,Ln,_n,Hn,Sn],On=()=>Object.assign({},...gr),Vn=()=>Object.assign({},Rn,...gr,Mn),Wn=()=>i(i(i({},In),Bn),Dn),Pn=()=>Object.keys(je.light).map(e=>`--lns-color-${e}: var(--lns-themeLight-color-${e});`),An=()=>Object.keys(je.dark).map(e=>`--lns-color-${e}: var(--lns-themeDark-color-${e});`),pr=(e=":root")=>`
    ${e||":root"},
    .theme-light,
  ...
  `},Fn=e=>{switch(e){case"orange":return{background:"orangeLight",text:"dangerHover"};case"blue":return{background:"blueLight",text:"blueDark"};case"yellow":return{background:"yellowLight",text:"#9E4C00"};case"teal":return{background:"tealLight",text:"tealDark"};default:return{background:"orangeLight",text:"dangerHover"}}},Zn=e=>`calc(${e} / 2)`,Ve=e=>{let t,a;if(e==="medium")t=u(4),a=u(4);else if(e==="large")t=u(7),a=u(7);else{const n=be(e);t=n,a=n}const r=Zn(t);return{width:t,height:a,fontSize:r}},jn=h.Z.span`
  display: block;
...
`,Nn=h.Z.img`
  ...
  height: ${e=>{const{height:t}=Ve(e.size);return t}};
  font-size: ${e=>{const{fontSize:t}=Ve(e.size);return t}};
`,Ii=e=>{var t=e,{altText:a="",size:r=4,letter:n,imageSrc:l,children:s,themeColor:d="blue"}=t,m=y(t,["altText","size","letter","imageSrc","children","themeColor"]);const v=()=>{if(s)return s;if(l){const f=Ve(r).height,w=Ve(r).width;return React3.createElement(Nn,{size:r,alt:a,src:l,height:f,width:w})}if(n)return a?React3.createElement("span",{"aria-label":a},n):n},p=n&&!l&&!s,g=Fn(d||"blue");return React3.createElement(jn,i({hasBackgroundColor:p,size:r,backgroundColor:g.background,color:g.text},m),v())},Bi=null,fr=(e=":root",t="body")=>`
    ${e} {
      font-size: 100%;
    }
    ${t} {
...
`,Gn=e=>{var t=e,{altText:a,icon:r,color:n="body",size:l=Un}=t,s=y(t,["altText","icon","color","size"]);const d=o.useRef(null);return o.createElement(Kn,i({ref:d,"aria-label":a,color:n,size:l},s),r)},te=Gn,br=1,St=8,It={small:{totalSize:18},medium:{totalSize:24},large:{totalSize:48}},gt=e=>It[e.size].totalSize/6,Bt=e=>It[e.size].totalSize,Yn=$.F4`
  50% {
    transform: scale(1);
  }
`,Xn=h.Z.span`
...
`,Qn=h.Z.span`
  ...
  transform: rotate(${e=>e.position*(360/St)}deg)
    translateY(${e=>Bt(e)/2-gt(e)/2}px);

  &:after {
    content: '';
    height: ${e=>gt(e)}px;
    width: ${e=>gt(e)}px;
    border-radius: ${e=>gt(e)}px;
...
`,Re={neutral:{color:c("body"),background:"transparent",borderColor:c("buttonBorder"),hover:c("backgroundHover"),active:c("backgroundActive"),floatingBackground:c("overlay"),floatingHover:c("overlayHover"),floatingActive:c("overlayActive")},neutralSecondary:{color:c("body"),background:c("backgroundNeutral"),borderColor:null,hover:c("backgroundNeutralHover"),active:c("backgroundNeutralActive")},primary:{color:c("white"),background:c("blurple"),borderColor:null,hover:c("primaryHover"),active:c("primaryActive")},secondary:{color:c("primary"),background:c("highlight"),borderColor:null,hover:c("highlightHover"),active:null},record:{color:c("white"),background:c("record"),borderColor:null,hover:c("recordHover"),active:c("recordActive")},upgrade:{color:c("body"),background:c("upgrade"),borderColor:null,hover:c("upgradeHover"),active:c("upgradeActive"),focusRing:Ce()},danger:{color:c("bodyInverse"),background:c("danger"),borderColor:null,hover:c("dangerHover"),active:c("dangerActive")},ai:{color:c("white"),background:c("ai-primary"),borderColor:null,hover:null,active:null}},Cr=e=>({enabled:$.iv`
  ...
  appearance: none;
  padding: 0
    ${e=>e.hasChildren?pe[e.size].xSpace:0};
  font: inherit;
  ...
  white-space: nowrap;
  ${Be("bold")};
  border-radius: ${e=>pe[e.size].radius};
  // TODO: remove hasFullWidth after deprecation period
  ${e=>e.hasFullWidth?"display: flex; width: 100%":"display: inline-flex"};
  ${e=>tl(e)[e.width]};
  height: ${e=>pe[e.size].height};
  ${e=>xe(pe[e.size].textSize)};
  ${e=>e.isFloating&&`box-shadow: ${kt.medium}`};
  ${e=>e.disabled?Cr(e).disabled:Cr(e).enabled};
  ${e=>!e.disabled&&`
    border: ${Re[e.variant].borderColor?`1px solid ${Re[e.variant].borderColor}`:"none"};
    background: ${e.isFloating&&e.variant==="neutral"?Re[e.variant].floatingBackground:Re[e.variant].background};
    background-position: left;
    background-size: 125%;
    color: ${Re[e.variant].color};
  `};
  ...
  &:hover {
    transition:
      0.3s background,
      0.3s border-color;
    background: ${e=>e.isFloating&&e.variant==="neutral"?Re[e.variant].floatingHover:Re[e.variant].hover};
  ...
  &:active {
    transition:
      0s background,
      0s border-color;
    background: ${e=>e.isFloating&&e.variant==="neutral"?Re[e.variant].floatingActive:Re[e.variant].active};
...
`,ll=h.Z.span`
  ${Ot};
`,Wi=e=>{var t=e,{size:a="medium",children:r,variant:n="neutral",hasFullWidth:l,width:s="auto",icon:d,iconPosition:m="left",iconBefore:v,iconAfter:p,logoSrc:g,hasLoader:f,isDisabled:w,ariaDisabled:x,htmlTag:z="button",interactionName:E,onClick:M,refHandler:B}=t,F=y(t,["size","children","variant","hasFullWidth","width","icon","iconPosition","iconBefore","iconAfter","logoSrc","hasLoader","isDisabled","ariaDisabled","htmlTag","interactionName","onClick","refHandler"]);const H=d&&m==="left"?d:null,G=v||H?React7.createElement(Er,{hasLoader:f,paddingLeft:"0",paddingRight:r?wr:"0"},React7.createElement(te,{icon:v||H,color:"currentColor",size:pe[a].iconSize})):null,ee=d&&m==="right"?d:null,W=p||ee?React7.createElement(Er,{hasLoader:f,paddingLeft:r?wr:"0",paddingRight:"unset"},React7.createElement(te,{icon:ee||p,color:"currentColor",size:pe[a].iconSize})):null,P=useCallback(Z=>{E&&traceUFOPress(E),M?.(Z)},[M,E]);return React7.createElement(rl,R(i({size:a,variant:n,hasFullWidth:l,width:s,icon:d,iconPosition:m,logoSrc:g,disabled:w,ariaDisabled:x,as:z,hasChildren:r,ref:Z=>B&&B(Z)},F),{onClick:E===void 0?M:P}),f&&React7.createElement(nl,null,React7.createElement(Dt,{color:"currentColor"})),G,g&&React7.createElement(al,{alt:"",hasSpacing:Boolean(r),src:g,size:a,height:pe[a].height,width:pe[a].height,hasLoader:f}),React7.createElement(ll,{hasLoader:f},r),W)},Pi=Object.keys(pe),Ai=Object.keys(Re),Ti=null,ol=h.Z.div`
...
`,il=e=>{var t=e,{children:a,all:r,y:n,x:l,top:s,right:d,bottom:m,left:v,isInline:p}=t,g=y(t,["children","all","y","x","top","right","bottom","left","isInline"]);return o.createElement(ol,i({all:r,top:n||s,bottom:n||m,right:l||d,left:l||v,isInline:p},g),a)},nt=il,pt={topLeft:"start",topCenter:"start center",topRight:"start end",centerLeft:"center start",center:"center",centerRight:"center end",bottomLeft:"end start",bottomCenter:"end center",bottomRight:"end"},sl=e=>{if(Array.isArray(e))return e.map(t=>pt[t]);if(typeof e=="object"){const t={};return Object.entries(e).forEach(([a,r])=>t[a]=pt[r]),t}return pt[e]},cl=h.Z.div`
  width: 100%;
  height: 100%;
  display: grid;
  ${e=>me("place-items",sl(e.alignment))};
`,dl=e=>{var t=e,{children:a,alignment:r="center",htmlTag:n="div"}=t,l=y(t,["children","alignment","htmlTag"]);return o.createElement(cl,i({alignment:r,as:n},l),a)},Fi=Object.keys(pt),Pe=dl,ul=(e,t,a)=>{const r=t||"border",l=`${be(a)} solid ${c(r)}`;if(e)return e==="all"?`border: ${l};`:`border-${e}: ${l};`},hl=h.Z.div`
...
`,ml=e=>{var t=e,{children:a,backgroundColor:r,backgroundImage:n,contentColor:l,borderColor:s,radius:d,borderSide:m,borderWidth:v="1px",shadow:p,padding:g,paddingX:f,paddingY:w,paddingLeft:x,paddingRight:z,paddingTop:E,paddingBottom:M,margin:B,marginX:F,marginY:H,marginLeft:G,marginRight:ee,marginTop:W,marginBottom:P,width:Z,height:ne,minWidth:Y,minHeight:U,maxWidth:D,maxHeight:le,htmlTag:X="div",position:fe,overflow:ke,zIndex:k,top:re,bottom:Je,left:Le,right:Se,refHandler:Ee}=t,L=y(t,["children","backgroundColor","backgroundImage","contentColor","borderColor","radius","borderSide","borderWidth","shadow","padding","paddingX","paddingY","paddingLeft","paddingRight","paddingTop","paddingBottom","margin","marginX","marginY","marginLeft","marginRight","marginTop","marginBottom","width","height","minWidth","minHeight","maxWidth","maxHeight","htmlTag","position","overflow","zIndex","top","bottom","left","right","refHandler"]);return o.createElement(hl,i({backgroundColor:r,backgroundImage:n,contentColor:l,borderColor:s,radius:d,borderSide:m,shadow:p,padding:g,paddingLeft:f||x,paddingRight:f||z,paddingTop:w||E,paddingBottom:w||M,margin:B,marginLeft:F||G,marginRight:F||ee,marginTop:H||W,marginBottom:H||P,width:Z,height:ne,minWidth:Y,minHeight:U,maxWidth:D,maxHeight:le,as:X,position:fe,top:re,bottom:Je,left:Le,right:Se,overflow:ke,zIndex:k,borderWidth:v,ref:S=>Ee&&Ee(S)},L),a)},ue=ml,ve={small:{height:u(4),width:u(5),iconSize:2,padding:u(1.75),withIconPadding:u(4.5),passwordAdditionalPadding:u(.5),textSize:"small",radius:"var(--lns-radius-150)"},medium:{height:"var(--lns-formFieldHeight)",width:u(6),iconSize:3,padding:"var(--lns-formFieldHorizontalPadding)",withIconPadding:u(5.5),passwordAdditionalPadding:u(.5),textSize:"medium",radius:"var(--lns-radius-175)"},large:{height:u(7),width:u(6),iconSize:3,padding:"var(--lns-formFieldHorizontalPadding)",withIconPadding:u(5.5),passwordAdditionalPadding:u(.5),textSize:"large",radius:"var(--lns-radius-250)"}},vl=e=>{let t=e.addOn?ve[e.inputSize].withIconPadding:ve[e.inputSize].padding;return e.type==="password"&&(t=`calc(${ve[e.inputSize].passwordAdditionalPadding} + ${t})`),t},gl=h.Z.input`
  -webkit-appearance: none;
  font-family: inherit;
  width: 100%;
  height: ${e=>ve[e.inputSize].height};
  border: none;
  color: inherit;
  ...
  padding-top: 0;
  padding-bottom: 0;
  padding-left: ${e=>e.icon?ve[e.inputSize].withIconPadding:ve[e.inputSize].padding};
  padding-right: ${e=>vl(e)};
  border-radius: ${e=>ve[e.inputSize].radius};
...
`,Zi=(0,o.forwardRef)((e,t)=>{var a=e,{placeholder:r,onFocus:n,onChange:l,onBlur:s,onKeyDown:d,isDisabled:m,icon:v,type:p="text",value:g,hasError:f,size:w="medium",addOn:x}=a,z=y(a,["placeholder","onFocus","onChange","onBlur","onKeyDown","isDisabled","icon","type","value","hasError","size","addOn"]);const E=o.createElement(gl,i({type:p,placeholder:r,onFocus:n,onChange:l,onBlur:s,onKeyDown:d,disabled:m,icon:v,ref:t,value:g,hasError:f,inputSize:w,addOn:x},z));return v||x?o.createElement(pl,null,v&&o.createElement(fl,{size:w},typeof v=="string"?o.createElement(ue,{radius:"50",width:ve[w].iconSize,height:ve[w].iconSize,overflow:"hidden"},o.createElement(Pe,{alignment:"center"},o.createElement(bl,{src:v,alt:"",isDisabled:m}))):o.createElement(te,{icon:v,size:ve[w].iconSize,color:c(m?"disabledContent":"body")})),E,x&&o.createElement(Cl,{size:w},x)):E}),wl=null,yr={start:"flex-start",center:"center",end:"flex-end",stretch:"stretch"},zr=!1,ft=e=>Array.isArray(e)?e:[e],xr=(e,t)=>{if(e.length===t)return e;const a=e[e.length-1];return[...Array(t)].map((r,n)=>e[n]||a)},El=(e,t)=>{const a=Math.max(ft(e).length,ft(t).length),r=xr(ft(t),a),n=xr(ft(e),a),l="& > * + *",s=r.map((m,v)=>{const p=`${be(m)} 0 0 0`,g=`0 0 0 ${be(m)}`,f=n[v]==="column"?p:g;return`${l}{ margin: ${f}; }`}),d=n.map(m=>`flex-direction: ${m}`);return Ne(s)+Ne(d)},yl=h.Z.div`
  display: flex;
  flex-wrap: wrap;
...
`,ji=e=>{var t=e,{children:a,gap:r,direction:n="row",alignment:l="start",isSpread:s,htmlTag:d="div"}=t,m=y(t,["children","gap","direction","alignment","isSpread","htmlTag"]);return zr||(console.warn(Ra),zr=!0),React12.createElement(yl,i({gap:r,flexDirection:n,flexAlign:l,isSpread:s,as:d},m),a)},Ni=Object.keys(yr),Ui=null,zl=h.Z.div`
  display: grid;
  ${e=>me("align-items",e.alignItems)};
  ${e=>me("justify-content",e.justifyContent)};
  ${e=>e.justifyItems&&me("justify-items",e.justifyItems)};
  ${e=>e.alignContent&&me("align-content",e.alignContent)};
  ...
  ${e=>e.autoFlow&&me("grid-auto-flow",e.autoFlow)};
  ${e=>e.columns&&e.autoFlow&&me("grid-auto-flow",e.autoFlow)};
  ${e=>nr(e.as)};
`,xl=e=>{var t=e,{children:a,width:r,height:n,minWidth:l,minHeight:s,maxWidth:d,maxHeight:m,gap:v,columns:p,rows:g,alignItems:f="center",justifyContent:w="start",justifyItems:x,alignContent:z,autoFlow:E,htmlTag:M="div",className:B,style:F}=t,H=y(t,["children","width","height","minWidth","minHeight","maxWidth","maxHeight","gap","columns","rows","alignItems","justifyContent","justifyItems","alignContent","autoFlow","htmlTag","className","style"]);return(B||F)&&console.warn(Lt),o.createElement(zl,i({alignItems:f,as:M,justifyContent:w,justifyItems:x,alignContent:z,gap:v,columns:p,rows:g,width:r,height:n,minWidth:l,minHeight:s,maxWidth:d,maxHeight:m,autoFlow:E},H),a)},Ke=xl;function $r(){return o.createElement(O.Z,{label:"",testId:"ads-refreshed-icon"})}var $l=h.Z.div`
  position: relative;
  ::before {
    content: '';
...
`,Ki=({children:e,errorActive:t,errorMessage:a="Oops, that didn't work. Try again."})=>t?React15.createElement($l,null,React15.createElement(Ke,{autoFlow:"row",gap:"small"},e,a?React15.createElement(Ke,{gap:"xsmall"},React15.createElement(te,{icon:React15.createElement($r,null),size:2,color:"danger"}),React15.createElement($e,{size:"body-sm",color:"danger"},a)):null)):React15.createElement(React15.Fragment,null,e),Gi=null,Rl={start:"flex-start",center:"center",end:"flex-end"},Ml=h.Z.div`
  display: flex;
  ${e=>tr(e.alignment,Rl)};
...
`,Ll=e=>{var t=e,{width:a,maxWidth:r,children:n}=t,l=y(t,["width","maxWidth","children"]);return console.warn(sr),o.createElement(kl,i({width:a,maxWidth:r},l),n)},_l=class extends o.Component{render(){return console.warn(sr),o.createElement(Ml,i({},this.props),this.props.children)}};_l.Section=Ll;var Yi=null,lt={small:{size:u(3),iconSize:2.25,radius:"var(--lns-radius-100)"},medium:{size:u(4),iconSize:3,radius:"var(--lns-radius-150)"},large:{size:u(5),iconSize:4,radius:"var(--lns-radius-175)"}},Hl=h.Z.button`
...
`,Rr=o.forwardRef((e,t)=>{var a=e,{altText:r,icon:n,onClick:l,iconColor:s="body",backgroundColor:d,isActive:m,isDisabled:v,size:p="medium"}=a,g=y(a,["altText","icon","onClick","iconColor","backgroundColor","isActive","isDisabled","size"]);return o.createElement(Hl,i({"aria-label":r,onClick:l,isActive:m,disabled:v,size:p,backgroundColor:d,ref:t},g),o.createElement(te,{icon:n,size:lt[p].iconSize,color:v?"disabledContent":s}))});Rr.displayName="IconButton";var Vt=Rr,Sl=e=>o.createElement("svg",i({width:12,height:9,viewBox:"0 0 12 9",fill:"none"},e),o.createElement("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M11.707.293a1 1 0 010 1.414l-7 7a1 1 0 01-1.414 0l-3-3a1 1 0 011.414-1.414L4 6.586 10.293.293a1 1 0 011.414 0z",fill:"currentColor"})),Il=e=>o.createElement("svg",i({width:12,height:2,viewBox:"0 0 12 2",fill:"none"},e),o.createElement("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M0 1a1 1 0 011-1h10a1 1 0 110 2H1a1 1 0 01-1-1z",fill:"currentColor"})),Bl=h.Z.div`
  display: block;
  position: relative;
`,Dl=h.Z.input`
  height: 100%;
...
`,Ol=h.Z.span`
  ...
  justify-content: center;
  user-select: none;
`,Vl=(0,o.forwardRef)((e,t)=>{var a=e,{isDisabled:r,isChecked:n,isIndeterminate:l,onFocus:s,onChange:d,onBlur:m}=a,v=y(a,["isDisabled","isChecked","isIndeterminate","onFocus","onChange","onBlur"]);const p=(0,o.useRef)(),g=t||p,f=c(r?"disabledContent":"currentColor");return(0,o.useEffect)(()=>{g.current.indeterminate=l}),o.createElement(Bl,null,o.createElement(Dl,i({type:"checkbox",disabled:r,checked:n,onFocus:s,onChange:d,onBlur:m,ref:g,"aria-checked":n},v)),o.createElement(Ol,{className:"CheckboxBox"},o.createElement(Il,{className:"Icon IconMinus",color:f}),o.createElement(Sl,{className:"Icon IconCheck",color:f})))}),Wl=Vl,Ge={small:{textSize:"small",iconSize:2.25,height:u(3),xSpace:u(1),radius:"var(--lns-radius-100)"},medium:{textSize:"medium",iconSize:3,height:u(4),xSpace:u(1.5),radius:"var(--lns-radius-150)"},large:{textSize:"large",iconSize:4,height:u(6),xSpace:u(3),radius:"var(--lns-radius-200)"}},Pl=h.Z.button`
...
`,Al=o.forwardRef((e,t)=>{var a=e,{onClick:r,size:n="medium",children:l,icon:s,iconPosition:d="left",isActive:m,isDisabled:v,htmlTag:p,offsetSide:g}=a,f=y(a,["onClick","size","children","icon","iconPosition","isActive","isDisabled","htmlTag","offsetSide"]);const w=o.createElement(ue,{paddingLeft:d==="right"&&"small",paddingRight:d==="left"&&"small",htmlTag:"span"},o.createElement(te,{icon:s,size:Ge[n].iconSize,color:v?"disabledColor":void 0}));return o.createElement(Pl,i({onClick:r,size:n,icon:s,iconPosition:d,disabled:v,isActive:m,as:p,offsetSide:g,ref:t},f),s&&d==="left"&&w,l,s&&d==="right"&&w)});Al.displayName="TextButton";var Xi=null,Wt=e=>{var t,a;const r=(a=(t=e?.())==null?void 0:t.getRootNode)==null?void 0:a.call(t);if(String(r)==="[object ShadowRoot]"){r.createElement=(...l)=>r.ownerDocument.createElement(...l);const n=r.createElement("div");return n.id="a11y-status-message",n.style.display="none",r.appendChild(n),{document:r,addEventListener:r.addEventListener.bind(r),removeEventListener:r.removeEventListener.bind(r)}}return typeof window>"u"?null:window},We=e=>typeof e=="string"?e:typeof e=="number"||typeof e=="boolean"||typeof e=="bigint"?e.toString():e==null?"":Tl(e)?Array.from(e).map(We).join(""):typeof e=="object"&&"props"in e&&e.props&&e.props.children!==void 0?We(e.props.children):"",Tl=e=>typeof e[Symbol.iterator]=="function";function Mr(){return o.createElement("span",{"aria-hidden":!0,"data-testid":"ads-refreshed-icon"},o.createElement("svg",{viewBox:"-2 -2 16 16"},o.createElement("path",{fill:"currentColor",fillRule:"evenodd",d:"M2.03 3.97 6 7.94l3.97-3.97 1.06 1.06-4.5 4.5a.75.75 0 0 1-1.06 0l-4.5-4.5z",clipRule:"evenodd"})))}function Fl(){return o.createElement(ae.Z,{label:"",testId:"ads-refreshed-icon"})}var Pt={left:"bottom-start",right:"bottom-end",topLeft:"top-start",topRight:"top-end",leftSide:"left-start",rightSide:"right-start"},Zl=h.Z.div`
...
`,Ul=h.Z.img`
  ...
  object-fit: cover;
  opacity: ${({isDisabled:e})=>e?.5:1};
`,At=e=>{var t=e,{isDisabled:a,isHighlighted:r,isSelected:n,icon:l,hasDivider:s,children:d,menuItemRole:m,keyboardMove:v}=t,p=y(t,["isDisabled","isHighlighted","isSelected","icon","hasDivider","children","menuItemRole","keyboardMove"]);const w=`${l?"auto":""} 1fr ${n?"auto":""}`,x=a?"disabledContent":void 0,z=m?R(i({},p),{role:m}):p;return o.createElement(Nl,i({isHighlighted:r,isDisabled:a,keyboardMove:v,columns:w,hasDivider:s,tabIndex:a?-1:0,"data-highlighted":r||void 0},z),l&&(typeof l=="string"?o.createElement(ue,{radius:"50",width:3,height:3,overflow:"hidden"},o.createElement(Pe,{alignment:"center"},o.createElement(Ul,{src:l,alt:"",isDisabled:a}))):o.createElement(te,{icon:l,color:x})),o.createElement($e,{color:x,hasEllipsis:!0},d),n&&o.createElement(te,{icon:o.createElement(Fl,null),color:x}))},Kl=e=>{var t=e,{position:a,zIndex:r,minWidth:n,maxWidth:l,maxHeight:s,children:d,role:m,downshiftMenuProps:v=()=>null,search:p}=t,g=y(t,["position","zIndex","minWidth","maxWidth","maxHeight","children","role","downshiftMenuProps","search"]);const f=m?R(i({},v()),{role:m}):i({},v());return o.createElement(Zl,i(i({minWidth:n,maxWidth:l,maxHeight:s,zIndex:r,position:a},f),g),p&&p,o.createElement(jl,{search:p},d))},Ae=Kl;function Gl(){return React24.createElement(SearchIcon,{label:"",testId:"ads-refreshed-icon"})}var Yl=h.Z.div`
  padding: ${u(1.5)} ${u(1.5)} 0;
  margin-bottom: ${u(1.5)};
  position: sticky;
  top: 0;
`,Ji=({ariaLabel:e,placeholder:t,value:a,onChange:r,getInputProps:n})=>React25.createElement(Yl,null,React25.createElement(wl,i({"aria-label":e,icon:React25.createElement(Gl,null)},n({placeholder:t,value:a,onChange:r,type:"text"})))),kr=null,Xl=h.Z.div`
  position: relative;
`,Jl=h.Z.button`
  appearance: none;
  font: inherit;
...
`,e1=h.Z.span`
  ...
  grid-column-start: 1;
  grid-column-end: 3;
`,bt=e=>Array.isArray(e)&&e.length>0&&"group"in e[0],Tt=({options:e,selectedOptionValue:t})=>{if(!e||!t)return{icon:null,title:null};if(bt(e))for(const a of e){const r=a.items.find(n=>n.value===t);if(r)return r}else return e.find(r=>r.value===t)||{icon:null,title:null};return{icon:null,title:null}},Lr=({options:e,selectedItem:t,selectedOptionValue:a})=>{if(t)return t.icon;if(a)return Tt({options:e,selectedOptionValue:a}).icon},t1=({options:e,selectedItem:t,selectedOptionValue:a,selectPlaceholder:r})=>t?t.title:a?Tt({options:e,selectedOptionValue:a}).title:r,_r=({selectedItem:e,getInputProps:t,getToggleButtonProps:a,ariaMenuName:r,isOpen:n})=>{const l=e?`selected value is ${e.title}`:"no value selected",s=a?.()["aria-label"];return{"aria-expanded":n,"aria-activedescendant":t()["aria-activedescendant"],"aria-label":[r,s,l].filter(Boolean).join(", ")}},r1=({getToggleButtonProps:e,inputValue:t,selectedItem:a,selectedOptionValue:r,selectPlaceholder:n,isDisabled:l,options:s,getInputProps:d,ariaMenuName:m,hasError:v,isOpen:p})=>{const g=Lr({options:s,selectedItem:a,selectedOptionValue:r}),f=Boolean(g),w=!r&&!a,z=`${f?"auto":""} 1fr auto`,E=l?"disabledContent":void 0;return React26.createElement(Jl,R(i(i({},e()),_r({selectedItem:a,getInputProps:d,getToggleButtonProps:e,ariaMenuName:m,isOpen:p})),{hasValue:t||r,disabled:l,columns:z,hasError:v}),f&&(typeof g=="string"?React26.createElement(ue,{radius:"50",width:3,height:3,overflow:"hidden"},React26.createElement(Pe,{alignment:"center"},React26.createElement(Ql,{src:g,alt:"",isDisabled:l}))):React26.createElement(te,{icon:Lr({options:s,selectedItem:a,selectedOptionValue:r}),color:E})),React26.createElement($e,{hasEllipsis:!0,color:w?"bodyDimmed":"inherit"},t1({options:s,selectedItem:a,selectedOptionValue:r,selectPlaceholder:n})),React26.createElement(te,{icon:React26.createElement(Mr,null),color:E}))},a1=({selectedOptionValue:e,selectedItem:t,trigger:a,getToggleButtonProps:r,options:n,selectPlaceholder:l,isDisabled:s,getInputProps:d,ariaMenuName:m,hasError:v,errorMessage:p,isOpen:g})=>{const f=()=>i(i({},r()),_r({selectedItem:t,getInputProps:d,getToggleButtonProps:r,ariaMenuName:m,isOpen:g})),x=R(i({},(()=>{if(t)return t;if(e)return Tt({options:n,selectedOptionValue:e})})()),{placeholder:l,isDisabled:s,hasError:v,errorMessage:p});return a(x,f())},Hr=(e,t)=>{if(bt(t))for(const a of t){const r=a.items.find(n=>n.value===e);if(r)return r}else return t.find(a=>a.value===e)},Sr=(e,t,a,r,n,l,s,d)=>{const m=!a&&e.value===r||a&&a.value===e.value;return React26.createElement(At,R(i({key:t,getItemProps:l,icon:e.icon,hidden:e.hidden},l({key:`${e.value}-${t}`,index:t,item:e,disabled:e.isDisabled,"aria-selected":m,onMouseMove:()=>{s&&d(!1)}})),{isDisabled:e.isDisabled,hasDivider:e.hasDivider,isHighlighted:n===t,keyboardMove:s&&n===t,isSelected:m}),e.title)},n1=e=>{var t=e,{options:a,selectedItem:r,selectedOptionValue:n,highlightedIndex:l,getItemProps:s,search:d,keyboardMove:m,setKeyboardMove:v}=t,p=y(t,["options","selectedItem","selectedOptionValue","highlightedIndex","getItemProps","search","keyboardMove","setKeyboardMove"]);if(!bt(a))return React26.createElement(Ae,i({search:d},p),a.map((f,w)=>Sr(f,w,r,n,l,s,m,v)));let g=0;return React26.createElement(Ae,i({search:d},p),a.map(f=>{const w=`group-${f.group.replace(/\s+/g,"-")}`;return React26.createElement("li",{key:w},React26.createElement(nt,{left:"medium",top:"small",bottom:"xsmall"},React26.createElement($e,{id:w,size:"body-sm",fontWeight:"bold"},f.group)),React26.createElement(ql,{role:"group","aria-labelledby":w},f.items.map(x=>Sr(x,g++,r,n,l,s,m,v))))}))},Qi=e=>{var t=e,{container:a,onChange:r,menuZIndex:n=1100,menuMaxWidth:l,menuMaxHeight:s=34,menuMinWidth:d,triggerOffset:m=0,ariaMenuName:v,selectedOptionValue:p,onOuterClick:g,options:f,placeholder:w,menuPosition:x="left",isDisabled:z,onOpenChange:E,trigger:M,hasError:B,errorMessage:F="Oops, that didn't work.",search:H}=t,G=y(t,["container","onChange","menuZIndex","menuMaxWidth","menuMaxHeight","menuMinWidth","triggerOffset","ariaMenuName","selectedOptionValue","onOuterClick","options","placeholder","menuPosition","isDisabled","onOpenChange","trigger","hasError","errorMessage","search"]);const ee=Wt(a),[W,P]=useState(!1),[Z,ne]=useState(!1),[Y,U]=useState(""),D=L=>{const S=L.target.value;U(S)},[le,X]=useState(Hr(p,f)),ke={itemToString:L=>L?L.value:"",onChange:L=>{X(L),r&&r(L||"")},onOuterClick:g,environment:ee,selectedItem:le,isOpen:W};ee&&(ke.environment=ee);const{layerProps:k,triggerProps:re,renderLayer:Je,triggerBounds:Le}=useLayer({isOpen:W,container:a,ResizeObserver,placement:Pt[x],auto:!0,snap:!0,triggerOffset:m});useEffect2(()=>{const L=Hr(p,f);L?.value!==le?.value&&X(L)},[p,f,le]),useEffect2(()=>{E&&E(W)},[W,E]);const Se=(L,S)=>{if(S.isOpen!==void 0){if(S.type===Downshift.stateChangeTypes.keyDownEscape)return P(!1),{isOpen:!1};P(S.isOpen)}return S},Ee=L=>{switch(L.key){case"ArrowDown":case"ArrowUp":case"ArrowLeft":case"ArrowRight":case"Enter":case" ":case"Tab":case"Escape":ne(!0);break;default:break}};return f=useMemo(()=>{if(H){if(bt(f)){let L;return H.searchType==="startsWith"?L=f.map(S=>R(i({},S),{items:S.items.filter(_e=>We(_e.title).toLowerCase().startsWith(Y.toLowerCase()))})):L=f.map(S=>R(i({},S),{items:S.items.filter(_e=>We(_e.title).toLowerCase().includes(Y.toLowerCase()))})),L.reduce((S,_e)=>(_e.items.length>0&&S.push(_e),S),[])}return H.searchType==="startsWith"?f.filter(L=>We(L.title).toLowerCase().startsWith(Y.toLowerCase())):f.filter(L=>We(L.title).toLowerCase().includes(Y.toLowerCase()))}return f},[f,Y,H]),React26.createElement(Xl,i({},G),React26.createElement(Downshift,R(i({},ke),{stateReducer:Se}),({getItemProps:L,getInputProps:S,getMenuProps:_e,getToggleButtonProps:yt,isOpen:A,inputValue:ye,highlightedIndex:Gt,selectedItem:Qe})=>React26.createElement("div",{role:"presentation"},React26.createElement("div",i({},re),M?React26.createElement(a1,{getToggleButtonProps:()=>i({},yt({onKeyDown:Ee})),selectedItem:Qe,selectedOptionValue:p,selectPlaceholder:w,isDisabled:z,options:f,trigger:M,getInputProps:S,ariaMenuName:v,hasError:B,errorMessage:F,isOpen:A}):React26.createElement(r1,{getToggleButtonProps:()=>i({},yt({onKeyDown:Ee})),selectedItem:Qe,selectedOptionValue:p,selectPlaceholder:w,options:f,inputValue:ye,isDisabled:z,getInputProps:S,ariaMenuName:v,hasError:B,isOpen:A})),W&&A&&Je(React26.createElement("div",R(i({},k),{style:R(i({},k.style),{zIndex:n,width:d?"auto":Le?.width})}),React26.createElement(n1,{options:f,selectedItem:Qe,selectedOptionValue:p,highlightedIndex:Gt,getItemProps:L,position:x,downshiftMenuProps:()=>_e({onKeyDown:Ee}),maxWidth:l,maxHeight:s,minWidth:d,search:H&&React26.createElement(kr,{ariaLabel:H.searchPlaceholder,placeholder:H.searchPlaceholder,value:Y,onChange:D,getInputProps:S}),keyboardMove:Z,setKeyboardMove:ne}))),B&&!W&&React26.createElement(e1,null,F))))},qi=null;function l1(e,t){const a=document;(0,o.useLayoutEffect)(()=>{const r=a?.documentElement,n=a?.body;if(!(a==null||!r||!n)){if(t){const l=window.innerWidth-r.clientWidth,s=parseInt(window.getComputedStyle(n).getPropertyValue("padding-right"),10)||0;switch(e){case"html":{r.style.position="relative",r.style.overflow="hidden",n.style.paddingRight=`${s+l}px`;break}case"body":{n.style.setProperty("position","relative"),n.style.setProperty("overflow","hidden"),n.style.setProperty("padding-right",`${s+l}px`);break}default:return}}return()=>{switch(e){case"html":{r.style.position="",r.style.overflow="",n.style.paddingRight="";break}case"body":{n.style.removeProperty("position"),n.style.removeProperty("overflow"),n.style.removeProperty("padding-right");break}default:return}}}},[a,t,e])}var Ir=l1,Br=300,o1=h.Z.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`,i1=h.Z.div`
  overflow: auto;
  height: 100%;
`,Dr=o.forwardRef((e,t)=>{var a=e,{children:r,isOpen:n,zIndex:l=1e3,backgroundColor:s="backdropDark"}=a,d=y(a,["children","isOpen","zIndex","backgroundColor"]);const{stage:m,shouldMount:v}=(0,zt.Yz)(n,Br);return Ir("html",n),o.createElement(o.Fragment,null,v&&o.createElement(o1,i({ref:t,backgroundColor:s,zIndex:l,style:{transition:`opacity ${Br}ms`,opacity:m==="enter"?1:0}},d),o.createElement(i1,null,r)))});Dr.displayName="Backdrop";var s1=Dr;function Ft(){return o.createElement(Rt.Z,{label:"",testId:"ads-refreshed-icon"})}var c1="70vh",d1=h.Z.div`
  display: grid;
  grid-template-rows: ${e=>e.rows};
  position: relative;
`,u1=h.Z.dialog`
  top: ${e=>Mt(be(e.maxHeight),e.placement).top};
  background-color: ${c("overlay")};
  color: ${c("body")};
...
`,Or=e=>typeof e=="number"?b("max-height",e):"max-height: "+e,b1=e=>{var t=e,{children:a,onCloseClick:r,isOpen:n,maxWidth:l=60,maxHeight:s=c1,placement:d="center",ariaLabel:m,ariaModal:v,ariaLabelledBy:p,ref:g,removeClose:f,initialFocus:w}=t,x=y(t,["children","onCloseClick","isOpen","maxWidth","maxHeight","placement","ariaLabel","ariaModal","ariaLabelledBy","ref","removeClose","initialFocus"]);const z=E=>{E.key==="Escape"&&(E.preventDefault(),f||r(E))};return(0,o.useEffect)(()=>(window.addEventListener("keydown",z),()=>{window.removeEventListener("keydown",z)}),[n,r]),Ir("html",n),o.createElement($t(),{active:n,focusTrapOptions:i({clickOutsideDeactivates:!1,allowOutsideClick:!0},w!==void 0?{initialFocus:w}:{})},o.createElement(u1,i({open:n,maxWidth:l,maxHeight:s,placement:d,onClick:E=>E.stopPropagation(),ref:g,"aria-label":m,"aria-modal":v,"aria-labelledby":p},x),!f&&r&&o.createElement(h1,null,o.createElement(Vt,{altText:"Close",icon:o.createElement(Ft,null),onClick:r})),o.createElement(f1,R(i({},f?{tabIndex:0}:{tabIndex:-1}),{maxHeight:s}),a)))},e0=o.forwardRef((e,t)=>{var a=e,{children:r,id:n,isOpen:l,mainButton:s,secondaryButton:d,alternativeButton:m,title:v,noPadding:p,onCloseClick:g,onBackgroundClick:f,onKeyDown:w,hasDividers:x,maxHeight:z="70vh",maxWidth:E=60,placement:M="center",zIndex:B=1e3,ariaLabel:F,ariaModal:H=!0,ariaLabelledBy:G,initialFocus:ee}=a,W=y(a,["children","id","isOpen","mainButton","secondaryButton","alternativeButton","title","noPadding","onCloseClick","onBackgroundClick","onKeyDown","hasDividers","maxHeight","maxWidth","placement","zIndex","ariaLabel","ariaModal","ariaLabelledBy","initialFocus"]),P;const Z=(0,o.useRef)(null),ne=n?`${n}-modal-title`:"modal-title",Y=!!(s||d||m),U=D=>{if(f){D.stopPropagation(),f(D);return}g(D)};return(0,o.useEffect)(()=>{if(!l||!Z.current)return;const D=Z.current.parentElement;return D?(Array.from(D.children).filter(X=>X!==Z.current&&X instanceof HTMLElement).forEach(X=>{X.hasAttribute("aria-hidden")||(X.setAttribute("aria-hidden","true"),X.setAttribute("data-lens-modal-hidden","true"))}),()=>{document.querySelectorAll("[data-lens-modal-hidden]").forEach(fe=>{fe.removeAttribute("aria-hidden"),fe.removeAttribute("data-lens-modal-hidden")})}):void 0},[l]),o.createElement(s1,i({ref:Z,isOpen:l,zIndex:B},W),o.createElement(ue,{height:"100%",onClick:U,onKeyDown:w},o.createElement(b1,{ref:t,id:n,isOpen:l,maxHeight:z,maxWidth:E,placement:M,onCloseClick:g,ariaLabel:F,ariaModal:H,ariaLabelledBy:(P=G??ne)!=null?P:void 0,initialFocus:ee},o.createElement(d1,{rows:`${v?"auto ":""} ${r?"1fr ":""} ${Y?"auto":""}`},v&&o.createElement(v1,{bottom:r?"var(--lns-space-medium)":"var(--lns-space-xlarge)"},o.createElement($e,{htmlTag:"h1",variant:"title",id:ne},v)),o.createElement(p1,{noPadding:p,hasDividers:x,hasTitle:Boolean(v),hasButtons:Y},r&&r),Y&&o.createElement(g1,{top:r?"var(--lns-space-xlarge)":0,hasDividers:x},m,o.createElement(m1,null,d&&o.createElement(nt,{right:"small",isInline:!0},d),s))))))}),t0=null,Ct={neutral:{color:c("inherit"),focusRing:Ce(),underline:"inactive"},primary:{color:c("primary"),focusRing:Ce(),underline:"inactive"},subtle:{color:c("body"),focusRing:Ce(),underline:"hover"}},Vr={enabled:$.iv`
    cursor: pointer;
  `,disabled:$.iv`
    pointer-events: none;
    color: ${c("disabledContent")};
  `},C1={isButton:$.iv`
    ...
    font: inherit;
  `},w1=h.Z.a`
  ${e=>!e.disabled&&`color: ${Ct[e.variant].color}`};
  ${e=>e.disabled?Vr.disabled:Vr.enabled};
  ${e=>e.as==="button"&&C1.isButton};
  ${e=>`text-decoration: ${Ct[e.variant].underline==="inactive"?"underline":"none"}`};
  ...
  ${e=>e.noWrap&&$.iv`
    ...
    `}
  &:hover {
    ${e=>`text-decoration: ${Ct[e.variant].underline==="hover"?"underline":"none"}`};
  }
  &:focus,
  &:focus-visible {
    outline: 1px solid transparent;
...
`,r0=e=>{var t=e,{children:a,href:r,variant:n="primary",htmlTag:l="a",isDisabled:s,noWrap:d}=t,m=y(t,["children","href","variant","htmlTag","isDisabled","noWrap"]);return React30.createElement(w1,i({href:r,variant:n,as:l,disabled:s,noWrap:d},m),a)},a0=Object.keys(Ct),n0=null,Wr={small:{padding:`${u(1.5)} ${u(1.75)}`,textSize:"small"},medium:{padding:`${u(1.5)} var(--lns-formFieldHorizontalPadding)`,textSize:"medium"}},E1=h.Z.textarea`
  width: 100%;
  border: none;
  font-family: inherit;
  color: inherit;
...
`,l0=o.forwardRef((e,t)=>{var a=e,{onChange:r,value:n,rows:l=4,isDisabled:s,placeholder:d,size:m="medium",resize:v="both",error:p=null}=a,g=y(a,["onChange","value","rows","isDisabled","placeholder","size","resize","error"]);return o.createElement(o.Fragment,null,o.createElement(E1,i({disabled:s,onChange:r,placeholder:d,ref:t,rows:l,value:n,size:m,resize:v,error:p},g)),p?o.createElement(o.Fragment,null,o.createElement(nt,{bottom:"xmsall"}),o.createElement($e,{color:"danger",fontWeight:"regular",size:"body-md"},p)):null)}),o0=null,y1=h.Z.div`
  position: relative;
`,z1=h.Z.ul`
  list-style: none;
  margin: 0;
...
`,x1=h.Z.span`
  ...
  grid-column-start: 1;
  grid-column-end: 3;
`,wt=e=>Array.isArray(e)&&e.length>0&&"group"in e[0],Pr=({options:e,selectedOptionValue:t})=>{if(!e||!t)return{icon:null,title:null};if(wt(e))for(const a of e){const r=a.items.find(n=>n.value===t);if(r)return r}else return e.find(r=>r.value===t)||{icon:null,title:null};return{icon:null,title:null}},$1=({options:e,selectedItem:t,selectedOptionValue:a})=>{if(t)return t.icon;if(a)return Pr({options:e,selectedOptionValue:a}).icon},R1=({options:e,selectedItem:t,selectedOptionValue:a,placeholder:r})=>t?t.title:a?Pr({options:e,selectedOptionValue:a}).title:r,M1=({selectedItem:e,getInputProps:t,ariaMenuName:a})=>{const r=e?`selected value is ${e.title}`:"no value selected";return{"aria-activedescendant":t()["aria-activedescendant"],"aria-label":[a,r].filter(Boolean).join(", ")}},k1=h.Z.button`
  position: relative;
  width: 100%;
  background: none;
  border: none;
...
`,I1=h.Z.img`
  ...
  object-fit: cover;
  opacity: ${({isDisabled:e})=>e?.5:1};
`,B1=({selectedItem:e,selectedOptionValue:t,placeholder:a,isDisabled:r,options:n,getInputProps:l,ariaMenuName:s,isOpen:d,onInputFocus:m,hasError:v,hasLoader:p,inputValue:g,handleInputValueChange:f,inputRef:w,id:x})=>{const z=$1({options:n,selectedItem:e,selectedOptionValue:t}),E=Boolean(z),M=r?"disabledContent":void 0,B=()=>{r||m()},F=i(i({role:"combobox","aria-autocomplete":"list","aria-haspopup":"listbox","aria-expanded":d},M1({selectedItem:e,getInputProps:l,ariaMenuName:s})),l({id:x,"aria-labelledby":void 0,disabled:r,onFocus:B,onClick:B,value:g,onBlur:()=>{f("")},onChange:G=>f(G.target.value)})),H=!g&&!t;return o.createElement(k1,{onClick:B,disabled:r},E&&o.createElement(_1,null,typeof z=="string"?o.createElement(ue,{radius:"50",width:3,height:3,overflow:"hidden"},o.createElement(Pe,{alignment:"center"},o.createElement(I1,{src:z,alt:"",isDisabled:r}))):o.createElement(te,{icon:z,color:M})),o.createElement(L1,R(i({ref:w},F),{hasIcon:E,hasAddOn:!0,hasError:v,isDisabled:r})),!g&&o.createElement(S1,{hasIcon:E},o.createElement($e,{hasEllipsis:!0,color:H?"bodyDimmed":"inherit"},R1({options:n,selectedItem:e,selectedOptionValue:t,placeholder:a}))),o.createElement(H1,null,p?o.createElement(Dt,{size:"small"}):o.createElement(te,{icon:o.createElement(Mr,null),color:M})))},Ar=(e,t)=>{var a;if(wt(t))for(const r of t){const n=r.items.find(l=>l.value===e);if(n)return n}else return(a=t.find(r=>r.value===e))!=null?a:null;return null},D1=(e,t)=>(e||null)!=t?.value,Tr=(e,t,a,r,n,l)=>{const s=!a&&e.value===r||a&&a.value===e.value;return o.createElement(At,R(i({key:t,getItemProps:l,icon:e.icon,hidden:e.hidden},l({key:`${e.value}-${t}`,index:t,item:e,disabled:e.isDisabled,"aria-selected":s})),{isDisabled:e.isDisabled,hasDivider:e.hasDivider,isHighlighted:n===t,isSelected:s}),e.title)},O1=e=>{var t=e,{options:a,selectedItem:r,selectedOptionValue:n,highlightedIndex:l,getItemProps:s,isLoading:d,loadingMessage:m,emptyResultsMessage:v,hasAvailableOptions:p}=t,g=y(t,["options","selectedItem","selectedOptionValue","highlightedIndex","getItemProps","isLoading","loadingMessage","emptyResultsMessage","hasAvailableOptions"]);const f=m||o.createElement(Dt,null),w=v||"No results";if(d)return o.createElement(Ae,i({as:"div"},g),o.createElement(ue,{padding:"large"},o.createElement(Pe,{alignment:"center"},f)));if(!p)return o.createElement(Ae,i({as:"div"},g),o.createElement(ue,{padding:"large"},o.createElement(Pe,{alignment:"center"},w)));if(!wt(a))return o.createElement(Ae,i({},g),a.map((z,E)=>Tr(z,E,r,n,l,s)));let x=0;return o.createElement(Ae,i({},g),a.map(z=>{const E=`group-${z.group.replace(/\s+/g,"-")}`;return o.createElement("li",{key:E},o.createElement(nt,{left:"medium",top:"small",bottom:"xsmall"},o.createElement($e,{id:E,size:"body-sm",fontWeight:"bold",htmlTag:z.headingTag||"h2"},z.group)),o.createElement(z1,{role:"group","aria-labelledby":E},z.items.map(M=>Tr(M,x++,r,n,l,s))))}))},V1=(0,o.forwardRef)((e,t)=>{var a=e,{container:r,onOptionChange:n,onInputValueChange:l,menuZIndex:s=1100,menuMaxWidth:d,menuMaxHeight:m=34,menuMinWidth:v,ariaMenuName:p,selectedOptionValue:g,onOuterClick:f,options:w,placeholder:x,menuPosition:z="left",isDisabled:E,onOpenChange:M,isLoading:B,loadingMessage:F,emptyResultsMessage:H,errorMessage:G,id:ee}=a,W=y(a,["container","onOptionChange","onInputValueChange","menuZIndex","menuMaxWidth","menuMaxHeight","menuMinWidth","ariaMenuName","selectedOptionValue","onOuterClick","options","placeholder","menuPosition","isDisabled","onOpenChange","isLoading","loadingMessage","emptyResultsMessage","errorMessage","id"]);const P=Wt(r),Z=(0,o.useRef)(null),ne=(0,o.useCallback)(A=>{Z.current=A,t&&(typeof t=="function"?t(A):t.current=A)},[t]),[Y,U]=(0,o.useState)(""),[D,le]=(0,o.useState)(!1),[X,fe]=(0,o.useState)(Ar(g,w)),[ke,k]=(0,o.useState)(X),re=A=>{U(A),l&&l(A)},Le={itemToString:A=>A?A.value:"",onChange:A=>{const ye=A||null;k(ye),n&&n(ye)},onOuterClick:f,environment:P,selectedItem:ke,isOpen:D};P&&(Le.environment=P);const{layerProps:Se,triggerProps:Ee,renderLayer:L,triggerBounds:S}=(0,Fe.sJ)({isOpen:D,container:r,ResizeObserver:he.Z,placement:Pt[z],auto:!0,snap:!0});(0,o.useEffect)(()=>{if(D1(g,X)){const A=Ar(g,w);fe(A),k(A),U("")}},[g,w,X]),(0,o.useEffect)(()=>{var A;M&&M(D),D||(A=Z.current)==null||A.blur()},[D,M]);const _e=(0,o.useMemo)(()=>Array.isArray(w)?wt(w)?w.some(A=>A.items.length>0):w.length>0:!1,[w]),yt=(A,ye)=>{if(ye.isOpen!==void 0){if(ye.type===ze.ZP.stateChangeTypes.keyDownEscape)return le(!1),{isOpen:!1};le(ye.isOpen)}return ye};return o.createElement(y1,i({},W),o.createElement(ze.ZP,R(i({},Le),{stateReducer:yt}),({getItemProps:A,getInputProps:ye,getMenuProps:Gt,isOpen:Qe,highlightedIndex:xi,selectedItem:da})=>o.createElement("div",{role:"presentation"},o.createElement("div",i({},Ee),o.createElement(B1,{inputRef:ne,selectedItem:da,selectedOptionValue:g,placeholder:x,isDisabled:E,options:w,getInputProps:ye,ariaMenuName:p,inputValue:Y,handleInputValueChange:re,isOpen:D&&Qe,onInputFocus:()=>{le(!0)},hasLoader:B,hasError:Boolean(G),id:ee})),D&&Qe&&L(o.createElement("div",R(i({},Se),{style:R(i({},Se.style),{zIndex:s,width:v?"auto":S?.width})}),o.createElement(O1,{options:w,selectedItem:da,selectedOptionValue:g,hasAvailableOptions:_e,highlightedIndex:xi,getItemProps:A,isLoading:B,loadingMessage:F,emptyResultsMessage:H,position:z,downshiftMenuProps:Gt,maxWidth:d,maxHeight:m,minWidth:v}))),Boolean(G)&&!D?o.createElement(x1,null,G):null)))});V1.displayName="Typeahead";var i0=null,W1=({ariaMenuName:e,getInputProps:t,isOpen:a})=>({"aria-activedescendant":t()["aria-activedescendant"],"aria-expanded":a,"aria-label":e||""}),P1=h.Z.div`
  display: inline-block;
  vertical-align: middle;
`,s0=e=>{var t=e,{ariaMenuName:a,menuPosition:r="left",menuZIndex:n=1100,options:l,trigger:s,triggerCallback:d,isOpen:m,menuMinWidth:v=24,menuMaxWidth:p=48,menuMaxHeight:g,container:f,onOuterClick:w,triggerOffset:x=0,onOpenChange:z,search:E,role:M,menuItemRole:B}=t,F=y(t,["ariaMenuName","menuPosition","menuZIndex","options","trigger","triggerCallback","isOpen","menuMinWidth","menuMaxWidth","menuMaxHeight","container","onOuterClick","triggerOffset","onOpenChange","search","role","menuItemRole"]);const H=Wt(f),[G,ee]=useState3(!1),[W,P]=useState3(!1),[Z,ne]=useState3(""),Y=k=>{const re=k.target.value;ne(re)},U=k=>{switch(k.key){case"ArrowDown":case"ArrowUp":case"ArrowLeft":case"ArrowRight":case"Enter":case" ":case"Tab":case"Escape":P(!0);break;default:break}},D=m||G,{layerProps:le,triggerProps:X,renderLayer:fe}=useLayer3({isOpen:D,container:f,placement:Pt[r],ResizeObserver:ResizeObserver3,auto:!0,snap:!0,triggerOffset:x});useEffect5(()=>{z&&z(D)},[D,z]);const ke=(k,re)=>(re.isOpen!==void 0&&ee(re.isOpen),re);return l=useMemo3(()=>E?E.searchType==="startsWith"?l.filter(k=>We(k.title).toLowerCase().startsWith(Z.toLowerCase())):l.filter(k=>We(k.title).toLowerCase().includes(Z.toLowerCase())):l,[l,Z,E]),React33.createElement(Downshift3,{stateReducer:ke,itemToString:k=>k?k.title:"",onSelect:k=>k&&!k.disabled&&k.onClick&&k.onClick(),onOuterClick:w,environment:H},({getInputProps:k,getItemProps:re,getMenuProps:Je,getToggleButtonProps:Le,highlightedIndex:Se,isOpen:Ee})=>React33.createElement("div",i(i({},F),d?{role:null,"aria-haspopup":null,"aria-expanded":null,"aria-labelledby":null}:{}),React33.createElement("div",i({},X),d?d(i(i({},Le({onKeyDown:U})),W1({ariaMenuName:a,getInputProps:k,isOpen:Ee}))):React33.createElement(P1,i({},Le({onKeyDown:U,tabIndex:0})),s)),Ee&&fe(React33.createElement("div",R(i({},le),{style:R(i({},le.style),{zIndex:n})}),React33.createElement(Ae,{position:r,minWidth:v,maxWidth:p,maxHeight:g,downshiftMenuProps:()=>Je({onKeyDown:U}),role:M,search:E&&React33.createElement(kr,{ariaLabel:E.searchPlaceholder,placeholder:E.searchPlaceholder,value:Z,onChange:Y,getInputProps:k})},l.map((L,S)=>React33.createElement(At,i({key:S,isHighlighted:Se===S,keyboardMove:W&&Se===S,isDisabled:L.disabled,isSelected:L.selected,icon:L.icon,hasDivider:L.hasDivider,getItemProps:re,menuItemRole:B,index:S},re({key:S,index:S,item:L,disabled:L.disabled,onMouseMove:()=>{W&&P(!1)}})),L.title)))))))},c0=null,A1=h.Z.label`
  display: block;
  position: relative;
...
`,Z1=(0,o.forwardRef)((e,t)=>{var a=e,{isDisabled:r,isChecked:n,onFocus:l,onChange:s,onBlur:d}=a,m=y(a,["isDisabled","isChecked","onFocus","onChange","onBlur"]);return o.createElement(A1,{htmlFor:m.id},o.createElement(T1,i({type:"radio",disabled:r,checked:n,onFocus:l,onChange:s,onBlur:d,ref:t},m)),o.createElement(F1,{className:"RadioBox"}))}),j1=Z1,Me={medium:{switchHeight:16,switchWidth:32,knobOffset:2},large:{switchHeight:20,switchWidth:36,knobOffset:2}},Ye={knob:{active:{enabled:c("white"),disabled:c("disabledContent")},inactive:{enabled:c("white"),disabled:c("disabledContent")}},track:{active:{enabled:c("blurple"),disabled:c("disabledBackground")},inactive:{enabled:c("grey6"),disabled:c("disabledBackground")}}},N1=e=>Me[e.switchSize].switchWidth-Me[e.switchSize].switchHeight,Fr=e=>Me[e.switchSize].switchHeight-Me[e.switchSize].knobOffset*2,U1=h.Z.label`
  display: block;
  position: relative;
`,K1=h.Z.input`
  position: absolute;
  ...
  z-index: 1;
  margin: 0;
  width: ${e=>Me[e.switchSize].switchWidth}px;
  height: ${e=>Me[e.switchSize].switchHeight}px;
...
`,G1=h.Z.div`
  ...
  &:after {
    content: '';
    position: absolute;
    top: ${e=>Me[e.switchSize].knobOffset}px;
    left: ${e=>Me[e.switchSize].knobOffset}px;
    width: ${e=>Fr(e)}px;
    height: ${e=>Fr(e)}px;
    border-radius: var(--lns-radius-full);
    transition: 0.15s;
...
`,Y1=e=>{var t=e,{isActive:a,isDisabled:r,onChange:n,size:l="medium",ariaLabelledby:s,ariaLabel:d,ariaDescribedby:m}=t,v=y(t,["isActive","isDisabled","onChange","size","ariaLabelledby","ariaLabel","ariaDescribedby"]);if(s&&d)throw new Error("ariaLabelledby and ariaLabel serve the same purpose and therefore cannot be used at the same time. Choose the one that best suites your needs.");return o.createElement(U1,{htmlFor:v.id},o.createElement(K1,R(i({},v),{checked:a,disabled:r,onChange:n,type:"checkbox",switchSize:l,"aria-labelledby":s,"aria-label":d,"aria-describedby":m,"aria-checked":a})),o.createElement(G1,{className:"SwitchBox",isDisabled:r,isActive:a,switchSize:l}))},X1=Y1,Zr={row:{wrapper:{display:"grid",gridTemplateColumns:"auto 1fr",alignItems:"center"},label:{marginLeft:"var(--lns-space-small)"},errorMessage:{marginLeft:"var(--lns-space-small)"}},"row-reverse":{wrapper:{display:"grid",gridTemplateColumns:"1fr auto",alignItems:"center"},label:{}},column:{wrapper:{},label:{marginBottom:"var(--lns-space-xsmall)"}}},J1=h.Z.div`
...
`,q1=h.Z.span`
  ...
  grid-column-start: 1;
  grid-column-end: 3;
`,eo=[j1,Wl,X1],to=e=>eo.includes(e),d0=e=>{var t=e,{label:a,children:r,errorMessage:n,labelFor:l,direction:s="column"}=t,d=y(t,["label","children","errorMessage","labelFor","direction"]);const m=React36.Children.toArray(r).some(p=>isValidElement(p)&&typeof p.type!="string"&&to(p.type)),v=a&&React36.createElement(Q1,{direction:s,htmlFor:l,isLabelClickable:m},a);return React36.createElement(J1,i({direction:s},d),s==="row"&&React36.createElement(React36.Fragment,null,r,v),s==="column"&&React36.createElement(React36.Fragment,null,v,r),s==="row-reverse"&&React36.createElement(React36.Fragment,null,v,r),n&&React36.createElement(q1,null,n))},u0=null;function h0(e,t){React37.useEffect(()=>{const a=r=>{!e.current||e.current.contains(r.target)||t(r)};return document.addEventListener("mousedown",a),document.addEventListener("touchstart",a),()=>{document.removeEventListener("mousedown",a),document.removeEventListener("touchstart",a)}},[e,t])}function m0(e){const[t,a]=useState4(!1),r=useCallback3(l=>{const s=e.current;l.type==="focusin"&&l.target===s&&a(!0)},[e]),n=useCallback3(l=>{const s=e.current;l.type==="focusout"&&l.target===s&&a(!1)},[e]);return useEffect6(()=>(document.addEventListener("focusin",r),document.addEventListener("focusout",n),()=>{document.removeEventListener("focusin",r),document.removeEventListener("focusout",n)}),[r,n]),Boolean(t)}function v0(e){const t=document;useLayoutEffect2(()=>{const a=t?.documentElement,r=t?.body;if(!(t==null||!a||!r))return e&&(r.style.setProperty("padding-top","3.25rem"),r.style.setProperty("transition","padding-top 350ms")),()=>{r.style.removeProperty("padding-top")}},[t,e])}var ro=null;function ao(){return o.createElement(Yt.Z,{label:"",testId:"ads-refreshed-icon"})}var no=e=>o.createElement("svg",i({viewBox:"0 0 24 24",fill:"none"},e),o.createElement("path",{fill:"currentColor",fillRule:"evenodd",clipRule:"evenodd",d:"M7.42 2.293A1 1 0 0 1 8.127 2h7.245a1 1 0 0 1 .708.293l5.127 5.127a1 1 0 0 1 .293.707v7.245a1 1 0 0 1-.293.708l-5.127 5.127a1 1 0 0 1-.707.293H8.128a1 1 0 0 1-.708-.293L2.293 16.08A1 1 0 0 1 2 15.373V8.128a1 1 0 0 1 .293-.708L7.42 2.293ZM8.542 4 4 8.542v6.416L8.542 19.5h6.416l4.542-4.542V8.542L14.958 4H8.542Zm2.208 11.25a1 1 0 0 1 1-1h.009a1 1 0 1 1 0 2h-.009a1 1 0 0 1-1-1Zm2-7a1 1 0 1 0-2 0v3.5a1 1 0 1 0 2 0v-3.5Z"})),Te={info:{bgColor:"var(--lns-color-blurple)",icon:o.createElement(ao,null),color:"var(--lns-color-white)",fontFamily:"inherit"},warning:{bgColor:"var(--lns-color-warning)",icon:o.createElement(no,null),color:"var(--lns-color-grey8)",fontFamily:"inherit"},error:{bgColor:"var(--lns-color-danger)",icon:o.createElement($r,null),color:"var(--lns-color-white)",fontFamily:"inherit"},internal:{icon:o.createElement("span",{role:"img"},"\u{1F514}"),color:"var(--lns-color-tealLight)",bgColor:"var(--lns-color-grey8)",fontFamily:"var(--lns-fontFamily-code)"}},jr=350,lo=h.Z.aside`
  ...
  ${e=>`background-color: ${Te[e.severity].bgColor}`};
  ${e=>`font-family: ${Te[e.severity].fontFamily}`};

  ${e=>`color: ${Te[e.severity].color}`};
  position: fixed;
...
`,g0=({children:e,onCloseClick:t,isOpen:a,severity:r="info",id:n})=>{var l,s,d;useEffect7(()=>{if(!a)return;const v=p=>{p.key==="Escape"&&(p.preventDefault(),t&&t())};return window.addEventListener("keydown",v),()=>{window.removeEventListener("keydown",v)}},[a,t]),ro(a);const m=r==="internal";return a?React40.createElement(lo,{isOpen:a,severity:r,id:n},React40.createElement(Ke,{alignItems:{default:"start",small:"center"},justifyContent:"space-between",autoFlow:m?"column":void 0,columns:m?void 0:["1fr auto"]},React40.createElement(ue,{paddingY:{default:"xsmall",xsmall:0},paddingLeft:m?void 0:{default:0,medium:u(3.5)},width:"100%"},React40.createElement(Ke,{autoFlow:"column",gap:m?"medium":"small",justifyContent:"center"},(l=Te[r])!=null&&l.icon?React40.createElement(Pe,{alignment:"topLeft"},React40.createElement(te,{icon:Te[r].icon,color:(s=Te[r].color)!=null?s:"var(--lns-color-white)"})):null," ",e))),t&&React40.createElement(Vt,{iconColor:(d=Te[r].color)!=null?d:"var(--lns-color-white)",tabIndex:0,altText:"Close",icon:React40.createElement(Ft,null),onClick:t})):null},p0=null,Nr="web-app",Zt="chrome-extension",oo={short:3e3,long:8e3},io=(e,t)=>$.F4`
  0% {
    opacity: 0;
...
`,so=e=>{switch(e){case Nr:return"unset";case Zt:return u(4);default:return"unset"}},co=e=>{switch(e){case Nr:return u(4);case Zt:return"unset";default:return u(4)}},uo=h.Z.div`
...
`,ho=h.Z.div`
  align-self: center;
`,f0=({children:e,isOpen:t,onCloseClick:a,zIndex:r=1100,duration:n="short",platform:l="web-app"})=>{const s=oo[n];return useEffect8(()=>{const d=setTimeout(()=>{t&&a()},s);return()=>clearTimeout(d)},[t]),React41.createElement(React41.Fragment,null,t&&React41.createElement(uo,{role:"presentation",onClick:d=>d.stopPropagation(),zIndex:r,isOpen:t,toastDuration:s,platform:l},React41.createElement(ho,{"aria-live":"polite"},e),a&&React41.createElement(Vt,{altText:"Close",icon:React41.createElement(Ft,null),onClick:a,iconColor:"bodyInverse"})))},b0=null,Ur={topLeft:"top-start",topCenter:"top-center",topRight:"top-end",bottomLeft:"bottom-start",bottomCenter:"bottom-center",bottomRight:"bottom-end",leftTop:"left-start",leftCenter:"left-center",leftBottom:"left-end",rightTop:"right-start",rightCenter:"right-center",rightBottom:"right-end"},mo=4,vo=De.small.fontSize*De.small.lineHeight,go=(mo-vo)/2,po=h.Z.div`
  background-color: ${c("backgroundInverse")};
  color: ${c("bodyInverse")};
  ${N("150")};
  ${Be("bold")};
...
`,fo=h.Z.div`
  ...
  padding-left: ${u(.5)};
  padding-right: ${u(.5)};
`,bo=({children:e})=>o.createElement(fo,null,e),Co=e=>{var t=e,{children:a,maxWidth:r,onMouseEnter:n,onMouseLeave:l,layerProps:s,zIndex:d}=t,m=y(t,["children","maxWidth","onMouseEnter","onMouseLeave","layerProps","zIndex"]);return o.createElement(po,i(i({maxWidth:r,onMouseEnter:n,onMouseLeave:l,zIndex:d},s),m),a)},wo=h.Z.div`
  display: ${e=>e.isInline?"inline-block":"block"};
...
`;function Eo(e){switch(e){case"immediate":return 200;case"long":return 800;default:return 200}}var yo=e=>{var t=e,{ariaLive:a=!1,children:r,content:n,shortcut:l,placement:s="topCenter",keepOpen:d,triggerOffset:m=4,maxWidth:v=26,isInline:p=!0,isDisabled:g,container:f,tabIndex:w=0,zIndex:x=1100,verticalAlign:z="middle",delay:E="immediate",tooltipId:M}=t,B=y(t,["ariaLive","children","content","shortcut","placement","keepOpen","triggerOffset","maxWidth","isInline","isDisabled","container","tabIndex","zIndex","verticalAlign","delay","tooltipId"]);const[F,H]=(0,Fe.XI)({delayEnter:Eo(E),delayLeave:200}),[G,ee]=(0,o.useState)(!1),[W,P]=(0,o.useState)(!1),[Z,ne]=(0,o.useState)(!1),Y=(0,o.useRef)(),U=!n||g;(0,o.useEffect)(()=>{if(U){P(!1);return}const k=G&&d;(F||k)&&P(!0),!F&&!k&&!Z&&P(!1)},[n,g,G,U,d,P,F,Z]);const D=()=>{ne(!1),U||P(!0)},le=()=>{P(!1),ne(!1)};(0,o.useEffect)(()=>{if(!W)return;const k=re=>{re.key==="Escape"&&(re.preventDefault(),le())};return window.addEventListener("keydown",k),()=>{window.removeEventListener("keydown",k)}},[W,P]);const{layerProps:X,triggerProps:fe,renderLayer:ke}=(0,Fe.sJ)({isOpen:W,placement:Ur[s],ResizeObserver:he.Z,triggerOffset:m,container:f,auto:!0});return o.createElement(o.Fragment,null,o.createElement(wo,R(i(i({},fe),H),{onClick:k=>{k.detail===0&&ne(!0)},onFocus:D,onBlur:le,isInline:p,verticalAlign:z,tabIndex:U?-1:w,ref:(0,Fe.lq)(fe.ref,Y)}),r),a&&o.createElement("span",{className:"srOnly","aria-live":"polite"},W&&n),W&&ke(o.createElement("div",R(i({},X),{style:R(i({},X.style),{zIndex:x})}),o.createElement(Co,i({maxWidth:v,onMouseEnter:()=>ee(!0),onMouseLeave:()=>ee(!1),role:"tooltip",id:M},B),o.createElement(Ke,{gap:"small"},o.createElement($e,{size:"small",fontWeight:"bold"},n),l&&o.createElement(Ke,{gap:"xsmall"},l.map((k,re)=>o.createElement(bo,{key:re},k))))))))},C0=Object.keys(Ur),zo=yo,Kr=$.iv`
...
`,y0=e=>{var t=e,{variant:a="combined",maxWidth:r,symbolColor:n,wordmarkColor:l="body",brand:s="loom",customId:d=""}=t,m=y(t,["variant","maxWidth","symbolColor","wordmarkColor","brand","customId"]);return React44.createElement(Lo,i({variant:a,maxWidth:r},m),a==="combined"&&React44.createElement(ko,{brand:s,symbolColor:n,wordmarkColor:c(l),customId:d,className:"lns-logoSvg"}),a==="symbol"&&React44.createElement(Ro,{brand:s,symbolColor:n,customId:d,className:"lns-logoSvg"}),a==="wordmark"&&React44.createElement(Mo,{brand:s,wordmarkColor:c(l),className:"lns-logoSvg"}))},z0=null,_o="https://cdn.loom.com/assets/lens",Jr={small:"40px",medium:"80px"},Ho=h.Z.span`
...
`,x0=({animation:e="spin 2s infinite steps(49) forwards",brand:t="loom",size:a="medium"})=>React45.createElement(Ho,{animation:e,brand:t,size:a}),$0=null,jt="/* emotion-disable-server-rendering-unsafe-selector-warning-please-do-not-use-this-the-warning-exists-for-a-reason */",So={border:$.iv`
...
`,Do=e=>{var t=e,{children:a,htmlTag:r="li",className:n,backgroundColor:l,onClick:s,href:d,role:m}=t,v=y(t,["children","htmlTag","className","backgroundColor","onClick","href","role"]);const p=n?` ${n}`:"",g=["div","span","p","h1","h2","h3","h4","h5","h6","section","article","header","footer","main","aside","nav"],f=!r&&s;let w=!1;const x=r||"div";f||(w=g.includes(x));const z=!w||f?{onClick:s,onKeyDown:E=>{E.key==="Enter"&&(E.preventDefault(),s?.(E))}}:{};return React46.createElement(Bo,i(i({role:m||(r==="li"?"listitem":void 0),className:`ListRowWrapper${p}`,as:r,backgroundColor:l,href:d},z),v),a)},Oo=e=>e.map(t=>be(t)).join(" "),R0=e=>{var t=e,{children:a,columns:r,gap:n,variant:l="stripe",htmlTag:s="ul"}=t,d=y(t,["children","columns","gap","variant","htmlTag"]);let m=a;return s==="ul"&&(m=React46.Children.map(a,v=>React46.isValidElement(v)&&v.type===Do?React46.cloneElement(v,{htmlTag:"li"}):v)),React46.createElement(Io,i({as:s,columns:r&&Oo(r),gap:n,variant:l,role:s==="ul"?"list":void 0},d),m)},M0=null,Et=o.createContext({}),Vo=e=>`calc(-1 * ${be(e)})`,Qr=h.Z.div`
...
`,k0=e=>{var t=e,{children:a,isActive:r,htmlTag:n="button",icon:l,isDisabled:s=!1}=t,d=y(t,["children","isActive","htmlTag","icon","isDisabled"]);const{isPilledDesign:m}=React47.useContext(Et);return m?React47.createElement(ra,i({as:n,isActive:r,icon:l,role:"tab","aria-selected":r,disabled:s},d),l&&React47.createElement(ue,{htmlTag:"span",paddingRight:a&&"small"},React47.createElement(te,{icon:l,color:"currentColor"})),a):React47.createElement(ta,i({as:n,isActive:r,icon:l,role:"tab","aria-selected":r,disabled:s},d),l&&React47.createElement(ue,{htmlTag:"span",paddingRight:a&&"small"},React47.createElement(te,{icon:l,color:"currentColor"})),a)},Wo=e=>{var t=e,{children:a,scrollOffset:r,hasFullTabs:n,isPilledDesign:l,hasBottomBorder:s=!1}=t,d=y(t,["children","scrollOffset","hasFullTabs","isPilledDesign","hasBottomBorder"]);const m=l?React47.createElement(ea,i({hasFullTabs:n,scrollOffset:r,role:"tablist"},d),a):React47.createElement(qr,i({hasFullTabs:n,scrollOffset:r,hasBottomBorder:s,role:"tablist"},d),a);return r?React47.createElement(Qr,{scrollOffset:r},m):React47.createElement(Et.Provider,{value:{isPilledDesign:l}},m)},Po=({tooltipProps:e,children:t,tooltipId:a})=>e?o.createElement(zo,R(i({},e),{tooltipId:a,tabIndex:-1}),t):t,aa=o.forwardRef((e,t)=>{var a=e,{tabContent:r,tooltipProps:n,isActive:l,htmlTag:s="button",icon:d,isDisabled:m=!1,onKeyDown:v,onClick:p}=a,g=y(a,["tabContent","tooltipProps","isActive","htmlTag","icon","isDisabled","onKeyDown","onClick"]);const{isPilledDesign:f}=o.useContext(Et),w=(0,o.useId)(),x=i({as:s,isActive:l,icon:d,role:"tab","aria-selected":l,disabled:m,tabIndex:l?0:-1,"aria-describedby":n?w:void 0,onKeyDown:v,onClick:p,ref:t},g);return o.createElement(Po,{tooltipProps:n,tooltipId:w},f?o.createElement(ra,i({},x),d?o.createElement(ue,{htmlTag:"span",paddingRight:r&&"small"},o.createElement(te,{icon:d,color:"currentColor"})):null,r):o.createElement(ta,i({},x),d?o.createElement(ue,{htmlTag:"span",paddingRight:r&&"small"},o.createElement(te,{icon:d,color:"currentColor"})):null,r))});aa.displayName="TabNew";var Ao=e=>{var t=e,{tabs:a,scrollOffset:r,hasFullTabs:n,isPilledDesign:l,hasBottomBorder:s=!1}=t,d=y(t,["tabs","scrollOffset","hasFullTabs","isPilledDesign","hasBottomBorder"]);const m=useRef5({}),v=useCallback4((x,z)=>{var E;let M=z;switch(x.key){case"ArrowLeft":x.preventDefault(),M=z>0?z-1:a.length-1;break;case"ArrowRight":x.preventDefault(),M=z<a.length-1?z+1:0;break;case"Home":x.preventDefault(),M=0;break;case"End":x.preventDefault(),M=a.length-1;break;default:return}(E=m.current[M])==null||E.focus()},[a.length]),p=useCallback4(x=>z=>{m.current[x]=z},[]),g=useMemo4(()=>a.map((x,z)=>React47.createElement(aa,i({key:z,ref:p(z),onKeyDown:E=>v(E,z)},x))),[a,v,p]),f=useMemo4(()=>l?React47.createElement(ea,i({hasFullTabs:n,scrollOffset:r,role:"tablist"},d),g):React47.createElement(qr,i({hasFullTabs:n,scrollOffset:r,hasBottomBorder:s,role:"tablist"},d),g),[g,n,r,s,l,d]),w=React47.createElement(Et.Provider,{value:{isPilledDesign:l}},f);return r?React47.createElement(Qr,{scrollOffset:r},w):w},L0=e=>{var t=e,{children:a,tabs:r}=t,n=y(t,["children","tabs"]);return a&&r&&console.warn("Both children and tabs props are provided. Please use only one of them."),!a&&!r?(console.error("Either children or tabs must be provided."),null):a?React47.createElement(Wo,i({},n),a):React47.createElement(Ao,i({tabs:r},n))},_0=null,To=h.Z.div`
  display: inline-grid;
  grid-auto-flow: column;
  align-items: center;
  vertical-align: middle;
  ...
  ${Be("bold")};
  ${b("gap","xsmall")};
`,H0=e=>{var t=e,{color:a,backgroundColor:r,children:n,icon:l,iconPosition:s="left"}=t,d=y(t,["color","backgroundColor","children","icon","iconPosition"]);const m=React48.createElement(ue,{htmlTag:"span",paddingLeft:s==="right"&&"xsmall",paddingRight:s==="left"&&"xsmall"},React48.createElement(te,{icon:l,color:"currentColor",size:2}));return React48.createElement(To,i({color:a,backgroundColor:r},d),l&&s==="left"&&m,n,l&&s==="right"&&m)},S0=null,Fo={topLeft:"top-start",topCenter:"top",topRight:"top-end",bottomLeft:"bottom-start",bottomCenter:"bottom",bottomRight:"bottom-end",leftTop:"left-start",leftCenter:"left",leftBottom:"left-end",rightTop:"right-start",rightCenter:"right",rightBottom:"right-end"},Zo=h.Z.div`
  position: relative;
  width: fit-content;
...
`,na=h.Z.div`
  ${e=>e.zIndex&&`z-index: ${e.zIndex}`};
`,I0=e=>{var t=e,{children:a,content:r,offset:n=.5,boundaryOffset:l=.5,isOpen:s,zIndex:d=500,childrenZIndex:m=1,placement:v="topCenter",rootId:p,boundaryElement:g="body",transitionDuration:f=0,transitionDelay:w=0}=t,x=y(t,["children","content","offset","boundaryOffset","isOpen","zIndex","childrenZIndex","placement","rootId","boundaryElement","transitionDuration","transitionDelay"]);const z=n*Ue,E=l*Ue,M=typeof window<"u",B=p&&M?document.getElementById(p):void 0,{stage:F,shouldMount:H}=useTransition2(s,f+w),G=()=>g==="body"&&M?document.body:g,{x:ee,y:W,reference:P,floating:Z,strategy:ne,update:Y,refs:U}=useFloating({placement:Fo[v],middleware:[shift({padding:E,boundary:g?G():void 0,limiter:limitShift()}),flip({fallbackPlacements:["top","bottom"],fallbackStrategy:"initialPlacement"}),floatingUiOffset(z)],strategy:"fixed"});useEffect10(()=>{if(!(!U.reference.current||!U.floating.current))return autoUpdate(U.reference.current,U.floating.current,Y)},[U.reference,U.floating,Y,H]);const D={zIndex:d,ref:Z,style:{position:ne,top:W??"",left:ee??"",transition:`opacity ${f}ms ${w}ms`,opacity:F==="enter"?1:0}};return React49.createElement(Zo,R(i({ref:P},x),{childrenZIndex:m}),a,H&&React49.createElement(React49.Fragment,null,!B&&React49.createElement(na,i({},D),r),B&&ReactDOM.createPortal(React49.createElement(na,i({},D),r),B)))},B0=null,jo=h.Z.span`
  display: block;
...
`,D0=e=>{var t=e,{altText:a,illustration:r,color:n="orange",size:l=12}=t,s=y(t,["altText","illustration","color","size"]);return React50.createElement(jo,i({"aria-hidden":"true","aria-label":a,color:n,size:l},s),r)},O0=null,la=e=>$.iv`
  ${b("width",e.width)};
  ${b("height",e.height)};
...
`,No=h.Z.div`
  display: flex;
  ${e=>me("align-items",e.alignItems)};
  ${e=>e.justifyContent&&me("justify-content",e.justifyContent)};
  ${e=>e.alignContent&&me("align-content",e.alignContent)};
  ${e=>me("flex-wrap",e.wrap)};
  ${e=>e.direction&&me("flex-direction",e.direction)};
  ${e=>e.gap&&b("gap",e.gap)};
...
`,Uo=h.Z.div`
  ...
  ${e=>la(e)};
`,Ko=e=>{var t=e,{children:a,grow:r,shrink:n,basis:l,width:s,height:d,minWidth:m,minHeight:v,maxWidth:p,maxHeight:g,htmlTag:f="div",className:w,style:x}=t,z=y(t,["children","grow","shrink","basis","width","height","minWidth","minHeight","maxWidth","maxHeight","htmlTag","className","style"]);return(w||x)&&console.warn(Lt),React51.createElement(Uo,i({as:f,grow:r,shrink:n,basis:l,width:s,height:d,minWidth:m,minHeight:v,maxWidth:p,maxHeight:g},z),a)},Go=e=>{var t=e,{children:a,gap:r="initial",rowGap:n,columnGap:l,alignItems:s="center",justifyContent:d,alignContent:m,wrap:v="wrap",width:p,height:g,minWidth:f,minHeight:w,maxWidth:x,maxHeight:z,htmlTag:E="div",className:M,style:B}=t,F=y(t,["children","gap","rowGap","columnGap","alignItems","justifyContent","alignContent","wrap","width","height","minWidth","minHeight","maxWidth","maxHeight","htmlTag","className","style"]);return(M||B)&&console.warn(Lt),React51.createElement(No,i({as:E,gap:r,rowGap:n,columnGap:l,alignItems:s,justifyContent:d,alignContent:m,wrap:v,width:p,height:g,minWidth:f,minHeight:w,maxWidth:x,maxHeight:z},F),E==="ul"||E==="ol"?Children.map(a,H=>H.type===Ko||H.type===Go?cloneElement(H,{htmlTag:"li"}):H):a)},V0=null,Yo=h.Z.div`
...
`,ri=({swatches:e,currentColor:t,onSwatchClick:a})=>{const r=e.includes(t)&&t;return React52.createElement(ei,null,e.map(n=>React52.createElement(ti,{key:n,color:n,selected:r,onClick:()=>a(n),role:"button",tabIndex:0,onKeyDown:l=>{l.key==="Enter"&&(l.preventDefault(),a(n))}})))},ai=({color:e,setColor:t})=>React52.createElement(Yo,null,React52.createElement(HexColorPicker,{color:e,onChange:t}),React52.createElement(Jo,null,React52.createElement(HexColorInput,{prefixed:!0,color:e,onChange:t}),React52.createElement(Qo,{color:e}))),W0=e=>{var t=e,{defaultColor:a="#ffffff",confirmButton:r,swatches:n,onChange:l}=t,s=y(t,["defaultColor","confirmButton","swatches","onChange"]);const[d,m]=useState6(a||"#FFFFFF"),v=g=>{m(g),l(g)},p=g=>{v(g)};return React52.createElement(Xo,i({},s),n&&React52.createElement(ri,{swatches:n,currentColor:d,onSwatchClick:p}),React52.createElement(ai,{color:d,setColor:v}),r&&React52.createElement(qo,null,r))},P0=null,ni=2,Xe={small:{totalSize:u(2.25),height:u(.5625),dotSize:u(.375),gap:u(.25)},medium:{totalSize:u(3),height:u(.75),dotSize:u(.5),gap:u(.375)},large:{totalSize:u(6),height:u(1.5),dotSize:u(1),gap:u(.75)}},li=e=>Xe[e.size].totalSize,oi=e=>Xe[e.size].height,oa=e=>Xe[e.size].dotSize,ii=e=>Xe[e.size].gap,si=e=>Xe[e.size].dotSize,ci=e=>$.F4`
  0%, 40%, 100% {
    transform: translateY(50%);
  }
  20% {
...
`,A0=e=>{var t=e,{color:a="body",size:r="medium"}=t,n=y(t,["color","size"]);return React53.createElement(di,i({size:r},n),React53.createElement(Nt,{color:a,size:r,delay:0}),React53.createElement(Nt,{color:a,size:r,delay:.2}),React53.createElement(Nt,{color:a,size:r,delay:.4}))},T0=Object.keys(Xe),F0=null,Ut={medium:{totalSize:u(3),barHeight:u(2.25)}},ia={fast:1.2,slow:1.7},ui="linear-gradient(270deg, #565ADD 10.58%, #DC43BE 41.83%, #565ADD 69.23%, #565ADD 96.63%)",hi=2,Kt=5,mi=u(.25),vi=e=>Ut[e.size||"medium"].barHeight,ot=e=>Ut[e.size||"medium"].totalSize,sa=e=>ia[e.speed||"fast"],gi=$.F4`
  0%, 100% {
...
`,Ci=h.Z.span`
  ...
  position: relative;
`,Z0=e=>{var t=e,{size:a="medium",speed:r="fast",color:n="body"}=t,l=y(t,["size","speed","color"]);const s=Array.from({length:Kt},(d,m)=>React54.createElement(Ci,{key:m,index:m,size:a,speed:r,color:n}));return React54.createElement(bi,i({size:a,color:n},l),s)},j0=Object.keys(Ut),N0=Object.keys(ia),U0=null,wi=$.F4`
  0% {
    transform: scale(1);
    opacity: 0;
  }
...
`,He={dot:{size:"8px",borderWidth:"1px",borderColor:c("background")},positioning:{top:"-2px",right:"-2px"},animation:{duration:"2s",timing:"ease-out",iteration:"infinite"}},ca={blue:c("blue"),orange:c("orange")},Ei=h.Z.span`
  position: relative;
  display: inline-block;
`,yi=h.Z.span`
  position: absolute;
